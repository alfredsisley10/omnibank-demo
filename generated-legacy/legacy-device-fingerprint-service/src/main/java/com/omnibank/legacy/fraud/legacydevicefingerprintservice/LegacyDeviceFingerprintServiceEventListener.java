...
/**
 * Event listener for the retired Legacy Device Fingerprint Service.
 *
...
public final class LegacyDeviceFingerprintServiceEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyDeviceFingerprintServiceEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code DeviceTrustEvaluator}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyDeviceFingerprintService absorbed event={} bytes={}",

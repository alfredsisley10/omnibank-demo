...
/**
 * Configuration for the retired Legacy Device Fingerprint Service.
 *
...
public final class LegacyDeviceFingerprintServiceConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYDEVICEFINGERPRINTSERVICE_";
    ...
    private LegacyDeviceFingerprintServiceConfiguration() {
        throw new AssertionError("constants only — see DeviceTrustEvaluator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "DeviceTrustEvaluator",
                "ticket", "MIG-4022",

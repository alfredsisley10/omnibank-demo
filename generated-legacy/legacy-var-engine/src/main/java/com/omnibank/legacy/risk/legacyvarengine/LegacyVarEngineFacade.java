...
/**
 * Facade for the Legacy VaR Engine subsystem.
 *
 ...
 * {@code com.omnibank.legacy.risk.legacyvarengine} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyVarEngineFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyVarEngineFacade.class);
    ...
    public LegacyVarEngineFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code ValueAtRiskCalculator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by ValueAtRiskCalculator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code ValueAtRiskCalculator}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code ValueAtRiskCalculator} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

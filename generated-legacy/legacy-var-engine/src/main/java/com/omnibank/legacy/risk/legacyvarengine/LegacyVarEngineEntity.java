...
/**
 * Persistent entity for the retired Legacy VaR Engine.
 *
 ...
 * is read-only after 2019. New writes go through the {@code ValueAtRiskCalculator}
...
public final class LegacyVarEngineEntity {
    ...
    public LegacyVarEngineEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyVarEngineEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyVarEngineEntity[id=" + id + ", ref=" + externalReference

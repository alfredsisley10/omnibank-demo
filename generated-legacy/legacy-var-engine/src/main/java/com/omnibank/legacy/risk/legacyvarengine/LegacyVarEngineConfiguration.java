...
/**
 * Configuration for the retired Legacy VaR Engine.
 *
...
public final class LegacyVarEngineConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYVARENGINE_";
    ...
    private LegacyVarEngineConfiguration() {
        throw new AssertionError("constants only — see ValueAtRiskCalculator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "ValueAtRiskCalculator",
                "ticket", "MIG-8001",

...
/**
 * Persistent entity for the retired Legacy Customer Profile Service.
 *
 ...
 * is read-only after 2018. New writes go through the {@code ConsumerAccountService}
...
public final class LegacyCustomerProfileServiceEntity {
    ...
    public LegacyCustomerProfileServiceEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCustomerProfileServiceEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCustomerProfileServiceEntity[id=" + id + ", ref=" + externalReference

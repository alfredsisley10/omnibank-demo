...
/**
 * Facade for the Legacy Customer Profile Service subsystem.
 *
 ...
 * {@code com.omnibank.legacy.accounts.legacycustomerprofileservice} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyCustomerProfileServiceFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyCustomerProfileServiceFacade.class);
    ...
    public LegacyCustomerProfileServiceFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code ConsumerAccountService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by ConsumerAccountService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code ConsumerAccountService}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code ConsumerAccountService} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

...
/**
 * Persistent entity for the retired Legacy Rewards Calculator.
 *
 ...
 * is read-only after 2021. New writes go through the {@code CardRewardsCalculator}
...
public final class LegacyRewardsCalculatorEntity {
    ...
    public LegacyRewardsCalculatorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyRewardsCalculatorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyRewardsCalculatorEntity[id=" + id + ", ref=" + externalReference

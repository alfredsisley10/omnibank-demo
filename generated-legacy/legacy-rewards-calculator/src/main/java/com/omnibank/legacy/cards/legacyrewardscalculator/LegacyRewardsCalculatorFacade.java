...
/**
 * Facade for the Legacy Rewards Calculator subsystem.
 *
 ...
 * {@code com.omnibank.legacy.cards.legacyrewardscalculator} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyRewardsCalculatorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyRewardsCalculatorFacade.class);
    ...
    public LegacyRewardsCalculatorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CardRewardsCalculator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CardRewardsCalculator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CardRewardsCalculator}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code CardRewardsCalculator} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

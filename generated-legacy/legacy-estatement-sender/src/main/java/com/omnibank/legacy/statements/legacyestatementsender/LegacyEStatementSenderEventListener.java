...
/**
 * Event listener for the retired Legacy E-Statement Sender.
 *
...
public final class LegacyEStatementSenderEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyEStatementSenderEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code StatementDeliveryService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyEStatementSender absorbed event={} bytes={}",

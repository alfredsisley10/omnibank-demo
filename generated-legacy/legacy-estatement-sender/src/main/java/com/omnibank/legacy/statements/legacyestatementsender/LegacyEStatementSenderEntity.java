...
/**
 * Persistent entity for the retired Legacy E-Statement Sender.
 *
 ...
 * is read-only after 2020. New writes go through the {@code StatementDeliveryService}
...
public final class LegacyEStatementSenderEntity {
    ...
    public LegacyEStatementSenderEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyEStatementSenderEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyEStatementSenderEntity[id=" + id + ", ref=" + externalReference

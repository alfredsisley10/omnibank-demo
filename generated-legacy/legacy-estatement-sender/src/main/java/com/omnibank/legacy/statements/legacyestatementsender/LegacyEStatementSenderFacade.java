...
/**
 * Facade for the Legacy E-Statement Sender subsystem.
 *
 ...
 * {@code com.omnibank.legacy.statements.legacyestatementsender} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyEStatementSenderFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyEStatementSenderFacade.class);
    ...
    public LegacyEStatementSenderFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code StatementDeliveryService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by StatementDeliveryService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code StatementDeliveryService}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code StatementDeliveryService} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

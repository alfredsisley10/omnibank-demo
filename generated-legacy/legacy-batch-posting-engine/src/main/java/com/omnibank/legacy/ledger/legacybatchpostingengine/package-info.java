/**
 * Legacy Batch Posting Engine — retired in Q? 2018 under MIG-1102.
 *
 * <p>Replaced by {@code PostingService}; this package is retained
 ...
 * authoritative behavior, stop — see {@code PostingService}.
 */

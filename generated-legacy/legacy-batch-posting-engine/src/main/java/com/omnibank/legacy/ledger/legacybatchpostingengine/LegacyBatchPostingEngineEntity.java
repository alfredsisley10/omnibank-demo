...
/**
 * Persistent entity for the retired Legacy Batch Posting Engine.
 *
 ...
 * is read-only after 2018. New writes go through the {@code PostingService}
...
public final class LegacyBatchPostingEngineEntity {
    ...
    public LegacyBatchPostingEngineEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyBatchPostingEngineEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyBatchPostingEngineEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Facade for the Legacy Account Open Wizard subsystem.
 *
 ...
 * {@code com.omnibank.legacy.accounts.legacyaccountopenwizard} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyAccountOpenWizardFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyAccountOpenWizardFacade.class);
    ...
    public LegacyAccountOpenWizardFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code AccountOpeningOrchestrator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by AccountOpeningOrchestrator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code AccountOpeningOrchestrator}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code AccountOpeningOrchestrator} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

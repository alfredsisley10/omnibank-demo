...
/**
 * Event listener for the retired Legacy Counterparty Scorer.
 *
...
public final class LegacyCounterpartyScorerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyCounterpartyScorerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code CounterpartyRiskScorer}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyCounterpartyScorer absorbed event={} bytes={}",

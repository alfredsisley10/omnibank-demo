...
/**
 * Persistent entity for the retired Legacy Counterparty Scorer.
 *
 ...
 * is read-only after 2022. New writes go through the {@code CounterpartyRiskScorer}
...
public final class LegacyCounterpartyScorerEntity {
    ...
    public LegacyCounterpartyScorerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCounterpartyScorerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCounterpartyScorerEntity[id=" + id + ", ref=" + externalReference

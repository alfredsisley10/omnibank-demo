...
/**
 * Event listener for the retired Legacy ACH Processor.
 *
...
public final class LegacyAchProcessorEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyAchProcessorEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code AchPaymentProcessor}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyAchProcessor absorbed event={} bytes={}",

...
/**
 * Facade for the Legacy ACH Processor subsystem.
 *
 ...
 * {@code com.omnibank.legacy.payments.legacyachprocessor} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyAchProcessorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyAchProcessorFacade.class);
    ...
    public LegacyAchProcessorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code AchPaymentProcessor} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by AchPaymentProcessor",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code AchPaymentProcessor}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code AchPaymentProcessor} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

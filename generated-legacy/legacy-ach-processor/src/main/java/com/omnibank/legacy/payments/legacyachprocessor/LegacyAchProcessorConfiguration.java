...
/**
 * Configuration for the retired Legacy ACH Processor.
 *
...
public final class LegacyAchProcessorConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYACHPROCESSOR_";
    ...
    private LegacyAchProcessorConfiguration() {
        throw new AssertionError("constants only — see AchPaymentProcessor");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "AchPaymentProcessor",
                "ticket", "MIG-1042",

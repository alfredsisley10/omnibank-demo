...
/**
 * Facade for the Legacy XML Importer subsystem.
 *
 ...
 * {@code com.omnibank.legacy.integration.legacyxmlimporter} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyXmlImporterFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyXmlImporterFacade.class);
    ...
    public LegacyXmlImporterFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code JsonImporter} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by JsonImporter",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code JsonImporter}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code JsonImporter} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

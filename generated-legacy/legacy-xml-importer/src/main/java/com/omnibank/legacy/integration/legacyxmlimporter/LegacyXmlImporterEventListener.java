...
/**
 * Event listener for the retired Legacy XML Importer.
 *
...
public final class LegacyXmlImporterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyXmlImporterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code JsonImporter}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyXmlImporter absorbed event={} bytes={}",

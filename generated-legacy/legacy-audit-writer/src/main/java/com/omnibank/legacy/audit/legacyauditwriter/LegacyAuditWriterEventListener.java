...
/**
 * Event listener for the retired Legacy Audit Writer.
 *
...
public final class LegacyAuditWriterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyAuditWriterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code AuditEventWriter}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyAuditWriter absorbed event={} bytes={}",

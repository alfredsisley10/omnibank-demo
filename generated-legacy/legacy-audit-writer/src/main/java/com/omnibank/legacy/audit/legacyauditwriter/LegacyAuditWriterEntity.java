...
/**
 * Persistent entity for the retired Legacy Audit Writer.
 *
 ...
 * is read-only after 2018. New writes go through the {@code AuditEventWriter}
...
public final class LegacyAuditWriterEntity {
    ...
    public LegacyAuditWriterEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyAuditWriterEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyAuditWriterEntity[id=" + id + ", ref=" + externalReference

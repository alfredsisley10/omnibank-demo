...
/**
 * Persistent entity for the retired Legacy Batch Scheduler.
 *
 ...
 * is read-only after 2018. New writes go through the {@code BatchJobOrchestrator}
...
public final class LegacyBatchSchedulerEntity {
    ...
    public LegacyBatchSchedulerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyBatchSchedulerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyBatchSchedulerEntity[id=" + id + ", ref=" + externalReference

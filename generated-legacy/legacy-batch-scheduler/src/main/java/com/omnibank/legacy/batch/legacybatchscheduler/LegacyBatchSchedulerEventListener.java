...
/**
 * Event listener for the retired Legacy Batch Scheduler.
 *
...
public final class LegacyBatchSchedulerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyBatchSchedulerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code BatchJobOrchestrator}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyBatchScheduler absorbed event={} bytes={}",

...
/**
 * Configuration for the retired Legacy Batch Scheduler.
 *
...
public final class LegacyBatchSchedulerConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYBATCHSCHEDULER_";
    ...
    private LegacyBatchSchedulerConfiguration() {
        throw new AssertionError("constants only — see BatchJobOrchestrator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "BatchJobOrchestrator",
                "ticket", "MIG-9601",

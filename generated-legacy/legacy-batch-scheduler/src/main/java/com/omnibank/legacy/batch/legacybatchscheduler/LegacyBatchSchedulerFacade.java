...
/**
 * Facade for the Legacy Batch Scheduler subsystem.
 *
 ...
 * {@code com.omnibank.legacy.batch.legacybatchscheduler} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyBatchSchedulerFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyBatchSchedulerFacade.class);
    ...
    public LegacyBatchSchedulerFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code BatchJobOrchestrator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by BatchJobOrchestrator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code BatchJobOrchestrator}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code BatchJobOrchestrator} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

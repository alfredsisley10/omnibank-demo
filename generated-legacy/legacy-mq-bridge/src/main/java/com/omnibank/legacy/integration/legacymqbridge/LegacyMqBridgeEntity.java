...
/**
 * Persistent entity for the retired Legacy MQ Bridge.
 *
 ...
 * is read-only after 2019. New writes go through the {@code MessagingBridge}
...
public final class LegacyMqBridgeEntity {
    ...
    public LegacyMqBridgeEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyMqBridgeEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyMqBridgeEntity[id=" + id + ", ref=" + externalReference

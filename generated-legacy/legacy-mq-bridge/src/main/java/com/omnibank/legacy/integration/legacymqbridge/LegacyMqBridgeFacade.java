...
/**
 * Facade for the Legacy MQ Bridge subsystem.
 *
 ...
 * {@code com.omnibank.legacy.integration.legacymqbridge} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyMqBridgeFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyMqBridgeFacade.class);
    ...
    public LegacyMqBridgeFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code MessagingBridge} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by MessagingBridge",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code MessagingBridge}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code MessagingBridge} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

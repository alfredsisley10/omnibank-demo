...
/**
 * Persistent entity for the retired Legacy Fraud Rules Engine.
 *
 ...
 * is read-only after 2018. New writes go through the {@code CardFraudRuleEvaluator}
...
public final class LegacyFraudRulesEngineEntity {
    ...
    public LegacyFraudRulesEngineEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyFraudRulesEngineEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyFraudRulesEngineEntity[id=" + id + ", ref=" + externalReference

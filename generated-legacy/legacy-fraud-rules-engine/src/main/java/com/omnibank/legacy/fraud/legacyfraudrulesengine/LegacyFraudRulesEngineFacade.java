...
/**
 * Facade for the Legacy Fraud Rules Engine subsystem.
 *
 ...
 * {@code com.omnibank.legacy.fraud.legacyfraudrulesengine} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyFraudRulesEngineFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyFraudRulesEngineFacade.class);
    ...
    public LegacyFraudRulesEngineFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CardFraudRuleEvaluator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CardFraudRuleEvaluator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CardFraudRuleEvaluator}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code CardFraudRuleEvaluator} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

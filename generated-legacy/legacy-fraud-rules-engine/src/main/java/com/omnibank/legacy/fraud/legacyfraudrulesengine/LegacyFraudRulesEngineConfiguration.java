...
/**
 * Configuration for the retired Legacy Fraud Rules Engine.
 *
...
public final class LegacyFraudRulesEngineConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYFRAUDRULESENGINE_";
    ...
    private LegacyFraudRulesEngineConfiguration() {
        throw new AssertionError("constants only — see CardFraudRuleEvaluator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "CardFraudRuleEvaluator",
                "ticket", "MIG-4001",

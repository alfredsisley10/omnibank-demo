/**
 * Legacy Fraud Rules Engine — retired in Q? 2018 under MIG-4001.
 *
 * <p>Replaced by {@code CardFraudRuleEvaluator}; this package is retained
 ...
 * authoritative behavior, stop — see {@code CardFraudRuleEvaluator}.
 */

...
/**
 * Persistent entity for the retired Legacy Trial Balance Calculator.
 *
 * <p>// DO NOT MODIFY — retired 2019 under MIG-1110 (replaced by TrialBalanceEngine).
 *
 * <p>Schema lives in the {@code legacy_ledger} schema and
 * is read-only after 2019. New writes go through the {@code TrialBalanceEngine}
...
public final class LegacyTrialBalanceCalculatorEntity {
    ...
    public LegacyTrialBalanceCalculatorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyTrialBalanceCalculatorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyTrialBalanceCalculatorEntity[id=" + id + ", ref=" + externalReference

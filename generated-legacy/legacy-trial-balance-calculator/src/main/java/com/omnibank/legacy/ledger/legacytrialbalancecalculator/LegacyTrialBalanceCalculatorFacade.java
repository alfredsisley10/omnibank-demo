...
/**
 * Facade for the Legacy Trial Balance Calculator subsystem.
 *
 ...
 * {@code com.omnibank.legacy.ledger.legacytrialbalancecalculator} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyTrialBalanceCalculatorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyTrialBalanceCalculatorFacade.class);
    ...
    public LegacyTrialBalanceCalculatorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code TrialBalanceEngine} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by TrialBalanceEngine",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code TrialBalanceEngine}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code TrialBalanceEngine} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

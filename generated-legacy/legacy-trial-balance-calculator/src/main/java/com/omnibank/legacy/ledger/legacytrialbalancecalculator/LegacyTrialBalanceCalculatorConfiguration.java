...
/**
 * Configuration for the retired Legacy Trial Balance Calculator.
 *
...
public final class LegacyTrialBalanceCalculatorConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYTRIALBALANCECALCULATOR_";
    ...
    private LegacyTrialBalanceCalculatorConfiguration() {
        throw new AssertionError("constants only — see TrialBalanceEngine");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "TrialBalanceEngine",
                "ticket", "MIG-1110",

...
/**
 * Facade for the Legacy Chargeback Processor subsystem.
 *
 ...
 * {@code com.omnibank.legacy.fraud.legacychargebackprocessor} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyChargebackProcessorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyChargebackProcessorFacade.class);
    ...
    public LegacyChargebackProcessorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CardDisputeManager} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CardDisputeManager",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CardDisputeManager}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code CardDisputeManager} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

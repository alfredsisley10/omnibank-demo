...
/**
 * Persistent entity for the retired Legacy Chargeback Processor.
 *
 ...
 * is read-only after 2020. New writes go through the {@code CardDisputeManager}
...
public final class LegacyChargebackProcessorEntity {
    ...
    public LegacyChargebackProcessorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyChargebackProcessorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyChargebackProcessorEntity[id=" + id + ", ref=" + externalReference

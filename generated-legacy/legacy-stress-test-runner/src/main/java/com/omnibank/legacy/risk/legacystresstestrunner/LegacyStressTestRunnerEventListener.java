...
/**
 * Event listener for the retired Legacy Stress Test Runner.
 *
...
public final class LegacyStressTestRunnerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyStressTestRunnerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code StressTestHarness}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyStressTestRunner absorbed event={} bytes={}",

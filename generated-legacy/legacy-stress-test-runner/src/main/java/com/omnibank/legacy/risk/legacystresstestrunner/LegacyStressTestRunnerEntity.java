...
/**
 * Persistent entity for the retired Legacy Stress Test Runner.
 *
 ...
 * is read-only after 2020. New writes go through the {@code StressTestHarness}
...
public final class LegacyStressTestRunnerEntity {
    ...
    public LegacyStressTestRunnerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyStressTestRunnerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyStressTestRunnerEntity[id=" + id + ", ref=" + externalReference

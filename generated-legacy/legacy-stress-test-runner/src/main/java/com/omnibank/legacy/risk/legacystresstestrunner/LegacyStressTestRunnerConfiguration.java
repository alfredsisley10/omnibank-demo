...
/**
 * Configuration for the retired Legacy Stress Test Runner.
 *
...
public final class LegacyStressTestRunnerConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYSTRESSTESTRUNNER_";
    ...
    private LegacyStressTestRunnerConfiguration() {
        throw new AssertionError("constants only — see StressTestHarness");
    }

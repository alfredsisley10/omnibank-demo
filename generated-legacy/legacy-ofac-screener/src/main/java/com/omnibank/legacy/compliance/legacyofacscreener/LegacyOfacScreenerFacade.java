...
/**
 * Facade for the Legacy OFAC Screener subsystem.
 *
 ...
 * {@code com.omnibank.legacy.compliance.legacyofacscreener} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyOfacScreenerFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyOfacScreenerFacade.class);
    ...
    public LegacyOfacScreenerFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code SanctionsScreeningService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by SanctionsScreeningService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code SanctionsScreeningService}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code SanctionsScreeningService} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

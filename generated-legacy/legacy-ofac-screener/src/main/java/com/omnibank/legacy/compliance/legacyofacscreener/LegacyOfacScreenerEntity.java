...
/**
 * Persistent entity for the retired Legacy OFAC Screener.
 *
 ...
 * is read-only after 2019. New writes go through the {@code SanctionsScreeningService}
...
public final class LegacyOfacScreenerEntity {
    ...
    public LegacyOfacScreenerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyOfacScreenerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyOfacScreenerEntity[id=" + id + ", ref=" + externalReference

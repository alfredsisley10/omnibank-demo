...
/**
 * Event listener for the retired Legacy OFAC Screener.
 *
...
public final class LegacyOfacScreenerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyOfacScreenerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code SanctionsScreeningService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyOfacScreener absorbed event={} bytes={}",

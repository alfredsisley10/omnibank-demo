...
/**
 * Event listener for the retired Legacy P2P Router.
 *
...
public final class LegacyP2PRouterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyP2PRouterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code P2PPaymentProcessor}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyP2PRouter absorbed event={} bytes={}",

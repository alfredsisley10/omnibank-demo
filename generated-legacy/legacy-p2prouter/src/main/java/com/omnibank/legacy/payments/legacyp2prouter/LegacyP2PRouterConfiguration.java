...
/**
 * Configuration for the retired Legacy P2P Router.
 *
...
public final class LegacyP2PRouterConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYP2PROUTER_";
    ...
    private LegacyP2PRouterConfiguration() {
        throw new AssertionError("constants only — see P2PPaymentProcessor");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "P2PPaymentProcessor",
                "ticket", "MIG-1090",

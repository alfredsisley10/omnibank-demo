...
/**
 * Persistent entity for the retired Legacy P2P Router.
 *
 ...
 * is read-only after 2021. New writes go through the {@code P2PPaymentProcessor}
...
public final class LegacyP2PRouterEntity {
    ...
    public LegacyP2PRouterEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyP2PRouterEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyP2PRouterEntity[id=" + id + ", ref=" + externalReference

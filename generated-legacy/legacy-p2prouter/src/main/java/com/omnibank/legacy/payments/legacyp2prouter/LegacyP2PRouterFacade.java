...
/**
 * Facade for the Legacy P2P Router subsystem.
 *
 ...
 * {@code com.omnibank.legacy.payments.legacyp2prouter} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyP2PRouterFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyP2PRouterFacade.class);
    ...
    public LegacyP2PRouterFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code P2PPaymentProcessor} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by P2PPaymentProcessor",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code P2PPaymentProcessor}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code P2PPaymentProcessor} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

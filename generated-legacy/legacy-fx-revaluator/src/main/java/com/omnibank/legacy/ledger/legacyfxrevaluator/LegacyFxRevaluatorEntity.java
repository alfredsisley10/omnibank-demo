...
/**
 * Persistent entity for the retired Legacy FX Revaluator.
 *
 ...
 * is read-only after 2022. New writes go through the {@code CurrencyRevaluationEngine}
...
public final class LegacyFxRevaluatorEntity {
    ...
    public LegacyFxRevaluatorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyFxRevaluatorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyFxRevaluatorEntity[id=" + id + ", ref=" + externalReference

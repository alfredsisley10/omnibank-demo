...
/**
 * Facade for the Legacy FX Revaluator subsystem.
 *
 ...
 * {@code com.omnibank.legacy.ledger.legacyfxrevaluator} package.
 */
@Deprecated(since = "2022-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyFxRevaluatorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyFxRevaluatorFacade.class);
    ...
    public LegacyFxRevaluatorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CurrencyRevaluationEngine} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2022-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CurrencyRevaluationEngine",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CurrencyRevaluationEngine}.
     */
    @Deprecated(since = "2022-01-01")
     ...
     *             {@code CurrencyRevaluationEngine} which preserves audit ordering.
     */
    @Deprecated(since = "2022-01-01")

...
/**
 * Persistent entity for the retired Legacy Preferences Portal.
 *
 ...
 * is read-only after 2021. New writes go through the {@code StatementPreferencesManager}
...
public final class LegacyPreferencesPortalEntity {
    ...
    public LegacyPreferencesPortalEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyPreferencesPortalEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyPreferencesPortalEntity[id=" + id + ", ref=" + externalReference

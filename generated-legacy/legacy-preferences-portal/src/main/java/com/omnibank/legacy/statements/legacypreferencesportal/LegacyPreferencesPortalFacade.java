...
/**
 * Facade for the Legacy Preferences Portal subsystem.
 *
 ...
 * {@code com.omnibank.legacy.statements.legacypreferencesportal} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyPreferencesPortalFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyPreferencesPortalFacade.class);
    ...
    public LegacyPreferencesPortalFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code StatementPreferencesManager} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by StatementPreferencesManager",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code StatementPreferencesManager}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code StatementPreferencesManager} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

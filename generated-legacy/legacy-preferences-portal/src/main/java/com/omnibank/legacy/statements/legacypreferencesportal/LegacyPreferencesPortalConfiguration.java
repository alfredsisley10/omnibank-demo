...
/**
 * Configuration for the retired Legacy Preferences Portal.
 *
...
public final class LegacyPreferencesPortalConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYPREFERENCESPORTAL_";
    ...
    private LegacyPreferencesPortalConfiguration() {
        throw new AssertionError("constants only — see StatementPreferencesManager");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "StatementPreferencesManager",
                "ticket", "MIG-6022",

...
/**
 * Event listener for the retired Legacy Preferences Portal.
 *
 * <p>// DO NOT MODIFY — retired 2021 under MIG-6022 (replaced by StatementPreferencesManager).
 *
 * <p>Used to subscribe to the {@code legacy.statements.events} JMS
...
public final class LegacyPreferencesPortalEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyPreferencesPortalEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code StatementPreferencesManager}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyPreferencesPortal absorbed event={} bytes={}",

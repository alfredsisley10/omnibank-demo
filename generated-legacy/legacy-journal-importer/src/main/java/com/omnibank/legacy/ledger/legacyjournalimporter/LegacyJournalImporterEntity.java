...
/**
 * Persistent entity for the retired Legacy Journal Importer.
 *
 ...
 * is read-only after 2020. New writes go through the {@code JournalEntryProposalService}
...
public final class LegacyJournalImporterEntity {
    ...
    public LegacyJournalImporterEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyJournalImporterEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyJournalImporterEntity[id=" + id + ", ref=" + externalReference

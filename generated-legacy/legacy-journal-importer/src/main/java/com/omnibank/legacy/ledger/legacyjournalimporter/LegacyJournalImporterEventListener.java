...
/**
 * Event listener for the retired Legacy Journal Importer.
 *
...
public final class LegacyJournalImporterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyJournalImporterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code JournalEntryProposalService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyJournalImporter absorbed event={} bytes={}",

...
/**
 * Facade for the Legacy Journal Importer subsystem.
 *
 ...
 * {@code com.omnibank.legacy.ledger.legacyjournalimporter} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyJournalImporterFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyJournalImporterFacade.class);
    ...
    public LegacyJournalImporterFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code JournalEntryProposalService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by JournalEntryProposalService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code JournalEntryProposalService}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code JournalEntryProposalService} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

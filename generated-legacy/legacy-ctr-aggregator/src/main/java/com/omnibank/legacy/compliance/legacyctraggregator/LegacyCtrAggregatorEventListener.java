...
/**
 * Event listener for the retired Legacy CTR Aggregator.
 *
...
public final class LegacyCtrAggregatorEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyCtrAggregatorEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code CurrencyTransactionReporter}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyCtrAggregator absorbed event={} bytes={}",

...
/**
 * Persistent entity for the retired Legacy CTR Aggregator.
 *
 ...
 * is read-only after 2021. New writes go through the {@code CurrencyTransactionReporter}
...
public final class LegacyCtrAggregatorEntity {
    ...
    public LegacyCtrAggregatorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCtrAggregatorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCtrAggregatorEntity[id=" + id + ", ref=" + externalReference

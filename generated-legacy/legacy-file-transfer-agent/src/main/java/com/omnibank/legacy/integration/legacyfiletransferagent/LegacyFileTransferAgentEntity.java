...
/**
 * Persistent entity for the retired Legacy File Transfer Agent.
 *
 ...
 * is read-only after 2018. New writes go through the {@code SecureFileTransferService}
...
public final class LegacyFileTransferAgentEntity {
    ...
    public LegacyFileTransferAgentEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyFileTransferAgentEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyFileTransferAgentEntity[id=" + id + ", ref=" + externalReference

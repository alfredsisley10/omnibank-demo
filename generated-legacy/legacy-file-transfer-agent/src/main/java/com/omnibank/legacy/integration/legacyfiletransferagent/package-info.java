/**
 * Legacy File Transfer Agent — retired in Q? 2018 under MIG-9701.
 *
 * <p>Replaced by {@code SecureFileTransferService}; this package is retained
 ...
 * authoritative behavior, stop — see {@code SecureFileTransferService}.
 */

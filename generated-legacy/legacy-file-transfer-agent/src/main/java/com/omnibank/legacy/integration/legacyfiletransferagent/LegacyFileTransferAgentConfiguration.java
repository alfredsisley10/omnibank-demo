...
/**
 * Configuration for the retired Legacy File Transfer Agent.
 *
...
public final class LegacyFileTransferAgentConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYFILETRANSFERAGENT_";
    ...
    private LegacyFileTransferAgentConfiguration() {
        throw new AssertionError("constants only — see SecureFileTransferService");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "SecureFileTransferService",
                "ticket", "MIG-9701",

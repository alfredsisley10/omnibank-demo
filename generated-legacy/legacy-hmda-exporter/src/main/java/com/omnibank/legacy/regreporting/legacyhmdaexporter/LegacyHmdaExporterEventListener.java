...
/**
 * Event listener for the retired Legacy HMDA Exporter.
 *
...
public final class LegacyHmdaExporterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyHmdaExporterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code HmdaReportGenerator}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyHmdaExporter absorbed event={} bytes={}",

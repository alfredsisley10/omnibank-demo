...
/**
 * Persistent entity for the retired Legacy SAR Filer.
 *
 ...
 * is read-only after 2020. New writes go through the {@code AmlTransactionMonitor}
...
public final class LegacySarFilerEntity {
    ...
    public LegacySarFilerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacySarFilerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacySarFilerEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Facade for the Legacy SAR Filer subsystem.
 *
 ...
 * {@code com.omnibank.legacy.compliance.legacysarfiler} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacySarFilerFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacySarFilerFacade.class);
    ...
    public LegacySarFilerFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code AmlTransactionMonitor} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by AmlTransactionMonitor",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code AmlTransactionMonitor}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code AmlTransactionMonitor} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

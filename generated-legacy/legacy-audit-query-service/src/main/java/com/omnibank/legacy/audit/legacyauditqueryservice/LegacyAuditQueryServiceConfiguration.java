...
/**
 * Configuration for the retired Legacy Audit Query Service.
 *
...
public final class LegacyAuditQueryServiceConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYAUDITQUERYSERVICE_";
    ...
    private LegacyAuditQueryServiceConfiguration() {
        throw new AssertionError("constants only — see AuditEventReader");
    }

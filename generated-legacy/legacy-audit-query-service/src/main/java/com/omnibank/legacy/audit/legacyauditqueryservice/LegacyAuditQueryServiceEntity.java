...
/**
 * Persistent entity for the retired Legacy Audit Query Service.
 *
 * <p>// DO NOT MODIFY — retired 2020 under MIG-9508 (replaced by AuditEventReader).
 *
 * <p>Schema lives in the {@code legacy_audit} schema and
 * is read-only after 2020. New writes go through the {@code AuditEventReader}
...
public final class LegacyAuditQueryServiceEntity {
    ...
    public LegacyAuditQueryServiceEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyAuditQueryServiceEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyAuditQueryServiceEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Facade for the Legacy Audit Query Service subsystem.
 *
 ...
 * {@code com.omnibank.legacy.audit.legacyauditqueryservice} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyAuditQueryServiceFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyAuditQueryServiceFacade.class);
    ...
    public LegacyAuditQueryServiceFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code AuditEventReader} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by AuditEventReader",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code AuditEventReader}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code AuditEventReader} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

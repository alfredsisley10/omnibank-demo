...
/**
 * Event listener for the retired Legacy Notification Dispatcher.
 *
...
public final class LegacyNotificationDispatcherEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyNotificationDispatcherEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code NotificationDispatcher}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyNotificationDispatcher absorbed event={} bytes={}",

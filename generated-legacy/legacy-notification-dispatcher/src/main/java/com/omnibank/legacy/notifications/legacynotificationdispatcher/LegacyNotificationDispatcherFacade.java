...
/**
 * Facade for the Legacy Notification Dispatcher subsystem.
 *
 ...
 * {@code com.omnibank.legacy.notifications.legacynotificationdispatcher} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyNotificationDispatcherFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyNotificationDispatcherFacade.class);
    ...
    public LegacyNotificationDispatcherFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code NotificationDispatcher} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by NotificationDispatcher",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code NotificationDispatcher}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code NotificationDispatcher} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

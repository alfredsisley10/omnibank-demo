...
/**
 * Persistent entity for the retired Legacy Notification Dispatcher.
 *
 ...
 * is read-only after 2018. New writes go through the {@code NotificationDispatcher}
...
public final class LegacyNotificationDispatcherEntity {
    ...
    public LegacyNotificationDispatcherEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyNotificationDispatcherEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyNotificationDispatcherEntity[id=" + id + ", ref=" + externalReference

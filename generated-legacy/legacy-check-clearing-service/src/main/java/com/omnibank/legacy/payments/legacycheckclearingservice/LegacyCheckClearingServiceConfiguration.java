...
/**
 * Configuration for the retired Legacy Check Clearing Service.
 *
...
public final class LegacyCheckClearingServiceConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYCHECKCLEARINGSERVICE_";

    /** Default legacy connection string format — never resolved at runtime. */
    public static final String CONNECTION_TEMPLATE =
            "jdbc:sybase:Tds:legacy-payments-host:DEFAULT_LEGACY_PORT/legacy_payments_db";

    private static final int DEFAULT_LEGACY_PORT = 5000;

    private LegacyCheckClearingServiceConfiguration() {
        throw new AssertionError("constants only — see CheckClearingProcessor");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "CheckClearingProcessor",
                "ticket", "MIG-1078",

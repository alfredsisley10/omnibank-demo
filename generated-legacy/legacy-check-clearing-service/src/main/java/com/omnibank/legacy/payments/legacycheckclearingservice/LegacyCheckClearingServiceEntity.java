...
/**
 * Persistent entity for the retired Legacy Check Clearing Service.
 *
 ...
 * is read-only after 2020. New writes go through the {@code CheckClearingProcessor}
...
public final class LegacyCheckClearingServiceEntity {
    ...
    public LegacyCheckClearingServiceEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCheckClearingServiceEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCheckClearingServiceEntity[id=" + id + ", ref=" + externalReference

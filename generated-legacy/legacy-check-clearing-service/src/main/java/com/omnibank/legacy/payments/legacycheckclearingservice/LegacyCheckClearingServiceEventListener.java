...
/**
 * Event listener for the retired Legacy Check Clearing Service.
 *
...
public final class LegacyCheckClearingServiceEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyCheckClearingServiceEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code CheckClearingProcessor}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyCheckClearingService absorbed event={} bytes={}",

...
/**
 * Facade for the Legacy Check Clearing Service subsystem.
 *
 ...
 * {@code com.omnibank.legacy.payments.legacycheckclearingservice} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyCheckClearingServiceFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyCheckClearingServiceFacade.class);
    ...
    public LegacyCheckClearingServiceFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CheckClearingProcessor} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CheckClearingProcessor",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CheckClearingProcessor}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code CheckClearingProcessor} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

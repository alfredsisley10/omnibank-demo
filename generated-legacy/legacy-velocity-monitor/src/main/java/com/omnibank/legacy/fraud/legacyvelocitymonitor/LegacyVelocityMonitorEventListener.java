...
/**
 * Event listener for the retired Legacy Velocity Monitor.
 *
...
public final class LegacyVelocityMonitorEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyVelocityMonitorEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code VelocityCheckEngine}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyVelocityMonitor absorbed event={} bytes={}",

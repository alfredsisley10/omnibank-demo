...
/**
 * Persistent entity for the retired Legacy Velocity Monitor.
 *
 ...
 * is read-only after 2019. New writes go through the {@code VelocityCheckEngine}
...
public final class LegacyVelocityMonitorEntity {
    ...
    public LegacyVelocityMonitorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyVelocityMonitorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyVelocityMonitorEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Configuration for the retired Legacy Velocity Monitor.
 *
...
public final class LegacyVelocityMonitorConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYVELOCITYMONITOR_";
    ...
    private LegacyVelocityMonitorConfiguration() {
        throw new AssertionError("constants only — see VelocityCheckEngine");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "VelocityCheckEngine",
                "ticket", "MIG-4008",

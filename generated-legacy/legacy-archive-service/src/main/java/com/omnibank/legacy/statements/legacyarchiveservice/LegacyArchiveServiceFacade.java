...
/**
 * Facade for the Legacy Archive Service subsystem.
 *
 ...
 * {@code com.omnibank.legacy.statements.legacyarchiveservice} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyArchiveServiceFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyArchiveServiceFacade.class);
    ...
    public LegacyArchiveServiceFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code StatementArchiveService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by StatementArchiveService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code StatementArchiveService}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code StatementArchiveService} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

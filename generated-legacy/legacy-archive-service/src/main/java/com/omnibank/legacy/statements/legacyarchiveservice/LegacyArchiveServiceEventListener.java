...
/**
 * Event listener for the retired Legacy Archive Service.
 *
...
public final class LegacyArchiveServiceEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyArchiveServiceEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code StatementArchiveService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyArchiveService absorbed event={} bytes={}",

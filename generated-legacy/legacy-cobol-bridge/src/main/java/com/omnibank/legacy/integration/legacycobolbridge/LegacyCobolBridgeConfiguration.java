...
/**
 * Configuration for the retired Legacy COBOL Bridge.
 *
...
public final class LegacyCobolBridgeConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYCOBOLBRIDGE_";
    ...
    private LegacyCobolBridgeConfiguration() {
        throw new AssertionError("constants only — see LegacyMainframeBridge");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "LegacyMainframeBridge",
                "ticket", "MIG-9722",

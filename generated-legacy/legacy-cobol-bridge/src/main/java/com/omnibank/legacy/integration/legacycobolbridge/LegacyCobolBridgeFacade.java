...
/**
 * Facade for the Legacy COBOL Bridge subsystem.
 *
 ...
 * {@code com.omnibank.legacy.integration.legacycobolbridge} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyCobolBridgeFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyCobolBridgeFacade.class);
    ...
    public LegacyCobolBridgeFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code LegacyMainframeBridge} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by LegacyMainframeBridge",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code LegacyMainframeBridge}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code LegacyMainframeBridge} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

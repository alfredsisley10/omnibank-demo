...
/**
 * Persistent entity for the retired Legacy COBOL Bridge.
 *
 ...
 * is read-only after 2021. New writes go through the {@code LegacyMainframeBridge}
...
public final class LegacyCobolBridgeEntity {
    ...
    public LegacyCobolBridgeEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCobolBridgeEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCobolBridgeEntity[id=" + id + ", ref=" + externalReference

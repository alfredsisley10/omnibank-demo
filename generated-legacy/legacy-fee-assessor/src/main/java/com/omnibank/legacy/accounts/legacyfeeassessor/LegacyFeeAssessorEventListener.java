...
/**
 * Event listener for the retired Legacy Fee Assessor.
 *
...
public final class LegacyFeeAssessorEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyFeeAssessorEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code AccountFeeEngine}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyFeeAssessor absorbed event={} bytes={}",

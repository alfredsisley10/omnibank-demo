...
/**
 * Persistent entity for the retired Legacy Fee Assessor.
 *
 ...
 * is read-only after 2021. New writes go through the {@code AccountFeeEngine}
...
public final class LegacyFeeAssessorEntity {
    ...
    public LegacyFeeAssessorEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyFeeAssessorEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyFeeAssessorEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Facade for the Legacy SMS Gateway subsystem.
 *
 ...
 * {@code com.omnibank.legacy.notifications.legacysmsgateway} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacySmsGatewayFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacySmsGatewayFacade.class);
    ...
    public LegacySmsGatewayFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code SmsDeliveryService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by SmsDeliveryService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code SmsDeliveryService}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code SmsDeliveryService} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

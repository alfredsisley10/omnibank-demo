...
/**
 * Persistent entity for the retired Legacy SMS Gateway.
 *
 ...
 * is read-only after 2021. New writes go through the {@code SmsDeliveryService}
...
public final class LegacySmsGatewayEntity {
    ...
    public LegacySmsGatewayEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacySmsGatewayEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacySmsGatewayEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Configuration for the retired Legacy Call Report Builder.
 *
...
public final class LegacyCallReportBuilderConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYCALLREPORTBUILDER_";
    ...
    private LegacyCallReportBuilderConfiguration() {
        throw new AssertionError("constants only — see FfiecCallReportGenerator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "FfiecCallReportGenerator",
                "ticket", "MIG-5001",

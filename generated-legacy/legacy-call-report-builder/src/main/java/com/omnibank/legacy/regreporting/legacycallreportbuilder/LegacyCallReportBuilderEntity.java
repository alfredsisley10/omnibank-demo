...
/**
 * Persistent entity for the retired Legacy Call Report Builder.
 *
 ...
 * is read-only after 2019. New writes go through the {@code FfiecCallReportGenerator}
...
public final class LegacyCallReportBuilderEntity {
    ...
    public LegacyCallReportBuilderEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCallReportBuilderEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCallReportBuilderEntity[id=" + id + ", ref=" + externalReference

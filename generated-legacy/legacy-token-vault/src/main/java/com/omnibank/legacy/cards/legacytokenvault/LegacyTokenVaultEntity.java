...
/**
 * Persistent entity for the retired Legacy Token Vault.
 *
 ...
 * is read-only after 2019. New writes go through the {@code CardTokenizationService}
...
public final class LegacyTokenVaultEntity {
    ...
    public LegacyTokenVaultEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyTokenVaultEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyTokenVaultEntity[id=" + id + ", ref=" + externalReference

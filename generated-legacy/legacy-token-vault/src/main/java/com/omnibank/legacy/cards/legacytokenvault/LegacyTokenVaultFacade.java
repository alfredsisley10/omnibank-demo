...
/**
 * Facade for the Legacy Token Vault subsystem.
 *
 ...
 * {@code com.omnibank.legacy.cards.legacytokenvault} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyTokenVaultFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyTokenVaultFacade.class);
    ...
    public LegacyTokenVaultFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CardTokenizationService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CardTokenizationService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CardTokenizationService}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code CardTokenizationService} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

...
/**
 * Facade for the Legacy Card Auth Gateway subsystem.
 *
 ...
 * {@code com.omnibank.legacy.cards.legacycardauthgateway} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyCardAuthGatewayFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyCardAuthGatewayFacade.class);
    ...
    public LegacyCardAuthGatewayFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code CardAuthorizationEngine} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by CardAuthorizationEngine",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code CardAuthorizationEngine}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code CardAuthorizationEngine} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

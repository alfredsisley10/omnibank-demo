...
/**
 * Persistent entity for the retired Legacy Card Auth Gateway.
 *
 ...
 * is read-only after 2018. New writes go through the {@code CardAuthorizationEngine}
...
public final class LegacyCardAuthGatewayEntity {
    ...
    public LegacyCardAuthGatewayEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyCardAuthGatewayEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyCardAuthGatewayEntity[id=" + id + ", ref=" + externalReference

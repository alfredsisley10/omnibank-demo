...
/**
 * Persistent entity for the retired Legacy Wire Gateway.
 *
 ...
 * is read-only after 2018. New writes go through the {@code WirePaymentProcessor}
...
public final class LegacyWireGatewayEntity {
    ...
    public LegacyWireGatewayEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyWireGatewayEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyWireGatewayEntity[id=" + id + ", ref=" + externalReference

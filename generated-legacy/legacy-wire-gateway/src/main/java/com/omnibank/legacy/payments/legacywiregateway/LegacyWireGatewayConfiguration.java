...
/**
 * Configuration for the retired Legacy Wire Gateway.
 *
...
public final class LegacyWireGatewayConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYWIREGATEWAY_";
    ...
    private LegacyWireGatewayConfiguration() {
        throw new AssertionError("constants only — see WirePaymentProcessor");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "WirePaymentProcessor",
                "ticket", "MIG-1051",

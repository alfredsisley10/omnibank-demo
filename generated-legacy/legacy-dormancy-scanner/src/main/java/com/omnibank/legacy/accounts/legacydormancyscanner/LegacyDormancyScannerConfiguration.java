...
/**
 * Configuration for the retired Legacy Dormancy Scanner.
 *
...
public final class LegacyDormancyScannerConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYDORMANCYSCANNER_";
    ...
    private LegacyDormancyScannerConfiguration() {
        throw new AssertionError("constants only — see AccountStateMachine");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "AccountStateMachine",
                "ticket", "MIG-2031",

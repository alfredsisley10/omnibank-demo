...
/**
 * Persistent entity for the retired Legacy Dormancy Scanner.
 *
 ...
 * is read-only after 2020. New writes go through the {@code AccountStateMachine}
...
public final class LegacyDormancyScannerEntity {
    ...
    public LegacyDormancyScannerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyDormancyScannerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyDormancyScannerEntity[id=" + id + ", ref=" + externalReference

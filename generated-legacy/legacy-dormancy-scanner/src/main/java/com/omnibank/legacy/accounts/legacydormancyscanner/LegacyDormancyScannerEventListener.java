...
/**
 * Event listener for the retired Legacy Dormancy Scanner.
 *
...
public final class LegacyDormancyScannerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyDormancyScannerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code AccountStateMachine}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyDormancyScanner absorbed event={} bytes={}",

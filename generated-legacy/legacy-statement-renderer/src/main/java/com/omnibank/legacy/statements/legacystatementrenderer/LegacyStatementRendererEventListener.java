...
/**
 * Event listener for the retired Legacy Statement Renderer.
 *
...
public final class LegacyStatementRendererEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyStatementRendererEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code StatementGenerator}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyStatementRenderer absorbed event={} bytes={}",

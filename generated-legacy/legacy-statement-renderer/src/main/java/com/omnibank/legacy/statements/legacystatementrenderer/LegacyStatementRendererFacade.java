...
/**
 * Facade for the Legacy Statement Renderer subsystem.
 *
 ...
 * {@code com.omnibank.legacy.statements.legacystatementrenderer} package.
 */
@Deprecated(since = "2018-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyStatementRendererFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyStatementRendererFacade.class);
    ...
    public LegacyStatementRendererFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code StatementGenerator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2018-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by StatementGenerator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code StatementGenerator}.
     */
    @Deprecated(since = "2018-01-01")
     ...
     *             {@code StatementGenerator} which preserves audit ordering.
     */
    @Deprecated(since = "2018-01-01")

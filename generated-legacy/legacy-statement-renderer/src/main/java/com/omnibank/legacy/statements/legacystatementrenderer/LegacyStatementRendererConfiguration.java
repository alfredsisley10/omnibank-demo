...
/**
 * Configuration for the retired Legacy Statement Renderer.
 *
...
public final class LegacyStatementRendererConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYSTATEMENTRENDERER_";
    ...
    private LegacyStatementRendererConfiguration() {
        throw new AssertionError("constants only — see StatementGenerator");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "StatementGenerator",
                "ticket", "MIG-6001",

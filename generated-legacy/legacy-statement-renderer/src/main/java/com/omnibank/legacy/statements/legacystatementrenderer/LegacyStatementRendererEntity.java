...
/**
 * Persistent entity for the retired Legacy Statement Renderer.
 *
 ...
 * is read-only after 2018. New writes go through the {@code StatementGenerator}
...
public final class LegacyStatementRendererEntity {
    ...
    public LegacyStatementRendererEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyStatementRendererEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyStatementRendererEntity[id=" + id + ", ref=" + externalReference

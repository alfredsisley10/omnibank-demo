...
/**
 * Facade for the Legacy EOD Close Runner subsystem.
 *
 ...
 * {@code com.omnibank.legacy.batch.legacyeodcloserunner} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyEodCloseRunnerFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyEodCloseRunnerFacade.class);
    ...
    public LegacyEodCloseRunnerFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code EndOfDayCloseManager} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by EndOfDayCloseManager",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code EndOfDayCloseManager}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code EndOfDayCloseManager} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

...
/**
 * Persistent entity for the retired Legacy EOD Close Runner.
 *
 ...
 * is read-only after 2019. New writes go through the {@code EndOfDayCloseManager}
...
public final class LegacyEodCloseRunnerEntity {
    ...
    public LegacyEodCloseRunnerEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyEodCloseRunnerEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyEodCloseRunnerEntity[id=" + id + ", ref=" + externalReference

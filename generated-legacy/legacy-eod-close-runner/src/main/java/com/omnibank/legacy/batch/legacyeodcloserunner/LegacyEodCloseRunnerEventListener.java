...
/**
 * Event listener for the retired Legacy EOD Close Runner.
 *
...
public final class LegacyEodCloseRunnerEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyEodCloseRunnerEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code EndOfDayCloseManager}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyEodCloseRunner absorbed event={} bytes={}",

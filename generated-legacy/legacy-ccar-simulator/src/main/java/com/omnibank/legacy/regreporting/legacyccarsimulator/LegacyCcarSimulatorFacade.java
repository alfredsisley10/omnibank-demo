...
/**
 * Facade for the Legacy CCAR Simulator subsystem.
 *
 ...
 * {@code com.omnibank.legacy.regreporting.legacyccarsimulator} package.
 */
@Deprecated(since = "2021-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyCcarSimulatorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyCcarSimulatorFacade.class);
    ...
    public LegacyCcarSimulatorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code Ccar5YearProjection} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2021-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by Ccar5YearProjection",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code Ccar5YearProjection}.
     */
    @Deprecated(since = "2021-01-01")
     ...
     *             {@code Ccar5YearProjection} which preserves audit ordering.
     */
    @Deprecated(since = "2021-01-01")

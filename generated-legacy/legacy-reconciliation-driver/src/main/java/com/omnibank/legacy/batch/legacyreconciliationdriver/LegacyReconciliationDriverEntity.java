...
/**
 * Persistent entity for the retired Legacy Reconciliation Driver.
 *
 * <p>// DO NOT MODIFY — retired 2020 under MIG-9615 (replaced by LedgerReconciliationService).
 *
 * <p>Schema lives in the {@code legacy_batch} schema and
 * is read-only after 2020. New writes go through the {@code LedgerReconciliationService}
...
public final class LegacyReconciliationDriverEntity {
    ...
    public LegacyReconciliationDriverEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyReconciliationDriverEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyReconciliationDriverEntity[id=" + id + ", ref=" + externalReference

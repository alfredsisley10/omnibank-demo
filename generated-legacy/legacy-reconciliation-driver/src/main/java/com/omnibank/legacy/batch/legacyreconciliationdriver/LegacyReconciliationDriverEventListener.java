...
/**
 * Event listener for the retired Legacy Reconciliation Driver.
 *
 * <p>// DO NOT MODIFY — retired 2020 under MIG-9615 (replaced by LedgerReconciliationService).
 *
 * <p>Used to subscribe to the {@code legacy.batch.events} JMS
...
public final class LegacyReconciliationDriverEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyReconciliationDriverEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code LedgerReconciliationService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyReconciliationDriver absorbed event={} bytes={}",

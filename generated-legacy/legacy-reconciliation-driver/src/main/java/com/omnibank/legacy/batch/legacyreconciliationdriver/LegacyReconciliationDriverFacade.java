...
/**
 * Facade for the Legacy Reconciliation Driver subsystem.
 *
 ...
 * {@code com.omnibank.legacy.batch.legacyreconciliationdriver} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyReconciliationDriverFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyReconciliationDriverFacade.class);
    ...
    public LegacyReconciliationDriverFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code LedgerReconciliationService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by LedgerReconciliationService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code LedgerReconciliationService}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code LedgerReconciliationService} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

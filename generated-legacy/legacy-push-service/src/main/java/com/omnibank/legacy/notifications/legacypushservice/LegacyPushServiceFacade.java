...
/**
 * Facade for the Legacy Push Service subsystem.
 *
 ...
 * {@code com.omnibank.legacy.notifications.legacypushservice} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyPushServiceFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyPushServiceFacade.class);
    ...
    public LegacyPushServiceFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code PushNotificationService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by PushNotificationService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code PushNotificationService}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code PushNotificationService} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

...
/**
 * Event listener for the retired Legacy Push Service.
 *
...
public final class LegacyPushServiceEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyPushServiceEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code PushNotificationService}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyPushService absorbed event={} bytes={}",

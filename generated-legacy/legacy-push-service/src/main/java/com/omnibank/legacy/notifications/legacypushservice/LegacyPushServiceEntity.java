...
/**
 * Persistent entity for the retired Legacy Push Service.
 *
 ...
 * is read-only after 2020. New writes go through the {@code PushNotificationService}
...
public final class LegacyPushServiceEntity {
    ...
    public LegacyPushServiceEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyPushServiceEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyPushServiceEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Configuration for the retired Legacy Push Service.
 *
...
public final class LegacyPushServiceConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYPUSHSERVICE_";
    ...
    private LegacyPushServiceConfiguration() {
        throw new AssertionError("constants only — see PushNotificationService");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "PushNotificationService",
                "ticket", "MIG-9015",

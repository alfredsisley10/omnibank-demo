...
/**
 * Facade for the Legacy LCR Calculator subsystem.
 *
 ...
 * {@code com.omnibank.legacy.regreporting.legacylcrcalculator} package.
 */
@Deprecated(since = "2022-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyLcrCalculatorFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyLcrCalculatorFacade.class);
    ...
    public LegacyLcrCalculatorFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code LcrReportGenerator} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2022-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by LcrReportGenerator",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code LcrReportGenerator}.
     */
    @Deprecated(since = "2022-01-01")
     ...
     *             {@code LcrReportGenerator} which preserves audit ordering.
     */
    @Deprecated(since = "2022-01-01")

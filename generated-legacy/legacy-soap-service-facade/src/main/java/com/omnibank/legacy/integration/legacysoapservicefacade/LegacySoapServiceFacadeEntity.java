...
/**
 * Persistent entity for the retired Legacy SOAP Service Facade.
 *
 ...
 * is read-only after 2022. New writes go through the {@code RestServiceFacade}
...
public final class LegacySoapServiceFacadeEntity {
    ...
    public LegacySoapServiceFacadeEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacySoapServiceFacadeEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacySoapServiceFacadeEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Event listener for the retired Legacy SOAP Service Facade.
 *
...
public final class LegacySoapServiceFacadeEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacySoapServiceFacadeEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code RestServiceFacade}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacySoapServiceFacade absorbed event={} bytes={}",

...
/**
 * Facade for the Legacy SOAP Service Facade subsystem.
 *
 ...
 * {@code com.omnibank.legacy.integration.legacysoapservicefacade} package.
 */
@Deprecated(since = "2022-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacySoapServiceFacadeFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacySoapServiceFacadeFacade.class);
    ...
    public LegacySoapServiceFacadeFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code RestServiceFacade} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2022-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by RestServiceFacade",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code RestServiceFacade}.
     */
    @Deprecated(since = "2022-01-01")
     ...
     *             {@code RestServiceFacade} which preserves audit ordering.
     */
    @Deprecated(since = "2022-01-01")

...
/**
 * Configuration for the retired Legacy Mainframe Adapter.
 *
...
public final class LegacyMainframeAdapterConfiguration {
    ...
    public static final String LEGACY_ENV_PREFIX = "LEGACY_LEGACYMAINFRAMEADAPTER_";
    ...
    private LegacyMainframeAdapterConfiguration() {
        throw new AssertionError("constants only — see MainframeIntegration");
    }
    ...
    public static Map<String, String> legacyProperties(Clock clock) {
        ...
        return Map.of(
                ...
                "replacement", "MainframeIntegration",
                "ticket", "MIG-9715",

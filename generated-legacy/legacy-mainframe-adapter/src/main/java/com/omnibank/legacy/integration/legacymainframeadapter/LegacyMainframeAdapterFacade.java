...
/**
 * Facade for the Legacy Mainframe Adapter subsystem.
 *
 ...
 * {@code com.omnibank.legacy.integration.legacymainframeadapter} package.
 */
@Deprecated(since = "2020-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyMainframeAdapterFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyMainframeAdapterFacade.class);
    ...
    public LegacyMainframeAdapterFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code MainframeIntegration} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2020-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by MainframeIntegration",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code MainframeIntegration}.
     */
    @Deprecated(since = "2020-01-01")
     ...
     *             {@code MainframeIntegration} which preserves audit ordering.
     */
    @Deprecated(since = "2020-01-01")

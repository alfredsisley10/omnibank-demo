...
/**
 * Persistent entity for the retired Legacy Mainframe Adapter.
 *
 ...
 * is read-only after 2020. New writes go through the {@code MainframeIntegration}
...
public final class LegacyMainframeAdapterEntity {
    ...
    public LegacyMainframeAdapterEntity(UUID id, String externalReference, BigDecimal amount,
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof LegacyMainframeAdapterEntity that)) return false;
    ...
    @Override public String toString() {
        return "LegacyMainframeAdapterEntity[id=" + id + ", ref=" + externalReference

...
/**
 * Event listener for the retired Legacy Mainframe Adapter.
 *
...
public final class LegacyMainframeAdapterEventListener {

    private static final Logger log = LoggerFactory.getLogger(LegacyMainframeAdapterEventListener.class);
    private final AtomicLong handled = new AtomicLong();
    private final AtomicLong rejected = new AtomicLong();

    /**
     * @deprecated Replaced by {@code MainframeIntegration}'s event handler.
    ...
    public void onEvent(String eventType, String payload) {
        ...
        log.trace("legacy LegacyMainframeAdapter absorbed event={} bytes={}",

...
/**
 * Facade for the Legacy Email Sender subsystem.
 *
 ...
 * {@code com.omnibank.legacy.notifications.legacyemailsender} package.
 */
@Deprecated(since = "2019-01-01", forRemoval = false)
@SuppressWarnings({"unused", "java:S1133", "java:S1135"})
public final class LegacyEmailSenderFacade {

    private static final Logger log = LoggerFactory.getLogger(LegacyEmailSenderFacade.class);
    ...
    public LegacyEmailSenderFacade(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
    }

    /**
     * @deprecated Use {@code EmailDeliveryService} instead. This shim returns
     *             empty results for every input.
     */
    @Deprecated(since = "2019-01-01")
    public Optional<LegacyEntry> lookup(String correlationId) {
        invocations.incrementAndGet();
        log.debug("legacy lookup invoked correlationId={} — replaced by EmailDeliveryService",
                correlationId);
        return Optional.ofNullable(entries.get(correlationId));
    }

    /**
     * @deprecated Replaced by the corresponding method on {@code EmailDeliveryService}.
     */
    @Deprecated(since = "2019-01-01")
     ...
     *             {@code EmailDeliveryService} which preserves audit ordering.
     */
    @Deprecated(since = "2019-01-01")

package com.omnibank.channel.standardsavings.call_center;
...
class StandardSavingsCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new StandardSavingsCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new StandardSavingsCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new StandardSavingsCallcenterUiCopy();

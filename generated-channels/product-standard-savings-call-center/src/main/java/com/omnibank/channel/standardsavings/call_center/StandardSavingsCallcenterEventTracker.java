...
/**
 * Channel-scoped telemetry tracker for StandardSavings on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StandardSavingsCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "standardsavings" + "." + "CALL_CENTER".toLowerCase();
    }

...
/**
 * Session configuration for StandardSavings accessed through Phone Banking.
 ...
 */
public final class StandardSavingsCallcenterSessionConfig {
    ...
    public StandardSavingsCallcenterSessionConfig() {

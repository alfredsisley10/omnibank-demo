...
/**
 * Channel-scoped telemetry tracker for EssentialChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class EssentialCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "essentialchecking" + "." + "ATM".toLowerCase();
    }

...
/**
 * Session configuration for EssentialChecking accessed through ATM Network.
 ...
 */
public final class EssentialCheckingAtmSessionConfig {
    ...
    public EssentialCheckingAtmSessionConfig() {

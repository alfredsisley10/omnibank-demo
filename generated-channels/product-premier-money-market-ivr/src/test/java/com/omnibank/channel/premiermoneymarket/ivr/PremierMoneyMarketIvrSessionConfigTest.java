package com.omnibank.channel.premiermoneymarket.ivr;
...
class PremierMoneyMarketIvrSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new PremierMoneyMarketIvrSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new PremierMoneyMarketIvrAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new PremierMoneyMarketIvrUiCopy();

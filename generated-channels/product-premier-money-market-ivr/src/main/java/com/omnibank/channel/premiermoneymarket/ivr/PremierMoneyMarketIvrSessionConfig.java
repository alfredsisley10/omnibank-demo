...
/**
 * Session configuration for PremierMoneyMarket accessed through Interactive Voice Response.
 ...
 */
public final class PremierMoneyMarketIvrSessionConfig {
    ...
    public PremierMoneyMarketIvrSessionConfig() {

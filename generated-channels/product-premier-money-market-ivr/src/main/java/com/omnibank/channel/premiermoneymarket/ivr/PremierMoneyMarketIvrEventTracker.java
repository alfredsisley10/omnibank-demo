...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "IVR".toLowerCase();
    }

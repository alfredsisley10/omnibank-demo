...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "KIOSK".toLowerCase();
    }

 ...
 * In-Branch Kiosk. Copy length and vocabulary differ: web has room for
 * long-form copy, ATM screens must fit a narrow line, IVR text is
 * read aloud and must avoid visual-only cues.
 */
public final class DigitalOnlyCheckingKioskUiCopy {

    private final boolean supportsSpanish;

    public DigitalOnlyCheckingKioskUiCopy() {

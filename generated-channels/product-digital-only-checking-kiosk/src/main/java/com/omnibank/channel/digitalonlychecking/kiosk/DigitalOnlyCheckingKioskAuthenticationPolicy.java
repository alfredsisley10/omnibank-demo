...
/**
 * Authentication policy for DigitalOnlyChecking on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingKioskAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingKioskAuthenticationPolicy() {
        this.authStrength = "CARD_PIN";

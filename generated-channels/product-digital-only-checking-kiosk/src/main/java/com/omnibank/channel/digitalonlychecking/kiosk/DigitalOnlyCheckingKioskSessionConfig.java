...
/**
 * Session configuration for DigitalOnlyChecking accessed through In-Branch Kiosk.
 ...
 */
public final class DigitalOnlyCheckingKioskSessionConfig {
    ...
    public DigitalOnlyCheckingKioskSessionConfig() {

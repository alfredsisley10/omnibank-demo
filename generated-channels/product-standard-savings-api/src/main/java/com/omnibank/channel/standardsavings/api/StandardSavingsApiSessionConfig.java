...
/**
 * Session configuration for StandardSavings accessed through Third-Party API.
 ...
 */
public final class StandardSavingsApiSessionConfig {
    ...
    public StandardSavingsApiSessionConfig() {

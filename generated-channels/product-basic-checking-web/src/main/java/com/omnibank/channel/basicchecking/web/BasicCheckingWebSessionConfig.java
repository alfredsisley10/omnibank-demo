...
/**
 * Session configuration for BasicChecking accessed through Web Banking.
 ...
 */
public final class BasicCheckingWebSessionConfig {
    ...
    public BasicCheckingWebSessionConfig() {

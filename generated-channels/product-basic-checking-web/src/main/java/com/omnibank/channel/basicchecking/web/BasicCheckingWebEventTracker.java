...
/**
 * Channel-scoped telemetry tracker for BasicChecking on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class BasicCheckingWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "basicchecking" + "." + "WEB".toLowerCase();
    }

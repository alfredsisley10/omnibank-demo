...
/**
 * Channel-scoped telemetry tracker for VeteranChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class VeteranCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "veteranchecking" + "." + "ATM".toLowerCase();
    }

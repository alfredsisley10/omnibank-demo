...
/**
 * Session configuration for VeteranChecking accessed through ATM Network.
 ...
 */
public final class VeteranCheckingAtmSessionConfig {
    ...
    public VeteranCheckingAtmSessionConfig() {

...
class VeteranCheckingAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new VeteranCheckingAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new VeteranCheckingAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new VeteranCheckingAtmUiCopy();

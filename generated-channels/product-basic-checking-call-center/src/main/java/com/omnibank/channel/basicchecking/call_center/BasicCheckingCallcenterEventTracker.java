...
/**
 * Channel-scoped telemetry tracker for BasicChecking on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class BasicCheckingCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "basicchecking" + "." + "CALL_CENTER".toLowerCase();
    }

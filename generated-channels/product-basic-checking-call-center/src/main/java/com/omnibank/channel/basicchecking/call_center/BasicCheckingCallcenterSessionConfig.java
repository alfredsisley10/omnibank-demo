...
/**
 * Session configuration for BasicChecking accessed through Phone Banking.
 ...
 */
public final class BasicCheckingCallcenterSessionConfig {
    ...
    public BasicCheckingCallcenterSessionConfig() {

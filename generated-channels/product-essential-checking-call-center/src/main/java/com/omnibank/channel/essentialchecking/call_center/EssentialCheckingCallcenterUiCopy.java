...
/**
 * Channel-tailored UI / audio copy for the EssentialChecking account flow over
 ...
 */
public final class EssentialCheckingCallcenterUiCopy {

    private final boolean supportsSpanish;

    public EssentialCheckingCallcenterUiCopy() {
        this.supportsSpanish = true;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta essentialchecking";
        }
        return "Welcome to your essentialchecking account";
    }

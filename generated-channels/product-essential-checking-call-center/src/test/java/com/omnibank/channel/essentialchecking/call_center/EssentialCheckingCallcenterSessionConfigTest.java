package com.omnibank.channel.essentialchecking.call_center;
...
class EssentialCheckingCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new EssentialCheckingCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new EssentialCheckingCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new EssentialCheckingCallcenterUiCopy();

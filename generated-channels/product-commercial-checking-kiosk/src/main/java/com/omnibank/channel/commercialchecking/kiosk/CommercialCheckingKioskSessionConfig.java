...
/**
 * Session configuration for CommercialChecking accessed through In-Branch Kiosk.
 ...
 */
public final class CommercialCheckingKioskSessionConfig {
    ...
    public CommercialCheckingKioskSessionConfig() {

...
/**
 * Authentication policy for CommercialChecking on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class CommercialCheckingKioskAuthenticationPolicy {
    ...
    public CommercialCheckingKioskAuthenticationPolicy() {

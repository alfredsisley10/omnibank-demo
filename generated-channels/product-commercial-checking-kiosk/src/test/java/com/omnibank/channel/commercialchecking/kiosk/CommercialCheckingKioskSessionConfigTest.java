package com.omnibank.channel.commercialchecking.kiosk;
...
class CommercialCheckingKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new CommercialCheckingKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new CommercialCheckingKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new CommercialCheckingKioskUiCopy();

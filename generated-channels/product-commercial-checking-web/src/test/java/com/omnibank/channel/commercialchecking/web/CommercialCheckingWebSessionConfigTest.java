package com.omnibank.channel.commercialchecking.web;
...
class CommercialCheckingWebSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new CommercialCheckingWebSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new CommercialCheckingWebAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new CommercialCheckingWebUiCopy();

...
/**
 * Session configuration for CommercialChecking accessed through Web Banking.
 ...
 */
public final class CommercialCheckingWebSessionConfig {
    ...
    public CommercialCheckingWebSessionConfig() {

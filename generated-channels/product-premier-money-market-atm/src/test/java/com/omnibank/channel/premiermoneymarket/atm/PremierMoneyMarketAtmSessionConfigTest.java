package com.omnibank.channel.premiermoneymarket.atm;
...
class PremierMoneyMarketAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new PremierMoneyMarketAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new PremierMoneyMarketAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new PremierMoneyMarketAtmUiCopy();

...
/**
 * Session configuration for PremierMoneyMarket accessed through ATM Network.
 ...
 */
public final class PremierMoneyMarketAtmSessionConfig {
    ...
    public PremierMoneyMarketAtmSessionConfig() {

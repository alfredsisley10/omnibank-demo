...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "ATM".toLowerCase();
    }

...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "CALL_CENTER".toLowerCase();
    }

...
/**
 * Session configuration for TraditionalIra accessed through Phone Banking.
 ...
 */
public final class TraditionalIraCallcenterSessionConfig {
    ...
    public TraditionalIraCallcenterSessionConfig() {

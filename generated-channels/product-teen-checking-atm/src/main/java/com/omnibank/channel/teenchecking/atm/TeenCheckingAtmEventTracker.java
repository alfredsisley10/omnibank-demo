...
/**
 * Channel-scoped telemetry tracker for TeenChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TeenCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "teenchecking" + "." + "ATM".toLowerCase();
    }

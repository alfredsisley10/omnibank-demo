...
/**
 * Authentication policy for TeenChecking on ATM Network. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class TeenCheckingAtmAuthenticationPolicy {
    ...
    public TeenCheckingAtmAuthenticationPolicy() {

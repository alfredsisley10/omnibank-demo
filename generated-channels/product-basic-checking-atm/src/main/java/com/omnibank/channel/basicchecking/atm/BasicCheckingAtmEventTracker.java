...
/**
 * Channel-scoped telemetry tracker for BasicChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class BasicCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "basicchecking" + "." + "ATM".toLowerCase();
    }

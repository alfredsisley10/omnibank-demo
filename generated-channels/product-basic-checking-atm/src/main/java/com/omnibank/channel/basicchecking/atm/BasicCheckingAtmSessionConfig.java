...
/**
 * Session configuration for BasicChecking accessed through ATM Network.
 ...
 */
public final class BasicCheckingAtmSessionConfig {
    ...
    public BasicCheckingAtmSessionConfig() {

...
/**
 * Channel-tailored UI / audio copy for the CommercialChecking account flow over
 ...
 */
public final class CommercialCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public CommercialCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta commercialchecking";
        }
        return "Welcome to your commercialchecking account";
    }

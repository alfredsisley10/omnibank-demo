...
/**
 * Channel-scoped telemetry tracker for CommercialChecking on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class CommercialCheckingApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "commercialchecking" + "." + "API".toLowerCase();
    }

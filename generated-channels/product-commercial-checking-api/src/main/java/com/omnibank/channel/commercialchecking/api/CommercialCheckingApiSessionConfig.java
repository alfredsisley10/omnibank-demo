...
/**
 * Session configuration for CommercialChecking accessed through Third-Party API.
 ...
 */
public final class CommercialCheckingApiSessionConfig {
    ...
    public CommercialCheckingApiSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "ATM".toLowerCase();
    }

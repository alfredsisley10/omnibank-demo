...
/**
 * Session configuration for TraditionalIra accessed through ATM Network.
 ...
 */
public final class TraditionalIraAtmSessionConfig {
    ...
    public TraditionalIraAtmSessionConfig() {

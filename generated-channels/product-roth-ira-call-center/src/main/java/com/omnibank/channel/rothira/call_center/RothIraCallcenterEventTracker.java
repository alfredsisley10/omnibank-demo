...
/**
 * Channel-scoped telemetry tracker for RothIra on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RothIraCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rothira" + "." + "CALL_CENTER".toLowerCase();
    }

...
/**
 * Session configuration for RothIra accessed through Phone Banking.
 ...
 */
public final class RothIraCallcenterSessionConfig {
    ...
    public RothIraCallcenterSessionConfig() {

package com.omnibank.channel.rothira.call_center;
...
class RothIraCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RothIraCallcenterUiCopy();

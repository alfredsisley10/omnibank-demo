...
/**
 * Channel-scoped telemetry tracker for SeniorChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SeniorCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "seniorchecking" + "." + "IVR".toLowerCase();
    }

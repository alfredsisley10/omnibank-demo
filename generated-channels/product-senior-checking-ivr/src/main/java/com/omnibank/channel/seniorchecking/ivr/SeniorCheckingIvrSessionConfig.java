...
/**
 * Session configuration for SeniorChecking accessed through Interactive Voice Response.
 ...
 */
public final class SeniorCheckingIvrSessionConfig {
    ...
    public SeniorCheckingIvrSessionConfig() {

...
/**
 * Session configuration for VeteranChecking accessed through Web Banking.
 ...
 */
public final class VeteranCheckingWebSessionConfig {
    ...
    public VeteranCheckingWebSessionConfig() {

...
/**
 * Session configuration for SmallBizChecking accessed through Phone Banking.
 ...
 */
public final class SmallBizCheckingCallcenterSessionConfig {
    ...
    public SmallBizCheckingCallcenterSessionConfig() {

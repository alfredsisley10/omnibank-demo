...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "CALL_CENTER".toLowerCase();
    }

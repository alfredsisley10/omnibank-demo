package com.omnibank.channel.smallbizchecking.call_center;
...
class SmallBizCheckingCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new SmallBizCheckingCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new SmallBizCheckingCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new SmallBizCheckingCallcenterUiCopy();

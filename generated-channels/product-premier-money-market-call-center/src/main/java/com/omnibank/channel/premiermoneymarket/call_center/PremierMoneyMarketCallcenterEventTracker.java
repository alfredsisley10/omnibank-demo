...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "CALL_CENTER".toLowerCase();
    }

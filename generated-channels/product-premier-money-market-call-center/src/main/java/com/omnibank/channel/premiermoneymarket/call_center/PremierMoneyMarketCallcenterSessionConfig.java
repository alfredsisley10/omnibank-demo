...
/**
 * Session configuration for PremierMoneyMarket accessed through Phone Banking.
 ...
 */
public final class PremierMoneyMarketCallcenterSessionConfig {
    ...
    public PremierMoneyMarketCallcenterSessionConfig() {

...
/**
 * Session configuration for SeniorChecking accessed through Web Banking.
 ...
 */
public final class SeniorCheckingWebSessionConfig {
    ...
    public SeniorCheckingWebSessionConfig() {

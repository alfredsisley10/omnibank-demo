package com.omnibank.channel.basicchecking.branch;
...
class BasicCheckingBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new BasicCheckingBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new BasicCheckingBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new BasicCheckingBranchUiCopy();

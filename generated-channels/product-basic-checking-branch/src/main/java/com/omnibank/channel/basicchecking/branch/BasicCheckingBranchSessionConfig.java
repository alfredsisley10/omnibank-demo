...
/**
 * Session configuration for BasicChecking accessed through Branch Teller.
 ...
 */
public final class BasicCheckingBranchSessionConfig {
    ...
    public BasicCheckingBranchSessionConfig() {

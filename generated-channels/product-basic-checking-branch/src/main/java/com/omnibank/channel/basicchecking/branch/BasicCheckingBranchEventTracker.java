...
/**
 * Channel-scoped telemetry tracker for BasicChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class BasicCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "basicchecking" + "." + "BRANCH".toLowerCase();
    }

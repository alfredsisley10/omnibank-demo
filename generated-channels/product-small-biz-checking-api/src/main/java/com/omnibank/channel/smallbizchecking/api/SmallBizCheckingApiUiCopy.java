package com.omnibank.channel.smallbizchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the SmallBizChecking account flow over
 ...
 */
public final class SmallBizCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public SmallBizCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta smallbizchecking";
        }
        return "Welcome to your smallbizchecking account";
    }

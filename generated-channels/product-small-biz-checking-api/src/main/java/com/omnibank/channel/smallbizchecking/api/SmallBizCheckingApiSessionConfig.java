...
/**
 * Session configuration for SmallBizChecking accessed through Third-Party API.
 ...
 */
public final class SmallBizCheckingApiSessionConfig {
    ...
    public SmallBizCheckingApiSessionConfig() {

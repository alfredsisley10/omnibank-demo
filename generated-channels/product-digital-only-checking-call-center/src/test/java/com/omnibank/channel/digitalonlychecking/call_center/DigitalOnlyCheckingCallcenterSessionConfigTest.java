package com.omnibank.channel.digitalonlychecking.call_center;
...
class DigitalOnlyCheckingCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new DigitalOnlyCheckingCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new DigitalOnlyCheckingCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new DigitalOnlyCheckingCallcenterUiCopy();

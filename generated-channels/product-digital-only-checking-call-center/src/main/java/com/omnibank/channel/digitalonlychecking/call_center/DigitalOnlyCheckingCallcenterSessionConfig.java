...
/**
 * Session configuration for DigitalOnlyChecking accessed through Phone Banking.
 ...
 */
public final class DigitalOnlyCheckingCallcenterSessionConfig {
    ...
    public DigitalOnlyCheckingCallcenterSessionConfig() {
        ...
        this.targetLatencyMs = 800;
        this.deviceClass = "PHONE";
    }

...
/**
 * Session configuration for RewardsChecking accessed through ATM Network.
 ...
 */
public final class RewardsCheckingAtmSessionConfig {
    ...
    public RewardsCheckingAtmSessionConfig() {

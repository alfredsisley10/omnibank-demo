...
class RewardsCheckingKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RewardsCheckingKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RewardsCheckingKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RewardsCheckingKioskUiCopy();

...
/**
 * Session configuration for RewardsChecking accessed through In-Branch Kiosk.
 ...
 */
public final class RewardsCheckingKioskSessionConfig {
    ...
    public RewardsCheckingKioskSessionConfig() {

...
/**
 * Authentication policy for RewardsChecking on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RewardsCheckingKioskAuthenticationPolicy {
    ...
    public RewardsCheckingKioskAuthenticationPolicy() {

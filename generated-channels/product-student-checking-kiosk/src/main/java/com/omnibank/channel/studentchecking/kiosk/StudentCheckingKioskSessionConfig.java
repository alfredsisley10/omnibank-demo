...
/**
 * Session configuration for StudentChecking accessed through In-Branch Kiosk.
 ...
 */
public final class StudentCheckingKioskSessionConfig {
    ...
    public StudentCheckingKioskSessionConfig() {

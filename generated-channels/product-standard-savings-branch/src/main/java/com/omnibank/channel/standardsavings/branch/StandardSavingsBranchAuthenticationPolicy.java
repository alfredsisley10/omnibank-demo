...
/**
 * Authentication policy for StandardSavings on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class StandardSavingsBranchAuthenticationPolicy {
    ...
    public StandardSavingsBranchAuthenticationPolicy() {

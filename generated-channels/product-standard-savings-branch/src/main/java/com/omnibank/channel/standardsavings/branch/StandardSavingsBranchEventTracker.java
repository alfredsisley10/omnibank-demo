...
/**
 * Channel-scoped telemetry tracker for StandardSavings on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StandardSavingsBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "standardsavings" + "." + "BRANCH".toLowerCase();
    }

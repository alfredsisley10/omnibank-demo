...
/**
 * Session configuration for StandardSavings accessed through Branch Teller.
 ...
 */
public final class StandardSavingsBranchSessionConfig {
    ...
    public StandardSavingsBranchSessionConfig() {

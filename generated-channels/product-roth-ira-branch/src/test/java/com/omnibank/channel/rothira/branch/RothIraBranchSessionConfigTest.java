package com.omnibank.channel.rothira.branch;
...
class RothIraBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RothIraBranchUiCopy();

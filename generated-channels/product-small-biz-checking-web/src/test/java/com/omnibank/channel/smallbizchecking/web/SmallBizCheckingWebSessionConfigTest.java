...
class SmallBizCheckingWebSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new SmallBizCheckingWebSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new SmallBizCheckingWebAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new SmallBizCheckingWebUiCopy();

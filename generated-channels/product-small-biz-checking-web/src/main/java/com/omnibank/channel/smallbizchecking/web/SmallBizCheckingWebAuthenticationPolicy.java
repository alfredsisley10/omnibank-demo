...
/**
 * Authentication policy for SmallBizChecking on Web Banking. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class SmallBizCheckingWebAuthenticationPolicy {
    ...
    public SmallBizCheckingWebAuthenticationPolicy() {

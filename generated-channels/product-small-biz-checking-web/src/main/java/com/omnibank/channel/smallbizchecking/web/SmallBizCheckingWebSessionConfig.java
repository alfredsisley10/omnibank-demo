...
/**
 * Session configuration for SmallBizChecking accessed through Web Banking.
 ...
 */
public final class SmallBizCheckingWebSessionConfig {
    ...
    public SmallBizCheckingWebSessionConfig() {

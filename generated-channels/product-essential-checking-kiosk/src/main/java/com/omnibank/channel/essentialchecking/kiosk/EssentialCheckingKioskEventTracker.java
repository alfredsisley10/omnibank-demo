...
/**
 * Channel-scoped telemetry tracker for EssentialChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class EssentialCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "essentialchecking" + "." + "KIOSK".toLowerCase();
    }

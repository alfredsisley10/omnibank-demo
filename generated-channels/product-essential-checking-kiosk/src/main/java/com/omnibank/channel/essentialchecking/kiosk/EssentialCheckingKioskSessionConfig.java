...
/**
 * Session configuration for EssentialChecking accessed through In-Branch Kiosk.
 ...
 */
public final class EssentialCheckingKioskSessionConfig {
    ...
    public EssentialCheckingKioskSessionConfig() {

package com.omnibank.channel.traditionalira.branch;
...
class TraditionalIraBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new TraditionalIraBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new TraditionalIraBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new TraditionalIraBranchUiCopy();

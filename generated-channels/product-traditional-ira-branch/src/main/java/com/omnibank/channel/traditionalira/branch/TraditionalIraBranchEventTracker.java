...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "BRANCH".toLowerCase();
    }

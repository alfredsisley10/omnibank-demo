...
/**
 * Authentication policy for TraditionalIra on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class TraditionalIraBranchAuthenticationPolicy {
    ...
    public TraditionalIraBranchAuthenticationPolicy() {

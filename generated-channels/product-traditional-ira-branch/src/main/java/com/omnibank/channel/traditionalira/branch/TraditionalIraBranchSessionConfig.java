...
/**
 * Session configuration for TraditionalIra accessed through Branch Teller.
 ...
 */
public final class TraditionalIraBranchSessionConfig {
    ...
    public TraditionalIraBranchSessionConfig() {

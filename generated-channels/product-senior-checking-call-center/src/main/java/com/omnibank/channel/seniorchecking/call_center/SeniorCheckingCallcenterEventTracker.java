...
/**
 * Channel-scoped telemetry tracker for SeniorChecking on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SeniorCheckingCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "seniorchecking" + "." + "CALL_CENTER".toLowerCase();
    }

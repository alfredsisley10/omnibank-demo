...
/**
 * Session configuration for SeniorChecking accessed through Phone Banking.
 ...
 */
public final class SeniorCheckingCallcenterSessionConfig {
    ...
    public SeniorCheckingCallcenterSessionConfig() {

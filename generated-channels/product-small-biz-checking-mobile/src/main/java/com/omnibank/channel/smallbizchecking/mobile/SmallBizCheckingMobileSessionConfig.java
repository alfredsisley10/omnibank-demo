...
/**
 * Session configuration for SmallBizChecking accessed through Mobile App.
 ...
 */
public final class SmallBizCheckingMobileSessionConfig {
    ...
    public SmallBizCheckingMobileSessionConfig() {

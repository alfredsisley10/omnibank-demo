...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "MOBILE".toLowerCase();
    }

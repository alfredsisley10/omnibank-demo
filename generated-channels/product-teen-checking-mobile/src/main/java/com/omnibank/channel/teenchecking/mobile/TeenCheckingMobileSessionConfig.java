...
/**
 * Session configuration for TeenChecking accessed through Mobile App.
 ...
 */
public final class TeenCheckingMobileSessionConfig {
    ...
    public TeenCheckingMobileSessionConfig() {

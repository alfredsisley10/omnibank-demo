...
/**
 * Session configuration for PremierMoneyMarket accessed through Web Banking.
 ...
 */
public final class PremierMoneyMarketWebSessionConfig {
    ...
    public PremierMoneyMarketWebSessionConfig() {

...
/**
 * Session configuration for PremierMoneyMarket accessed through Third-Party API.
 ...
 */
public final class PremierMoneyMarketApiSessionConfig {
    ...
    public PremierMoneyMarketApiSessionConfig() {

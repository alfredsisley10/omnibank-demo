package com.omnibank.channel.premiermoneymarket.api;
...
class PremierMoneyMarketApiSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new PremierMoneyMarketApiSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new PremierMoneyMarketApiAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new PremierMoneyMarketApiUiCopy();

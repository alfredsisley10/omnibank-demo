...
class RothIraApiSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraApiSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraApiAuthenticationPolicy();

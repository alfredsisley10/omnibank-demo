package com.omnibank.channel.rothira.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the RothIra account flow over
 ...
 */
public final class RothIraApiUiCopy {

    private final boolean supportsSpanish;

    public RothIraApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta rothira";
        }
        return "Welcome to your rothira account";
    }

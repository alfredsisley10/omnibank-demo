package com.omnibank.channel.traditionalira.kiosk;
...
class TraditionalIraKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new TraditionalIraKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new TraditionalIraKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new TraditionalIraKioskUiCopy();

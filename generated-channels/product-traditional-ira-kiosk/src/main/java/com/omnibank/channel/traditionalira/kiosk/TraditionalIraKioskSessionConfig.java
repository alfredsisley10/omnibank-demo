...
/**
 * Session configuration for TraditionalIra accessed through In-Branch Kiosk.
 ...
 */
public final class TraditionalIraKioskSessionConfig {
    ...
    public TraditionalIraKioskSessionConfig() {

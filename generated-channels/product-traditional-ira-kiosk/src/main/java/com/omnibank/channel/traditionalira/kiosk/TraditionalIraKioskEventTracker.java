...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "KIOSK".toLowerCase();
    }

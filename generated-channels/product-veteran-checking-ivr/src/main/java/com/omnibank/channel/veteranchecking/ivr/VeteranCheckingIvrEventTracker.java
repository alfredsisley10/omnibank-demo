...
/**
 * Channel-scoped telemetry tracker for VeteranChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class VeteranCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "veteranchecking" + "." + "IVR".toLowerCase();
    }

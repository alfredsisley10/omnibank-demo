...
/**
 * Session configuration for VeteranChecking accessed through Interactive Voice Response.
 ...
 */
public final class VeteranCheckingIvrSessionConfig {
    ...
    public VeteranCheckingIvrSessionConfig() {

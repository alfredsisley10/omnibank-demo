...
/**
 * Channel-scoped telemetry tracker for CommercialChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class CommercialCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "commercialchecking" + "." + "ATM".toLowerCase();
    }

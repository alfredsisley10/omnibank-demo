...
/**
 * Authentication policy for CommercialChecking on ATM Network. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class CommercialCheckingAtmAuthenticationPolicy {
    ...
    public CommercialCheckingAtmAuthenticationPolicy() {

...
/**
 * Session configuration for CommercialChecking accessed through ATM Network.
 ...
 */
public final class CommercialCheckingAtmSessionConfig {
    ...
    public CommercialCheckingAtmSessionConfig() {

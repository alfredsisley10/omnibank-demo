package com.omnibank.channel.commercialchecking.atm;
...
class CommercialCheckingAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new CommercialCheckingAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new CommercialCheckingAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new CommercialCheckingAtmUiCopy();

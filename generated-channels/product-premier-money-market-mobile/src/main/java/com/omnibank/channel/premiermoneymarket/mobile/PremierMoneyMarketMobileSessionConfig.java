...
/**
 * Session configuration for PremierMoneyMarket accessed through Mobile App.
 ...
 */
public final class PremierMoneyMarketMobileSessionConfig {
    ...
    public PremierMoneyMarketMobileSessionConfig() {

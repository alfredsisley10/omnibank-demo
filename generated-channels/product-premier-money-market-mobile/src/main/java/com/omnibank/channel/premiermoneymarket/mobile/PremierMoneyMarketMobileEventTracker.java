...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "MOBILE".toLowerCase();
    }

package com.omnibank.channel.premiermoneymarket.mobile;
...
class PremierMoneyMarketMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new PremierMoneyMarketMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new PremierMoneyMarketMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new PremierMoneyMarketMobileUiCopy();

...
/**
 * Authentication policy for TraditionalIra on Mobile App. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class TraditionalIraMobileAuthenticationPolicy {
    ...
    public TraditionalIraMobileAuthenticationPolicy() {

...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "MOBILE".toLowerCase();
    }

...
/**
 * Session configuration for TraditionalIra accessed through Mobile App.
 ...
 */
public final class TraditionalIraMobileSessionConfig {
    ...
    public TraditionalIraMobileSessionConfig() {

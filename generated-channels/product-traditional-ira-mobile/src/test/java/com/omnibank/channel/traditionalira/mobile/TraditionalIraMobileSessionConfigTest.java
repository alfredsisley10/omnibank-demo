package com.omnibank.channel.traditionalira.mobile;
...
class TraditionalIraMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new TraditionalIraMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new TraditionalIraMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new TraditionalIraMobileUiCopy();

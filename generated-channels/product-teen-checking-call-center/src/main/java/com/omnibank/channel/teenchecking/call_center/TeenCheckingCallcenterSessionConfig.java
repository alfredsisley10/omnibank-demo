...
/**
 * Session configuration for TeenChecking accessed through Phone Banking.
 ...
 */
public final class TeenCheckingCallcenterSessionConfig {
    ...
    public TeenCheckingCallcenterSessionConfig() {

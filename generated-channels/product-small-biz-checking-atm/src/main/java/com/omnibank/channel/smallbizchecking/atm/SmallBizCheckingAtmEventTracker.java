...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "ATM".toLowerCase();
    }

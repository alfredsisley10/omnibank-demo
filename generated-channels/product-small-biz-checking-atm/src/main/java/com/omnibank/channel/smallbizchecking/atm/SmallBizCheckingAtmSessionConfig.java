...
/**
 * Session configuration for SmallBizChecking accessed through ATM Network.
 ...
 */
public final class SmallBizCheckingAtmSessionConfig {
    ...
    public SmallBizCheckingAtmSessionConfig() {

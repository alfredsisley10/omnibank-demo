...
/**
 * Session configuration for StandardSavings accessed through Web Banking.
 ...
 */
public final class StandardSavingsWebSessionConfig {
    ...
    public StandardSavingsWebSessionConfig() {

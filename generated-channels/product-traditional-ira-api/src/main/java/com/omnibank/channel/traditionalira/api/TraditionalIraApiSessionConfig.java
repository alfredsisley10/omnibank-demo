...
/**
 * Session configuration for TraditionalIra accessed through Third-Party API.
 ...
 */
public final class TraditionalIraApiSessionConfig {
    ...
    public TraditionalIraApiSessionConfig() {

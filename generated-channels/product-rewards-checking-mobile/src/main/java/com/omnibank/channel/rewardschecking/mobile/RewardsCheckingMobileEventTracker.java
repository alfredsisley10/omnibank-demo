...
/**
 * Channel-scoped telemetry tracker for RewardsChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RewardsCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rewardschecking" + "." + "MOBILE".toLowerCase();
    }

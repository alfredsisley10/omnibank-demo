...
/**
 * Authentication policy for RewardsChecking on Mobile App. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RewardsCheckingMobileAuthenticationPolicy {
    ...
    public RewardsCheckingMobileAuthenticationPolicy() {

...
/**
 * Session configuration for EssentialChecking accessed through Web Banking.
 ...
 */
public final class EssentialCheckingWebSessionConfig {
    ...
    public EssentialCheckingWebSessionConfig() {

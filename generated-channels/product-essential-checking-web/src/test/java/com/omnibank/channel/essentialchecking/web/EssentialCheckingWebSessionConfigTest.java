package com.omnibank.channel.essentialchecking.web;
...
class EssentialCheckingWebSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new EssentialCheckingWebSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new EssentialCheckingWebAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new EssentialCheckingWebUiCopy();

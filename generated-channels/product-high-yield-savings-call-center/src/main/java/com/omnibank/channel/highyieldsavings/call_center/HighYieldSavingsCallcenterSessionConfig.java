...
/**
 * Session configuration for HighYieldSavings accessed through Phone Banking.
 ...
 */
public final class HighYieldSavingsCallcenterSessionConfig {
    ...
    public HighYieldSavingsCallcenterSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for HighYieldSavings on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class HighYieldSavingsCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "highyieldsavings" + "." + "CALL_CENTER".toLowerCase();
    }

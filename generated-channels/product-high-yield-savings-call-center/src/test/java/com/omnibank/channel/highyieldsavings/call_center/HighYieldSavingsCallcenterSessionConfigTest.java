package com.omnibank.channel.highyieldsavings.call_center;
...
class HighYieldSavingsCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new HighYieldSavingsCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new HighYieldSavingsCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new HighYieldSavingsCallcenterUiCopy();

package com.omnibank.channel.seniorchecking.mobile;
...
class SeniorCheckingMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new SeniorCheckingMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new SeniorCheckingMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new SeniorCheckingMobileUiCopy();

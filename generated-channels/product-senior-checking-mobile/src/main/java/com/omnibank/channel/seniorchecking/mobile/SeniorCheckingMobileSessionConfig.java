...
/**
 * Session configuration for SeniorChecking accessed through Mobile App.
 ...
 */
public final class SeniorCheckingMobileSessionConfig {
    ...
    public SeniorCheckingMobileSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for SeniorChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SeniorCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "seniorchecking" + "." + "MOBILE".toLowerCase();
    }

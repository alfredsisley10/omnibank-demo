...
/**
 * Session configuration for VeteranChecking accessed through Phone Banking.
 ...
 */
public final class VeteranCheckingCallcenterSessionConfig {
    ...
    public VeteranCheckingCallcenterSessionConfig() {

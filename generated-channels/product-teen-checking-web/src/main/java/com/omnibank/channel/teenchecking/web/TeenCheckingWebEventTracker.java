...
/**
 * Channel-scoped telemetry tracker for TeenChecking on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TeenCheckingWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "teenchecking" + "." + "WEB".toLowerCase();
    }

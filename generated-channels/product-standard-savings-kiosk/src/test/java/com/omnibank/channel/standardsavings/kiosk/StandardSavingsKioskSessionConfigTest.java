package com.omnibank.channel.standardsavings.kiosk;
...
class StandardSavingsKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new StandardSavingsKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new StandardSavingsKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new StandardSavingsKioskUiCopy();

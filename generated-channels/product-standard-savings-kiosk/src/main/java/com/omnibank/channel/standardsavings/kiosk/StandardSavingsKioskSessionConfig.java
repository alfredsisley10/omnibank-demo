...
/**
 * Session configuration for StandardSavings accessed through In-Branch Kiosk.
 ...
 */
public final class StandardSavingsKioskSessionConfig {
    ...
    public StandardSavingsKioskSessionConfig() {

...
/**
 * Authentication policy for StandardSavings on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class StandardSavingsKioskAuthenticationPolicy {
    ...
    public StandardSavingsKioskAuthenticationPolicy() {

...
/**
 * Channel-scoped telemetry tracker for StandardSavings on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StandardSavingsKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "standardsavings" + "." + "KIOSK".toLowerCase();
    }

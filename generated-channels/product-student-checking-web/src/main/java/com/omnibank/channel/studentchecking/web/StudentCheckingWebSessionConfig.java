...
/**
 * Session configuration for StudentChecking accessed through Web Banking.
 ...
 */
public final class StudentCheckingWebSessionConfig {
    ...
    public StudentCheckingWebSessionConfig() {

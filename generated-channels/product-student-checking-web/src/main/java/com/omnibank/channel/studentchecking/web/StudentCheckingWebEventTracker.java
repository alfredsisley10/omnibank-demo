...
/**
 * Channel-scoped telemetry tracker for StudentChecking on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StudentCheckingWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "studentchecking" + "." + "WEB".toLowerCase();
    }

...
/**
 * Channel-scoped telemetry tracker for StudentChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StudentCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "studentchecking" + "." + "MOBILE".toLowerCase();
    }

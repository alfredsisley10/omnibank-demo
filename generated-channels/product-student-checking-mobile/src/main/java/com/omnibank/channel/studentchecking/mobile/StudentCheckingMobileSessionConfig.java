...
/**
 * Session configuration for StudentChecking accessed through Mobile App.
 ...
 */
public final class StudentCheckingMobileSessionConfig {
    ...
    public StudentCheckingMobileSessionConfig() {

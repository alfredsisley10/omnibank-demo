package com.omnibank.channel.rewardschecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the RewardsChecking account flow over
 ...
 */
public final class RewardsCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public RewardsCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta rewardschecking";
        }
        return "Welcome to your rewardschecking account";
    }

...
/**
 * Channel-scoped telemetry tracker for RewardsChecking on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RewardsCheckingApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rewardschecking" + "." + "API".toLowerCase();
    }

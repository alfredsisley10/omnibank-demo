...
/**
 * Session configuration for RewardsChecking accessed through Third-Party API.
 ...
 */
public final class RewardsCheckingApiSessionConfig {
    ...
    public RewardsCheckingApiSessionConfig() {

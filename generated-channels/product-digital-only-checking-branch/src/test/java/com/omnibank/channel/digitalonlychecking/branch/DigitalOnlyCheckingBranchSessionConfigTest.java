package com.omnibank.channel.digitalonlychecking.branch;
...
class DigitalOnlyCheckingBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new DigitalOnlyCheckingBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new DigitalOnlyCheckingBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new DigitalOnlyCheckingBranchUiCopy();

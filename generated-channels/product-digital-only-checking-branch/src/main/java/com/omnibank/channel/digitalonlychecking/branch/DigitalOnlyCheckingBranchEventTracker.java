...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "BRANCH".toLowerCase();
    }

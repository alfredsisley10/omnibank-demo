...
/**
 * Authentication policy for DigitalOnlyChecking on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingBranchAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingBranchAuthenticationPolicy() {
        this.authStrength = "ID_IN_PERSON";

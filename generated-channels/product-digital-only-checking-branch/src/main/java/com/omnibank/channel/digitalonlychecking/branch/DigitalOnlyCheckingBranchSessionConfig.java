...
/**
 * Session configuration for DigitalOnlyChecking accessed through Branch Teller.
 ...
 */
public final class DigitalOnlyCheckingBranchSessionConfig {
    ...
    public DigitalOnlyCheckingBranchSessionConfig() {
        ...
        this.targetLatencyMs = 1000;
        this.deviceClass = "TERMINAL";
    }

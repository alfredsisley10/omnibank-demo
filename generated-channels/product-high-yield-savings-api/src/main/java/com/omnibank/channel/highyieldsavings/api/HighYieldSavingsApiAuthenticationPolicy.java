...
/**
 * Authentication policy for HighYieldSavings on Third-Party API. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class HighYieldSavingsApiAuthenticationPolicy {
    ...
    public HighYieldSavingsApiAuthenticationPolicy() {

package com.omnibank.channel.highyieldsavings.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the HighYieldSavings account flow over
 ...
 */
public final class HighYieldSavingsApiUiCopy {

    private final boolean supportsSpanish;

    public HighYieldSavingsApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta highyieldsavings";
        }
        return "Welcome to your highyieldsavings account";
    }

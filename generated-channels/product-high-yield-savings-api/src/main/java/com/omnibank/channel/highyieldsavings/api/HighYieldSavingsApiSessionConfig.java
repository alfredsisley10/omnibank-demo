...
/**
 * Session configuration for HighYieldSavings accessed through Third-Party API.
 ...
 */
public final class HighYieldSavingsApiSessionConfig {
    ...
    public HighYieldSavingsApiSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for HighYieldSavings on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class HighYieldSavingsApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "highyieldsavings" + "." + "API".toLowerCase();
    }

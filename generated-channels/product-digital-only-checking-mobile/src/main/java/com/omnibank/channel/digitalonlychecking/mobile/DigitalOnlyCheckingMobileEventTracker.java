...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "MOBILE".toLowerCase();
    }

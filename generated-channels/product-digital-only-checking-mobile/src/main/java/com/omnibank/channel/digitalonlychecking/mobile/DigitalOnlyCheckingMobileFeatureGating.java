...
/**
 * Feature gating for DigitalOnlyChecking on Mobile App. Not every capability is
 * available on every channel — ATMs cannot open accounts, IVR
 * cannot render PDFs, API cannot present a PIN pad, etc.
 */
public final class DigitalOnlyCheckingMobileFeatureGating {

    private final boolean canOpenAccount = true;
    private final boolean canCloseAccount = true;
    private final boolean supportsOffline = true;

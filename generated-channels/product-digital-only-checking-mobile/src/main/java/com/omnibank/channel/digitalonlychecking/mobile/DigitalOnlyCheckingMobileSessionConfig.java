...
/**
 * Session configuration for DigitalOnlyChecking accessed through Mobile App.
 ...
 */
public final class DigitalOnlyCheckingMobileSessionConfig {
    ...
    public DigitalOnlyCheckingMobileSessionConfig() {

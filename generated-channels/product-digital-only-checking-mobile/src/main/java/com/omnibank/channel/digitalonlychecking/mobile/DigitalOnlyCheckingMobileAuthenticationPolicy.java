...
/**
 * Authentication policy for DigitalOnlyChecking on Mobile App. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingMobileAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingMobileAuthenticationPolicy() {
        this.authStrength = "BIOMETRIC";

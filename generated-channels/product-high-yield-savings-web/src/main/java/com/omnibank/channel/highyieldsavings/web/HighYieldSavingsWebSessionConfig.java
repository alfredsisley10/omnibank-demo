...
/**
 * Session configuration for HighYieldSavings accessed through Web Banking.
 ...
 */
public final class HighYieldSavingsWebSessionConfig {
    ...
    public HighYieldSavingsWebSessionConfig() {

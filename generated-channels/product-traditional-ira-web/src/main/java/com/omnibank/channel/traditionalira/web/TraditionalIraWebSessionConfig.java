...
/**
 * Session configuration for TraditionalIra accessed through Web Banking.
 ...
 */
public final class TraditionalIraWebSessionConfig {
    ...
    public TraditionalIraWebSessionConfig() {

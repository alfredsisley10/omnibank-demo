...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "WEB".toLowerCase();
    }

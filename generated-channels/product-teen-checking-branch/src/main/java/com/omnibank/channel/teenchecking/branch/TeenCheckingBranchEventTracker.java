...
/**
 * Channel-scoped telemetry tracker for TeenChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TeenCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "teenchecking" + "." + "BRANCH".toLowerCase();
    }

...
/**
 * Session configuration for TeenChecking accessed through Branch Teller.
 ...
 */
public final class TeenCheckingBranchSessionConfig {
    ...
    public TeenCheckingBranchSessionConfig() {

...
/**
 * Authentication policy for TeenChecking on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class TeenCheckingBranchAuthenticationPolicy {
    ...
    public TeenCheckingBranchAuthenticationPolicy() {

package com.omnibank.channel.seniorchecking.branch;
...
class SeniorCheckingBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new SeniorCheckingBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new SeniorCheckingBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new SeniorCheckingBranchUiCopy();

...
/**
 * Session configuration for SeniorChecking accessed through Branch Teller.
 ...
 */
public final class SeniorCheckingBranchSessionConfig {
    ...
    public SeniorCheckingBranchSessionConfig() {

package com.omnibank.channel.veteranchecking.mobile;
...
class VeteranCheckingMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new VeteranCheckingMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new VeteranCheckingMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new VeteranCheckingMobileUiCopy();

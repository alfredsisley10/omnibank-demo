...
/**
 * Channel-scoped telemetry tracker for VeteranChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class VeteranCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "veteranchecking" + "." + "MOBILE".toLowerCase();
    }

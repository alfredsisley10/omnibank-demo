...
/**
 * Session configuration for VeteranChecking accessed through Mobile App.
 ...
 */
public final class VeteranCheckingMobileSessionConfig {
    ...
    public VeteranCheckingMobileSessionConfig() {

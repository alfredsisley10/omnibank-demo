...
/**
 * Session configuration for VeteranChecking accessed through Branch Teller.
 ...
 */
public final class VeteranCheckingBranchSessionConfig {
    ...
    public VeteranCheckingBranchSessionConfig() {

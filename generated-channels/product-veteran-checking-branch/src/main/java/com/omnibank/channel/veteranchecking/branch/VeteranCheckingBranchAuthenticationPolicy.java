...
/**
 * Authentication policy for VeteranChecking on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class VeteranCheckingBranchAuthenticationPolicy {
    ...
    public VeteranCheckingBranchAuthenticationPolicy() {

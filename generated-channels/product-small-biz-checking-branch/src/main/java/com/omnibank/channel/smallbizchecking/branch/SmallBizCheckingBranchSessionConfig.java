...
/**
 * Session configuration for SmallBizChecking accessed through Branch Teller.
 ...
 */
public final class SmallBizCheckingBranchSessionConfig {
    ...
    public SmallBizCheckingBranchSessionConfig() {

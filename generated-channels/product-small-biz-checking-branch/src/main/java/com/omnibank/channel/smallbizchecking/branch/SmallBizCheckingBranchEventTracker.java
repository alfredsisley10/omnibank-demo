...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "BRANCH".toLowerCase();
    }

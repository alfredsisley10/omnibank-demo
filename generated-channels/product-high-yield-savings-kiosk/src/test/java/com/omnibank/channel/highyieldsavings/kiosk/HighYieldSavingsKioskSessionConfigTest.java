package com.omnibank.channel.highyieldsavings.kiosk;
...
class HighYieldSavingsKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new HighYieldSavingsKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new HighYieldSavingsKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new HighYieldSavingsKioskUiCopy();

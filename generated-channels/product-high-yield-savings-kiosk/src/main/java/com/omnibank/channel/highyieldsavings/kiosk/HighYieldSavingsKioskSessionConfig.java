...
/**
 * Session configuration for HighYieldSavings accessed through In-Branch Kiosk.
 ...
 */
public final class HighYieldSavingsKioskSessionConfig {
    ...
    public HighYieldSavingsKioskSessionConfig() {

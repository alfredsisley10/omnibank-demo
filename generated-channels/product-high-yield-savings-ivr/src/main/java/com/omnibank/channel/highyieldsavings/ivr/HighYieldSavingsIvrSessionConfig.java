...
/**
 * Session configuration for HighYieldSavings accessed through Interactive Voice Response.
 ...
 */
public final class HighYieldSavingsIvrSessionConfig {
    ...
    public HighYieldSavingsIvrSessionConfig() {

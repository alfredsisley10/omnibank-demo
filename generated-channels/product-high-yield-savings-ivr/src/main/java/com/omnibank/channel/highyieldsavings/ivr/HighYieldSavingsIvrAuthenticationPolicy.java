...
/**
 * Authentication policy for HighYieldSavings on Interactive Voice Response. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class HighYieldSavingsIvrAuthenticationPolicy {
    ...
    public HighYieldSavingsIvrAuthenticationPolicy() {

...
/**
 * Channel-scoped telemetry tracker for HighYieldSavings on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class HighYieldSavingsIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "highyieldsavings" + "." + "IVR".toLowerCase();
    }

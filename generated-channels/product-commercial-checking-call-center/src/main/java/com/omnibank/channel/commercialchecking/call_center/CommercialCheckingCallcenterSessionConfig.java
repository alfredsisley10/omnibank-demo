...
/**
 * Session configuration for CommercialChecking accessed through Phone Banking.
 ...
 */
public final class CommercialCheckingCallcenterSessionConfig {
    ...
    public CommercialCheckingCallcenterSessionConfig() {

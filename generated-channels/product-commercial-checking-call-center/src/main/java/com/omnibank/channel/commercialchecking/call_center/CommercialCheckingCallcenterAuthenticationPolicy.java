...
/**
 * Authentication policy for CommercialChecking on Phone Banking. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class CommercialCheckingCallcenterAuthenticationPolicy {
    ...
    public CommercialCheckingCallcenterAuthenticationPolicy() {

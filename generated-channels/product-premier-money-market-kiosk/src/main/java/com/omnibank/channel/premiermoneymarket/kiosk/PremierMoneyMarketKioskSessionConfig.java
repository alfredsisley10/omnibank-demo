...
/**
 * Session configuration for PremierMoneyMarket accessed through In-Branch Kiosk.
 ...
 */
public final class PremierMoneyMarketKioskSessionConfig {
    ...
    public PremierMoneyMarketKioskSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "KIOSK".toLowerCase();
    }

...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "IVR".toLowerCase();
    }

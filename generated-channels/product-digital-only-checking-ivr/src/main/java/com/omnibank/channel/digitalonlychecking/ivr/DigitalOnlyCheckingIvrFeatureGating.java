...
/**
 * Feature gating for DigitalOnlyChecking on Interactive Voice Response. Not every capability is
 * available on every channel — ATMs cannot open accounts, IVR
 * cannot render PDFs, API cannot present a PIN pad, etc.
 */
public final class DigitalOnlyCheckingIvrFeatureGating {

    private final boolean canOpenAccount = false;

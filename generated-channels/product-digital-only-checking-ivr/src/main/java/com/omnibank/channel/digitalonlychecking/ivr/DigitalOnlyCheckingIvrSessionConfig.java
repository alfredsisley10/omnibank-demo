...
/**
 * Session configuration for DigitalOnlyChecking accessed through Interactive Voice Response.
 ...
 */
public final class DigitalOnlyCheckingIvrSessionConfig {
    ...
    public DigitalOnlyCheckingIvrSessionConfig() {

package com.omnibank.channel.digitalonlychecking.ivr;
 ...
 * Interactive Voice Response. Copy length and vocabulary differ: web has room for
 * long-form copy, ATM screens must fit a narrow line, IVR text is
 * read aloud and must avoid visual-only cues.
 */
public final class DigitalOnlyCheckingIvrUiCopy {

    private final boolean supportsSpanish;

    public DigitalOnlyCheckingIvrUiCopy() {

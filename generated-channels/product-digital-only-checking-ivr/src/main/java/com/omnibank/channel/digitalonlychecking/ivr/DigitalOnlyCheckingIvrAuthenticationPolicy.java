...
/**
 * Authentication policy for DigitalOnlyChecking on Interactive Voice Response. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingIvrAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingIvrAuthenticationPolicy() {
        this.authStrength = "ACCOUNT_PIN";

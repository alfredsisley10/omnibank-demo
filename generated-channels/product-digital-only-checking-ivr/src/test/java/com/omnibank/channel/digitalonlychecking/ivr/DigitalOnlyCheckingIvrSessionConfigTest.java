...
class DigitalOnlyCheckingIvrSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new DigitalOnlyCheckingIvrSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new DigitalOnlyCheckingIvrAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new DigitalOnlyCheckingIvrUiCopy();

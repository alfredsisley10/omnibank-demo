...
/**
 * Channel-scoped telemetry tracker for StudentChecking on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StudentCheckingApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "studentchecking" + "." + "API".toLowerCase();
    }

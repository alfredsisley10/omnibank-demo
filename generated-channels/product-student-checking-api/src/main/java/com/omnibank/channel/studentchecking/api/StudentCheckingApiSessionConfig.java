...
/**
 * Session configuration for StudentChecking accessed through Third-Party API.
 ...
 */
public final class StudentCheckingApiSessionConfig {
    ...
    public StudentCheckingApiSessionConfig() {

package com.omnibank.channel.studentchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the StudentChecking account flow over
 ...
 */
public final class StudentCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public StudentCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta studentchecking";
        }
        return "Welcome to your studentchecking account";
    }

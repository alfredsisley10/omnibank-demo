...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "IVR".toLowerCase();
    }

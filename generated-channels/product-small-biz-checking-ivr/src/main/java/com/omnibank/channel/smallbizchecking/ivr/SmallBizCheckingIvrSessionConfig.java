...
/**
 * Session configuration for SmallBizChecking accessed through Interactive Voice Response.
 ...
 */
public final class SmallBizCheckingIvrSessionConfig {
    ...
    public SmallBizCheckingIvrSessionConfig() {

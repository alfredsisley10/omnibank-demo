package com.omnibank.channel.highyieldsavings.branch;
...
class HighYieldSavingsBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new HighYieldSavingsBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new HighYieldSavingsBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new HighYieldSavingsBranchUiCopy();

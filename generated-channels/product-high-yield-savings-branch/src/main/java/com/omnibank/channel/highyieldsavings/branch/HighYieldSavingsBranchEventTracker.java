...
/**
 * Channel-scoped telemetry tracker for HighYieldSavings on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class HighYieldSavingsBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "highyieldsavings" + "." + "BRANCH".toLowerCase();
    }

...
/**
 * Authentication policy for HighYieldSavings on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class HighYieldSavingsBranchAuthenticationPolicy {
    ...
    public HighYieldSavingsBranchAuthenticationPolicy() {

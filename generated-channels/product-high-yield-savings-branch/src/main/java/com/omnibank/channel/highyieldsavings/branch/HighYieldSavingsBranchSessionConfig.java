...
/**
 * Session configuration for HighYieldSavings accessed through Branch Teller.
 ...
 */
public final class HighYieldSavingsBranchSessionConfig {
    ...
    public HighYieldSavingsBranchSessionConfig() {

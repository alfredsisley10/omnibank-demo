...
/**
 * Session configuration for StudentChecking accessed through Branch Teller.
 ...
 */
public final class StudentCheckingBranchSessionConfig {
    ...
    public StudentCheckingBranchSessionConfig() {

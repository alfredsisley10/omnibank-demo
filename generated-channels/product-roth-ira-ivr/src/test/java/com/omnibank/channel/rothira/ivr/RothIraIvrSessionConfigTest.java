...
class RothIraIvrSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraIvrSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraIvrAuthenticationPolicy();

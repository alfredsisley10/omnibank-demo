...
/**
 * Channel-scoped telemetry tracker for RothIra on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RothIraIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rothira" + "." + "IVR".toLowerCase();
    }

...
/**
 * Session configuration for RewardsChecking accessed through Branch Teller.
 ...
 */
public final class RewardsCheckingBranchSessionConfig {
    ...
    public RewardsCheckingBranchSessionConfig() {

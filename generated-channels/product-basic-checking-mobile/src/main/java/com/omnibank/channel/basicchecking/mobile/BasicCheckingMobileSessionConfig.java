...
/**
 * Session configuration for BasicChecking accessed through Mobile App.
 ...
 */
public final class BasicCheckingMobileSessionConfig {
    ...
    public BasicCheckingMobileSessionConfig() {

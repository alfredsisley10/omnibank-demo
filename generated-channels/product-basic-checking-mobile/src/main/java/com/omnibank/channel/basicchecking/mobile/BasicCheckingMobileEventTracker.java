...
/**
 * Channel-scoped telemetry tracker for BasicChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class BasicCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "basicchecking" + "." + "MOBILE".toLowerCase();
    }

...
/**
 * Session configuration for HighYieldSavings accessed through ATM Network.
 ...
 */
public final class HighYieldSavingsAtmSessionConfig {
    ...
    public HighYieldSavingsAtmSessionConfig() {

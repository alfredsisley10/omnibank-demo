...
class HighYieldSavingsAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new HighYieldSavingsAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new HighYieldSavingsAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new HighYieldSavingsAtmUiCopy();

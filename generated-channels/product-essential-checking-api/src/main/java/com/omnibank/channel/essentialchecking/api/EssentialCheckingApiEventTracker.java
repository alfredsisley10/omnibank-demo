...
/**
 * Channel-scoped telemetry tracker for EssentialChecking on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class EssentialCheckingApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "essentialchecking" + "." + "API".toLowerCase();
    }

...
/**
 * Session configuration for EssentialChecking accessed through Third-Party API.
 ...
 */
public final class EssentialCheckingApiSessionConfig {
    ...
    public EssentialCheckingApiSessionConfig() {

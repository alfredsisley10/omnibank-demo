...
/**
 * Session configuration for RewardsChecking accessed through Interactive Voice Response.
 ...
 */
public final class RewardsCheckingIvrSessionConfig {
    ...
    public RewardsCheckingIvrSessionConfig() {

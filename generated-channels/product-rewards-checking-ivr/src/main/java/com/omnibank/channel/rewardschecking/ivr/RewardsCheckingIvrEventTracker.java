...
/**
 * Channel-scoped telemetry tracker for RewardsChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RewardsCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rewardschecking" + "." + "IVR".toLowerCase();
    }

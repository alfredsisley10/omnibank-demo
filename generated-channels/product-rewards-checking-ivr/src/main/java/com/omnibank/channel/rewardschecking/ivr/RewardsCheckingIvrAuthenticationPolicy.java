...
/**
 * Authentication policy for RewardsChecking on Interactive Voice Response. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RewardsCheckingIvrAuthenticationPolicy {
    ...
    public RewardsCheckingIvrAuthenticationPolicy() {

...
class RewardsCheckingIvrSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RewardsCheckingIvrSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RewardsCheckingIvrAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RewardsCheckingIvrUiCopy();

package com.omnibank.channel.basicchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the BasicChecking account flow over
 ...
 */
public final class BasicCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public BasicCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta basicchecking";
        }
        return "Welcome to your basicchecking account";
    }

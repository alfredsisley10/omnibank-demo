...
/**
 * Session configuration for BasicChecking accessed through Third-Party API.
 ...
 */
public final class BasicCheckingApiSessionConfig {
    ...
    public BasicCheckingApiSessionConfig() {

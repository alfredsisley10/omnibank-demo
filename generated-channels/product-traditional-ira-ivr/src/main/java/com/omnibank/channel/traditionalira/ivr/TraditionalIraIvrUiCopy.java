package com.omnibank.channel.traditionalira.ivr;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the TraditionalIra account flow over
 ...
 */
public final class TraditionalIraIvrUiCopy {

    private final boolean supportsSpanish;

    public TraditionalIraIvrUiCopy() {
        this.supportsSpanish = true;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta traditionalira";
        }
        return "Welcome to your traditionalira account";
    }

...
/**
 * Channel-scoped telemetry tracker for TraditionalIra on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TraditionalIraIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "traditionalira" + "." + "IVR".toLowerCase();
    }

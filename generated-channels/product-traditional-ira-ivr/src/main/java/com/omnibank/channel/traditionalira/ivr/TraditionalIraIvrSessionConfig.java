...
/**
 * Session configuration for TraditionalIra accessed through Interactive Voice Response.
 ...
 */
public final class TraditionalIraIvrSessionConfig {
    ...
    public TraditionalIraIvrSessionConfig() {

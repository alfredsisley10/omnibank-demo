...
/**
 * Session configuration for VeteranChecking accessed through In-Branch Kiosk.
 ...
 */
public final class VeteranCheckingKioskSessionConfig {
    ...
    public VeteranCheckingKioskSessionConfig() {

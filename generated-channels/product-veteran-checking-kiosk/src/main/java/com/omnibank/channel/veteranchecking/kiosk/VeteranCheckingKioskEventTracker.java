...
/**
 * Channel-scoped telemetry tracker for VeteranChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class VeteranCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "veteranchecking" + "." + "KIOSK".toLowerCase();
    }

package com.omnibank.channel.veteranchecking.kiosk;
...
class VeteranCheckingKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new VeteranCheckingKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new VeteranCheckingKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new VeteranCheckingKioskUiCopy();

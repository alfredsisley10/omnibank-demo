...
/**
 * Authentication policy for VeteranChecking on Third-Party API. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class VeteranCheckingApiAuthenticationPolicy {
    ...
    public VeteranCheckingApiAuthenticationPolicy() {

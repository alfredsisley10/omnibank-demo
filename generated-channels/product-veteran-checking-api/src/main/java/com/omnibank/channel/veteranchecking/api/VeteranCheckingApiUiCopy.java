package com.omnibank.channel.veteranchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the VeteranChecking account flow over
 ...
 */
public final class VeteranCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public VeteranCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta veteranchecking";
        }
        return "Welcome to your veteranchecking account";
    }

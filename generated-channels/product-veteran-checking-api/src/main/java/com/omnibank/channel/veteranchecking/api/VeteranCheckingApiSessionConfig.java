...
/**
 * Session configuration for VeteranChecking accessed through Third-Party API.
 ...
 */
public final class VeteranCheckingApiSessionConfig {
    ...
    public VeteranCheckingApiSessionConfig() {

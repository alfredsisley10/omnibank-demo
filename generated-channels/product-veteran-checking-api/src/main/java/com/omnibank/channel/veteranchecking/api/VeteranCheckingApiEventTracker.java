...
/**
 * Channel-scoped telemetry tracker for VeteranChecking on Third-Party API.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class VeteranCheckingApiEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "veteranchecking" + "." + "API".toLowerCase();
    }

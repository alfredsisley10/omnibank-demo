...
class DigitalOnlyCheckingApiSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new DigitalOnlyCheckingApiSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new DigitalOnlyCheckingApiAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new DigitalOnlyCheckingApiUiCopy();

...
/**
 * Session configuration for DigitalOnlyChecking accessed through Third-Party API.
 ...
 */
public final class DigitalOnlyCheckingApiSessionConfig {
    ...
    public DigitalOnlyCheckingApiSessionConfig() {
        ...
        this.targetLatencyMs = 150;
        this.deviceClass = "API_CLIENT";
    }

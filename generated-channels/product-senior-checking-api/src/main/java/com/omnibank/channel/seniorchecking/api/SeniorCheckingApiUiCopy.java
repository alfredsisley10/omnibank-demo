package com.omnibank.channel.seniorchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the SeniorChecking account flow over
 ...
 */
public final class SeniorCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public SeniorCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta seniorchecking";
        }
        return "Welcome to your seniorchecking account";
    }

...
/**
 * Session configuration for SeniorChecking accessed through Third-Party API.
 ...
 */
public final class SeniorCheckingApiSessionConfig {
    ...
    public SeniorCheckingApiSessionConfig() {

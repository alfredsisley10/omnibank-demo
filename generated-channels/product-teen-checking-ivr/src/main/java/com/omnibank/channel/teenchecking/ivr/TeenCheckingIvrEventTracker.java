...
/**
 * Channel-scoped telemetry tracker for TeenChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TeenCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "teenchecking" + "." + "IVR".toLowerCase();
    }

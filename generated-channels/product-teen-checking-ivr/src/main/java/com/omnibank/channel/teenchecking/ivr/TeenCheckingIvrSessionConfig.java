...
/**
 * Session configuration for TeenChecking accessed through Interactive Voice Response.
 ...
 */
public final class TeenCheckingIvrSessionConfig {
    ...
    public TeenCheckingIvrSessionConfig() {

...
/**
 * Session configuration for TeenChecking accessed through In-Branch Kiosk.
 ...
 */
public final class TeenCheckingKioskSessionConfig {
    ...
    public TeenCheckingKioskSessionConfig() {

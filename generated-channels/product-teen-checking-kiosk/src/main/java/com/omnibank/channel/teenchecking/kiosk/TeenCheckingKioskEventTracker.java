...
/**
 * Channel-scoped telemetry tracker for TeenChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class TeenCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "teenchecking" + "." + "KIOSK".toLowerCase();
    }

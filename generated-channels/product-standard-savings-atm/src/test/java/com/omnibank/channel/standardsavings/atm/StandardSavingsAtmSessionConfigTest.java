package com.omnibank.channel.standardsavings.atm;
...
class StandardSavingsAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new StandardSavingsAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new StandardSavingsAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new StandardSavingsAtmUiCopy();

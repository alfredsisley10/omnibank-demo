...
/**
 * Session configuration for StandardSavings accessed through ATM Network.
 ...
 */
public final class StandardSavingsAtmSessionConfig {
    ...
    public StandardSavingsAtmSessionConfig() {

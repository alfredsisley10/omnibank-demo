...
/**
 * Channel-scoped telemetry tracker for StandardSavings on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StandardSavingsAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "standardsavings" + "." + "ATM".toLowerCase();
    }

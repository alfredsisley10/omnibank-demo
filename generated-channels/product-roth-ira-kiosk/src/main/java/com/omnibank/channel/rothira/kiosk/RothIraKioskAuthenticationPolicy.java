...
/**
 * Authentication policy for RothIra on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RothIraKioskAuthenticationPolicy {
    ...
    public RothIraKioskAuthenticationPolicy() {

...
/**
 * Session configuration for DigitalOnlyChecking accessed through Web Banking.
 ...
 */
public final class DigitalOnlyCheckingWebSessionConfig {
    ...
    public DigitalOnlyCheckingWebSessionConfig() {

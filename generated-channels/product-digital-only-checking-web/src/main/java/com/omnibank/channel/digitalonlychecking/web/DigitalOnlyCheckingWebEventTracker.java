...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "WEB".toLowerCase();
    }

...
/**
 * Authentication policy for DigitalOnlyChecking on Web Banking. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingWebAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingWebAuthenticationPolicy() {

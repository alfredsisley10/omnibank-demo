...
/**
 * Session configuration for BasicChecking accessed through Interactive Voice Response.
 ...
 */
public final class BasicCheckingIvrSessionConfig {
    ...
    public BasicCheckingIvrSessionConfig() {

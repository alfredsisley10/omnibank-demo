package com.omnibank.channel.seniorchecking.kiosk;
...
class SeniorCheckingKioskSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new SeniorCheckingKioskSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new SeniorCheckingKioskAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new SeniorCheckingKioskUiCopy();

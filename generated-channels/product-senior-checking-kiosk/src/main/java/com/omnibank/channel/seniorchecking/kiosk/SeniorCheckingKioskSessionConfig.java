...
/**
 * Session configuration for SeniorChecking accessed through In-Branch Kiosk.
 ...
 */
public final class SeniorCheckingKioskSessionConfig {
    ...
    public SeniorCheckingKioskSessionConfig() {

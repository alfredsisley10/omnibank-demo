...
/**
 * Channel-scoped telemetry tracker for SeniorChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SeniorCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "seniorchecking" + "." + "KIOSK".toLowerCase();
    }

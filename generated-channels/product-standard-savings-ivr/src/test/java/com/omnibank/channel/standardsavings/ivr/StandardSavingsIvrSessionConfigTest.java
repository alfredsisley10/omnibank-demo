package com.omnibank.channel.standardsavings.ivr;
...
class StandardSavingsIvrSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new StandardSavingsIvrSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new StandardSavingsIvrAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new StandardSavingsIvrUiCopy();

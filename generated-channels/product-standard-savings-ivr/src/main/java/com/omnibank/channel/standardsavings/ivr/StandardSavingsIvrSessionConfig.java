...
/**
 * Session configuration for StandardSavings accessed through Interactive Voice Response.
 ...
 */
public final class StandardSavingsIvrSessionConfig {
    ...
    public StandardSavingsIvrSessionConfig() {

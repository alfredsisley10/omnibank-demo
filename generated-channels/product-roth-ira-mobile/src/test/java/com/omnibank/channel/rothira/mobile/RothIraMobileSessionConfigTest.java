package com.omnibank.channel.rothira.mobile;
...
class RothIraMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RothIraMobileUiCopy();

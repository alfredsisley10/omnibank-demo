package com.omnibank.channel.digitalonlychecking.atm;
...
class DigitalOnlyCheckingAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new DigitalOnlyCheckingAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new DigitalOnlyCheckingAtmAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new DigitalOnlyCheckingAtmUiCopy();

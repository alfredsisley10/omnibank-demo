...
/**
 * Channel-scoped telemetry tracker for DigitalOnlyChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class DigitalOnlyCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "digitalonlychecking" + "." + "ATM".toLowerCase();
    }

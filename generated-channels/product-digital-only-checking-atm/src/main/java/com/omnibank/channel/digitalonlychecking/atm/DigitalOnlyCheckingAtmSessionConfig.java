...
/**
 * Session configuration for DigitalOnlyChecking accessed through ATM Network.
 ...
 */
public final class DigitalOnlyCheckingAtmSessionConfig {
    ...
    public DigitalOnlyCheckingAtmSessionConfig() {
        ...
        this.targetLatencyMs = 200;
        this.deviceClass = "ATM";
    }

...
/**
 * Authentication policy for DigitalOnlyChecking on ATM Network. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class DigitalOnlyCheckingAtmAuthenticationPolicy {
    ...
    public DigitalOnlyCheckingAtmAuthenticationPolicy() {

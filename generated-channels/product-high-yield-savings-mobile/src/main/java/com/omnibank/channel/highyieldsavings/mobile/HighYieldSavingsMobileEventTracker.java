...
/**
 * Channel-scoped telemetry tracker for HighYieldSavings on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class HighYieldSavingsMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "highyieldsavings" + "." + "MOBILE".toLowerCase();
    }

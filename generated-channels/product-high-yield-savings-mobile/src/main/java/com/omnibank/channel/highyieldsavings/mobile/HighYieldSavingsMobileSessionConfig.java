...
/**
 * Session configuration for HighYieldSavings accessed through Mobile App.
 ...
 */
public final class HighYieldSavingsMobileSessionConfig {
    ...
    public HighYieldSavingsMobileSessionConfig() {

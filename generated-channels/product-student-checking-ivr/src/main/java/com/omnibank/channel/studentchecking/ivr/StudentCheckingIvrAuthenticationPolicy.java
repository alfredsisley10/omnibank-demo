...
/**
 * Authentication policy for StudentChecking on Interactive Voice Response. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class StudentCheckingIvrAuthenticationPolicy {
    ...
    public StudentCheckingIvrAuthenticationPolicy() {

...
/**
 * Session configuration for StudentChecking accessed through Interactive Voice Response.
 ...
 */
public final class StudentCheckingIvrSessionConfig {
    ...
    public StudentCheckingIvrSessionConfig() {

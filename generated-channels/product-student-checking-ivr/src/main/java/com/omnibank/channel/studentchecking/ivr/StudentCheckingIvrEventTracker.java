...
/**
 * Channel-scoped telemetry tracker for StudentChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StudentCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "studentchecking" + "." + "IVR".toLowerCase();
    }

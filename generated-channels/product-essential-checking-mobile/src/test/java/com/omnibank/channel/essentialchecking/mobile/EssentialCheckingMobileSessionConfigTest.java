package com.omnibank.channel.essentialchecking.mobile;
...
class EssentialCheckingMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new EssentialCheckingMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new EssentialCheckingMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new EssentialCheckingMobileUiCopy();

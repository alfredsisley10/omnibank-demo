...
/**
 * Channel-scoped telemetry tracker for EssentialChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class EssentialCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "essentialchecking" + "." + "MOBILE".toLowerCase();
    }

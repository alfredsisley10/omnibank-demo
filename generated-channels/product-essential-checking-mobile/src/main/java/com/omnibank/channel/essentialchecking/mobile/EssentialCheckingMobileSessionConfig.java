...
/**
 * Session configuration for EssentialChecking accessed through Mobile App.
 ...
 */
public final class EssentialCheckingMobileSessionConfig {
    ...
    public EssentialCheckingMobileSessionConfig() {

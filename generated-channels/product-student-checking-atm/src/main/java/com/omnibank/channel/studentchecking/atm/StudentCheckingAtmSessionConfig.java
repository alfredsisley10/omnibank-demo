...
/**
 * Session configuration for StudentChecking accessed through ATM Network.
 ...
 */
public final class StudentCheckingAtmSessionConfig {
    ...
    public StudentCheckingAtmSessionConfig() {

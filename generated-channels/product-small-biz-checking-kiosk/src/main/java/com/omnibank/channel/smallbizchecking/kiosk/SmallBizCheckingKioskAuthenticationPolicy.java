...
/**
 * Authentication policy for SmallBizChecking on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class SmallBizCheckingKioskAuthenticationPolicy {
    ...
    public SmallBizCheckingKioskAuthenticationPolicy() {

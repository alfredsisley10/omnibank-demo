...
/**
 * Channel-scoped telemetry tracker for SmallBizChecking on In-Branch Kiosk.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SmallBizCheckingKioskEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "smallbizchecking" + "." + "KIOSK".toLowerCase();
    }

...
/**
 * Session configuration for SmallBizChecking accessed through In-Branch Kiosk.
 ...
 */
public final class SmallBizCheckingKioskSessionConfig {
    ...
    public SmallBizCheckingKioskSessionConfig() {

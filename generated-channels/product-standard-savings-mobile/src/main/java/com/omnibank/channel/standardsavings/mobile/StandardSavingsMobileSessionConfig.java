...
/**
 * Session configuration for StandardSavings accessed through Mobile App.
 ...
 */
public final class StandardSavingsMobileSessionConfig {
    ...
    public StandardSavingsMobileSessionConfig() {

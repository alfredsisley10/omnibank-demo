...
/**
 * Channel-scoped telemetry tracker for StandardSavings on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StandardSavingsMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "standardsavings" + "." + "MOBILE".toLowerCase();
    }

...
/**
 * Authentication policy for StandardSavings on Mobile App. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class StandardSavingsMobileAuthenticationPolicy {
    ...
    public StandardSavingsMobileAuthenticationPolicy() {

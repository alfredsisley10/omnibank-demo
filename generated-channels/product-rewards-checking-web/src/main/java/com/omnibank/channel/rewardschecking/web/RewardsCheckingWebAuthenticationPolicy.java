...
/**
 * Authentication policy for RewardsChecking on Web Banking. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RewardsCheckingWebAuthenticationPolicy {
    ...
    public RewardsCheckingWebAuthenticationPolicy() {

...
/**
 * Session configuration for RewardsChecking accessed through Web Banking.
 ...
 */
public final class RewardsCheckingWebSessionConfig {
    ...
    public RewardsCheckingWebSessionConfig() {

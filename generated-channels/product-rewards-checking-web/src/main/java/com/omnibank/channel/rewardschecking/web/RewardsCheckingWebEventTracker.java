...
/**
 * Channel-scoped telemetry tracker for RewardsChecking on Web Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RewardsCheckingWebEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rewardschecking" + "." + "WEB".toLowerCase();
    }

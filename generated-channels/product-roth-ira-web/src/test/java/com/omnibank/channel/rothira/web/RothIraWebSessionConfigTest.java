...
class RothIraWebSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraWebSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraWebAuthenticationPolicy();

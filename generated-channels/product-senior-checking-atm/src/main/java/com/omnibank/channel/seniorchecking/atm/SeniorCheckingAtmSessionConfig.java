...
/**
 * Session configuration for SeniorChecking accessed through ATM Network.
 ...
 */
public final class SeniorCheckingAtmSessionConfig {
    ...
    public SeniorCheckingAtmSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for SeniorChecking on ATM Network.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class SeniorCheckingAtmEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "seniorchecking" + "." + "ATM".toLowerCase();
    }

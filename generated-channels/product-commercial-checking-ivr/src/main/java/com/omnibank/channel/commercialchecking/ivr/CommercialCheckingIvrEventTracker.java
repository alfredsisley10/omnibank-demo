...
/**
 * Channel-scoped telemetry tracker for CommercialChecking on Interactive Voice Response.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class CommercialCheckingIvrEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "commercialchecking" + "." + "IVR".toLowerCase();
    }

...
/**
 * Session configuration for CommercialChecking accessed through Interactive Voice Response.
 ...
 */
public final class CommercialCheckingIvrSessionConfig {
    ...
    public CommercialCheckingIvrSessionConfig() {

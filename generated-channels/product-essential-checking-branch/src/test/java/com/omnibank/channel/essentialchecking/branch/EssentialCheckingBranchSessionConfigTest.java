...
class EssentialCheckingBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new EssentialCheckingBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new EssentialCheckingBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new EssentialCheckingBranchUiCopy();

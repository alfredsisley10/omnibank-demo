...
/**
 * Channel-scoped telemetry tracker for EssentialChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class EssentialCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "essentialchecking" + "." + "BRANCH".toLowerCase();
    }

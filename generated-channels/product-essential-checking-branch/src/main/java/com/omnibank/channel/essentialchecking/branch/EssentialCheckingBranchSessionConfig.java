...
/**
 * Session configuration for EssentialChecking accessed through Branch Teller.
 ...
 */
public final class EssentialCheckingBranchSessionConfig {
    ...
    public EssentialCheckingBranchSessionConfig() {

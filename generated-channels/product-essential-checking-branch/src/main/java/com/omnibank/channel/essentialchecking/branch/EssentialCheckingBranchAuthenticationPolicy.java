...
/**
 * Authentication policy for EssentialChecking on Branch Teller. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class EssentialCheckingBranchAuthenticationPolicy {
    ...
    public EssentialCheckingBranchAuthenticationPolicy() {

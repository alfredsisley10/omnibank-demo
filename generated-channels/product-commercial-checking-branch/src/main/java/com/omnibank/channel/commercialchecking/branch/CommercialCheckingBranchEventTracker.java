...
/**
 * Channel-scoped telemetry tracker for CommercialChecking on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class CommercialCheckingBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "commercialchecking" + "." + "BRANCH".toLowerCase();
    }

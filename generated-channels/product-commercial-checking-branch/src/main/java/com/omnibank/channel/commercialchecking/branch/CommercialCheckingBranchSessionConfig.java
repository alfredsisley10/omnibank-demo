...
/**
 * Session configuration for CommercialChecking accessed through Branch Teller.
 ...
 */
public final class CommercialCheckingBranchSessionConfig {
    ...
    public CommercialCheckingBranchSessionConfig() {

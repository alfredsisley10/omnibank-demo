package com.omnibank.channel.commercialchecking.branch;
...
class CommercialCheckingBranchSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new CommercialCheckingBranchSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new CommercialCheckingBranchAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new CommercialCheckingBranchUiCopy();

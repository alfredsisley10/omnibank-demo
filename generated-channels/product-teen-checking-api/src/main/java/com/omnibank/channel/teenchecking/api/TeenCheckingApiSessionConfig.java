...
/**
 * Session configuration for TeenChecking accessed through Third-Party API.
 ...
 */
public final class TeenCheckingApiSessionConfig {
    ...
    public TeenCheckingApiSessionConfig() {

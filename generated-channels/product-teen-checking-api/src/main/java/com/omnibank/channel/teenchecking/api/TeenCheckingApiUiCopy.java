package com.omnibank.channel.teenchecking.api;

import java.util.Locale;
import java.util.Map;

/**
 * Channel-tailored UI / audio copy for the TeenChecking account flow over
 ...
 */
public final class TeenCheckingApiUiCopy {

    private final boolean supportsSpanish;

    public TeenCheckingApiUiCopy() {
        this.supportsSpanish = false;
    }

    public String welcomeHeadline(Locale locale) {
        if (isSpanish(locale)) {
            return "Bienvenido a su cuenta teenchecking";
        }
        return "Welcome to your teenchecking account";
    }

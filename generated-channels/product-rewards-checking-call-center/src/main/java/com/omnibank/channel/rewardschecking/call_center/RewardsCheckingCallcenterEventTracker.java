...
/**
 * Channel-scoped telemetry tracker for RewardsChecking on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class RewardsCheckingCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "rewardschecking" + "." + "CALL_CENTER".toLowerCase();
    }

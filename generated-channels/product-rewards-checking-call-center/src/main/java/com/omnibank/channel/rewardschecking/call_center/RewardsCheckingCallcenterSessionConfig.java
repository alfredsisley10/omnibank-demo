...
/**
 * Session configuration for RewardsChecking accessed through Phone Banking.
 ...
 */
public final class RewardsCheckingCallcenterSessionConfig {
    ...
    public RewardsCheckingCallcenterSessionConfig() {

...
/**
 * Authentication policy for RewardsChecking on Phone Banking. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class RewardsCheckingCallcenterAuthenticationPolicy {
    ...
    public RewardsCheckingCallcenterAuthenticationPolicy() {

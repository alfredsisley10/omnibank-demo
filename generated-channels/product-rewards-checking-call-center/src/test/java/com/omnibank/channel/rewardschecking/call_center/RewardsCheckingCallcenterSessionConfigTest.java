package com.omnibank.channel.rewardschecking.call_center;
...
class RewardsCheckingCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RewardsCheckingCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RewardsCheckingCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new RewardsCheckingCallcenterUiCopy();

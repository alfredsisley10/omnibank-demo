...
/**
 * Session configuration for BasicChecking accessed through In-Branch Kiosk.
 ...
 */
public final class BasicCheckingKioskSessionConfig {
    ...
    public BasicCheckingKioskSessionConfig() {

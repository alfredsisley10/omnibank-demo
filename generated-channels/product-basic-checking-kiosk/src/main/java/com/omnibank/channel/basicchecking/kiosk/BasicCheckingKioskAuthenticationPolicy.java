...
/**
 * Authentication policy for BasicChecking on In-Branch Kiosk. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class BasicCheckingKioskAuthenticationPolicy {
    ...
    public BasicCheckingKioskAuthenticationPolicy() {

...
/**
 * Session configuration for StudentChecking accessed through Phone Banking.
 ...
 */
public final class StudentCheckingCallcenterSessionConfig {
    ...
    public StudentCheckingCallcenterSessionConfig() {

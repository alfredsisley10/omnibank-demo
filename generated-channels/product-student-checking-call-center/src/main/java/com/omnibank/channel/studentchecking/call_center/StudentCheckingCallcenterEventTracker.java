...
/**
 * Channel-scoped telemetry tracker for StudentChecking on Phone Banking.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class StudentCheckingCallcenterEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "studentchecking" + "." + "CALL_CENTER".toLowerCase();
    }

package com.omnibank.channel.studentchecking.call_center;
...
class StudentCheckingCallcenterSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new StudentCheckingCallcenterSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new StudentCheckingCallcenterAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new StudentCheckingCallcenterUiCopy();

...
/**
 * Session configuration for EssentialChecking accessed through Interactive Voice Response.
 ...
 */
public final class EssentialCheckingIvrSessionConfig {
    ...
    public EssentialCheckingIvrSessionConfig() {

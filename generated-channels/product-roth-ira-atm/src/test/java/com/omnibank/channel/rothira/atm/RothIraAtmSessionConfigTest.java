...
class RothIraAtmSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new RothIraAtmSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new RothIraAtmAuthenticationPolicy();

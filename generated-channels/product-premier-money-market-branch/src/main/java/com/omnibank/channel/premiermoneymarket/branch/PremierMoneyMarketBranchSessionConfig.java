...
/**
 * Session configuration for PremierMoneyMarket accessed through Branch Teller.
 ...
 */
public final class PremierMoneyMarketBranchSessionConfig {
    ...
    public PremierMoneyMarketBranchSessionConfig() {

...
/**
 * Channel-scoped telemetry tracker for PremierMoneyMarket on Branch Teller.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class PremierMoneyMarketBranchEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "premiermoneymarket" + "." + "BRANCH".toLowerCase();
    }

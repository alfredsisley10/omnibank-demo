package com.omnibank.channel.commercialchecking.mobile;
...
class CommercialCheckingMobileSessionConfigTest {

    @Test
    void session_config_has_positive_idle_timeout() {
        var cfg = new CommercialCheckingMobileSessionConfig();
    ...
    void auth_policy_exposes_base_factors() {
        var auth = new CommercialCheckingMobileAuthenticationPolicy();
    ...
    void ui_copy_welcome_is_nonempty() {
        var ui = new CommercialCheckingMobileUiCopy();

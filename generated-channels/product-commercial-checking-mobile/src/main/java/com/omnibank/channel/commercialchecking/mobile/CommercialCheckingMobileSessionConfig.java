...
/**
 * Session configuration for CommercialChecking accessed through Mobile App.
 ...
 */
public final class CommercialCheckingMobileSessionConfig {
    ...
    public CommercialCheckingMobileSessionConfig() {

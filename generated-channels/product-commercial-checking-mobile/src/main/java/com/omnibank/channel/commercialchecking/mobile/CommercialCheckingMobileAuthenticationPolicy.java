...
/**
 * Authentication policy for CommercialChecking on Mobile App. Specifies the
 * required factors, step-up conditions, and device attestation
 * requirements for this channel.
 */
public final class CommercialCheckingMobileAuthenticationPolicy {
    ...
    public CommercialCheckingMobileAuthenticationPolicy() {

...
/**
 * Channel-scoped telemetry tracker for CommercialChecking on Mobile App.
 * Captures screen transitions, latency, and abandonments for
 * the analytics pipeline.
 */
public final class CommercialCheckingMobileEventTracker {
    ...
    public String telemetryNamespace() {
        return "omnibank." + "commercialchecking" + "." + "MOBILE".toLowerCase();
    }

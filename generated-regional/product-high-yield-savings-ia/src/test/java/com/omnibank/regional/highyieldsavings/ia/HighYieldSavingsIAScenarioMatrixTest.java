...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsIA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsIAProfile},
 * {@link HighYieldSavingsIARateTable}, {@link HighYieldSavingsIADisclosures},
 * {@link HighYieldSavingsIARegulatoryFilings}, and {@link HighYieldSavingsIABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsIAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsIAScenarioMatrixTest {

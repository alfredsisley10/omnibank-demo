...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Iowa.
 ...
 */
public final class HighYieldSavingsIARateTable {
    ...
    public HighYieldSavingsIARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IA-HighYieldSavings-2026Q1";

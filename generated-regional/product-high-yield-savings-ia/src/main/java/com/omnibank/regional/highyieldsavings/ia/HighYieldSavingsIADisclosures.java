package com.omnibank.regional.highyieldsavings.ia;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Iowa.
 ...
 */
public final class HighYieldSavingsIADisclosures {

    private final HighYieldSavingsIAProfile profile;

    public HighYieldSavingsIADisclosures() {
        this.profile = new HighYieldSavingsIAProfile();
    }

    public HighYieldSavingsIADisclosures(HighYieldSavingsIAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Iowa State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

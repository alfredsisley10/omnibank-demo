...
/**
 * State regulatory filing cadence for HighYieldSavings in Iowa.
 ...
 */
public final class HighYieldSavingsIARegulatoryFilings {
    ...
    public HighYieldSavingsIARegulatoryFilings() {
        this(new HighYieldSavingsIAProfile());
    }

    public HighYieldSavingsIARegulatoryFilings(HighYieldSavingsIAProfile profile) {

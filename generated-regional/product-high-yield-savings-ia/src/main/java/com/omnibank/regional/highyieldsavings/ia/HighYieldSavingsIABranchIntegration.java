...
public final class HighYieldSavingsIABranchIntegration {
    ...
    public HighYieldSavingsIABranchIntegration() {
        this.profile = new HighYieldSavingsIAProfile();
    }

    public HighYieldSavingsIABranchIntegration(HighYieldSavingsIAProfile profile) {

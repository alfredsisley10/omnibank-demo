package com.omnibank.regional.essentialchecking.mt;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Montana.
 ...
 */
public final class EssentialCheckingMTDisclosures {

    private final EssentialCheckingMTProfile profile;

    public EssentialCheckingMTDisclosures() {
        this.profile = new EssentialCheckingMTProfile();
    }

    public EssentialCheckingMTDisclosures(EssentialCheckingMTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Montana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in Montana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMTBranchIntegration {
    ...
    public EssentialCheckingMTBranchIntegration() {
        this.profile = new EssentialCheckingMTProfile();
    }

    public EssentialCheckingMTBranchIntegration(EssentialCheckingMTProfile profile) {

...
/**
 * State regulatory filing cadence for EssentialChecking in Montana.
 ...
 */
public final class EssentialCheckingMTRegulatoryFilings {
    ...
    public EssentialCheckingMTRegulatoryFilings() {
        this(new EssentialCheckingMTProfile());
    }

    public EssentialCheckingMTRegulatoryFilings(EssentialCheckingMTProfile profile) {

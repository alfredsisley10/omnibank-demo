...
/**
 * State-specific rate table overlay for EssentialChecking offered in Montana.
 ...
 */
public final class EssentialCheckingMTRateTable {
    ...
    public EssentialCheckingMTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MT-EssentialChecking-2026Q1";

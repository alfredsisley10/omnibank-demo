...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMTProfile},
 * {@link EssentialCheckingMTRateTable}, {@link EssentialCheckingMTDisclosures},
 * {@link EssentialCheckingMTRegulatoryFilings}, and {@link EssentialCheckingMTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMTScenarioMatrixTest {

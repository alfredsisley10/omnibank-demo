...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsLA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsLAProfile},
 * {@link HighYieldSavingsLARateTable}, {@link HighYieldSavingsLADisclosures},
 * {@link HighYieldSavingsLARegulatoryFilings}, and {@link HighYieldSavingsLABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsLAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsLAScenarioMatrixTest {

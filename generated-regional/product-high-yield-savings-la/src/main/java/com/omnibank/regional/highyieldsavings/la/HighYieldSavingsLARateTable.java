...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Louisiana.
 ...
 */
public final class HighYieldSavingsLARateTable {
    ...
    public HighYieldSavingsLARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-LA-HighYieldSavings-2026Q1";

...
/**
 * Branch / channel integration metadata for HighYieldSavings in Louisiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsLABranchIntegration {
    ...
    public HighYieldSavingsLABranchIntegration() {
        this.profile = new HighYieldSavingsLAProfile();
    }

    public HighYieldSavingsLABranchIntegration(HighYieldSavingsLAProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Louisiana.
 ...
 */
public final class HighYieldSavingsLADisclosures {

    private final HighYieldSavingsLAProfile profile;

    public HighYieldSavingsLADisclosures() {
        this.profile = new HighYieldSavingsLAProfile();
    }

    public HighYieldSavingsLADisclosures(HighYieldSavingsLAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Louisiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

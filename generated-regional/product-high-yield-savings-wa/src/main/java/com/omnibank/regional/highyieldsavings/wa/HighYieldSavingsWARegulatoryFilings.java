...
/**
 * State regulatory filing cadence for HighYieldSavings in Washington.
 ...
 */
public final class HighYieldSavingsWARegulatoryFilings {
    ...
    public HighYieldSavingsWARegulatoryFilings() {
        this(new HighYieldSavingsWAProfile());
    }

    public HighYieldSavingsWARegulatoryFilings(HighYieldSavingsWAProfile profile) {

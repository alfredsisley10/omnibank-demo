...
/**
 * Branch / channel integration metadata for HighYieldSavings in Washington.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsWABranchIntegration {
    ...
    public HighYieldSavingsWABranchIntegration() {
        this.profile = new HighYieldSavingsWAProfile();
    }

    public HighYieldSavingsWABranchIntegration(HighYieldSavingsWAProfile profile) {

package com.omnibank.regional.highyieldsavings.wa;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Washington.
 ...
 */
public final class HighYieldSavingsWADisclosures {

    private final HighYieldSavingsWAProfile profile;

    public HighYieldSavingsWADisclosures() {
        this.profile = new HighYieldSavingsWAProfile();
    }

    public HighYieldSavingsWADisclosures(HighYieldSavingsWAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Washington State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

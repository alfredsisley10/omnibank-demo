...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Washington.
 ...
 */
public final class HighYieldSavingsWARateTable {
    ...
    public HighYieldSavingsWARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WA-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsWA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsWAProfile},
 * {@link HighYieldSavingsWARateTable}, {@link HighYieldSavingsWADisclosures},
 * {@link HighYieldSavingsWARegulatoryFilings}, and {@link HighYieldSavingsWABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsWAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsWAScenarioMatrixTest {

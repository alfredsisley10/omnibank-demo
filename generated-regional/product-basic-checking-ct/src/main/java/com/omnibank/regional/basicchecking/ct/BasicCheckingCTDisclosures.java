package com.omnibank.regional.basicchecking.ct;
...
/**
 * State-specific disclosure overlays for BasicChecking in Connecticut.
 ...
 */
public final class BasicCheckingCTDisclosures {

    private final BasicCheckingCTProfile profile;

    public BasicCheckingCTDisclosures() {
        this.profile = new BasicCheckingCTProfile();
    }

    public BasicCheckingCTDisclosures(BasicCheckingCTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Connecticut State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in Connecticut.
 ...
 */
public final class BasicCheckingCTRegulatoryFilings {
    ...
    public BasicCheckingCTRegulatoryFilings() {
        this(new BasicCheckingCTProfile());
    }

    public BasicCheckingCTRegulatoryFilings(BasicCheckingCTProfile profile) {

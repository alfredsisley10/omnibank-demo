...
public final class BasicCheckingCTBranchIntegration {
    ...
    public BasicCheckingCTBranchIntegration() {
        this.profile = new BasicCheckingCTProfile();
    }

    public BasicCheckingCTBranchIntegration(BasicCheckingCTProfile profile) {

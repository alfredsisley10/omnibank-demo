...
/**
 * State-specific rate table overlay for BasicChecking offered in Connecticut.
 ...
 */
public final class BasicCheckingCTRateTable {
    ...
    public BasicCheckingCTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CT-BasicChecking-2026Q1";

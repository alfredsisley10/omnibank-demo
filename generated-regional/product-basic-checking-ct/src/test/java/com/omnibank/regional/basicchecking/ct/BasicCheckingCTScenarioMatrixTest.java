...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingCT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingCTProfile},
 * {@link BasicCheckingCTRateTable}, {@link BasicCheckingCTDisclosures},
 * {@link BasicCheckingCTRegulatoryFilings}, and {@link BasicCheckingCTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingCTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingCTScenarioMatrixTest {

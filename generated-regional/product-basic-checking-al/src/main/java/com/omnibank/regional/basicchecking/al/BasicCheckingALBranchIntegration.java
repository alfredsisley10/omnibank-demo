...
public final class BasicCheckingALBranchIntegration {
    ...
    public BasicCheckingALBranchIntegration() {
        this.profile = new BasicCheckingALProfile();
    }

    public BasicCheckingALBranchIntegration(BasicCheckingALProfile profile) {

package com.omnibank.regional.basicchecking.al;
...
/**
 * State-specific disclosure overlays for BasicChecking in Alabama.
 * Layered on top of the national disclosure, these capture
 * items that only apply under AL law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingALDisclosures {

    private final BasicCheckingALProfile profile;

    public BasicCheckingALDisclosures() {
        this.profile = new BasicCheckingALProfile();
    }

    public BasicCheckingALDisclosures(BasicCheckingALProfile profile) {
    ...
    public String stateHeader() {
        return "Alabama Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Alabama unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Alabama law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Alabama does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Alabama State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

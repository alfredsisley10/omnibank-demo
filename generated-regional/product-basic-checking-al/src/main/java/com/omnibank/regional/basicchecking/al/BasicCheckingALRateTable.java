...
/**
 * State-specific rate table overlay for BasicChecking offered in Alabama.
 ...
 */
public final class BasicCheckingALRateTable {
    ...
    public BasicCheckingALRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AL-BasicChecking-2026Q1";

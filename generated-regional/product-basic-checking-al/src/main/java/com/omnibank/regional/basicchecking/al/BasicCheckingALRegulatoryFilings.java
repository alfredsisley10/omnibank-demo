...
/**
 * State regulatory filing cadence for BasicChecking in Alabama.
 ...
 */
public final class BasicCheckingALRegulatoryFilings {
    ...
    public BasicCheckingALRegulatoryFilings() {
        this(new BasicCheckingALProfile());
    }

    public BasicCheckingALRegulatoryFilings(BasicCheckingALProfile profile) {

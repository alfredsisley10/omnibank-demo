...
/**
 * State-specific rate table overlay for EssentialChecking offered in Oregon.
 ...
 */
public final class EssentialCheckingORRateTable {
    ...
    public EssentialCheckingORRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OR-EssentialChecking-2026Q1";

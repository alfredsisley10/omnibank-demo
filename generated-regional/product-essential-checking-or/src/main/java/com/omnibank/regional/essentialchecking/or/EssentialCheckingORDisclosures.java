package com.omnibank.regional.essentialchecking.or;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Oregon.
 ...
 */
public final class EssentialCheckingORDisclosures {

    private final EssentialCheckingORProfile profile;

    public EssentialCheckingORDisclosures() {
        this.profile = new EssentialCheckingORProfile();
    }

    public EssentialCheckingORDisclosures(EssentialCheckingORProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Oregon State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in Oregon.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingORBranchIntegration {
    ...
    public EssentialCheckingORBranchIntegration() {
        this.profile = new EssentialCheckingORProfile();
    }

    public EssentialCheckingORBranchIntegration(EssentialCheckingORProfile profile) {

...
/**
 * State regulatory filing cadence for EssentialChecking in Oregon.
 ...
 */
public final class EssentialCheckingORRegulatoryFilings {
    ...
    public EssentialCheckingORRegulatoryFilings() {
        this(new EssentialCheckingORProfile());
    }

    public EssentialCheckingORRegulatoryFilings(EssentialCheckingORProfile profile) {

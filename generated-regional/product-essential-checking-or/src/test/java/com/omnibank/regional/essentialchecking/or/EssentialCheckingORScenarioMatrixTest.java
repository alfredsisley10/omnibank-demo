...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingOR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingORProfile},
 * {@link EssentialCheckingORRateTable}, {@link EssentialCheckingORDisclosures},
 * {@link EssentialCheckingORRegulatoryFilings}, and {@link EssentialCheckingORBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingORProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingORScenarioMatrixTest {

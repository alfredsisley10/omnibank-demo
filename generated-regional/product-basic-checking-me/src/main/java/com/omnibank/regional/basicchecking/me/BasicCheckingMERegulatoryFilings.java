...
/**
 * State regulatory filing cadence for BasicChecking in Maine.
 ...
 */
public final class BasicCheckingMERegulatoryFilings {
    ...
    public BasicCheckingMERegulatoryFilings() {
        this(new BasicCheckingMEProfile());
    }

    public BasicCheckingMERegulatoryFilings(BasicCheckingMEProfile profile) {

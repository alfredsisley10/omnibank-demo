package com.omnibank.regional.basicchecking.me;
...
/**
 * State-specific disclosure overlays for BasicChecking in Maine.
 ...
 */
public final class BasicCheckingMEDisclosures {

    private final BasicCheckingMEProfile profile;

    public BasicCheckingMEDisclosures() {
        this.profile = new BasicCheckingMEProfile();
    }

    public BasicCheckingMEDisclosures(BasicCheckingMEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Maine State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

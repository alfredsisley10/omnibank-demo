...
public final class BasicCheckingMEBranchIntegration {
    ...
    public BasicCheckingMEBranchIntegration() {
        this.profile = new BasicCheckingMEProfile();
    }

    public BasicCheckingMEBranchIntegration(BasicCheckingMEProfile profile) {

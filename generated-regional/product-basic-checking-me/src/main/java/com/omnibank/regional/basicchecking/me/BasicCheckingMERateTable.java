...
/**
 * State-specific rate table overlay for BasicChecking offered in Maine.
 ...
 */
public final class BasicCheckingMERateTable {
    ...
    public BasicCheckingMERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ME-BasicChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsAZ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsAZProfile},
 * {@link HighYieldSavingsAZRateTable}, {@link HighYieldSavingsAZDisclosures},
 * {@link HighYieldSavingsAZRegulatoryFilings}, and {@link HighYieldSavingsAZBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsAZProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsAZScenarioMatrixTest {

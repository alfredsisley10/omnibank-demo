...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Arizona.
 ...
 */
public final class HighYieldSavingsAZRateTable {
    ...
    public HighYieldSavingsAZRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AZ-HighYieldSavings-2026Q1";

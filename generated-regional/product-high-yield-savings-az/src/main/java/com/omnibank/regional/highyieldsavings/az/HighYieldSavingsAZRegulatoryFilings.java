...
/**
 * State regulatory filing cadence for HighYieldSavings in Arizona.
 ...
 */
public final class HighYieldSavingsAZRegulatoryFilings {
    ...
    public HighYieldSavingsAZRegulatoryFilings() {
        this(new HighYieldSavingsAZProfile());
    }

    public HighYieldSavingsAZRegulatoryFilings(HighYieldSavingsAZProfile profile) {

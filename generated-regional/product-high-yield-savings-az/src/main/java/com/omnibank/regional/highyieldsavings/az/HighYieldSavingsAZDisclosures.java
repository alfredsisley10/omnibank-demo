package com.omnibank.regional.highyieldsavings.az;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Arizona.
 ...
 */
public final class HighYieldSavingsAZDisclosures {

    private final HighYieldSavingsAZProfile profile;

    public HighYieldSavingsAZDisclosures() {
        this.profile = new HighYieldSavingsAZProfile();
    }

    public HighYieldSavingsAZDisclosures(HighYieldSavingsAZProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Arizona State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

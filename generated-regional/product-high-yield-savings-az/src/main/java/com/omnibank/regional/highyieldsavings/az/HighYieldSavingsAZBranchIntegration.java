...
/**
 * Branch / channel integration metadata for HighYieldSavings in Arizona.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsAZBranchIntegration {
    ...
    public HighYieldSavingsAZBranchIntegration() {
        this.profile = new HighYieldSavingsAZProfile();
    }

    public HighYieldSavingsAZBranchIntegration(HighYieldSavingsAZProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNYProfile},
 * {@link HighYieldSavingsNYRateTable}, {@link HighYieldSavingsNYDisclosures},
 * {@link HighYieldSavingsNYRegulatoryFilings}, and {@link HighYieldSavingsNYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNYScenarioMatrixTest {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in New York.
 ...
 */
public final class HighYieldSavingsNYDisclosures {

    private final HighYieldSavingsNYProfile profile;

    public HighYieldSavingsNYDisclosures() {
        this.profile = new HighYieldSavingsNYProfile();
    }

    public HighYieldSavingsNYDisclosures(HighYieldSavingsNYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — New York State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

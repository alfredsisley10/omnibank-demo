...
/**
 * State regulatory filing cadence for HighYieldSavings in New York.
 ...
 */
public final class HighYieldSavingsNYRegulatoryFilings {
    ...
    public HighYieldSavingsNYRegulatoryFilings() {
        this(new HighYieldSavingsNYProfile());
    }

    public HighYieldSavingsNYRegulatoryFilings(HighYieldSavingsNYProfile profile) {

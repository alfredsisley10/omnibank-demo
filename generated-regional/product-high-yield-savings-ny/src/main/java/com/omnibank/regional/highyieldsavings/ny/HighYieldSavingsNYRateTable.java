...
/**
 * State-specific rate table overlay for HighYieldSavings offered in New York.
 ...
 */
public final class HighYieldSavingsNYRateTable {
    ...
    public HighYieldSavingsNYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NY-HighYieldSavings-2026Q1";

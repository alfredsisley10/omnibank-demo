...
/**
 * State-specific disclosure overlays for BasicChecking in Kansas.
 ...
 */
public final class BasicCheckingKSDisclosures {

    private final BasicCheckingKSProfile profile;

    public BasicCheckingKSDisclosures() {
        this.profile = new BasicCheckingKSProfile();
    }

    public BasicCheckingKSDisclosures(BasicCheckingKSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Kansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

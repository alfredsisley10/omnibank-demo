...
public final class BasicCheckingKSBranchIntegration {
    ...
    public BasicCheckingKSBranchIntegration() {
        this.profile = new BasicCheckingKSProfile();
    }

    public BasicCheckingKSBranchIntegration(BasicCheckingKSProfile profile) {

...
/**
 * State regulatory filing cadence for BasicChecking in Kansas.
 ...
 */
public final class BasicCheckingKSRegulatoryFilings {
    ...
    public BasicCheckingKSRegulatoryFilings() {
        this(new BasicCheckingKSProfile());
    }

    public BasicCheckingKSRegulatoryFilings(BasicCheckingKSProfile profile) {

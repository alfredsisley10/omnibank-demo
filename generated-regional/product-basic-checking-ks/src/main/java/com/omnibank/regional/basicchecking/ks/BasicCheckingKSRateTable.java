...
/**
 * State-specific rate table overlay for BasicChecking offered in Kansas.
 ...
 */
public final class BasicCheckingKSRateTable {
    ...
    public BasicCheckingKSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KS-BasicChecking-2026Q1";

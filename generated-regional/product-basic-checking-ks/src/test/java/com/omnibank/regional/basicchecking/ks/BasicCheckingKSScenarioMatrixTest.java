...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingKS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingKSProfile},
 * {@link BasicCheckingKSRateTable}, {@link BasicCheckingKSDisclosures},
 * {@link BasicCheckingKSRegulatoryFilings}, and {@link BasicCheckingKSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingKSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingKSScenarioMatrixTest {

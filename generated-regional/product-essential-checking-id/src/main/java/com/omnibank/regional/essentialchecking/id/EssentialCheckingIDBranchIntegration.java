...
/**
 * Branch / channel integration metadata for EssentialChecking in Idaho.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingIDBranchIntegration {
    ...
    public EssentialCheckingIDBranchIntegration() {
        this.profile = new EssentialCheckingIDProfile();
    }

    public EssentialCheckingIDBranchIntegration(EssentialCheckingIDProfile profile) {

...
/**
 * State regulatory filing cadence for EssentialChecking in Idaho.
 ...
 */
public final class EssentialCheckingIDRegulatoryFilings {
    ...
    public EssentialCheckingIDRegulatoryFilings() {
        this(new EssentialCheckingIDProfile());
    }

    public EssentialCheckingIDRegulatoryFilings(EssentialCheckingIDProfile profile) {

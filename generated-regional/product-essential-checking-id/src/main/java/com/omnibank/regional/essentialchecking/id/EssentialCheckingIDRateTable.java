...
/**
 * State-specific rate table overlay for EssentialChecking offered in Idaho.
 ...
 */
public final class EssentialCheckingIDRateTable {
    ...
    public EssentialCheckingIDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ID-EssentialChecking-2026Q1";

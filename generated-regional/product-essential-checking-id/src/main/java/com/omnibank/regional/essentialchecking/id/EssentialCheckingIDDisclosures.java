...
/**
 * State-specific disclosure overlays for EssentialChecking in Idaho.
 ...
 */
public final class EssentialCheckingIDDisclosures {

    private final EssentialCheckingIDProfile profile;

    public EssentialCheckingIDDisclosures() {
        this.profile = new EssentialCheckingIDProfile();
    }

    public EssentialCheckingIDDisclosures(EssentialCheckingIDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Idaho State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

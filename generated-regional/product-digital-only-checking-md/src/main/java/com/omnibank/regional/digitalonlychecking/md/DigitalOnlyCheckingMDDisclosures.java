package com.omnibank.regional.digitalonlychecking.md;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Maryland.
 ...
 */
public final class DigitalOnlyCheckingMDDisclosures {

    private final DigitalOnlyCheckingMDProfile profile;

    public DigitalOnlyCheckingMDDisclosures() {
        this.profile = new DigitalOnlyCheckingMDProfile();
    }

    public DigitalOnlyCheckingMDDisclosures(DigitalOnlyCheckingMDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Maryland State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

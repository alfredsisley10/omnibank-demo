...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Maryland.
 ...
 */
public final class DigitalOnlyCheckingMDRegulatoryFilings {
    ...
    public DigitalOnlyCheckingMDRegulatoryFilings() {
        this(new DigitalOnlyCheckingMDProfile());
    }

    public DigitalOnlyCheckingMDRegulatoryFilings(DigitalOnlyCheckingMDProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Maryland)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Maryland)",
                "ANNUAL",

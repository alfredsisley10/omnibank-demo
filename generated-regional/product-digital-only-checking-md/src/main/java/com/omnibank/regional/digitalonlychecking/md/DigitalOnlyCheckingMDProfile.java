...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Maryland (MD).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMDProfile {
    ...
    public DigitalOnlyCheckingMDProfile() {
        this.stateCode = "MD";

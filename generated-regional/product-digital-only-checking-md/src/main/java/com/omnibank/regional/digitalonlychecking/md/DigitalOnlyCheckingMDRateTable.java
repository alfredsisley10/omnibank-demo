...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Maryland.
 ...
 */
public final class DigitalOnlyCheckingMDRateTable {
    ...
    public DigitalOnlyCheckingMDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MD-DigitalOnlyChecking-2026Q1";

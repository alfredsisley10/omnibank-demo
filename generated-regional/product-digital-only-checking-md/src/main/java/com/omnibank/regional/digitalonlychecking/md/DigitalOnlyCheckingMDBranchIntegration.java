...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Maryland.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMDBranchIntegration {
    ...
    public DigitalOnlyCheckingMDBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMDProfile();
    }

    public DigitalOnlyCheckingMDBranchIntegration(DigitalOnlyCheckingMDProfile profile) {

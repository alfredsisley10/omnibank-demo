...
class DigitalOnlyCheckingMDProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingMDProfile();
        assertThat(p.stateCode()).isEqualTo("MD");
        assertThat(p.stateName()).isEqualTo("Maryland");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingMDRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingMDDisclosures();
        assertThat(d.renderFullSupplement()).contains("Maryland");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingMDRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingMDBranchIntegration();

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMDProfile},
 * {@link DigitalOnlyCheckingMDRateTable}, {@link DigitalOnlyCheckingMDDisclosures},
 * {@link DigitalOnlyCheckingMDRegulatoryFilings}, and {@link DigitalOnlyCheckingMDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMDScenarioMatrixTest {

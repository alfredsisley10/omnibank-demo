...
/**
 * State-specific disclosure overlays for BasicChecking in South Dakota.
 ...
 */
public final class BasicCheckingSDDisclosures {

    private final BasicCheckingSDProfile profile;

    public BasicCheckingSDDisclosures() {
        this.profile = new BasicCheckingSDProfile();
    }

    public BasicCheckingSDDisclosures(BasicCheckingSDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — South Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

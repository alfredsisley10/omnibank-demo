...
/**
 * State regulatory filing cadence for BasicChecking in South Dakota.
 ...
 */
public final class BasicCheckingSDRegulatoryFilings {
    ...
    public BasicCheckingSDRegulatoryFilings() {
        this(new BasicCheckingSDProfile());
    }

    public BasicCheckingSDRegulatoryFilings(BasicCheckingSDProfile profile) {

...
/**
 * Branch / channel integration metadata for BasicChecking in South Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingSDBranchIntegration {
    ...
    public BasicCheckingSDBranchIntegration() {
        this.profile = new BasicCheckingSDProfile();
    }

    public BasicCheckingSDBranchIntegration(BasicCheckingSDProfile profile) {

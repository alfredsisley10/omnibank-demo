...
/**
 * State-specific rate table overlay for BasicChecking offered in South Dakota.
 ...
 */
public final class BasicCheckingSDRateTable {
    ...
    public BasicCheckingSDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SD-BasicChecking-2026Q1";

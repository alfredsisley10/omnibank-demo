package com.omnibank.regional.digitalonlychecking.al;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Alabama.
 ...
 */
public final class DigitalOnlyCheckingALDisclosures {

    private final DigitalOnlyCheckingALProfile profile;

    public DigitalOnlyCheckingALDisclosures() {
        this.profile = new DigitalOnlyCheckingALProfile();
    }

    public DigitalOnlyCheckingALDisclosures(DigitalOnlyCheckingALProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Alabama State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

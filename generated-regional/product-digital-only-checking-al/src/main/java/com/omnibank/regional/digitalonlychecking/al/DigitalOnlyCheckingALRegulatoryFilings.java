...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Alabama.
 ...
 */
public final class DigitalOnlyCheckingALRegulatoryFilings {
    ...
    public DigitalOnlyCheckingALRegulatoryFilings() {
        this(new DigitalOnlyCheckingALProfile());
    }

    public DigitalOnlyCheckingALRegulatoryFilings(DigitalOnlyCheckingALProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Alabama)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Alabama)",
                "ANNUAL",

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Alabama (AL).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingALProfile {
    ...
    public DigitalOnlyCheckingALProfile() {
        this.stateCode = "AL";

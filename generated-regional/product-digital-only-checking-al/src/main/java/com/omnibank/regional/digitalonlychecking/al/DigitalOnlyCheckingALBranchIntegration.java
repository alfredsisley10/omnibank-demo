...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Alabama.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingALBranchIntegration {
    ...
    public DigitalOnlyCheckingALBranchIntegration() {
        this.profile = new DigitalOnlyCheckingALProfile();
    }

    public DigitalOnlyCheckingALBranchIntegration(DigitalOnlyCheckingALProfile profile) {

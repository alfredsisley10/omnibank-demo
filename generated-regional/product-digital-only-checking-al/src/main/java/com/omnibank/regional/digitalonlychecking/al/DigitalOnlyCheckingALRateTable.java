...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Alabama.
 ...
 */
public final class DigitalOnlyCheckingALRateTable {
    ...
    public DigitalOnlyCheckingALRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AL-DigitalOnlyChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingAL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingALProfile},
 * {@link DigitalOnlyCheckingALRateTable}, {@link DigitalOnlyCheckingALDisclosures},
 * {@link DigitalOnlyCheckingALRegulatoryFilings}, and {@link DigitalOnlyCheckingALBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingALProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingALScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNJ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNJProfile},
 * {@link BasicCheckingNJRateTable}, {@link BasicCheckingNJDisclosures},
 * {@link BasicCheckingNJRegulatoryFilings}, and {@link BasicCheckingNJBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNJProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNJScenarioMatrixTest {

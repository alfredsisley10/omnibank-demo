...
public final class BasicCheckingNJBranchIntegration {
    ...
    public BasicCheckingNJBranchIntegration() {
        this.profile = new BasicCheckingNJProfile();
    }

    public BasicCheckingNJBranchIntegration(BasicCheckingNJProfile profile) {

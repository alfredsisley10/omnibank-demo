...
/**
 * State regulatory filing cadence for BasicChecking in New Jersey.
 ...
 */
public final class BasicCheckingNJRegulatoryFilings {
    ...
    public BasicCheckingNJRegulatoryFilings() {
        this(new BasicCheckingNJProfile());
    }

    public BasicCheckingNJRegulatoryFilings(BasicCheckingNJProfile profile) {

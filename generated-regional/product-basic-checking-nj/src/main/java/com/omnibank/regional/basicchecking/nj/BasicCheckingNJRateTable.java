...
/**
 * State-specific rate table overlay for BasicChecking offered in New Jersey.
 ...
 */
public final class BasicCheckingNJRateTable {
    ...
    public BasicCheckingNJRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NJ-BasicChecking-2026Q1";

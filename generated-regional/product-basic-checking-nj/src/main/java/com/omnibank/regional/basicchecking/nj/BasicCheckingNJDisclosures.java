package com.omnibank.regional.basicchecking.nj;
...
/**
 * State-specific disclosure overlays for BasicChecking in New Jersey.
 * Layered on top of the national disclosure, these capture
 * items that only apply under NJ law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingNJDisclosures {

    private final BasicCheckingNJProfile profile;

    public BasicCheckingNJDisclosures() {
        this.profile = new BasicCheckingNJProfile();
    }

    public BasicCheckingNJDisclosures(BasicCheckingNJProfile profile) {
    ...
    public String stateHeader() {
        return "New Jersey Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "New Jersey unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by New Jersey law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "New Jersey does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — New Jersey State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

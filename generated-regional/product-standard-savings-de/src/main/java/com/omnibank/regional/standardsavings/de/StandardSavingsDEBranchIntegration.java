...
/**
 * Branch / channel integration metadata for StandardSavings in Delaware.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsDEBranchIntegration {
    ...
    public StandardSavingsDEBranchIntegration() {
        this.profile = new StandardSavingsDEProfile();
    }

    public StandardSavingsDEBranchIntegration(StandardSavingsDEProfile profile) {

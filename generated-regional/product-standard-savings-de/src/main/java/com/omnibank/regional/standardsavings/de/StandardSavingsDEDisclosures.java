package com.omnibank.regional.standardsavings.de;
...
/**
 * State-specific disclosure overlays for StandardSavings in Delaware.
 * Layered on top of the national disclosure, these capture
 * items that only apply under DE law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsDEDisclosures {

    private final StandardSavingsDEProfile profile;

    public StandardSavingsDEDisclosures() {
        this.profile = new StandardSavingsDEProfile();
    }

    public StandardSavingsDEDisclosures(StandardSavingsDEProfile profile) {
    ...
    public String stateHeader() {
        return "Delaware Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Delaware unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Delaware law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Delaware does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Delaware State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

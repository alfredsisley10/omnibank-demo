...
/**
 * State-specific rate table overlay for StandardSavings offered in Delaware.
 ...
 */
public final class StandardSavingsDERateTable {
    ...
    public StandardSavingsDERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-DE-StandardSavings-2026Q1";

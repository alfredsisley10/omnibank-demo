...
/**
 * State regulatory filing cadence for StandardSavings in Delaware.
 ...
 */
public final class StandardSavingsDERegulatoryFilings {
    ...
    public StandardSavingsDERegulatoryFilings() {
        this(new StandardSavingsDEProfile());
    }

    public StandardSavingsDERegulatoryFilings(StandardSavingsDEProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsDE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsDEProfile},
 * {@link StandardSavingsDERateTable}, {@link StandardSavingsDEDisclosures},
 * {@link StandardSavingsDERegulatoryFilings}, and {@link StandardSavingsDEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsDEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsDEScenarioMatrixTest {

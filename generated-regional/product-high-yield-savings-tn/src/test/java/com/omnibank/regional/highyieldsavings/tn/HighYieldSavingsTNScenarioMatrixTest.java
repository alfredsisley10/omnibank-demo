...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsTN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsTNProfile},
 * {@link HighYieldSavingsTNRateTable}, {@link HighYieldSavingsTNDisclosures},
 * {@link HighYieldSavingsTNRegulatoryFilings}, and {@link HighYieldSavingsTNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsTNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsTNScenarioMatrixTest {

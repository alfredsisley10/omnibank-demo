...
/**
 * State regulatory filing cadence for HighYieldSavings in Tennessee.
 ...
 */
public final class HighYieldSavingsTNRegulatoryFilings {
    ...
    public HighYieldSavingsTNRegulatoryFilings() {
        this(new HighYieldSavingsTNProfile());
    }

    public HighYieldSavingsTNRegulatoryFilings(HighYieldSavingsTNProfile profile) {

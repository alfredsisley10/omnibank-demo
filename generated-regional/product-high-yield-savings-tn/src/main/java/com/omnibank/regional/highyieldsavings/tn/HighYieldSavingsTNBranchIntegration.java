...
/**
 * Branch / channel integration metadata for HighYieldSavings in Tennessee.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsTNBranchIntegration {
    ...
    public HighYieldSavingsTNBranchIntegration() {
        this.profile = new HighYieldSavingsTNProfile();
    }

    public HighYieldSavingsTNBranchIntegration(HighYieldSavingsTNProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Tennessee.
 ...
 */
public final class HighYieldSavingsTNRateTable {
    ...
    public HighYieldSavingsTNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TN-HighYieldSavings-2026Q1";

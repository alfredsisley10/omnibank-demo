package com.omnibank.regional.highyieldsavings.tn;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Tennessee.
 ...
 */
public final class HighYieldSavingsTNDisclosures {

    private final HighYieldSavingsTNProfile profile;

    public HighYieldSavingsTNDisclosures() {
        this.profile = new HighYieldSavingsTNProfile();
    }

    public HighYieldSavingsTNDisclosures(HighYieldSavingsTNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Tennessee State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

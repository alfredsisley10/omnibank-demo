...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Alaska.
 ...
 */
public final class DigitalOnlyCheckingAKRegulatoryFilings {
    ...
    public DigitalOnlyCheckingAKRegulatoryFilings() {
        this(new DigitalOnlyCheckingAKProfile());
    }

    public DigitalOnlyCheckingAKRegulatoryFilings(DigitalOnlyCheckingAKProfile profile) {

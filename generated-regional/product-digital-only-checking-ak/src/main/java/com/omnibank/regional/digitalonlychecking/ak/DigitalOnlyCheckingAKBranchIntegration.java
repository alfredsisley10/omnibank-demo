...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Alaska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingAKBranchIntegration {
    ...
    public DigitalOnlyCheckingAKBranchIntegration() {
        this.profile = new DigitalOnlyCheckingAKProfile();
    }

    public DigitalOnlyCheckingAKBranchIntegration(DigitalOnlyCheckingAKProfile profile) {

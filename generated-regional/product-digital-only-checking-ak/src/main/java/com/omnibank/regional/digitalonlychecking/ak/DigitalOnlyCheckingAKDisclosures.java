...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Alaska.
 ...
 */
public final class DigitalOnlyCheckingAKDisclosures {

    private final DigitalOnlyCheckingAKProfile profile;

    public DigitalOnlyCheckingAKDisclosures() {
        this.profile = new DigitalOnlyCheckingAKProfile();
    }

    public DigitalOnlyCheckingAKDisclosures(DigitalOnlyCheckingAKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Alaska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

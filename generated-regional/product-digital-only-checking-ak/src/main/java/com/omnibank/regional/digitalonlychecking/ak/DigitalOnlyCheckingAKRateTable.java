...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Alaska.
 ...
 */
public final class DigitalOnlyCheckingAKRateTable {
    ...
    public DigitalOnlyCheckingAKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AK-DigitalOnlyChecking-2026Q1";

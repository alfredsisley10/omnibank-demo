...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Alaska (AK).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingAKProfile {
    ...
    public DigitalOnlyCheckingAKProfile() {
        this.stateCode = "AK";

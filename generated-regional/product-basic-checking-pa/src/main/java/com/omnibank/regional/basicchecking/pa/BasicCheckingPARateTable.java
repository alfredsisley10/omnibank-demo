...
/**
 * State-specific rate table overlay for BasicChecking offered in Pennsylvania.
 ...
 */
public final class BasicCheckingPARateTable {
    ...
    public BasicCheckingPARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-PA-BasicChecking-2026Q1";

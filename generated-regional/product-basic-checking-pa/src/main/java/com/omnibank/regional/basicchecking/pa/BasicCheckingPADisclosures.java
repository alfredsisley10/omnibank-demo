...
/**
 * State-specific disclosure overlays for BasicChecking in Pennsylvania.
 ...
 */
public final class BasicCheckingPADisclosures {

    private final BasicCheckingPAProfile profile;

    public BasicCheckingPADisclosures() {
        this.profile = new BasicCheckingPAProfile();
    }

    public BasicCheckingPADisclosures(BasicCheckingPAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Pennsylvania State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in Pennsylvania.
 ...
 */
public final class BasicCheckingPARegulatoryFilings {
    ...
    public BasicCheckingPARegulatoryFilings() {
        this(new BasicCheckingPAProfile());
    }

    public BasicCheckingPARegulatoryFilings(BasicCheckingPAProfile profile) {

...
/**
 * Branch / channel integration metadata for BasicChecking in Pennsylvania.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingPABranchIntegration {
    ...
    public BasicCheckingPABranchIntegration() {
        this.profile = new BasicCheckingPAProfile();
    }

    public BasicCheckingPABranchIntegration(BasicCheckingPAProfile profile) {

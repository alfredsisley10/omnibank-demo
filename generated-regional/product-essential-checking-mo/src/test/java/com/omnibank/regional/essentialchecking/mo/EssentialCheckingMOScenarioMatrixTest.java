...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMOProfile},
 * {@link EssentialCheckingMORateTable}, {@link EssentialCheckingMODisclosures},
 * {@link EssentialCheckingMORegulatoryFilings}, and {@link EssentialCheckingMOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMOScenarioMatrixTest {

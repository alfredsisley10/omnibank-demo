...
/**
 * State regulatory filing cadence for EssentialChecking in Missouri.
 ...
 */
public final class EssentialCheckingMORegulatoryFilings {
    ...
    public EssentialCheckingMORegulatoryFilings() {
        this(new EssentialCheckingMOProfile());
    }

    public EssentialCheckingMORegulatoryFilings(EssentialCheckingMOProfile profile) {

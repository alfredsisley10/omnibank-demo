...
/**
 * Branch / channel integration metadata for EssentialChecking in Missouri.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMOBranchIntegration {
    ...
    public EssentialCheckingMOBranchIntegration() {
        this.profile = new EssentialCheckingMOProfile();
    }

    public EssentialCheckingMOBranchIntegration(EssentialCheckingMOProfile profile) {

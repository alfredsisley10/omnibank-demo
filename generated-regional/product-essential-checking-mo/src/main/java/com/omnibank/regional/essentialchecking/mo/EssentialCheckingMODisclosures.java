package com.omnibank.regional.essentialchecking.mo;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Missouri.
 ...
 */
public final class EssentialCheckingMODisclosures {

    private final EssentialCheckingMOProfile profile;

    public EssentialCheckingMODisclosures() {
        this.profile = new EssentialCheckingMOProfile();
    }

    public EssentialCheckingMODisclosures(EssentialCheckingMOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Missouri State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

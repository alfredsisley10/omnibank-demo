...
/**
 * State-specific rate table overlay for EssentialChecking offered in Missouri.
 ...
 */
public final class EssentialCheckingMORateTable {
    ...
    public EssentialCheckingMORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MO-EssentialChecking-2026Q1";

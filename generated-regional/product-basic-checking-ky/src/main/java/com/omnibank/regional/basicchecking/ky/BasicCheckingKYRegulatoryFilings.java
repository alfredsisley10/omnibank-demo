...
/**
 * State regulatory filing cadence for BasicChecking in Kentucky.
 ...
 */
public final class BasicCheckingKYRegulatoryFilings {
    ...
    public BasicCheckingKYRegulatoryFilings() {
        this(new BasicCheckingKYProfile());
    }

    public BasicCheckingKYRegulatoryFilings(BasicCheckingKYProfile profile) {

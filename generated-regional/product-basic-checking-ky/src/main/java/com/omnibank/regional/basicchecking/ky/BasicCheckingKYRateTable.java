...
/**
 * State-specific rate table overlay for BasicChecking offered in Kentucky.
 ...
 */
public final class BasicCheckingKYRateTable {
    ...
    public BasicCheckingKYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KY-BasicChecking-2026Q1";

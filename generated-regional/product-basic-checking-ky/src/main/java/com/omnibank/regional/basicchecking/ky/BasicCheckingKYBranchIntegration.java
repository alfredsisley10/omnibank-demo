...
public final class BasicCheckingKYBranchIntegration {
    ...
    public BasicCheckingKYBranchIntegration() {
        this.profile = new BasicCheckingKYProfile();
    }

    public BasicCheckingKYBranchIntegration(BasicCheckingKYProfile profile) {

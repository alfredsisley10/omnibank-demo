package com.omnibank.regional.basicchecking.ky;
...
/**
 * State-specific disclosure overlays for BasicChecking in Kentucky.
 ...
 */
public final class BasicCheckingKYDisclosures {

    private final BasicCheckingKYProfile profile;

    public BasicCheckingKYDisclosures() {
        this.profile = new BasicCheckingKYProfile();
    }

    public BasicCheckingKYDisclosures(BasicCheckingKYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Kentucky State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingKY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingKYProfile},
 * {@link BasicCheckingKYRateTable}, {@link BasicCheckingKYDisclosures},
 * {@link BasicCheckingKYRegulatoryFilings}, and {@link BasicCheckingKYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingKYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingKYScenarioMatrixTest {

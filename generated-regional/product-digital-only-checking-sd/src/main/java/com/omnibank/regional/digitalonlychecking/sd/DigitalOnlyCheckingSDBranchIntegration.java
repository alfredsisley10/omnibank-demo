...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in South Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingSDBranchIntegration {
    ...
    public DigitalOnlyCheckingSDBranchIntegration() {
        this.profile = new DigitalOnlyCheckingSDProfile();
    }

    public DigitalOnlyCheckingSDBranchIntegration(DigitalOnlyCheckingSDProfile profile) {

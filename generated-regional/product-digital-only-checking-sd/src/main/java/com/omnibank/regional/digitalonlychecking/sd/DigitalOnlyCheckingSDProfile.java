...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in South Dakota (SD).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingSDProfile {
    ...
    public DigitalOnlyCheckingSDProfile() {
        this.stateCode = "SD";
        this.stateName = "South Dakota";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0450");
        this.fdicRegion = "KANSAS_CITY";

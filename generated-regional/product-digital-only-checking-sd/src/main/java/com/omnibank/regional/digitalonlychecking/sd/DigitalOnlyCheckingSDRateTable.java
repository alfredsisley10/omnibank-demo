...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in South Dakota.
 ...
 */
public final class DigitalOnlyCheckingSDRateTable {
    ...
    public DigitalOnlyCheckingSDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SD-DigitalOnlyChecking-2026Q1";

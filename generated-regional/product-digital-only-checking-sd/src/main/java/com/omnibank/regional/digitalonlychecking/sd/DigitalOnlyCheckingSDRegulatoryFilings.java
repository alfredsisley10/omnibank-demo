...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in South Dakota.
 ...
 */
public final class DigitalOnlyCheckingSDRegulatoryFilings {
    ...
    public DigitalOnlyCheckingSDRegulatoryFilings() {
        this(new DigitalOnlyCheckingSDProfile());
    }

    public DigitalOnlyCheckingSDRegulatoryFilings(DigitalOnlyCheckingSDProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (South Dakota)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (South Dakota)",
                "ANNUAL",

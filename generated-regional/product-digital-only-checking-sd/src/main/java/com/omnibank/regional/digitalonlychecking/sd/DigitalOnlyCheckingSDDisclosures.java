package com.omnibank.regional.digitalonlychecking.sd;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in South Dakota.
 ...
 */
public final class DigitalOnlyCheckingSDDisclosures {

    private final DigitalOnlyCheckingSDProfile profile;

    public DigitalOnlyCheckingSDDisclosures() {
        this.profile = new DigitalOnlyCheckingSDProfile();
    }

    public DigitalOnlyCheckingSDDisclosures(DigitalOnlyCheckingSDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — South Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

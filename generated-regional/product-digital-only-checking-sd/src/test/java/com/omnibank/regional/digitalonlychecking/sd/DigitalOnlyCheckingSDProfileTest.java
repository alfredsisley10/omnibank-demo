...
class DigitalOnlyCheckingSDProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingSDProfile();
        assertThat(p.stateCode()).isEqualTo("SD");
        assertThat(p.stateName()).isEqualTo("South Dakota");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingSDRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingSDDisclosures();
        assertThat(d.renderFullSupplement()).contains("South Dakota");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingSDRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingSDBranchIntegration();

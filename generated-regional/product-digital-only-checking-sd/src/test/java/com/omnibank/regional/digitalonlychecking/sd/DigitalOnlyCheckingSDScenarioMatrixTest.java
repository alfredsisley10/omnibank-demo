...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingSD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingSDProfile},
 * {@link DigitalOnlyCheckingSDRateTable}, {@link DigitalOnlyCheckingSDDisclosures},
 * {@link DigitalOnlyCheckingSDRegulatoryFilings}, and {@link DigitalOnlyCheckingSDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingSDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingSDScenarioMatrixTest {

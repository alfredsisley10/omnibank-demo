...
/**
 * State regulatory filing cadence for StandardSavings in West Virginia.
 ...
 */
public final class StandardSavingsWVRegulatoryFilings {
    ...
    public StandardSavingsWVRegulatoryFilings() {
        this(new StandardSavingsWVProfile());
    }

    public StandardSavingsWVRegulatoryFilings(StandardSavingsWVProfile profile) {

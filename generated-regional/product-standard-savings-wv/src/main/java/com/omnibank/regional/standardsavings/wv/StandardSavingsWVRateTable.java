...
/**
 * State-specific rate table overlay for StandardSavings offered in West Virginia.
 ...
 */
public final class StandardSavingsWVRateTable {
    ...
    public StandardSavingsWVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WV-StandardSavings-2026Q1";

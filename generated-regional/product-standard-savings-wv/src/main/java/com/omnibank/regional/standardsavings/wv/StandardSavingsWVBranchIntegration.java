...
/**
 * Branch / channel integration metadata for StandardSavings in West Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsWVBranchIntegration {
    ...
    public StandardSavingsWVBranchIntegration() {
        this.profile = new StandardSavingsWVProfile();
    }

    public StandardSavingsWVBranchIntegration(StandardSavingsWVProfile profile) {

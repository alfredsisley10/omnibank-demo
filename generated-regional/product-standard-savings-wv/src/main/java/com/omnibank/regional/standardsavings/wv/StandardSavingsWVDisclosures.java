package com.omnibank.regional.standardsavings.wv;
...
/**
 * State-specific disclosure overlays for StandardSavings in West Virginia.
 * Layered on top of the national disclosure, these capture
 * items that only apply under WV law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsWVDisclosures {

    private final StandardSavingsWVProfile profile;

    public StandardSavingsWVDisclosures() {
        this.profile = new StandardSavingsWVProfile();
    }

    public StandardSavingsWVDisclosures(StandardSavingsWVProfile profile) {
    ...
    public String stateHeader() {
        return "West Virginia Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "West Virginia unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by West Virginia law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "West Virginia does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — West Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

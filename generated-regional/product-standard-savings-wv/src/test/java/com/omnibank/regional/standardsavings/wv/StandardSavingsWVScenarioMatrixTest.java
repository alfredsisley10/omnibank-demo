...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsWV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsWVProfile},
 * {@link StandardSavingsWVRateTable}, {@link StandardSavingsWVDisclosures},
 * {@link StandardSavingsWVRegulatoryFilings}, and {@link StandardSavingsWVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsWVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsWVScenarioMatrixTest {

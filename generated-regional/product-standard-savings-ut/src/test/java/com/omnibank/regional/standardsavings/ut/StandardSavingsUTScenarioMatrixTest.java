...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsUT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsUTProfile},
 * {@link StandardSavingsUTRateTable}, {@link StandardSavingsUTDisclosures},
 * {@link StandardSavingsUTRegulatoryFilings}, and {@link StandardSavingsUTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsUTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsUTScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Utah.
 ...
 */
public final class StandardSavingsUTRateTable {
    ...
    public StandardSavingsUTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-UT-StandardSavings-2026Q1";

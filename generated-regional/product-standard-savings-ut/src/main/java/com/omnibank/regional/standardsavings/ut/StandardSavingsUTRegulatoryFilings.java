...
/**
 * State regulatory filing cadence for StandardSavings in Utah.
 ...
 */
public final class StandardSavingsUTRegulatoryFilings {
    ...
    public StandardSavingsUTRegulatoryFilings() {
        this(new StandardSavingsUTProfile());
    }

    public StandardSavingsUTRegulatoryFilings(StandardSavingsUTProfile profile) {

package com.omnibank.regional.standardsavings.ut;
...
/**
 * State-specific disclosure overlays for StandardSavings in Utah.
 * Layered on top of the national disclosure, these capture
 * items that only apply under UT law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsUTDisclosures {

    private final StandardSavingsUTProfile profile;

    public StandardSavingsUTDisclosures() {
        this.profile = new StandardSavingsUTProfile();
    }

    public StandardSavingsUTDisclosures(StandardSavingsUTProfile profile) {
    ...
    public String stateHeader() {
        return "Utah Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Utah unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Utah law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Utah does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Utah State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

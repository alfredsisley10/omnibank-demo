...
public final class StandardSavingsUTBranchIntegration {
    ...
    public StandardSavingsUTBranchIntegration() {
        this.profile = new StandardSavingsUTProfile();
    }

    public StandardSavingsUTBranchIntegration(StandardSavingsUTProfile profile) {

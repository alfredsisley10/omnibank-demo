package com.omnibank.regional.highyieldsavings.ms;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Mississippi.
 ...
 */
public final class HighYieldSavingsMSDisclosures {

    private final HighYieldSavingsMSProfile profile;

    public HighYieldSavingsMSDisclosures() {
        this.profile = new HighYieldSavingsMSProfile();
    }

    public HighYieldSavingsMSDisclosures(HighYieldSavingsMSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Mississippi State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

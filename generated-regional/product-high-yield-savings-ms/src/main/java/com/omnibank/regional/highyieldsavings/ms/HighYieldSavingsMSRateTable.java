...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Mississippi.
 ...
 */
public final class HighYieldSavingsMSRateTable {
    ...
    public HighYieldSavingsMSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MS-HighYieldSavings-2026Q1";

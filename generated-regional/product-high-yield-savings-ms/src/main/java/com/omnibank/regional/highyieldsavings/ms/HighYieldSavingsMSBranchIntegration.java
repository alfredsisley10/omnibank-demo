...
/**
 * Branch / channel integration metadata for HighYieldSavings in Mississippi.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMSBranchIntegration {
    ...
    public HighYieldSavingsMSBranchIntegration() {
        this.profile = new HighYieldSavingsMSProfile();
    }

    public HighYieldSavingsMSBranchIntegration(HighYieldSavingsMSProfile profile) {

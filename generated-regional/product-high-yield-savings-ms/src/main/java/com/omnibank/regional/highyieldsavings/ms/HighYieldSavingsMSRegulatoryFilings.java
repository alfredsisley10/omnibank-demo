...
/**
 * State regulatory filing cadence for HighYieldSavings in Mississippi.
 ...
 */
public final class HighYieldSavingsMSRegulatoryFilings {
    ...
    public HighYieldSavingsMSRegulatoryFilings() {
        this(new HighYieldSavingsMSProfile());
    }

    public HighYieldSavingsMSRegulatoryFilings(HighYieldSavingsMSProfile profile) {

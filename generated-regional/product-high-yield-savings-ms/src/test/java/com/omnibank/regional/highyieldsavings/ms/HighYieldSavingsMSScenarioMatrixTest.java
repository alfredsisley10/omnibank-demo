...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMSProfile},
 * {@link HighYieldSavingsMSRateTable}, {@link HighYieldSavingsMSDisclosures},
 * {@link HighYieldSavingsMSRegulatoryFilings}, and {@link HighYieldSavingsMSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMSScenarioMatrixTest {

...
/**
 * State-specific disclosure overlays for StandardSavings in Minnesota.
 ...
 */
public final class StandardSavingsMNDisclosures {

    private final StandardSavingsMNProfile profile;

    public StandardSavingsMNDisclosures() {
        this.profile = new StandardSavingsMNProfile();
    }

    public StandardSavingsMNDisclosures(StandardSavingsMNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Minnesota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

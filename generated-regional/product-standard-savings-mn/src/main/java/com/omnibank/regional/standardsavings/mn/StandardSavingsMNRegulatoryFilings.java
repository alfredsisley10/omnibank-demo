...
/**
 * State regulatory filing cadence for StandardSavings in Minnesota.
 ...
 */
public final class StandardSavingsMNRegulatoryFilings {
    ...
    public StandardSavingsMNRegulatoryFilings() {
        this(new StandardSavingsMNProfile());
    }

    public StandardSavingsMNRegulatoryFilings(StandardSavingsMNProfile profile) {

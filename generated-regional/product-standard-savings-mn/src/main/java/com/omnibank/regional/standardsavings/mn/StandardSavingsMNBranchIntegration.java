...
/**
 * Branch / channel integration metadata for StandardSavings in Minnesota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMNBranchIntegration {
    ...
    public StandardSavingsMNBranchIntegration() {
        this.profile = new StandardSavingsMNProfile();
    }

    public StandardSavingsMNBranchIntegration(StandardSavingsMNProfile profile) {

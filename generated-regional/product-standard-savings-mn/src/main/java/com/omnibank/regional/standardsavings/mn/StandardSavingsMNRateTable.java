...
/**
 * State-specific rate table overlay for StandardSavings offered in Minnesota.
 ...
 */
public final class StandardSavingsMNRateTable {
    ...
    public StandardSavingsMNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MN-StandardSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMNProfile},
 * {@link StandardSavingsMNRateTable}, {@link StandardSavingsMNDisclosures},
 * {@link StandardSavingsMNRegulatoryFilings}, and {@link StandardSavingsMNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMNScenarioMatrixTest {

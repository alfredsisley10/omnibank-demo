...
/**
 * State-specific rate table overlay for EssentialChecking offered in Michigan.
 ...
 */
public final class EssentialCheckingMIRateTable {
    ...
    public EssentialCheckingMIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MI-EssentialChecking-2026Q1";

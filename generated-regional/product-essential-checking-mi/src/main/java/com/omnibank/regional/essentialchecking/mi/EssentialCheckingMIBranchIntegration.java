...
/**
 * Branch / channel integration metadata for EssentialChecking in Michigan.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMIBranchIntegration {
    ...
    public EssentialCheckingMIBranchIntegration() {
        this.profile = new EssentialCheckingMIProfile();
    }

    public EssentialCheckingMIBranchIntegration(EssentialCheckingMIProfile profile) {

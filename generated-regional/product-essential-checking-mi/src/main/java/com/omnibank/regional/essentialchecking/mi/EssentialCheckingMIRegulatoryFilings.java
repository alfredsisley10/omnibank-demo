...
/**
 * State regulatory filing cadence for EssentialChecking in Michigan.
 ...
 */
public final class EssentialCheckingMIRegulatoryFilings {
    ...
    public EssentialCheckingMIRegulatoryFilings() {
        this(new EssentialCheckingMIProfile());
    }

    public EssentialCheckingMIRegulatoryFilings(EssentialCheckingMIProfile profile) {

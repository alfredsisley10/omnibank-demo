...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMIProfile},
 * {@link EssentialCheckingMIRateTable}, {@link EssentialCheckingMIDisclosures},
 * {@link EssentialCheckingMIRegulatoryFilings}, and {@link EssentialCheckingMIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMIScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Ohio.
 ...
 */
public final class DigitalOnlyCheckingOHRegulatoryFilings {
    ...
    public DigitalOnlyCheckingOHRegulatoryFilings() {
        this(new DigitalOnlyCheckingOHProfile());
    }

    public DigitalOnlyCheckingOHRegulatoryFilings(DigitalOnlyCheckingOHProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Ohio)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Ohio)",
                "ANNUAL",

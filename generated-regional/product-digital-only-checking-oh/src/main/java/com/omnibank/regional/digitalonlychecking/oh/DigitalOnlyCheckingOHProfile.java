...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Ohio (OH).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingOHProfile {
    ...
    public DigitalOnlyCheckingOHProfile() {
        this.stateCode = "OH";
        this.stateName = "Ohio";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0575");

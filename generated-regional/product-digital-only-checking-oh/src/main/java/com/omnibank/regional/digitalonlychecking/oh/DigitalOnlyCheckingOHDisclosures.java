package com.omnibank.regional.digitalonlychecking.oh;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Ohio.
 ...
 */
public final class DigitalOnlyCheckingOHDisclosures {

    private final DigitalOnlyCheckingOHProfile profile;

    public DigitalOnlyCheckingOHDisclosures() {
        this.profile = new DigitalOnlyCheckingOHProfile();
    }

    public DigitalOnlyCheckingOHDisclosures(DigitalOnlyCheckingOHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Ohio State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

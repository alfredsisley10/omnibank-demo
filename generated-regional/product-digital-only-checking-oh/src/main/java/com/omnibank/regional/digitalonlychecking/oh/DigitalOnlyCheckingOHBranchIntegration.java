...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Ohio.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingOHBranchIntegration {
    ...
    public DigitalOnlyCheckingOHBranchIntegration() {
        this.profile = new DigitalOnlyCheckingOHProfile();
    }

    public DigitalOnlyCheckingOHBranchIntegration(DigitalOnlyCheckingOHProfile profile) {

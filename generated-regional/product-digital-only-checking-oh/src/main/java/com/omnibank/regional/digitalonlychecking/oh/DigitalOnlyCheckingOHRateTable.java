...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Ohio.
 ...
 */
public final class DigitalOnlyCheckingOHRateTable {
    ...
    public DigitalOnlyCheckingOHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OH-DigitalOnlyChecking-2026Q1";

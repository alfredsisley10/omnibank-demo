package com.omnibank.regional.digitalonlychecking.mo;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Missouri.
 ...
 */
public final class DigitalOnlyCheckingMODisclosures {

    private final DigitalOnlyCheckingMOProfile profile;

    public DigitalOnlyCheckingMODisclosures() {
        this.profile = new DigitalOnlyCheckingMOProfile();
    }

    public DigitalOnlyCheckingMODisclosures(DigitalOnlyCheckingMOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Missouri State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Missouri.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMOBranchIntegration {
    ...
    public DigitalOnlyCheckingMOBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMOProfile();
    }

    public DigitalOnlyCheckingMOBranchIntegration(DigitalOnlyCheckingMOProfile profile) {

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Missouri.
 ...
 */
public final class DigitalOnlyCheckingMORegulatoryFilings {
    ...
    public DigitalOnlyCheckingMORegulatoryFilings() {
        this(new DigitalOnlyCheckingMOProfile());
    }

    public DigitalOnlyCheckingMORegulatoryFilings(DigitalOnlyCheckingMOProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Missouri)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Missouri)",
                "ANNUAL",

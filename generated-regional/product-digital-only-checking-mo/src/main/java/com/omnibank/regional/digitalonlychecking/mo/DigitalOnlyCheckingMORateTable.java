...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Missouri.
 ...
 */
public final class DigitalOnlyCheckingMORateTable {
    ...
    public DigitalOnlyCheckingMORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MO-DigitalOnlyChecking-2026Q1";

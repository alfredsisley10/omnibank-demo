...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Missouri (MO).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMOProfile {
    ...
    public DigitalOnlyCheckingMOProfile() {
        this.stateCode = "MO";
        this.stateName = "Missouri";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0423");

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMOProfile},
 * {@link DigitalOnlyCheckingMORateTable}, {@link DigitalOnlyCheckingMODisclosures},
 * {@link DigitalOnlyCheckingMORegulatoryFilings}, and {@link DigitalOnlyCheckingMOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMOScenarioMatrixTest {

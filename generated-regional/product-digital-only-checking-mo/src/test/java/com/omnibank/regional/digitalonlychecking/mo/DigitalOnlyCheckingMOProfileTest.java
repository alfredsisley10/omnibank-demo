...
class DigitalOnlyCheckingMOProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingMOProfile();
        assertThat(p.stateCode()).isEqualTo("MO");
        assertThat(p.stateName()).isEqualTo("Missouri");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingMORateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingMODisclosures();
        assertThat(d.renderFullSupplement()).contains("Missouri");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingMORegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingMOBranchIntegration();

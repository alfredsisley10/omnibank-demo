...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMAProfile},
 * {@link HighYieldSavingsMARateTable}, {@link HighYieldSavingsMADisclosures},
 * {@link HighYieldSavingsMARegulatoryFilings}, and {@link HighYieldSavingsMABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMAScenarioMatrixTest {

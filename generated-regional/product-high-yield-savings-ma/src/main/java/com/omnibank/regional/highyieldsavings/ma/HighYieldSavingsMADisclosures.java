package com.omnibank.regional.highyieldsavings.ma;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Massachusetts.
 ...
 */
public final class HighYieldSavingsMADisclosures {

    private final HighYieldSavingsMAProfile profile;

    public HighYieldSavingsMADisclosures() {
        this.profile = new HighYieldSavingsMAProfile();
    }

    public HighYieldSavingsMADisclosures(HighYieldSavingsMAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Massachusetts State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

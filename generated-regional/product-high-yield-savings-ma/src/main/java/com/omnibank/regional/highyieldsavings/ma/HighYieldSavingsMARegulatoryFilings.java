...
/**
 * State regulatory filing cadence for HighYieldSavings in Massachusetts.
 ...
 */
public final class HighYieldSavingsMARegulatoryFilings {
    ...
    public HighYieldSavingsMARegulatoryFilings() {
        this(new HighYieldSavingsMAProfile());
    }

    public HighYieldSavingsMARegulatoryFilings(HighYieldSavingsMAProfile profile) {

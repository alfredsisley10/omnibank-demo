...
/**
 * Branch / channel integration metadata for HighYieldSavings in Massachusetts.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMABranchIntegration {
    ...
    public HighYieldSavingsMABranchIntegration() {
        this.profile = new HighYieldSavingsMAProfile();
    }

    public HighYieldSavingsMABranchIntegration(HighYieldSavingsMAProfile profile) {

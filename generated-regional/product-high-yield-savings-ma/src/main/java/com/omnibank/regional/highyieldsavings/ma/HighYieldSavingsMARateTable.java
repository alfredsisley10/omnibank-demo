...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Massachusetts.
 ...
 */
public final class HighYieldSavingsMARateTable {
    ...
    public HighYieldSavingsMARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MA-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingGA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingGAProfile},
 * {@link DigitalOnlyCheckingGARateTable}, {@link DigitalOnlyCheckingGADisclosures},
 * {@link DigitalOnlyCheckingGARegulatoryFilings}, and {@link DigitalOnlyCheckingGABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingGAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingGAScenarioMatrixTest {

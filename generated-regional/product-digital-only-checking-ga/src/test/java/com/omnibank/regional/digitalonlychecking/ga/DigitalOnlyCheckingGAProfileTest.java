...
class DigitalOnlyCheckingGAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingGAProfile();
        assertThat(p.stateCode()).isEqualTo("GA");
        assertThat(p.stateName()).isEqualTo("Georgia");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingGARateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingGADisclosures();
        assertThat(d.renderFullSupplement()).contains("Georgia");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingGARegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingGABranchIntegration();

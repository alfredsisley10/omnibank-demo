package com.omnibank.regional.digitalonlychecking.ga;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Georgia.
 ...
 */
public final class DigitalOnlyCheckingGADisclosures {

    private final DigitalOnlyCheckingGAProfile profile;

    public DigitalOnlyCheckingGADisclosures() {
        this.profile = new DigitalOnlyCheckingGAProfile();
    }

    public DigitalOnlyCheckingGADisclosures(DigitalOnlyCheckingGAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Georgia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Georgia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingGABranchIntegration {
    ...
    public DigitalOnlyCheckingGABranchIntegration() {
        this.profile = new DigitalOnlyCheckingGAProfile();
    }

    public DigitalOnlyCheckingGABranchIntegration(DigitalOnlyCheckingGAProfile profile) {

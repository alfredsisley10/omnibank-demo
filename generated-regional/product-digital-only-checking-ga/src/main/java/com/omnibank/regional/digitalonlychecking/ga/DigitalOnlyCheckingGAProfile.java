...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Georgia (GA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingGAProfile {
    ...
    public DigitalOnlyCheckingGAProfile() {
        this.stateCode = "GA";

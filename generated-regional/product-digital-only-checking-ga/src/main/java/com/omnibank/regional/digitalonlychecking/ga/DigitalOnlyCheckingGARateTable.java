...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Georgia.
 ...
 */
public final class DigitalOnlyCheckingGARateTable {
    ...
    public DigitalOnlyCheckingGARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-GA-DigitalOnlyChecking-2026Q1";

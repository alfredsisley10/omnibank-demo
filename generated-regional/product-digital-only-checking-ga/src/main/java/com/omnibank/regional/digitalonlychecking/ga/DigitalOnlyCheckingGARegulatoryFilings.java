...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Georgia.
 ...
 */
public final class DigitalOnlyCheckingGARegulatoryFilings {
    ...
    public DigitalOnlyCheckingGARegulatoryFilings() {
        this(new DigitalOnlyCheckingGAProfile());
    }

    public DigitalOnlyCheckingGARegulatoryFilings(DigitalOnlyCheckingGAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Georgia)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Georgia)",
                "ANNUAL",

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in West Virginia.
 ...
 */
public final class HighYieldSavingsWVRateTable {
    ...
    public HighYieldSavingsWVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WV-HighYieldSavings-2026Q1";

package com.omnibank.regional.highyieldsavings.wv;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in West Virginia.
 ...
 */
public final class HighYieldSavingsWVDisclosures {

    private final HighYieldSavingsWVProfile profile;

    public HighYieldSavingsWVDisclosures() {
        this.profile = new HighYieldSavingsWVProfile();
    }

    public HighYieldSavingsWVDisclosures(HighYieldSavingsWVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — West Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

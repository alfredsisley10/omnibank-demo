...
/**
 * Branch / channel integration metadata for HighYieldSavings in West Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsWVBranchIntegration {
    ...
    public HighYieldSavingsWVBranchIntegration() {
        this.profile = new HighYieldSavingsWVProfile();
    }

    public HighYieldSavingsWVBranchIntegration(HighYieldSavingsWVProfile profile) {

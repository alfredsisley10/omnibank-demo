...
/**
 * State regulatory filing cadence for HighYieldSavings in West Virginia.
 ...
 */
public final class HighYieldSavingsWVRegulatoryFilings {
    ...
    public HighYieldSavingsWVRegulatoryFilings() {
        this(new HighYieldSavingsWVProfile());
    }

    public HighYieldSavingsWVRegulatoryFilings(HighYieldSavingsWVProfile profile) {

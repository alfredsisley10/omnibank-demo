package com.omnibank.regional.basicchecking.ak;
...
/**
 * State-specific disclosure overlays for BasicChecking in Alaska.
 * Layered on top of the national disclosure, these capture
 * items that only apply under AK law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingAKDisclosures {

    private final BasicCheckingAKProfile profile;

    public BasicCheckingAKDisclosures() {
        this.profile = new BasicCheckingAKProfile();
    }

    public BasicCheckingAKDisclosures(BasicCheckingAKProfile profile) {
    ...
    public String stateHeader() {
        return "Alaska Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Alaska unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Alaska law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Alaska does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Alaska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

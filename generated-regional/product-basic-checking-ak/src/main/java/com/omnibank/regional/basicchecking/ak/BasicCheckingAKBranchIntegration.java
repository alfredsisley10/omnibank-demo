...
public final class BasicCheckingAKBranchIntegration {
    ...
    public BasicCheckingAKBranchIntegration() {
        this.profile = new BasicCheckingAKProfile();
    }

    public BasicCheckingAKBranchIntegration(BasicCheckingAKProfile profile) {

...
/**
 * State regulatory filing cadence for BasicChecking in Alaska.
 ...
 */
public final class BasicCheckingAKRegulatoryFilings {
    ...
    public BasicCheckingAKRegulatoryFilings() {
        this(new BasicCheckingAKProfile());
    }

    public BasicCheckingAKRegulatoryFilings(BasicCheckingAKProfile profile) {

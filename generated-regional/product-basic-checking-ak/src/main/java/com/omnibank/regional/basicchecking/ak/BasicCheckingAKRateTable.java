...
/**
 * State-specific rate table overlay for BasicChecking offered in Alaska.
 ...
 */
public final class BasicCheckingAKRateTable {
    ...
    public BasicCheckingAKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AK-BasicChecking-2026Q1";

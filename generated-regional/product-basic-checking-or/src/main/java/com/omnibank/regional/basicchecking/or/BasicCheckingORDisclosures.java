package com.omnibank.regional.basicchecking.or;
...
/**
 * State-specific disclosure overlays for BasicChecking in Oregon.
 * Layered on top of the national disclosure, these capture
 * items that only apply under OR law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingORDisclosures {

    private final BasicCheckingORProfile profile;

    public BasicCheckingORDisclosures() {
        this.profile = new BasicCheckingORProfile();
    }

    public BasicCheckingORDisclosures(BasicCheckingORProfile profile) {
    ...
    public String stateHeader() {
        return "Oregon Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Oregon unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Oregon law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Oregon does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Oregon State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

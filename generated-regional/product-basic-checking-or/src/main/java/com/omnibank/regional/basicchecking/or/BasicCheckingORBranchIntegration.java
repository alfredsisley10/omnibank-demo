...
public final class BasicCheckingORBranchIntegration {
    ...
    public BasicCheckingORBranchIntegration() {
        this.profile = new BasicCheckingORProfile();
    }

    public BasicCheckingORBranchIntegration(BasicCheckingORProfile profile) {

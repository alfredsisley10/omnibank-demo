...
/**
 * State-specific rate table overlay for BasicChecking offered in Oregon.
 ...
 */
public final class BasicCheckingORRateTable {
    ...
    public BasicCheckingORRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OR-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Oregon.
 ...
 */
public final class BasicCheckingORRegulatoryFilings {
    ...
    public BasicCheckingORRegulatoryFilings() {
        this(new BasicCheckingORProfile());
    }

    public BasicCheckingORRegulatoryFilings(BasicCheckingORProfile profile) {

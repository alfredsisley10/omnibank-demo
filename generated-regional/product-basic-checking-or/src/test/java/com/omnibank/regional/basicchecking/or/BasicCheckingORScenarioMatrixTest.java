...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingOR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingORProfile},
 * {@link BasicCheckingORRateTable}, {@link BasicCheckingORDisclosures},
 * {@link BasicCheckingORRegulatoryFilings}, and {@link BasicCheckingORBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingORProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingORScenarioMatrixTest {

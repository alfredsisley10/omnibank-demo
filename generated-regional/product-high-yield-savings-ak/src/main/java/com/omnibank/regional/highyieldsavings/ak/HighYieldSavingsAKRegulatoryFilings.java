...
/**
 * State regulatory filing cadence for HighYieldSavings in Alaska.
 ...
 */
public final class HighYieldSavingsAKRegulatoryFilings {
    ...
    public HighYieldSavingsAKRegulatoryFilings() {
        this(new HighYieldSavingsAKProfile());
    }

    public HighYieldSavingsAKRegulatoryFilings(HighYieldSavingsAKProfile profile) {

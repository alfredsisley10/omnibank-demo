...
/**
 * Branch / channel integration metadata for HighYieldSavings in Alaska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsAKBranchIntegration {
    ...
    public HighYieldSavingsAKBranchIntegration() {
        this.profile = new HighYieldSavingsAKProfile();
    }

    public HighYieldSavingsAKBranchIntegration(HighYieldSavingsAKProfile profile) {

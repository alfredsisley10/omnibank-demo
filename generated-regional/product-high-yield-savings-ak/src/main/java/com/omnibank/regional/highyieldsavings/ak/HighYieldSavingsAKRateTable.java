...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Alaska.
 ...
 */
public final class HighYieldSavingsAKRateTable {
    ...
    public HighYieldSavingsAKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AK-HighYieldSavings-2026Q1";

package com.omnibank.regional.highyieldsavings.ak;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Alaska.
 ...
 */
public final class HighYieldSavingsAKDisclosures {

    private final HighYieldSavingsAKProfile profile;

    public HighYieldSavingsAKDisclosures() {
        this.profile = new HighYieldSavingsAKProfile();
    }

    public HighYieldSavingsAKDisclosures(HighYieldSavingsAKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Alaska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Nevada.
 ...
 */
public final class EssentialCheckingNVRateTable {
    ...
    public EssentialCheckingNVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NV-EssentialChecking-2026Q1";

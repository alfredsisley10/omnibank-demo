package com.omnibank.regional.essentialchecking.nv;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Nevada.
 ...
 */
public final class EssentialCheckingNVDisclosures {

    private final EssentialCheckingNVProfile profile;

    public EssentialCheckingNVDisclosures() {
        this.profile = new EssentialCheckingNVProfile();
    }

    public EssentialCheckingNVDisclosures(EssentialCheckingNVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Nevada State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

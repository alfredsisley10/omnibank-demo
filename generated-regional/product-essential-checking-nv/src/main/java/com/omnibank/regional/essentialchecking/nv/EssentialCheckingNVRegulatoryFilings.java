...
/**
 * State regulatory filing cadence for EssentialChecking in Nevada.
 ...
 */
public final class EssentialCheckingNVRegulatoryFilings {
    ...
    public EssentialCheckingNVRegulatoryFilings() {
        this(new EssentialCheckingNVProfile());
    }

    public EssentialCheckingNVRegulatoryFilings(EssentialCheckingNVProfile profile) {

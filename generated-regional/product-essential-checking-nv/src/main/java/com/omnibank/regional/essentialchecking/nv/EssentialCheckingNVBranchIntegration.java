...
/**
 * Branch / channel integration metadata for EssentialChecking in Nevada.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNVBranchIntegration {
    ...
    public EssentialCheckingNVBranchIntegration() {
        this.profile = new EssentialCheckingNVProfile();
    }

    public EssentialCheckingNVBranchIntegration(EssentialCheckingNVProfile profile) {

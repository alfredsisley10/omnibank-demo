...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNVProfile},
 * {@link EssentialCheckingNVRateTable}, {@link EssentialCheckingNVDisclosures},
 * {@link EssentialCheckingNVRegulatoryFilings}, and {@link EssentialCheckingNVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNVScenarioMatrixTest {

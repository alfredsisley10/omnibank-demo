...
/**
 * State-specific rate table overlay for BasicChecking offered in Hawaii.
 ...
 */
public final class BasicCheckingHIRateTable {
    ...
    public BasicCheckingHIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-HI-BasicChecking-2026Q1";

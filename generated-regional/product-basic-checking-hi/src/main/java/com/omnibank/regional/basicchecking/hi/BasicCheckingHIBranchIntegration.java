...
public final class BasicCheckingHIBranchIntegration {
    ...
    public BasicCheckingHIBranchIntegration() {
        this.profile = new BasicCheckingHIProfile();
    }

    public BasicCheckingHIBranchIntegration(BasicCheckingHIProfile profile) {

package com.omnibank.regional.basicchecking.hi;
...
/**
 * State-specific disclosure overlays for BasicChecking in Hawaii.
 * Layered on top of the national disclosure, these capture
 * items that only apply under HI law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingHIDisclosures {

    private final BasicCheckingHIProfile profile;

    public BasicCheckingHIDisclosures() {
        this.profile = new BasicCheckingHIProfile();
    }

    public BasicCheckingHIDisclosures(BasicCheckingHIProfile profile) {
    ...
    public String stateHeader() {
        return "Hawaii Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Hawaii unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Hawaii law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Hawaii does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Hawaii State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

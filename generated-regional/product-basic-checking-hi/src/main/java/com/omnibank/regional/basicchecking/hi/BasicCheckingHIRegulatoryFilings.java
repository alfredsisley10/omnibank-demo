...
/**
 * State regulatory filing cadence for BasicChecking in Hawaii.
 ...
 */
public final class BasicCheckingHIRegulatoryFilings {
    ...
    public BasicCheckingHIRegulatoryFilings() {
        this(new BasicCheckingHIProfile());
    }

    public BasicCheckingHIRegulatoryFilings(BasicCheckingHIProfile profile) {

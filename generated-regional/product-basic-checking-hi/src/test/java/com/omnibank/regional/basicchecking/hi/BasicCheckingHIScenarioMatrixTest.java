...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingHI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingHIProfile},
 * {@link BasicCheckingHIRateTable}, {@link BasicCheckingHIDisclosures},
 * {@link BasicCheckingHIRegulatoryFilings}, and {@link BasicCheckingHIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingHIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingHIScenarioMatrixTest {

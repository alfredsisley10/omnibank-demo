...
class DigitalOnlyCheckingWAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingWAProfile();
        assertThat(p.stateCode()).isEqualTo("WA");
        assertThat(p.stateName()).isEqualTo("Washington");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingWARateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingWADisclosures();
        assertThat(d.renderFullSupplement()).contains("Washington");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingWARegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingWABranchIntegration();

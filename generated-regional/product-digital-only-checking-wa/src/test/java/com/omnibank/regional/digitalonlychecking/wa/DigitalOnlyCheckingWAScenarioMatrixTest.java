...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingWA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingWAProfile},
 * {@link DigitalOnlyCheckingWARateTable}, {@link DigitalOnlyCheckingWADisclosures},
 * {@link DigitalOnlyCheckingWARegulatoryFilings}, and {@link DigitalOnlyCheckingWABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingWAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingWAScenarioMatrixTest {

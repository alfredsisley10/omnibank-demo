...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Washington.
 ...
 */
public final class DigitalOnlyCheckingWARegulatoryFilings {
    ...
    public DigitalOnlyCheckingWARegulatoryFilings() {
        this(new DigitalOnlyCheckingWAProfile());
    }

    public DigitalOnlyCheckingWARegulatoryFilings(DigitalOnlyCheckingWAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Washington)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Washington)",
                "ANNUAL",

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Washington (WA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingWAProfile {
    ...
    public DigitalOnlyCheckingWAProfile() {
        this.stateCode = "WA";
        this.stateName = "Washington";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0650");
        this.fdicRegion = "SAN_FRANCISCO";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Washington.
 ...
 */
public final class DigitalOnlyCheckingWARateTable {
    ...
    public DigitalOnlyCheckingWARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WA-DigitalOnlyChecking-2026Q1";

package com.omnibank.regional.digitalonlychecking.wa;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Washington.
 ...
 */
public final class DigitalOnlyCheckingWADisclosures {

    private final DigitalOnlyCheckingWAProfile profile;

    public DigitalOnlyCheckingWADisclosures() {
        this.profile = new DigitalOnlyCheckingWAProfile();
    }

    public DigitalOnlyCheckingWADisclosures(DigitalOnlyCheckingWAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Washington State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

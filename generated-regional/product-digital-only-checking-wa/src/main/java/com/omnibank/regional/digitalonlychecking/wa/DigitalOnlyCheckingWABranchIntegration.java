...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Washington.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingWABranchIntegration {
    ...
    public DigitalOnlyCheckingWABranchIntegration() {
        this.profile = new DigitalOnlyCheckingWAProfile();
    }

    public DigitalOnlyCheckingWABranchIntegration(DigitalOnlyCheckingWAProfile profile) {

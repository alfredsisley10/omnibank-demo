...
/**
 * State regulatory filing cadence for StandardSavings in North Dakota.
 ...
 */
public final class StandardSavingsNDRegulatoryFilings {
    ...
    public StandardSavingsNDRegulatoryFilings() {
        this(new StandardSavingsNDProfile());
    }

    public StandardSavingsNDRegulatoryFilings(StandardSavingsNDProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in North Dakota.
 ...
 */
public final class StandardSavingsNDRateTable {
    ...
    public StandardSavingsNDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ND-StandardSavings-2026Q1";

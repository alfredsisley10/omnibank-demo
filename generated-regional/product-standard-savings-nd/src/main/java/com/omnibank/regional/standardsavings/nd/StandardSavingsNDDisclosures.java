...
/**
 * State-specific disclosure overlays for StandardSavings in North Dakota.
 * Layered on top of the national disclosure, these capture
 * items that only apply under ND law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsNDDisclosures {

    private final StandardSavingsNDProfile profile;

    public StandardSavingsNDDisclosures() {
        this.profile = new StandardSavingsNDProfile();
    }

    public StandardSavingsNDDisclosures(StandardSavingsNDProfile profile) {
    ...
    public String stateHeader() {
        return "North Dakota Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "North Dakota unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by North Dakota law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "North Dakota does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — North Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

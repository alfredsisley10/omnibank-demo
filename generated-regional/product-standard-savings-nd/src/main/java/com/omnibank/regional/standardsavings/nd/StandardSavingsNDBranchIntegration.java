...
/**
 * Branch / channel integration metadata for StandardSavings in North Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNDBranchIntegration {
    ...
    public StandardSavingsNDBranchIntegration() {
        this.profile = new StandardSavingsNDProfile();
    }

    public StandardSavingsNDBranchIntegration(StandardSavingsNDProfile profile) {

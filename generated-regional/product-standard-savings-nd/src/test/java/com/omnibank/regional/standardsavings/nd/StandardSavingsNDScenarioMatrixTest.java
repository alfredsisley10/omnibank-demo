...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsND jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNDProfile},
 * {@link StandardSavingsNDRateTable}, {@link StandardSavingsNDDisclosures},
 * {@link StandardSavingsNDRegulatoryFilings}, and {@link StandardSavingsNDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNDScenarioMatrixTest {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Alabama.
 ...
 */
public final class HighYieldSavingsALDisclosures {

    private final HighYieldSavingsALProfile profile;

    public HighYieldSavingsALDisclosures() {
        this.profile = new HighYieldSavingsALProfile();
    }

    public HighYieldSavingsALDisclosures(HighYieldSavingsALProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Alabama State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

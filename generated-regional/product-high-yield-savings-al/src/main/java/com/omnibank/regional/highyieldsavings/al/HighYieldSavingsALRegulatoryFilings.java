...
/**
 * State regulatory filing cadence for HighYieldSavings in Alabama.
 ...
 */
public final class HighYieldSavingsALRegulatoryFilings {
    ...
    public HighYieldSavingsALRegulatoryFilings() {
        this(new HighYieldSavingsALProfile());
    }

    public HighYieldSavingsALRegulatoryFilings(HighYieldSavingsALProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Alabama.
 ...
 */
public final class HighYieldSavingsALRateTable {
    ...
    public HighYieldSavingsALRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AL-HighYieldSavings-2026Q1";

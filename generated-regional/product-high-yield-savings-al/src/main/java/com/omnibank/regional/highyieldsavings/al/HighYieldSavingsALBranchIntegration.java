...
/**
 * Branch / channel integration metadata for HighYieldSavings in Alabama.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsALBranchIntegration {
    ...
    public HighYieldSavingsALBranchIntegration() {
        this.profile = new HighYieldSavingsALProfile();
    }

    public HighYieldSavingsALBranchIntegration(HighYieldSavingsALProfile profile) {

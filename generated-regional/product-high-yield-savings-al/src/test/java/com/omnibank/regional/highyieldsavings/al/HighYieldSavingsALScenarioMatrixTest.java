...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsAL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsALProfile},
 * {@link HighYieldSavingsALRateTable}, {@link HighYieldSavingsALDisclosures},
 * {@link HighYieldSavingsALRegulatoryFilings}, and {@link HighYieldSavingsALBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsALProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsALScenarioMatrixTest {

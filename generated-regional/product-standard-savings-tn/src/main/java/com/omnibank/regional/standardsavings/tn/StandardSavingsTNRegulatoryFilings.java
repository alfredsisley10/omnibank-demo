...
/**
 * State regulatory filing cadence for StandardSavings in Tennessee.
 ...
 */
public final class StandardSavingsTNRegulatoryFilings {
    ...
    public StandardSavingsTNRegulatoryFilings() {
        this(new StandardSavingsTNProfile());
    }

    public StandardSavingsTNRegulatoryFilings(StandardSavingsTNProfile profile) {

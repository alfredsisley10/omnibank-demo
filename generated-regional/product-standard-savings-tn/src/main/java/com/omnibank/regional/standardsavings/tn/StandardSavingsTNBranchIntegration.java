...
/**
 * Branch / channel integration metadata for StandardSavings in Tennessee.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsTNBranchIntegration {
    ...
    public StandardSavingsTNBranchIntegration() {
        this.profile = new StandardSavingsTNProfile();
    }

    public StandardSavingsTNBranchIntegration(StandardSavingsTNProfile profile) {

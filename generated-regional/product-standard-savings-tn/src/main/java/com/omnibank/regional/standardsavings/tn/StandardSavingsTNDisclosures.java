package com.omnibank.regional.standardsavings.tn;
...
/**
 * State-specific disclosure overlays for StandardSavings in Tennessee.
 * Layered on top of the national disclosure, these capture
 * items that only apply under TN law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsTNDisclosures {

    private final StandardSavingsTNProfile profile;

    public StandardSavingsTNDisclosures() {
        this.profile = new StandardSavingsTNProfile();
    }

    public StandardSavingsTNDisclosures(StandardSavingsTNProfile profile) {
    ...
    public String stateHeader() {
        return "Tennessee Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Tennessee unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Tennessee law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Tennessee does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Tennessee State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

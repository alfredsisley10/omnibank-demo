...
/**
 * State-specific rate table overlay for StandardSavings offered in Tennessee.
 ...
 */
public final class StandardSavingsTNRateTable {
    ...
    public StandardSavingsTNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TN-StandardSavings-2026Q1";

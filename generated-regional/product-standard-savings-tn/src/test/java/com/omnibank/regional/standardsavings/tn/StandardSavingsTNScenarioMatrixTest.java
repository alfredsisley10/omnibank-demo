...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsTN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsTNProfile},
 * {@link StandardSavingsTNRateTable}, {@link StandardSavingsTNDisclosures},
 * {@link StandardSavingsTNRegulatoryFilings}, and {@link StandardSavingsTNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsTNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsTNScenarioMatrixTest {

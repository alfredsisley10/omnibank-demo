...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMOProfile},
 * {@link StandardSavingsMORateTable}, {@link StandardSavingsMODisclosures},
 * {@link StandardSavingsMORegulatoryFilings}, and {@link StandardSavingsMOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMOScenarioMatrixTest {

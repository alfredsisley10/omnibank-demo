...
/**
 * Branch / channel integration metadata for StandardSavings in Missouri.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMOBranchIntegration {
    ...
    public StandardSavingsMOBranchIntegration() {
        this.profile = new StandardSavingsMOProfile();
    }

    public StandardSavingsMOBranchIntegration(StandardSavingsMOProfile profile) {

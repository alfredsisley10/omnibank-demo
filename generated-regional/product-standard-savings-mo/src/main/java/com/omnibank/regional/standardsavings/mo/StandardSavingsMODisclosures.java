package com.omnibank.regional.standardsavings.mo;
...
/**
 * State-specific disclosure overlays for StandardSavings in Missouri.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MO law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsMODisclosures {

    private final StandardSavingsMOProfile profile;

    public StandardSavingsMODisclosures() {
        this.profile = new StandardSavingsMOProfile();
    }

    public StandardSavingsMODisclosures(StandardSavingsMOProfile profile) {
    ...
    public String stateHeader() {
        return "Missouri Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Missouri unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Missouri law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Missouri does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Missouri State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for StandardSavings in Missouri.
 ...
 */
public final class StandardSavingsMORegulatoryFilings {
    ...
    public StandardSavingsMORegulatoryFilings() {
        this(new StandardSavingsMOProfile());
    }

    public StandardSavingsMORegulatoryFilings(StandardSavingsMOProfile profile) {

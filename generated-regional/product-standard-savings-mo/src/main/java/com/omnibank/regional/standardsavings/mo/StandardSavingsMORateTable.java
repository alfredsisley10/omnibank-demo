...
/**
 * State-specific rate table overlay for StandardSavings offered in Missouri.
 ...
 */
public final class StandardSavingsMORateTable {
    ...
    public StandardSavingsMORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MO-StandardSavings-2026Q1";

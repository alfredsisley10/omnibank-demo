package com.omnibank.regional.essentialchecking.ca;
...
/**
 * State-specific disclosure overlays for EssentialChecking in California.
 ...
 */
public final class EssentialCheckingCADisclosures {

    private final EssentialCheckingCAProfile profile;

    public EssentialCheckingCADisclosures() {
        this.profile = new EssentialCheckingCAProfile();
    }

    public EssentialCheckingCADisclosures(EssentialCheckingCAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — California State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

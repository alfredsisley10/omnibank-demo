...
/**
 * State regulatory filing cadence for EssentialChecking in California.
 ...
 */
public final class EssentialCheckingCARegulatoryFilings {
    ...
    public EssentialCheckingCARegulatoryFilings() {
        this(new EssentialCheckingCAProfile());
    }

    public EssentialCheckingCARegulatoryFilings(EssentialCheckingCAProfile profile) {

...
/**
 * Branch / channel integration metadata for EssentialChecking in California.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingCABranchIntegration {
    ...
    public EssentialCheckingCABranchIntegration() {
        this.profile = new EssentialCheckingCAProfile();
    }

    public EssentialCheckingCABranchIntegration(EssentialCheckingCAProfile profile) {

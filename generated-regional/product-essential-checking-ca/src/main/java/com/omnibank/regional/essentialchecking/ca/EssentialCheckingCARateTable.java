...
/**
 * State-specific rate table overlay for EssentialChecking offered in California.
 ...
 */
public final class EssentialCheckingCARateTable {
    ...
    public EssentialCheckingCARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CA-EssentialChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingCA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingCAProfile},
 * {@link EssentialCheckingCARateTable}, {@link EssentialCheckingCADisclosures},
 * {@link EssentialCheckingCARegulatoryFilings}, and {@link EssentialCheckingCABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingCAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingCAScenarioMatrixTest {

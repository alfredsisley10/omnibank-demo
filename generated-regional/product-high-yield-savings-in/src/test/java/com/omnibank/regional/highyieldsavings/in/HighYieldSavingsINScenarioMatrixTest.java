...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsIN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsINProfile},
 * {@link HighYieldSavingsINRateTable}, {@link HighYieldSavingsINDisclosures},
 * {@link HighYieldSavingsINRegulatoryFilings}, and {@link HighYieldSavingsINBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsINProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsINScenarioMatrixTest {

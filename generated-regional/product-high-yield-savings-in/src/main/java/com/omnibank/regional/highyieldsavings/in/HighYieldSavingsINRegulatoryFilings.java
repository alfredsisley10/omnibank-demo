...
/**
 * State regulatory filing cadence for HighYieldSavings in Indiana.
 ...
 */
public final class HighYieldSavingsINRegulatoryFilings {
    ...
    public HighYieldSavingsINRegulatoryFilings() {
        this(new HighYieldSavingsINProfile());
    }

    public HighYieldSavingsINRegulatoryFilings(HighYieldSavingsINProfile profile) {

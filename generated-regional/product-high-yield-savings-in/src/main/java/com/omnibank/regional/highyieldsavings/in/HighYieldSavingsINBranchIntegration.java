...
/**
 * Branch / channel integration metadata for HighYieldSavings in Indiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsINBranchIntegration {
    ...
    public HighYieldSavingsINBranchIntegration() {
        this.profile = new HighYieldSavingsINProfile();
    }

    public HighYieldSavingsINBranchIntegration(HighYieldSavingsINProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Indiana.
 ...
 */
public final class HighYieldSavingsINRateTable {
    ...
    public HighYieldSavingsINRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IN-HighYieldSavings-2026Q1";

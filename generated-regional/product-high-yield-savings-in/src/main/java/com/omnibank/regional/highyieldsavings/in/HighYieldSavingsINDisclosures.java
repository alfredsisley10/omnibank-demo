package com.omnibank.regional.highyieldsavings.in;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Indiana.
 ...
 */
public final class HighYieldSavingsINDisclosures {

    private final HighYieldSavingsINProfile profile;

    public HighYieldSavingsINDisclosures() {
        this.profile = new HighYieldSavingsINProfile();
    }

    public HighYieldSavingsINDisclosures(HighYieldSavingsINProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Indiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

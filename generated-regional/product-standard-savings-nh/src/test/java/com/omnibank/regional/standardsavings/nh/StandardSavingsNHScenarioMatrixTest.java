...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNHProfile},
 * {@link StandardSavingsNHRateTable}, {@link StandardSavingsNHDisclosures},
 * {@link StandardSavingsNHRegulatoryFilings}, and {@link StandardSavingsNHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNHScenarioMatrixTest {

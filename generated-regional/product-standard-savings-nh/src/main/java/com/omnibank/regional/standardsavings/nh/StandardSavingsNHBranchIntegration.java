...
/**
 * Branch / channel integration metadata for StandardSavings in New Hampshire.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNHBranchIntegration {
    ...
    public StandardSavingsNHBranchIntegration() {
        this.profile = new StandardSavingsNHProfile();
    }

    public StandardSavingsNHBranchIntegration(StandardSavingsNHProfile profile) {

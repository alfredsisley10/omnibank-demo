...
/**
 * State-specific disclosure overlays for StandardSavings in New Hampshire.
 ...
 */
public final class StandardSavingsNHDisclosures {

    private final StandardSavingsNHProfile profile;

    public StandardSavingsNHDisclosures() {
        this.profile = new StandardSavingsNHProfile();
    }

    public StandardSavingsNHDisclosures(StandardSavingsNHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — New Hampshire State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

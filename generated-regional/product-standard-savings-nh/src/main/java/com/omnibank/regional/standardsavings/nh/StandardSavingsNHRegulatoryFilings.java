...
/**
 * State regulatory filing cadence for StandardSavings in New Hampshire.
 ...
 */
public final class StandardSavingsNHRegulatoryFilings {
    ...
    public StandardSavingsNHRegulatoryFilings() {
        this(new StandardSavingsNHProfile());
    }

    public StandardSavingsNHRegulatoryFilings(StandardSavingsNHProfile profile) {

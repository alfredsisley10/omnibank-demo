...
/**
 * State-specific rate table overlay for StandardSavings offered in New Hampshire.
 ...
 */
public final class StandardSavingsNHRateTable {
    ...
    public StandardSavingsNHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NH-StandardSavings-2026Q1";

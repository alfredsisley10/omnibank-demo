...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsAR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsARProfile},
 * {@link HighYieldSavingsARRateTable}, {@link HighYieldSavingsARDisclosures},
 * {@link HighYieldSavingsARRegulatoryFilings}, and {@link HighYieldSavingsARBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsARProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsARScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Arkansas.
 ...
 */
public final class HighYieldSavingsARRateTable {
    ...
    public HighYieldSavingsARRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AR-HighYieldSavings-2026Q1";

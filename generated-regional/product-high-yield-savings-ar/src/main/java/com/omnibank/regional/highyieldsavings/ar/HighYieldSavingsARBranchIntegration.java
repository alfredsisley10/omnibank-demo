...
/**
 * Branch / channel integration metadata for HighYieldSavings in Arkansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsARBranchIntegration {
    ...
    public HighYieldSavingsARBranchIntegration() {
        this.profile = new HighYieldSavingsARProfile();
    }

    public HighYieldSavingsARBranchIntegration(HighYieldSavingsARProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Arkansas.
 ...
 */
public final class HighYieldSavingsARDisclosures {

    private final HighYieldSavingsARProfile profile;

    public HighYieldSavingsARDisclosures() {
        this.profile = new HighYieldSavingsARProfile();
    }

    public HighYieldSavingsARDisclosures(HighYieldSavingsARProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Arkansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

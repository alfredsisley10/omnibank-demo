...
/**
 * State regulatory filing cadence for HighYieldSavings in Arkansas.
 ...
 */
public final class HighYieldSavingsARRegulatoryFilings {
    ...
    public HighYieldSavingsARRegulatoryFilings() {
        this(new HighYieldSavingsARProfile());
    }

    public HighYieldSavingsARRegulatoryFilings(HighYieldSavingsARProfile profile) {

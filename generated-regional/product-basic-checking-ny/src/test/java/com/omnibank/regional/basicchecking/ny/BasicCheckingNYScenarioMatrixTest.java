...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNYProfile},
 * {@link BasicCheckingNYRateTable}, {@link BasicCheckingNYDisclosures},
 * {@link BasicCheckingNYRegulatoryFilings}, and {@link BasicCheckingNYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNYScenarioMatrixTest {

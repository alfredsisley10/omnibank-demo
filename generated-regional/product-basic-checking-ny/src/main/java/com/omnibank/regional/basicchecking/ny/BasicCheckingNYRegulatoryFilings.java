...
/**
 * State regulatory filing cadence for BasicChecking in New York.
 ...
 */
public final class BasicCheckingNYRegulatoryFilings {
    ...
    public BasicCheckingNYRegulatoryFilings() {
        this(new BasicCheckingNYProfile());
    }

    public BasicCheckingNYRegulatoryFilings(BasicCheckingNYProfile profile) {

package com.omnibank.regional.basicchecking.ny;
...
/**
 * State-specific disclosure overlays for BasicChecking in New York.
 ...
 */
public final class BasicCheckingNYDisclosures {

    private final BasicCheckingNYProfile profile;

    public BasicCheckingNYDisclosures() {
        this.profile = new BasicCheckingNYProfile();
    }

    public BasicCheckingNYDisclosures(BasicCheckingNYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — New York State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
public final class BasicCheckingNYBranchIntegration {
    ...
    public BasicCheckingNYBranchIntegration() {
        this.profile = new BasicCheckingNYProfile();
    }

    public BasicCheckingNYBranchIntegration(BasicCheckingNYProfile profile) {

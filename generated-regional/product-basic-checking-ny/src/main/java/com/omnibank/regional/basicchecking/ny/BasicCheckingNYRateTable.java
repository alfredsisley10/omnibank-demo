...
/**
 * State-specific rate table overlay for BasicChecking offered in New York.
 ...
 */
public final class BasicCheckingNYRateTable {
    ...
    public BasicCheckingNYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NY-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Maryland.
 ...
 */
public final class BasicCheckingMDRegulatoryFilings {
    ...
    public BasicCheckingMDRegulatoryFilings() {
        this(new BasicCheckingMDProfile());
    }

    public BasicCheckingMDRegulatoryFilings(BasicCheckingMDProfile profile) {

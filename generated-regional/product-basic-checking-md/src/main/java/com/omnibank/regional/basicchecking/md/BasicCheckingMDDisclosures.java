...
/**
 * State-specific disclosure overlays for BasicChecking in Maryland.
 ...
 */
public final class BasicCheckingMDDisclosures {

    private final BasicCheckingMDProfile profile;

    public BasicCheckingMDDisclosures() {
        this.profile = new BasicCheckingMDProfile();
    }

    public BasicCheckingMDDisclosures(BasicCheckingMDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Maryland State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for BasicChecking offered in Maryland.
 ...
 */
public final class BasicCheckingMDRateTable {
    ...
    public BasicCheckingMDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MD-BasicChecking-2026Q1";

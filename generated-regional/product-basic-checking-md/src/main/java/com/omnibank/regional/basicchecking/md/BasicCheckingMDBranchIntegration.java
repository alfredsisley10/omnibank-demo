...
public final class BasicCheckingMDBranchIntegration {
    ...
    public BasicCheckingMDBranchIntegration() {
        this.profile = new BasicCheckingMDProfile();
    }

    public BasicCheckingMDBranchIntegration(BasicCheckingMDProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingWA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingWAProfile},
 * {@link BasicCheckingWARateTable}, {@link BasicCheckingWADisclosures},
 * {@link BasicCheckingWARegulatoryFilings}, and {@link BasicCheckingWABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingWAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingWAScenarioMatrixTest {

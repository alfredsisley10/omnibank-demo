...
public final class BasicCheckingWABranchIntegration {
    ...
    public BasicCheckingWABranchIntegration() {
        this.profile = new BasicCheckingWAProfile();
    }

    public BasicCheckingWABranchIntegration(BasicCheckingWAProfile profile) {

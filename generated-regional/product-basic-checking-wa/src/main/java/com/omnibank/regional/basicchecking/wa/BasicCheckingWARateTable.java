...
/**
 * State-specific rate table overlay for BasicChecking offered in Washington.
 ...
 */
public final class BasicCheckingWARateTable {
    ...
    public BasicCheckingWARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WA-BasicChecking-2026Q1";

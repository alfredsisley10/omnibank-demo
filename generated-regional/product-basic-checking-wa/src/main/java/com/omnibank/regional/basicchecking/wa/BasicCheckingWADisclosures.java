package com.omnibank.regional.basicchecking.wa;
...
/**
 * State-specific disclosure overlays for BasicChecking in Washington.
 ...
 */
public final class BasicCheckingWADisclosures {

    private final BasicCheckingWAProfile profile;

    public BasicCheckingWADisclosures() {
        this.profile = new BasicCheckingWAProfile();
    }

    public BasicCheckingWADisclosures(BasicCheckingWAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Washington State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in Washington.
 ...
 */
public final class BasicCheckingWARegulatoryFilings {
    ...
    public BasicCheckingWARegulatoryFilings() {
        this(new BasicCheckingWAProfile());
    }

    public BasicCheckingWARegulatoryFilings(BasicCheckingWAProfile profile) {

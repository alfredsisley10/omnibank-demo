...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsPA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsPAProfile},
 * {@link StandardSavingsPARateTable}, {@link StandardSavingsPADisclosures},
 * {@link StandardSavingsPARegulatoryFilings}, and {@link StandardSavingsPABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsPAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsPAScenarioMatrixTest {

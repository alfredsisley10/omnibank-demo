...
/**
 * Branch / channel integration metadata for StandardSavings in Pennsylvania.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsPABranchIntegration {
    ...
    public StandardSavingsPABranchIntegration() {
        this.profile = new StandardSavingsPAProfile();
    }

    public StandardSavingsPABranchIntegration(StandardSavingsPAProfile profile) {

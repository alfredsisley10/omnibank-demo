...
/**
 * State regulatory filing cadence for StandardSavings in Pennsylvania.
 ...
 */
public final class StandardSavingsPARegulatoryFilings {
    ...
    public StandardSavingsPARegulatoryFilings() {
        this(new StandardSavingsPAProfile());
    }

    public StandardSavingsPARegulatoryFilings(StandardSavingsPAProfile profile) {

package com.omnibank.regional.standardsavings.pa;
...
/**
 * State-specific disclosure overlays for StandardSavings in Pennsylvania.
 * Layered on top of the national disclosure, these capture
 * items that only apply under PA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsPADisclosures {

    private final StandardSavingsPAProfile profile;

    public StandardSavingsPADisclosures() {
        this.profile = new StandardSavingsPAProfile();
    }

    public StandardSavingsPADisclosures(StandardSavingsPAProfile profile) {
    ...
    public String stateHeader() {
        return "Pennsylvania Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Pennsylvania unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Pennsylvania law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Pennsylvania does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Pennsylvania State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

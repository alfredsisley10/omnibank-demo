...
/**
 * State-specific rate table overlay for StandardSavings offered in Pennsylvania.
 ...
 */
public final class StandardSavingsPARateTable {
    ...
    public StandardSavingsPARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-PA-StandardSavings-2026Q1";

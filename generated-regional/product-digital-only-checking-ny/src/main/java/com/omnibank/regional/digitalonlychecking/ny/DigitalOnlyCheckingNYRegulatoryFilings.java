...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in New York.
 ...
 */
public final class DigitalOnlyCheckingNYRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNYRegulatoryFilings() {
        this(new DigitalOnlyCheckingNYProfile());
    }

    public DigitalOnlyCheckingNYRegulatoryFilings(DigitalOnlyCheckingNYProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (New York)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (New York)",
                "ANNUAL",

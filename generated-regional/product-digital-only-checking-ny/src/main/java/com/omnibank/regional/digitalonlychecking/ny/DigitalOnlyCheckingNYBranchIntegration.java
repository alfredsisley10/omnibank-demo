...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in New York.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNYBranchIntegration {
    ...
    public DigitalOnlyCheckingNYBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNYProfile();
    }

    public DigitalOnlyCheckingNYBranchIntegration(DigitalOnlyCheckingNYProfile profile) {

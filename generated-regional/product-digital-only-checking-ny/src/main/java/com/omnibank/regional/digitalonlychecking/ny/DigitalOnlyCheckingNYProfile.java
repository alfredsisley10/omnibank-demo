...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in New York (NY).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNYProfile {
    ...
    public DigitalOnlyCheckingNYProfile() {
        this.stateCode = "NY";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in New York.
 ...
 */
public final class DigitalOnlyCheckingNYRateTable {
    ...
    public DigitalOnlyCheckingNYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NY-DigitalOnlyChecking-2026Q1";

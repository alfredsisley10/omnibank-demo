package com.omnibank.regional.digitalonlychecking.ny;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in New York.
 ...
 */
public final class DigitalOnlyCheckingNYDisclosures {

    private final DigitalOnlyCheckingNYProfile profile;

    public DigitalOnlyCheckingNYDisclosures() {
        this.profile = new DigitalOnlyCheckingNYProfile();
    }

    public DigitalOnlyCheckingNYDisclosures(DigitalOnlyCheckingNYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — New York State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNYProfile},
 * {@link DigitalOnlyCheckingNYRateTable}, {@link DigitalOnlyCheckingNYDisclosures},
 * {@link DigitalOnlyCheckingNYRegulatoryFilings}, and {@link DigitalOnlyCheckingNYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNYScenarioMatrixTest {

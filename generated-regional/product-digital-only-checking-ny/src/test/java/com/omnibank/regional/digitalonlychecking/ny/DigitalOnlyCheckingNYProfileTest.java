...
class DigitalOnlyCheckingNYProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingNYProfile();
        assertThat(p.stateCode()).isEqualTo("NY");
        assertThat(p.stateName()).isEqualTo("New York");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingNYRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingNYDisclosures();
        assertThat(d.renderFullSupplement()).contains("New York");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingNYRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingNYBranchIntegration();

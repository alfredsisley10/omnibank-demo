...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingWY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingWYProfile},
 * {@link BasicCheckingWYRateTable}, {@link BasicCheckingWYDisclosures},
 * {@link BasicCheckingWYRegulatoryFilings}, and {@link BasicCheckingWYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingWYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingWYScenarioMatrixTest {

package com.omnibank.regional.basicchecking.wy;
...
/**
 * State-specific disclosure overlays for BasicChecking in Wyoming.
 ...
 */
public final class BasicCheckingWYDisclosures {

    private final BasicCheckingWYProfile profile;

    public BasicCheckingWYDisclosures() {
        this.profile = new BasicCheckingWYProfile();
    }

    public BasicCheckingWYDisclosures(BasicCheckingWYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Wyoming State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in Wyoming.
 ...
 */
public final class BasicCheckingWYRegulatoryFilings {
    ...
    public BasicCheckingWYRegulatoryFilings() {
        this(new BasicCheckingWYProfile());
    }

    public BasicCheckingWYRegulatoryFilings(BasicCheckingWYProfile profile) {

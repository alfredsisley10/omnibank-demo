...
public final class BasicCheckingWYBranchIntegration {
    ...
    public BasicCheckingWYBranchIntegration() {
        this.profile = new BasicCheckingWYProfile();
    }

    public BasicCheckingWYBranchIntegration(BasicCheckingWYProfile profile) {

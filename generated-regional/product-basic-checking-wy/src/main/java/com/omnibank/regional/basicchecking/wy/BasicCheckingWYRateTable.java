...
/**
 * State-specific rate table overlay for BasicChecking offered in Wyoming.
 ...
 */
public final class BasicCheckingWYRateTable {
    ...
    public BasicCheckingWYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WY-BasicChecking-2026Q1";

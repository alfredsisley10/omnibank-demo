...
/**
 * State regulatory filing cadence for StandardSavings in Virginia.
 ...
 */
public final class StandardSavingsVARegulatoryFilings {
    ...
    public StandardSavingsVARegulatoryFilings() {
        this(new StandardSavingsVAProfile());
    }

    public StandardSavingsVARegulatoryFilings(StandardSavingsVAProfile profile) {

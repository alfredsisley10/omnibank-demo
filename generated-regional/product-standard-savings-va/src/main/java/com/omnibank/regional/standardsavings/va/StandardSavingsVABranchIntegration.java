...
/**
 * Branch / channel integration metadata for StandardSavings in Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsVABranchIntegration {
    ...
    public StandardSavingsVABranchIntegration() {
        this.profile = new StandardSavingsVAProfile();
    }

    public StandardSavingsVABranchIntegration(StandardSavingsVAProfile profile) {

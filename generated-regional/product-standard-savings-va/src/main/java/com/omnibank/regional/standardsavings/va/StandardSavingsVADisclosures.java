package com.omnibank.regional.standardsavings.va;
...
/**
 * State-specific disclosure overlays for StandardSavings in Virginia.
 * Layered on top of the national disclosure, these capture
 * items that only apply under VA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsVADisclosures {

    private final StandardSavingsVAProfile profile;

    public StandardSavingsVADisclosures() {
        this.profile = new StandardSavingsVAProfile();
    }

    public StandardSavingsVADisclosures(StandardSavingsVAProfile profile) {
    ...
    public String stateHeader() {
        return "Virginia Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Virginia unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Virginia law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Virginia does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for StandardSavings offered in Virginia.
 ...
 */
public final class StandardSavingsVARateTable {
    ...
    public StandardSavingsVARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VA-StandardSavings-2026Q1";

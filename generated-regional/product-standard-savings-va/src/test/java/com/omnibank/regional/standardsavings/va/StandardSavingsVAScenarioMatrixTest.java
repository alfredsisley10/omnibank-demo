...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsVA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsVAProfile},
 * {@link StandardSavingsVARateTable}, {@link StandardSavingsVADisclosures},
 * {@link StandardSavingsVARegulatoryFilings}, and {@link StandardSavingsVABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsVAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsVAScenarioMatrixTest {

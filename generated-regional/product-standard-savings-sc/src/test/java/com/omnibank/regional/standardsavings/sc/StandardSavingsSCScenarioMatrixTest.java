...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsSC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsSCProfile},
 * {@link StandardSavingsSCRateTable}, {@link StandardSavingsSCDisclosures},
 * {@link StandardSavingsSCRegulatoryFilings}, and {@link StandardSavingsSCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsSCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsSCScenarioMatrixTest {

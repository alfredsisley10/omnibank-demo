...
/**
 * Branch / channel integration metadata for StandardSavings in South Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsSCBranchIntegration {
    ...
    public StandardSavingsSCBranchIntegration() {
        this.profile = new StandardSavingsSCProfile();
    }

    public StandardSavingsSCBranchIntegration(StandardSavingsSCProfile profile) {

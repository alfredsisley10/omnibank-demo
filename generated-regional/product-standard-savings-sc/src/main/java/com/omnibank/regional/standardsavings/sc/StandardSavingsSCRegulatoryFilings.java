...
/**
 * State regulatory filing cadence for StandardSavings in South Carolina.
 ...
 */
public final class StandardSavingsSCRegulatoryFilings {
    ...
    public StandardSavingsSCRegulatoryFilings() {
        this(new StandardSavingsSCProfile());
    }

    public StandardSavingsSCRegulatoryFilings(StandardSavingsSCProfile profile) {

...
/**
 * State-specific disclosure overlays for StandardSavings in South Carolina.
 * Layered on top of the national disclosure, these capture
 * items that only apply under SC law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsSCDisclosures {

    private final StandardSavingsSCProfile profile;

    public StandardSavingsSCDisclosures() {
        this.profile = new StandardSavingsSCProfile();
    }

    public StandardSavingsSCDisclosures(StandardSavingsSCProfile profile) {
    ...
    public String stateHeader() {
        return "South Carolina Residents Disclosure — Effective "
                + LocalDate.of(2026, 1, 1)
                + ". This supplement is part of the StandardSavings account agreement.";
    }
    ...
    public String unclaimedPropertyClause() {
        return "South Carolina unclaimed property law requires abandoned funds to be "
    ...
    public String electronicSignatureClause() {
        return "By consenting to electronic delivery, you agree that disclosures, "
                + "statements, and notices for this StandardSavings account may be delivered "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by South Carolina law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "South Carolina does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — South Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

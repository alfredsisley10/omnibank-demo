...
/**
 * State-specific rate table overlay for StandardSavings offered in South Carolina.
 ...
 */
public final class StandardSavingsSCRateTable {
    ...
    public StandardSavingsSCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SC-StandardSavings-2026Q1";

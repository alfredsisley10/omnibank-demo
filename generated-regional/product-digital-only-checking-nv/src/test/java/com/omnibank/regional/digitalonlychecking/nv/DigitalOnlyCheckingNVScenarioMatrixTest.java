...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNVProfile},
 * {@link DigitalOnlyCheckingNVRateTable}, {@link DigitalOnlyCheckingNVDisclosures},
 * {@link DigitalOnlyCheckingNVRegulatoryFilings}, and {@link DigitalOnlyCheckingNVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNVScenarioMatrixTest {

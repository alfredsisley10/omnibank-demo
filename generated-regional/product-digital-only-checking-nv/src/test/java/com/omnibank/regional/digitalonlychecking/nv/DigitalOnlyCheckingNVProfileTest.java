...
class DigitalOnlyCheckingNVProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingNVProfile();
        assertThat(p.stateCode()).isEqualTo("NV");
        assertThat(p.stateName()).isEqualTo("Nevada");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingNVRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingNVDisclosures();
        assertThat(d.renderFullSupplement()).contains("Nevada");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingNVRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingNVBranchIntegration();

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Nevada.
 ...
 */
public final class DigitalOnlyCheckingNVRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNVRegulatoryFilings() {
        this(new DigitalOnlyCheckingNVProfile());
    }

    public DigitalOnlyCheckingNVRegulatoryFilings(DigitalOnlyCheckingNVProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Nevada)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Nevada)",
                "ANNUAL",

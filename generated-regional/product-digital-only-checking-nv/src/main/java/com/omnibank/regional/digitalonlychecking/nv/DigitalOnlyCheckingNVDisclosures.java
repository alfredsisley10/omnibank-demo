package com.omnibank.regional.digitalonlychecking.nv;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Nevada.
 ...
 */
public final class DigitalOnlyCheckingNVDisclosures {

    private final DigitalOnlyCheckingNVProfile profile;

    public DigitalOnlyCheckingNVDisclosures() {
        this.profile = new DigitalOnlyCheckingNVProfile();
    }

    public DigitalOnlyCheckingNVDisclosures(DigitalOnlyCheckingNVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Nevada State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

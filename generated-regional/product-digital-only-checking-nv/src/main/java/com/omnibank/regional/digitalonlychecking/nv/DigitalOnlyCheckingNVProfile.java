...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Nevada (NV).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNVProfile {
    ...
    public DigitalOnlyCheckingNVProfile() {
        this.stateCode = "NV";
        this.stateName = "Nevada";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0685");

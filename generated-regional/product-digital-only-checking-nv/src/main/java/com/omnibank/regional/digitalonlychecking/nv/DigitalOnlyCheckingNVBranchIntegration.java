...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Nevada.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNVBranchIntegration {
    ...
    public DigitalOnlyCheckingNVBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNVProfile();
    }

    public DigitalOnlyCheckingNVBranchIntegration(DigitalOnlyCheckingNVProfile profile) {

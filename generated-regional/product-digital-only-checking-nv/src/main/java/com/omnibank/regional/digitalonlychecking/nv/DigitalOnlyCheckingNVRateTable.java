...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Nevada.
 ...
 */
public final class DigitalOnlyCheckingNVRateTable {
    ...
    public DigitalOnlyCheckingNVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NV-DigitalOnlyChecking-2026Q1";

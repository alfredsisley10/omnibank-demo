...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Massachusetts.
 ...
 */
public final class DigitalOnlyCheckingMARateTable {
    ...
    public DigitalOnlyCheckingMARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MA-DigitalOnlyChecking-2026Q1";

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Massachusetts.
 ...
 */
public final class DigitalOnlyCheckingMARegulatoryFilings {
    ...
    public DigitalOnlyCheckingMARegulatoryFilings() {
        this(new DigitalOnlyCheckingMAProfile());
    }

    public DigitalOnlyCheckingMARegulatoryFilings(DigitalOnlyCheckingMAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                ...
                "Massachusetts Condition Report",
                "QUARTERLY",
                dueDate,
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Massachusetts)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Massachusetts)",
                "ANNUAL",

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Massachusetts (MA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMAProfile {
    ...
    public DigitalOnlyCheckingMAProfile() {
        this.stateCode = "MA";

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Massachusetts.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMABranchIntegration {
    ...
    public DigitalOnlyCheckingMABranchIntegration() {
        this.profile = new DigitalOnlyCheckingMAProfile();
    }

    public DigitalOnlyCheckingMABranchIntegration(DigitalOnlyCheckingMAProfile profile) {

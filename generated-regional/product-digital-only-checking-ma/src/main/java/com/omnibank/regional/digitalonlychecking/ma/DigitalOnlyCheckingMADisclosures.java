package com.omnibank.regional.digitalonlychecking.ma;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Massachusetts.
 ...
 */
public final class DigitalOnlyCheckingMADisclosures {

    private final DigitalOnlyCheckingMAProfile profile;

    public DigitalOnlyCheckingMADisclosures() {
        this.profile = new DigitalOnlyCheckingMAProfile();
    }

    public DigitalOnlyCheckingMADisclosures(DigitalOnlyCheckingMAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Massachusetts State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

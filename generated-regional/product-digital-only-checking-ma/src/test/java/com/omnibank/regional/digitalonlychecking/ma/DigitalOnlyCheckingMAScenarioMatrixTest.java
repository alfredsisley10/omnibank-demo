...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMAProfile},
 * {@link DigitalOnlyCheckingMARateTable}, {@link DigitalOnlyCheckingMADisclosures},
 * {@link DigitalOnlyCheckingMARegulatoryFilings}, and {@link DigitalOnlyCheckingMABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMAScenarioMatrixTest {

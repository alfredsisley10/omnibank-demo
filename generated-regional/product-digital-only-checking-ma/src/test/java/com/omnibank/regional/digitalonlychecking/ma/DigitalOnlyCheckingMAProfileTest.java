...
class DigitalOnlyCheckingMAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingMAProfile();
        assertThat(p.stateCode()).isEqualTo("MA");
        assertThat(p.stateName()).isEqualTo("Massachusetts");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingMARateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingMADisclosures();
        assertThat(d.renderFullSupplement()).contains("Massachusetts");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingMARegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingMABranchIntegration();

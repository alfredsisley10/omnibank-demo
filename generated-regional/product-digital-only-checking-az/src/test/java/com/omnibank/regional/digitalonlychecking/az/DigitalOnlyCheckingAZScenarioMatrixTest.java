...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingAZ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingAZProfile},
 * {@link DigitalOnlyCheckingAZRateTable}, {@link DigitalOnlyCheckingAZDisclosures},
 * {@link DigitalOnlyCheckingAZRegulatoryFilings}, and {@link DigitalOnlyCheckingAZBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingAZProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingAZScenarioMatrixTest {

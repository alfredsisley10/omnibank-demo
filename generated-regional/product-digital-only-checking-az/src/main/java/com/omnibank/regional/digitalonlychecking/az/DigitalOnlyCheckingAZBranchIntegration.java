...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Arizona.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingAZBranchIntegration {
    ...
    public DigitalOnlyCheckingAZBranchIntegration() {
        this.profile = new DigitalOnlyCheckingAZProfile();
    }

    public DigitalOnlyCheckingAZBranchIntegration(DigitalOnlyCheckingAZProfile profile) {

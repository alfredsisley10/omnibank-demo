...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Arizona.
 ...
 */
public final class DigitalOnlyCheckingAZRateTable {
    ...
    public DigitalOnlyCheckingAZRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AZ-DigitalOnlyChecking-2026Q1";

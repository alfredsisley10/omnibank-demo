...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Arizona (AZ).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingAZProfile {
    ...
    public DigitalOnlyCheckingAZProfile() {
        this.stateCode = "AZ";
        this.stateName = "Arizona";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0560");

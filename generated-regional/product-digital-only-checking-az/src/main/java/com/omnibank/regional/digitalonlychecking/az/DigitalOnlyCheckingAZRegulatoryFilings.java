...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Arizona.
 ...
 */
public final class DigitalOnlyCheckingAZRegulatoryFilings {
    ...
    public DigitalOnlyCheckingAZRegulatoryFilings() {
        this(new DigitalOnlyCheckingAZProfile());
    }

    public DigitalOnlyCheckingAZRegulatoryFilings(DigitalOnlyCheckingAZProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Arizona)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Arizona)",
                "ANNUAL",

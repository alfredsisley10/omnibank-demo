package com.omnibank.regional.digitalonlychecking.az;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Arizona.
 ...
 */
public final class DigitalOnlyCheckingAZDisclosures {

    private final DigitalOnlyCheckingAZProfile profile;

    public DigitalOnlyCheckingAZDisclosures() {
        this.profile = new DigitalOnlyCheckingAZProfile();
    }

    public DigitalOnlyCheckingAZDisclosures(DigitalOnlyCheckingAZProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Arizona State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

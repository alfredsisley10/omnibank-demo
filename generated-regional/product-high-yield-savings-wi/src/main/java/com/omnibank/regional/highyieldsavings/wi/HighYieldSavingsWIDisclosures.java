package com.omnibank.regional.highyieldsavings.wi;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Wisconsin.
 ...
 */
public final class HighYieldSavingsWIDisclosures {

    private final HighYieldSavingsWIProfile profile;

    public HighYieldSavingsWIDisclosures() {
        this.profile = new HighYieldSavingsWIProfile();
    }

    public HighYieldSavingsWIDisclosures(HighYieldSavingsWIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Wisconsin State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

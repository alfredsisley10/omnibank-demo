...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Wisconsin.
 ...
 */
public final class HighYieldSavingsWIRateTable {
    ...
    public HighYieldSavingsWIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WI-HighYieldSavings-2026Q1";

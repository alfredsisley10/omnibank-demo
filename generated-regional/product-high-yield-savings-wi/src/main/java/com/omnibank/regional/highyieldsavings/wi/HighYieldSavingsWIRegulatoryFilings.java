...
/**
 * State regulatory filing cadence for HighYieldSavings in Wisconsin.
 ...
 */
public final class HighYieldSavingsWIRegulatoryFilings {
    ...
    public HighYieldSavingsWIRegulatoryFilings() {
        this(new HighYieldSavingsWIProfile());
    }

    public HighYieldSavingsWIRegulatoryFilings(HighYieldSavingsWIProfile profile) {

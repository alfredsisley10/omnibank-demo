...
/**
 * Branch / channel integration metadata for HighYieldSavings in Wisconsin.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsWIBranchIntegration {
    ...
    public HighYieldSavingsWIBranchIntegration() {
        this.profile = new HighYieldSavingsWIProfile();
    }

    public HighYieldSavingsWIBranchIntegration(HighYieldSavingsWIProfile profile) {

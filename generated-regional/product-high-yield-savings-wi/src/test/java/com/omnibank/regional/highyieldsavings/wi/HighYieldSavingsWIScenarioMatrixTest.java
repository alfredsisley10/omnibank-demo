...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsWI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsWIProfile},
 * {@link HighYieldSavingsWIRateTable}, {@link HighYieldSavingsWIDisclosures},
 * {@link HighYieldSavingsWIRegulatoryFilings}, and {@link HighYieldSavingsWIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsWIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsWIScenarioMatrixTest {

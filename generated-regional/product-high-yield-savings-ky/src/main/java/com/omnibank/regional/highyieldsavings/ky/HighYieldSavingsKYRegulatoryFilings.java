...
/**
 * State regulatory filing cadence for HighYieldSavings in Kentucky.
 ...
 */
public final class HighYieldSavingsKYRegulatoryFilings {
    ...
    public HighYieldSavingsKYRegulatoryFilings() {
        this(new HighYieldSavingsKYProfile());
    }

    public HighYieldSavingsKYRegulatoryFilings(HighYieldSavingsKYProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Kentucky.
 ...
 */
public final class HighYieldSavingsKYRateTable {
    ...
    public HighYieldSavingsKYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KY-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsKY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsKYProfile},
 * {@link HighYieldSavingsKYRateTable}, {@link HighYieldSavingsKYDisclosures},
 * {@link HighYieldSavingsKYRegulatoryFilings}, and {@link HighYieldSavingsKYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsKYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsKYScenarioMatrixTest {

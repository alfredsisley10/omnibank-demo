...
/**
 * State-specific rate table overlay for EssentialChecking offered in Colorado.
 ...
 */
public final class EssentialCheckingCORateTable {
    ...
    public EssentialCheckingCORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CO-EssentialChecking-2026Q1";

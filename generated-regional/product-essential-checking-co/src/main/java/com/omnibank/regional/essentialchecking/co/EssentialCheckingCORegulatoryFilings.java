...
/**
 * State regulatory filing cadence for EssentialChecking in Colorado.
 ...
 */
public final class EssentialCheckingCORegulatoryFilings {
    ...
    public EssentialCheckingCORegulatoryFilings() {
        this(new EssentialCheckingCOProfile());
    }

    public EssentialCheckingCORegulatoryFilings(EssentialCheckingCOProfile profile) {

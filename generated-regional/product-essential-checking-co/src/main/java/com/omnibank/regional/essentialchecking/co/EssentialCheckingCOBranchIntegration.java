...
/**
 * Branch / channel integration metadata for EssentialChecking in Colorado.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingCOBranchIntegration {
    ...
    public EssentialCheckingCOBranchIntegration() {
        this.profile = new EssentialCheckingCOProfile();
    }

    public EssentialCheckingCOBranchIntegration(EssentialCheckingCOProfile profile) {

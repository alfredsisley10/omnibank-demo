package com.omnibank.regional.essentialchecking.co;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Colorado.
 ...
 */
public final class EssentialCheckingCODisclosures {

    private final EssentialCheckingCOProfile profile;

    public EssentialCheckingCODisclosures() {
        this.profile = new EssentialCheckingCOProfile();
    }

    public EssentialCheckingCODisclosures(EssentialCheckingCOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Colorado State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

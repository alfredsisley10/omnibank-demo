...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingCO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingCOProfile},
 * {@link EssentialCheckingCORateTable}, {@link EssentialCheckingCODisclosures},
 * {@link EssentialCheckingCORegulatoryFilings}, and {@link EssentialCheckingCOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingCOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingCOScenarioMatrixTest {

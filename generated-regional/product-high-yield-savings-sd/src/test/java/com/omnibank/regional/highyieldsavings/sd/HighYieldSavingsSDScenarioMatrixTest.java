...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsSD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsSDProfile},
 * {@link HighYieldSavingsSDRateTable}, {@link HighYieldSavingsSDDisclosures},
 * {@link HighYieldSavingsSDRegulatoryFilings}, and {@link HighYieldSavingsSDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsSDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsSDScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for HighYieldSavings in South Dakota.
 ...
 */
public final class HighYieldSavingsSDRegulatoryFilings {
    ...
    public HighYieldSavingsSDRegulatoryFilings() {
        this(new HighYieldSavingsSDProfile());
    }

    public HighYieldSavingsSDRegulatoryFilings(HighYieldSavingsSDProfile profile) {

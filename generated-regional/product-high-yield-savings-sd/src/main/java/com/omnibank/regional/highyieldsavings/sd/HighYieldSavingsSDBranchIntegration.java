...
/**
 * Branch / channel integration metadata for HighYieldSavings in South Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsSDBranchIntegration {
    ...
    public HighYieldSavingsSDBranchIntegration() {
        this.profile = new HighYieldSavingsSDProfile();
    }

    public HighYieldSavingsSDBranchIntegration(HighYieldSavingsSDProfile profile) {

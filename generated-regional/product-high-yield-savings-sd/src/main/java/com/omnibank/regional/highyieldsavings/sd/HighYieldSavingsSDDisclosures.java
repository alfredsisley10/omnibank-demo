package com.omnibank.regional.highyieldsavings.sd;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in South Dakota.
 ...
 */
public final class HighYieldSavingsSDDisclosures {

    private final HighYieldSavingsSDProfile profile;

    public HighYieldSavingsSDDisclosures() {
        this.profile = new HighYieldSavingsSDProfile();
    }

    public HighYieldSavingsSDDisclosures(HighYieldSavingsSDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — South Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in South Dakota.
 ...
 */
public final class HighYieldSavingsSDRateTable {
    ...
    public HighYieldSavingsSDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SD-HighYieldSavings-2026Q1";

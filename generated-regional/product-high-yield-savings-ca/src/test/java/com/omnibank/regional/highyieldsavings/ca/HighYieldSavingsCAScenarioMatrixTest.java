...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsCA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsCAProfile},
 * {@link HighYieldSavingsCARateTable}, {@link HighYieldSavingsCADisclosures},
 * {@link HighYieldSavingsCARegulatoryFilings}, and {@link HighYieldSavingsCABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsCAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsCAScenarioMatrixTest {

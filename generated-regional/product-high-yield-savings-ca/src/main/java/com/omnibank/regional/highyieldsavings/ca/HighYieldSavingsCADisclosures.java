...
/**
 * State-specific disclosure overlays for HighYieldSavings in California.
 ...
 */
public final class HighYieldSavingsCADisclosures {

    private final HighYieldSavingsCAProfile profile;

    public HighYieldSavingsCADisclosures() {
        this.profile = new HighYieldSavingsCAProfile();
    }

    public HighYieldSavingsCADisclosures(HighYieldSavingsCAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — California State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for HighYieldSavings in California.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsCABranchIntegration {
    ...
    public HighYieldSavingsCABranchIntegration() {
        this.profile = new HighYieldSavingsCAProfile();
    }

    public HighYieldSavingsCABranchIntegration(HighYieldSavingsCAProfile profile) {

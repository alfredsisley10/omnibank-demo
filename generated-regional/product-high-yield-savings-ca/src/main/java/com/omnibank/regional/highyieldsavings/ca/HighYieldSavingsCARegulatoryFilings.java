...
/**
 * State regulatory filing cadence for HighYieldSavings in California.
 ...
 */
public final class HighYieldSavingsCARegulatoryFilings {
    ...
    public HighYieldSavingsCARegulatoryFilings() {
        this(new HighYieldSavingsCAProfile());
    }

    public HighYieldSavingsCARegulatoryFilings(HighYieldSavingsCAProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in California.
 ...
 */
public final class HighYieldSavingsCARateTable {
    ...
    public HighYieldSavingsCARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CA-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMAProfile},
 * {@link EssentialCheckingMARateTable}, {@link EssentialCheckingMADisclosures},
 * {@link EssentialCheckingMARegulatoryFilings}, and {@link EssentialCheckingMABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMAScenarioMatrixTest {

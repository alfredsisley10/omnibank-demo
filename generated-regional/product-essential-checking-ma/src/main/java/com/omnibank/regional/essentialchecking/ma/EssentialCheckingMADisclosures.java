package com.omnibank.regional.essentialchecking.ma;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Massachusetts.
 ...
 */
public final class EssentialCheckingMADisclosures {

    private final EssentialCheckingMAProfile profile;

    public EssentialCheckingMADisclosures() {
        this.profile = new EssentialCheckingMAProfile();
    }

    public EssentialCheckingMADisclosures(EssentialCheckingMAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Massachusetts State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

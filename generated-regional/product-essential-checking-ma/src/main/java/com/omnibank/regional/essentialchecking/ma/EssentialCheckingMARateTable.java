...
/**
 * State-specific rate table overlay for EssentialChecking offered in Massachusetts.
 ...
 */
public final class EssentialCheckingMARateTable {
    ...
    public EssentialCheckingMARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MA-EssentialChecking-2026Q1";

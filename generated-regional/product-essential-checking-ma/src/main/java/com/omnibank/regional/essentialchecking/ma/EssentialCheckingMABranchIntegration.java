...
/**
 * Branch / channel integration metadata for EssentialChecking in Massachusetts.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMABranchIntegration {
    ...
    public EssentialCheckingMABranchIntegration() {
        this.profile = new EssentialCheckingMAProfile();
    }

    public EssentialCheckingMABranchIntegration(EssentialCheckingMAProfile profile) {

...
/**
 * State regulatory filing cadence for EssentialChecking in Massachusetts.
 ...
 */
public final class EssentialCheckingMARegulatoryFilings {
    ...
    public EssentialCheckingMARegulatoryFilings() {
        this(new EssentialCheckingMAProfile());
    }

    public EssentialCheckingMARegulatoryFilings(EssentialCheckingMAProfile profile) {

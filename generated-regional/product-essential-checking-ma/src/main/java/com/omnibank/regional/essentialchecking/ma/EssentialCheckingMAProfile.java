...
/**
 * Jurisdiction profile for EssentialChecking as offered in Massachusetts (MA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingMAProfile {
    ...
    public EssentialCheckingMAProfile() {
        this.stateCode = "MA";

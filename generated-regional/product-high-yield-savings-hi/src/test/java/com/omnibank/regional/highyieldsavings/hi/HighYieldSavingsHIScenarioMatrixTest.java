...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsHI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsHIProfile},
 * {@link HighYieldSavingsHIRateTable}, {@link HighYieldSavingsHIDisclosures},
 * {@link HighYieldSavingsHIRegulatoryFilings}, and {@link HighYieldSavingsHIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsHIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsHIScenarioMatrixTest {

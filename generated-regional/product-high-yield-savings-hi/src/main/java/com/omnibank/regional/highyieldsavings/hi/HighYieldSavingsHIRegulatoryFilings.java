...
/**
 * State regulatory filing cadence for HighYieldSavings in Hawaii.
 ...
 */
public final class HighYieldSavingsHIRegulatoryFilings {
    ...
    public HighYieldSavingsHIRegulatoryFilings() {
        this(new HighYieldSavingsHIProfile());
    }

    public HighYieldSavingsHIRegulatoryFilings(HighYieldSavingsHIProfile profile) {

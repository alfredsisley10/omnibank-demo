package com.omnibank.regional.highyieldsavings.hi;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Hawaii.
 ...
 */
public final class HighYieldSavingsHIDisclosures {

    private final HighYieldSavingsHIProfile profile;

    public HighYieldSavingsHIDisclosures() {
        this.profile = new HighYieldSavingsHIProfile();
    }

    public HighYieldSavingsHIDisclosures(HighYieldSavingsHIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Hawaii State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

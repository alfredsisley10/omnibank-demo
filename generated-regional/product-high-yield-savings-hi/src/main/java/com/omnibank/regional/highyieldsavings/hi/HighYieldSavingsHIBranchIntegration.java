...
/**
 * Branch / channel integration metadata for HighYieldSavings in Hawaii.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsHIBranchIntegration {
    ...
    public HighYieldSavingsHIBranchIntegration() {
        this.profile = new HighYieldSavingsHIProfile();
    }

    public HighYieldSavingsHIBranchIntegration(HighYieldSavingsHIProfile profile) {

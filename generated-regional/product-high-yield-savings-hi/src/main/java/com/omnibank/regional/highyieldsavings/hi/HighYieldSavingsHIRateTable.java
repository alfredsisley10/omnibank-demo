...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Hawaii.
 ...
 */
public final class HighYieldSavingsHIRateTable {
    ...
    public HighYieldSavingsHIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-HI-HighYieldSavings-2026Q1";

...
/**
 * State-specific rate table overlay for BasicChecking offered in Vermont.
 ...
 */
public final class BasicCheckingVTRateTable {
    ...
    public BasicCheckingVTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VT-BasicChecking-2026Q1";

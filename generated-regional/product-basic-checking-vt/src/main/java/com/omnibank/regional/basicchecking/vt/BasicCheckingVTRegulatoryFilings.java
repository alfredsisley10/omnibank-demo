...
/**
 * State regulatory filing cadence for BasicChecking in Vermont.
 ...
 */
public final class BasicCheckingVTRegulatoryFilings {
    ...
    public BasicCheckingVTRegulatoryFilings() {
        this(new BasicCheckingVTProfile());
    }

    public BasicCheckingVTRegulatoryFilings(BasicCheckingVTProfile profile) {

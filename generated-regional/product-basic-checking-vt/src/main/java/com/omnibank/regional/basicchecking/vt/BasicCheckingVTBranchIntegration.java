...
public final class BasicCheckingVTBranchIntegration {
    ...
    public BasicCheckingVTBranchIntegration() {
        this.profile = new BasicCheckingVTProfile();
    }

    public BasicCheckingVTBranchIntegration(BasicCheckingVTProfile profile) {

package com.omnibank.regional.basicchecking.vt;
...
/**
 * State-specific disclosure overlays for BasicChecking in Vermont.
 ...
 */
public final class BasicCheckingVTDisclosures {

    private final BasicCheckingVTProfile profile;

    public BasicCheckingVTDisclosures() {
        this.profile = new BasicCheckingVTProfile();
    }

    public BasicCheckingVTDisclosures(BasicCheckingVTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Vermont State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

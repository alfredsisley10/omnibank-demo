...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingVT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingVTProfile},
 * {@link BasicCheckingVTRateTable}, {@link BasicCheckingVTDisclosures},
 * {@link BasicCheckingVTRegulatoryFilings}, and {@link BasicCheckingVTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingVTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingVTScenarioMatrixTest {

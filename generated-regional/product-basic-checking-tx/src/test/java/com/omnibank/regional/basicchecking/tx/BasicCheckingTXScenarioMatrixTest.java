...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingTX jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingTXProfile},
 * {@link BasicCheckingTXRateTable}, {@link BasicCheckingTXDisclosures},
 * {@link BasicCheckingTXRegulatoryFilings}, and {@link BasicCheckingTXBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingTXProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingTXScenarioMatrixTest {

...
public final class BasicCheckingTXBranchIntegration {
    ...
    public BasicCheckingTXBranchIntegration() {
        this.profile = new BasicCheckingTXProfile();
    }

    public BasicCheckingTXBranchIntegration(BasicCheckingTXProfile profile) {

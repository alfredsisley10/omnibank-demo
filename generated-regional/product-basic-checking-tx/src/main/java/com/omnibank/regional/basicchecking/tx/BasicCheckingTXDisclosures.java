package com.omnibank.regional.basicchecking.tx;
...
/**
 * State-specific disclosure overlays for BasicChecking in Texas.
 ...
 */
public final class BasicCheckingTXDisclosures {

    private final BasicCheckingTXProfile profile;

    public BasicCheckingTXDisclosures() {
        this.profile = new BasicCheckingTXProfile();
    }

    public BasicCheckingTXDisclosures(BasicCheckingTXProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Texas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for BasicChecking offered in Texas.
 ...
 */
public final class BasicCheckingTXRateTable {
    ...
    public BasicCheckingTXRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TX-BasicChecking-2026Q1";

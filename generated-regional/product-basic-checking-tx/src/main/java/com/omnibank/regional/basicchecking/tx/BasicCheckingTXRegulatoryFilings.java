...
/**
 * State regulatory filing cadence for BasicChecking in Texas.
 ...
 */
public final class BasicCheckingTXRegulatoryFilings {
    ...
    public BasicCheckingTXRegulatoryFilings() {
        this(new BasicCheckingTXProfile());
    }

    public BasicCheckingTXRegulatoryFilings(BasicCheckingTXProfile profile) {

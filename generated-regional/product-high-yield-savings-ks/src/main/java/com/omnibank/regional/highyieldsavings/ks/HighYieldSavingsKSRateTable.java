...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Kansas.
 ...
 */
public final class HighYieldSavingsKSRateTable {
    ...
    public HighYieldSavingsKSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KS-HighYieldSavings-2026Q1";

...
/**
 * Branch / channel integration metadata for HighYieldSavings in Kansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsKSBranchIntegration {
    ...
    public HighYieldSavingsKSBranchIntegration() {
        this.profile = new HighYieldSavingsKSProfile();
    }

    public HighYieldSavingsKSBranchIntegration(HighYieldSavingsKSProfile profile) {

...
/**
 * State regulatory filing cadence for HighYieldSavings in Kansas.
 ...
 */
public final class HighYieldSavingsKSRegulatoryFilings {
    ...
    public HighYieldSavingsKSRegulatoryFilings() {
        this(new HighYieldSavingsKSProfile());
    }

    public HighYieldSavingsKSRegulatoryFilings(HighYieldSavingsKSProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Kansas.
 ...
 */
public final class HighYieldSavingsKSDisclosures {

    private final HighYieldSavingsKSProfile profile;

    public HighYieldSavingsKSDisclosures() {
        this.profile = new HighYieldSavingsKSProfile();
    }

    public HighYieldSavingsKSDisclosures(HighYieldSavingsKSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Kansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

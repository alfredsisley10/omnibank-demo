...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsKS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsKSProfile},
 * {@link HighYieldSavingsKSRateTable}, {@link HighYieldSavingsKSDisclosures},
 * {@link HighYieldSavingsKSRegulatoryFilings}, and {@link HighYieldSavingsKSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsKSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsKSScenarioMatrixTest {

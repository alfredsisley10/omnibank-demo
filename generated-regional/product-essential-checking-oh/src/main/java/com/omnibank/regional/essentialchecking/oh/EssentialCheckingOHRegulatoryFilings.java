...
/**
 * State regulatory filing cadence for EssentialChecking in Ohio.
 ...
 */
public final class EssentialCheckingOHRegulatoryFilings {
    ...
    public EssentialCheckingOHRegulatoryFilings() {
        this(new EssentialCheckingOHProfile());
    }

    public EssentialCheckingOHRegulatoryFilings(EssentialCheckingOHProfile profile) {

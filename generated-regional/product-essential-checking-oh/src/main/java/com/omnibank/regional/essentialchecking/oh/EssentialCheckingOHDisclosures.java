...
/**
 * State-specific disclosure overlays for EssentialChecking in Ohio.
 ...
 */
public final class EssentialCheckingOHDisclosures {

    private final EssentialCheckingOHProfile profile;

    public EssentialCheckingOHDisclosures() {
        this.profile = new EssentialCheckingOHProfile();
    }

    public EssentialCheckingOHDisclosures(EssentialCheckingOHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Ohio State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in Ohio.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingOHBranchIntegration {
    ...
    public EssentialCheckingOHBranchIntegration() {
        this.profile = new EssentialCheckingOHProfile();
    }

    public EssentialCheckingOHBranchIntegration(EssentialCheckingOHProfile profile) {

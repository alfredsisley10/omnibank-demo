...
/**
 * State-specific rate table overlay for EssentialChecking offered in Ohio.
 ...
 */
public final class EssentialCheckingOHRateTable {
    ...
    public EssentialCheckingOHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OH-EssentialChecking-2026Q1";

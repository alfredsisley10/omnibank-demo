...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMIProfile},
 * {@link DigitalOnlyCheckingMIRateTable}, {@link DigitalOnlyCheckingMIDisclosures},
 * {@link DigitalOnlyCheckingMIRegulatoryFilings}, and {@link DigitalOnlyCheckingMIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMIScenarioMatrixTest {

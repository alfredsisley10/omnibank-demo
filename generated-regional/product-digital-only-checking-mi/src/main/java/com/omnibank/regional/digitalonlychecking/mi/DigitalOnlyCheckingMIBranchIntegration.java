...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Michigan.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMIBranchIntegration {
    ...
    public DigitalOnlyCheckingMIBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMIProfile();
    }

    public DigitalOnlyCheckingMIBranchIntegration(DigitalOnlyCheckingMIProfile profile) {

...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Michigan.
 ...
 */
public final class DigitalOnlyCheckingMIDisclosures {

    private final DigitalOnlyCheckingMIProfile profile;

    public DigitalOnlyCheckingMIDisclosures() {
        this.profile = new DigitalOnlyCheckingMIProfile();
    }

    public DigitalOnlyCheckingMIDisclosures(DigitalOnlyCheckingMIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Michigan State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

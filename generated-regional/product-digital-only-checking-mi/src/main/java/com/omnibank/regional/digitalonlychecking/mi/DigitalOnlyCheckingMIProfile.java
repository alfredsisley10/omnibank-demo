...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Michigan (MI).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMIProfile {
    ...
    public DigitalOnlyCheckingMIProfile() {
        this.stateCode = "MI";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Michigan.
 ...
 */
public final class DigitalOnlyCheckingMIRateTable {
    ...
    public DigitalOnlyCheckingMIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MI-DigitalOnlyChecking-2026Q1";

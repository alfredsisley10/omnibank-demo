package com.omnibank.regional.digitalonlychecking.mi;
...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Michigan.
 ...
 */
public final class DigitalOnlyCheckingMIRegulatoryFilings {
    ...
    private final DigitalOnlyCheckingMIProfile profile;

    public DigitalOnlyCheckingMIRegulatoryFilings() {
        this(new DigitalOnlyCheckingMIProfile());
    }

    public DigitalOnlyCheckingMIRegulatoryFilings(DigitalOnlyCheckingMIProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Michigan)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Michigan)",
                "ANNUAL",

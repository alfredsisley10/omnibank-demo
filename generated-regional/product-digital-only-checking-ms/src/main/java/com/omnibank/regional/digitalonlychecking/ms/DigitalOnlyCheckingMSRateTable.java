...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Mississippi.
 ...
 */
public final class DigitalOnlyCheckingMSRateTable {
    ...
    public DigitalOnlyCheckingMSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MS-DigitalOnlyChecking-2026Q1";

package com.omnibank.regional.digitalonlychecking.ms;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Mississippi.
 ...
 */
public final class DigitalOnlyCheckingMSDisclosures {

    private final DigitalOnlyCheckingMSProfile profile;

    public DigitalOnlyCheckingMSDisclosures() {
        this.profile = new DigitalOnlyCheckingMSProfile();
    }

    public DigitalOnlyCheckingMSDisclosures(DigitalOnlyCheckingMSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Mississippi State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Mississippi.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMSBranchIntegration {
    ...
    public DigitalOnlyCheckingMSBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMSProfile();
    }

    public DigitalOnlyCheckingMSBranchIntegration(DigitalOnlyCheckingMSProfile profile) {

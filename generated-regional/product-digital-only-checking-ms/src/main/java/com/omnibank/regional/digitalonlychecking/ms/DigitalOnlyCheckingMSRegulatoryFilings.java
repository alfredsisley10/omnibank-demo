...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Mississippi.
 ...
 */
public final class DigitalOnlyCheckingMSRegulatoryFilings {
    ...
    public DigitalOnlyCheckingMSRegulatoryFilings() {
        this(new DigitalOnlyCheckingMSProfile());
    }

    public DigitalOnlyCheckingMSRegulatoryFilings(DigitalOnlyCheckingMSProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Mississippi)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Mississippi)",
                "ANNUAL",

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Mississippi (MS).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMSProfile {
    ...
    public DigitalOnlyCheckingMSProfile() {
        this.stateCode = "MS";
        this.stateName = "Mississippi";
        this.region = "SOUTH";
        this.salesTaxRate = new BigDecimal("0.0700");
        this.fdicRegion = "DALLAS";

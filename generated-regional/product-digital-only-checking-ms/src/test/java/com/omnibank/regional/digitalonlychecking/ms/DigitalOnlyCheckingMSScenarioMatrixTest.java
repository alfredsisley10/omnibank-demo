...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMSProfile},
 * {@link DigitalOnlyCheckingMSRateTable}, {@link DigitalOnlyCheckingMSDisclosures},
 * {@link DigitalOnlyCheckingMSRegulatoryFilings}, and {@link DigitalOnlyCheckingMSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMSScenarioMatrixTest {

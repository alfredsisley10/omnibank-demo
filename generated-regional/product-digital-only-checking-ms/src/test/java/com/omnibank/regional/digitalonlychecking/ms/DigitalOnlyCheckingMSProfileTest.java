...
class DigitalOnlyCheckingMSProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingMSProfile();
        assertThat(p.stateCode()).isEqualTo("MS");
        assertThat(p.stateName()).isEqualTo("Mississippi");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingMSRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingMSDisclosures();
        assertThat(d.renderFullSupplement()).contains("Mississippi");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingMSRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingMSBranchIntegration();

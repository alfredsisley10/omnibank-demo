...
/**
 * State regulatory filing cadence for HighYieldSavings in Nebraska.
 ...
 */
public final class HighYieldSavingsNERegulatoryFilings {
    ...
    public HighYieldSavingsNERegulatoryFilings() {
        this(new HighYieldSavingsNEProfile());
    }

    public HighYieldSavingsNERegulatoryFilings(HighYieldSavingsNEProfile profile) {

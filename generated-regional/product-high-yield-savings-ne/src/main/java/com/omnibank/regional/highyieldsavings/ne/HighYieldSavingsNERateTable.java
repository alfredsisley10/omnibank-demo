...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Nebraska.
 ...
 */
public final class HighYieldSavingsNERateTable {
    ...
    public HighYieldSavingsNERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NE-HighYieldSavings-2026Q1";

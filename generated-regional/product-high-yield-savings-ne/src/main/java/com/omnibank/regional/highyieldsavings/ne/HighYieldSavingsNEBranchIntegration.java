...
/**
 * Branch / channel integration metadata for HighYieldSavings in Nebraska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNEBranchIntegration {
    ...
    public HighYieldSavingsNEBranchIntegration() {
        this.profile = new HighYieldSavingsNEProfile();
    }

    public HighYieldSavingsNEBranchIntegration(HighYieldSavingsNEProfile profile) {

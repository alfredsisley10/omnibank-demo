...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsME jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMEProfile},
 * {@link StandardSavingsMERateTable}, {@link StandardSavingsMEDisclosures},
 * {@link StandardSavingsMERegulatoryFilings}, and {@link StandardSavingsMEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMEScenarioMatrixTest {

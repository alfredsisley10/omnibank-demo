...
/**
 * State-specific rate table overlay for StandardSavings offered in Maine.
 ...
 */
public final class StandardSavingsMERateTable {
    ...
    public StandardSavingsMERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ME-StandardSavings-2026Q1";

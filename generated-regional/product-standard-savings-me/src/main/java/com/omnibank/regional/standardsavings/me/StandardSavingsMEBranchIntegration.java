...
public final class StandardSavingsMEBranchIntegration {
    ...
    public StandardSavingsMEBranchIntegration() {
        this.profile = new StandardSavingsMEProfile();
    }

    public StandardSavingsMEBranchIntegration(StandardSavingsMEProfile profile) {

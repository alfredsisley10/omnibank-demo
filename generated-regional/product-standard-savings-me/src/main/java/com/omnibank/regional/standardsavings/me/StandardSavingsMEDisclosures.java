package com.omnibank.regional.standardsavings.me;
...
/**
 * State-specific disclosure overlays for StandardSavings in Maine.
 * Layered on top of the national disclosure, these capture
 * items that only apply under ME law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsMEDisclosures {

    private final StandardSavingsMEProfile profile;

    public StandardSavingsMEDisclosures() {
        this.profile = new StandardSavingsMEProfile();
    }

    public StandardSavingsMEDisclosures(StandardSavingsMEProfile profile) {
    ...
    public String stateHeader() {
        return "Maine Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Maine unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Maine law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Maine does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Maine State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

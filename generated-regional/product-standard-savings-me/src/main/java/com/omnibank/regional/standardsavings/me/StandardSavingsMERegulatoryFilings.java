...
/**
 * State regulatory filing cadence for StandardSavings in Maine.
 ...
 */
public final class StandardSavingsMERegulatoryFilings {
    ...
    public StandardSavingsMERegulatoryFilings() {
        this(new StandardSavingsMEProfile());
    }

    public StandardSavingsMERegulatoryFilings(StandardSavingsMEProfile profile) {

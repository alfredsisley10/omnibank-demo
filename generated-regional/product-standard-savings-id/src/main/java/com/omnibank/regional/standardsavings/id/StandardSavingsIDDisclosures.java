...
/**
 * State-specific disclosure overlays for StandardSavings in Idaho.
 ...
 */
public final class StandardSavingsIDDisclosures {

    private final StandardSavingsIDProfile profile;

    public StandardSavingsIDDisclosures() {
        this.profile = new StandardSavingsIDProfile();
    }

    public StandardSavingsIDDisclosures(StandardSavingsIDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Idaho State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

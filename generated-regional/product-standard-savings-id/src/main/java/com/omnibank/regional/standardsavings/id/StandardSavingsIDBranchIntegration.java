...
public final class StandardSavingsIDBranchIntegration {
    ...
    public StandardSavingsIDBranchIntegration() {
        this.profile = new StandardSavingsIDProfile();
    }

    public StandardSavingsIDBranchIntegration(StandardSavingsIDProfile profile) {

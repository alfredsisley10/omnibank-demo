...
/**
 * State regulatory filing cadence for StandardSavings in Idaho.
 ...
 */
public final class StandardSavingsIDRegulatoryFilings {
    ...
    public StandardSavingsIDRegulatoryFilings() {
        this(new StandardSavingsIDProfile());
    }

    public StandardSavingsIDRegulatoryFilings(StandardSavingsIDProfile profile) {

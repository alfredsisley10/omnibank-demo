...
/**
 * State-specific rate table overlay for StandardSavings offered in Idaho.
 ...
 */
public final class StandardSavingsIDRateTable {
    ...
    public StandardSavingsIDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ID-StandardSavings-2026Q1";

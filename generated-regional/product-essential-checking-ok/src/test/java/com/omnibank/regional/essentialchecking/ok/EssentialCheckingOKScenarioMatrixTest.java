...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingOK jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingOKProfile},
 * {@link EssentialCheckingOKRateTable}, {@link EssentialCheckingOKDisclosures},
 * {@link EssentialCheckingOKRegulatoryFilings}, and {@link EssentialCheckingOKBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingOKProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingOKScenarioMatrixTest {

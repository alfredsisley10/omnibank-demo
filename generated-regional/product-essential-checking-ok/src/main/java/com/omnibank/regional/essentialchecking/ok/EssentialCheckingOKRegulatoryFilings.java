...
/**
 * State regulatory filing cadence for EssentialChecking in Oklahoma.
 ...
 */
public final class EssentialCheckingOKRegulatoryFilings {
    ...
    public EssentialCheckingOKRegulatoryFilings() {
        this(new EssentialCheckingOKProfile());
    }

    public EssentialCheckingOKRegulatoryFilings(EssentialCheckingOKProfile profile) {

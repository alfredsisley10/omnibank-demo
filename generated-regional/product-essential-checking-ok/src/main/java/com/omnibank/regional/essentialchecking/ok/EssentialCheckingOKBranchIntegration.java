...
/**
 * Branch / channel integration metadata for EssentialChecking in Oklahoma.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingOKBranchIntegration {
    ...
    public EssentialCheckingOKBranchIntegration() {
        this.profile = new EssentialCheckingOKProfile();
    }

    public EssentialCheckingOKBranchIntegration(EssentialCheckingOKProfile profile) {

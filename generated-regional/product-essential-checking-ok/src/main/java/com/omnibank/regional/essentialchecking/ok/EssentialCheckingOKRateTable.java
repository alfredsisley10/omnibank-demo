...
/**
 * State-specific rate table overlay for EssentialChecking offered in Oklahoma.
 ...
 */
public final class EssentialCheckingOKRateTable {
    ...
    public EssentialCheckingOKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OK-EssentialChecking-2026Q1";

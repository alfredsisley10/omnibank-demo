package com.omnibank.regional.essentialchecking.ok;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Oklahoma.
 ...
 */
public final class EssentialCheckingOKDisclosures {

    private final EssentialCheckingOKProfile profile;

    public EssentialCheckingOKDisclosures() {
        this.profile = new EssentialCheckingOKProfile();
    }

    public EssentialCheckingOKDisclosures(EssentialCheckingOKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Oklahoma State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in South Carolina (SC).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingSCProfile {
    ...
    public DigitalOnlyCheckingSCProfile() {
        this.stateCode = "SC";
        this.stateName = "South Carolina";
        this.region = "SOUTH";
        this.salesTaxRate = new BigDecimal("0.0600");
        this.fdicRegion = "ATLANTA";

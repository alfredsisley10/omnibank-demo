...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in South Carolina.
 ...
 */
public final class DigitalOnlyCheckingSCRateTable {
    ...
    public DigitalOnlyCheckingSCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SC-DigitalOnlyChecking-2026Q1";

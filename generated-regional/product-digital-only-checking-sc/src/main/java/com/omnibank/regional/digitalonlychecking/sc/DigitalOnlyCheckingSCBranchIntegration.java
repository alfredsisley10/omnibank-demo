...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in South Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingSCBranchIntegration {
    ...
    public DigitalOnlyCheckingSCBranchIntegration() {
        this.profile = new DigitalOnlyCheckingSCProfile();
    }

    public DigitalOnlyCheckingSCBranchIntegration(DigitalOnlyCheckingSCProfile profile) {

package com.omnibank.regional.digitalonlychecking.sc;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in South Carolina.
 ...
 */
public final class DigitalOnlyCheckingSCDisclosures {

    private final DigitalOnlyCheckingSCProfile profile;

    public DigitalOnlyCheckingSCDisclosures() {
        this.profile = new DigitalOnlyCheckingSCProfile();
    }

    public DigitalOnlyCheckingSCDisclosures(DigitalOnlyCheckingSCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — South Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

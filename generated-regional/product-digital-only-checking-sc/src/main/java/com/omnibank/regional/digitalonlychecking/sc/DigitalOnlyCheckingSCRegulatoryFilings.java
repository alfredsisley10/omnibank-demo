...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in South Carolina.
 ...
 */
public final class DigitalOnlyCheckingSCRegulatoryFilings {
    ...
    public DigitalOnlyCheckingSCRegulatoryFilings() {
        this(new DigitalOnlyCheckingSCProfile());
    }

    public DigitalOnlyCheckingSCRegulatoryFilings(DigitalOnlyCheckingSCProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                ...
                "South Carolina Condition Report",
                "QUARTERLY",
                dueDate,
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (South Carolina)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (South Carolina)",
                "ANNUAL",

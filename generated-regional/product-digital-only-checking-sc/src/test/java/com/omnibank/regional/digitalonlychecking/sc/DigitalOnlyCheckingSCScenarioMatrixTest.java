...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingSC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingSCProfile},
 * {@link DigitalOnlyCheckingSCRateTable}, {@link DigitalOnlyCheckingSCDisclosures},
 * {@link DigitalOnlyCheckingSCRegulatoryFilings}, and {@link DigitalOnlyCheckingSCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingSCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingSCScenarioMatrixTest {

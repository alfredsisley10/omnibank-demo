package com.omnibank.regional.digitalonlychecking.id;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Idaho.
 ...
 */
public final class DigitalOnlyCheckingIDDisclosures {

    private final DigitalOnlyCheckingIDProfile profile;

    public DigitalOnlyCheckingIDDisclosures() {
        this.profile = new DigitalOnlyCheckingIDProfile();
    }

    public DigitalOnlyCheckingIDDisclosures(DigitalOnlyCheckingIDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Idaho State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

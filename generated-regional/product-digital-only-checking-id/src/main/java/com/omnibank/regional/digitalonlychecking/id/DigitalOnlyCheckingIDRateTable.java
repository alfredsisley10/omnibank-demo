...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Idaho.
 ...
 */
public final class DigitalOnlyCheckingIDRateTable {
    ...
    public DigitalOnlyCheckingIDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ID-DigitalOnlyChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Idaho.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingIDBranchIntegration {
    ...
    public DigitalOnlyCheckingIDBranchIntegration() {
        this.profile = new DigitalOnlyCheckingIDProfile();
    }

    public DigitalOnlyCheckingIDBranchIntegration(DigitalOnlyCheckingIDProfile profile) {

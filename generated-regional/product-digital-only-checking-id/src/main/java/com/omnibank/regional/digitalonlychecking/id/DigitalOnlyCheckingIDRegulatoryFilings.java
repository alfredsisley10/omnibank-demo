...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Idaho.
 ...
 */
public final class DigitalOnlyCheckingIDRegulatoryFilings {
    ...
    public DigitalOnlyCheckingIDRegulatoryFilings() {
        this(new DigitalOnlyCheckingIDProfile());
    }

    public DigitalOnlyCheckingIDRegulatoryFilings(DigitalOnlyCheckingIDProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Idaho)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Idaho)",
                "ANNUAL",

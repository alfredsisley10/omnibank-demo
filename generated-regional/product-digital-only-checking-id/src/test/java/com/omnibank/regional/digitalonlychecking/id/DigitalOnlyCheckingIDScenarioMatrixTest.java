...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingID jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingIDProfile},
 * {@link DigitalOnlyCheckingIDRateTable}, {@link DigitalOnlyCheckingIDDisclosures},
 * {@link DigitalOnlyCheckingIDRegulatoryFilings}, and {@link DigitalOnlyCheckingIDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingIDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingIDScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNEProfile},
 * {@link DigitalOnlyCheckingNERateTable}, {@link DigitalOnlyCheckingNEDisclosures},
 * {@link DigitalOnlyCheckingNERegulatoryFilings}, and {@link DigitalOnlyCheckingNEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNEScenarioMatrixTest {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Nebraska (NE).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNEProfile {
    ...
    public DigitalOnlyCheckingNEProfile() {
        this.stateCode = "NE";
        this.stateName = "Nebraska";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0550");

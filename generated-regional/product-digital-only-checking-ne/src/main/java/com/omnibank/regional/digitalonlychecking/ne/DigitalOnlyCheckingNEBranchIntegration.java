...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Nebraska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNEBranchIntegration {
    ...
    public DigitalOnlyCheckingNEBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNEProfile();
    }

    public DigitalOnlyCheckingNEBranchIntegration(DigitalOnlyCheckingNEProfile profile) {

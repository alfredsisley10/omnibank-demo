...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Nebraska.
 ...
 */
public final class DigitalOnlyCheckingNEDisclosures {

    private final DigitalOnlyCheckingNEProfile profile;

    public DigitalOnlyCheckingNEDisclosures() {
        this.profile = new DigitalOnlyCheckingNEProfile();
    }

    public DigitalOnlyCheckingNEDisclosures(DigitalOnlyCheckingNEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Nebraska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

package com.omnibank.regional.digitalonlychecking.ne;
...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Nebraska.
 ...
 */
public final class DigitalOnlyCheckingNERegulatoryFilings {
    ...
    private final DigitalOnlyCheckingNEProfile profile;

    public DigitalOnlyCheckingNERegulatoryFilings() {
        this(new DigitalOnlyCheckingNEProfile());
    }

    public DigitalOnlyCheckingNERegulatoryFilings(DigitalOnlyCheckingNEProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Nebraska)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Nebraska)",
                "ANNUAL",

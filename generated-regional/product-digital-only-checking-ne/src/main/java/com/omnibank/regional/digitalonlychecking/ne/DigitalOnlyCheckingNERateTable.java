...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Nebraska.
 ...
 */
public final class DigitalOnlyCheckingNERateTable {
    ...
    public DigitalOnlyCheckingNERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NE-DigitalOnlyChecking-2026Q1";

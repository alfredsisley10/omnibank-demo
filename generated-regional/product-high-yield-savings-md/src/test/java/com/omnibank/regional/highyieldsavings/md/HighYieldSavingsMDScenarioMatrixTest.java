...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMDProfile},
 * {@link HighYieldSavingsMDRateTable}, {@link HighYieldSavingsMDDisclosures},
 * {@link HighYieldSavingsMDRegulatoryFilings}, and {@link HighYieldSavingsMDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMDScenarioMatrixTest {

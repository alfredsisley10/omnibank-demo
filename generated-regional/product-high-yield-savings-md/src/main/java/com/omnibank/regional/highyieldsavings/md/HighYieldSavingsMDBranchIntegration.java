...
/**
 * Branch / channel integration metadata for HighYieldSavings in Maryland.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMDBranchIntegration {
    ...
    public HighYieldSavingsMDBranchIntegration() {
        this.profile = new HighYieldSavingsMDProfile();
    }

    public HighYieldSavingsMDBranchIntegration(HighYieldSavingsMDProfile profile) {

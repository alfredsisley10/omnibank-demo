package com.omnibank.regional.highyieldsavings.md;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Maryland.
 ...
 */
public final class HighYieldSavingsMDDisclosures {

    private final HighYieldSavingsMDProfile profile;

    public HighYieldSavingsMDDisclosures() {
        this.profile = new HighYieldSavingsMDProfile();
    }

    public HighYieldSavingsMDDisclosures(HighYieldSavingsMDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Maryland State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

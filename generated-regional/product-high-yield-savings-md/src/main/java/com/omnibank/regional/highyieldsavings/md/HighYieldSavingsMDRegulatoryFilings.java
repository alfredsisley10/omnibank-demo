...
/**
 * State regulatory filing cadence for HighYieldSavings in Maryland.
 ...
 */
public final class HighYieldSavingsMDRegulatoryFilings {
    ...
    public HighYieldSavingsMDRegulatoryFilings() {
        this(new HighYieldSavingsMDProfile());
    }

    public HighYieldSavingsMDRegulatoryFilings(HighYieldSavingsMDProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Maryland.
 ...
 */
public final class HighYieldSavingsMDRateTable {
    ...
    public HighYieldSavingsMDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MD-HighYieldSavings-2026Q1";

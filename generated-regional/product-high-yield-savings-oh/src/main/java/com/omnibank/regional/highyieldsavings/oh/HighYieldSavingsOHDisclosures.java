package com.omnibank.regional.highyieldsavings.oh;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Ohio.
 ...
 */
public final class HighYieldSavingsOHDisclosures {

    private final HighYieldSavingsOHProfile profile;

    public HighYieldSavingsOHDisclosures() {
        this.profile = new HighYieldSavingsOHProfile();
    }

    public HighYieldSavingsOHDisclosures(HighYieldSavingsOHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Ohio State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for HighYieldSavings in Ohio.
 ...
 */
public final class HighYieldSavingsOHRegulatoryFilings {
    ...
    public HighYieldSavingsOHRegulatoryFilings() {
        this(new HighYieldSavingsOHProfile());
    }

    public HighYieldSavingsOHRegulatoryFilings(HighYieldSavingsOHProfile profile) {

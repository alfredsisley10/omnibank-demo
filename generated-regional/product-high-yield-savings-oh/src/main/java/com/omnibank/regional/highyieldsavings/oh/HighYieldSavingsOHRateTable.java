...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Ohio.
 ...
 */
public final class HighYieldSavingsOHRateTable {
    ...
    public HighYieldSavingsOHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OH-HighYieldSavings-2026Q1";

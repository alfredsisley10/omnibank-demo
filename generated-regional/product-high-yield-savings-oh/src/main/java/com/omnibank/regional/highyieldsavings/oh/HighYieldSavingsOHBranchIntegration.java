...
public final class HighYieldSavingsOHBranchIntegration {
    ...
    public HighYieldSavingsOHBranchIntegration() {
        this.profile = new HighYieldSavingsOHProfile();
    }

    public HighYieldSavingsOHBranchIntegration(HighYieldSavingsOHProfile profile) {

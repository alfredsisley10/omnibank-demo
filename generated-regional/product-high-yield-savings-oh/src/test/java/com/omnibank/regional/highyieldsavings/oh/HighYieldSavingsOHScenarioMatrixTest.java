...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsOH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsOHProfile},
 * {@link HighYieldSavingsOHRateTable}, {@link HighYieldSavingsOHDisclosures},
 * {@link HighYieldSavingsOHRegulatoryFilings}, and {@link HighYieldSavingsOHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsOHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsOHScenarioMatrixTest {

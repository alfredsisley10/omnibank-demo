...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsCT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsCTProfile},
 * {@link StandardSavingsCTRateTable}, {@link StandardSavingsCTDisclosures},
 * {@link StandardSavingsCTRegulatoryFilings}, and {@link StandardSavingsCTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsCTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsCTScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Connecticut.
 ...
 */
public final class StandardSavingsCTRateTable {
    ...
    public StandardSavingsCTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CT-StandardSavings-2026Q1";

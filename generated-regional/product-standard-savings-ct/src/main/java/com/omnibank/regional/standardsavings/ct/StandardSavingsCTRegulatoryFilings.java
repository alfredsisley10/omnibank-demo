...
/**
 * State regulatory filing cadence for StandardSavings in Connecticut.
 ...
 */
public final class StandardSavingsCTRegulatoryFilings {
    ...
    public StandardSavingsCTRegulatoryFilings() {
        this(new StandardSavingsCTProfile());
    }

    public StandardSavingsCTRegulatoryFilings(StandardSavingsCTProfile profile) {

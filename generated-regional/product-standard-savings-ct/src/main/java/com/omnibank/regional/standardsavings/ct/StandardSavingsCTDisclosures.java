package com.omnibank.regional.standardsavings.ct;
...
/**
 * State-specific disclosure overlays for StandardSavings in Connecticut.
 * Layered on top of the national disclosure, these capture
 * items that only apply under CT law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsCTDisclosures {

    private final StandardSavingsCTProfile profile;

    public StandardSavingsCTDisclosures() {
        this.profile = new StandardSavingsCTProfile();
    }

    public StandardSavingsCTDisclosures(StandardSavingsCTProfile profile) {
    ...
    public String stateHeader() {
        return "Connecticut Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Connecticut unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Connecticut law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Connecticut does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Connecticut State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

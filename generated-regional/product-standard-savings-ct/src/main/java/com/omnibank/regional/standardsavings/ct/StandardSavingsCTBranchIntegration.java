...
/**
 * Branch / channel integration metadata for StandardSavings in Connecticut.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsCTBranchIntegration {
    ...
    public StandardSavingsCTBranchIntegration() {
        this.profile = new StandardSavingsCTProfile();
    }

    public StandardSavingsCTBranchIntegration(StandardSavingsCTProfile profile) {

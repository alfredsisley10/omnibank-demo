...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsDE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsDEProfile},
 * {@link HighYieldSavingsDERateTable}, {@link HighYieldSavingsDEDisclosures},
 * {@link HighYieldSavingsDERegulatoryFilings}, and {@link HighYieldSavingsDEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsDEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsDEScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for HighYieldSavings in Delaware.
 ...
 */
public final class HighYieldSavingsDERegulatoryFilings {
    ...
    public HighYieldSavingsDERegulatoryFilings() {
        this(new HighYieldSavingsDEProfile());
    }

    public HighYieldSavingsDERegulatoryFilings(HighYieldSavingsDEProfile profile) {

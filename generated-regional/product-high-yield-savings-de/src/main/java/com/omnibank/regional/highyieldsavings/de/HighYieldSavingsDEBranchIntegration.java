...
/**
 * Branch / channel integration metadata for HighYieldSavings in Delaware.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsDEBranchIntegration {
    ...
    public HighYieldSavingsDEBranchIntegration() {
        this.profile = new HighYieldSavingsDEProfile();
    }

    public HighYieldSavingsDEBranchIntegration(HighYieldSavingsDEProfile profile) {

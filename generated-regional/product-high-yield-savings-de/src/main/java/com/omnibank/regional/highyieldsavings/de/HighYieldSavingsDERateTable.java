...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Delaware.
 ...
 */
public final class HighYieldSavingsDERateTable {
    ...
    public HighYieldSavingsDERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-DE-HighYieldSavings-2026Q1";

package com.omnibank.regional.highyieldsavings.de;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Delaware.
 ...
 */
public final class HighYieldSavingsDEDisclosures {

    private final HighYieldSavingsDEProfile profile;

    public HighYieldSavingsDEDisclosures() {
        this.profile = new HighYieldSavingsDEProfile();
    }

    public HighYieldSavingsDEDisclosures(HighYieldSavingsDEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Delaware State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

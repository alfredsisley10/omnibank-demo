package com.omnibank.regional.highyieldsavings.nm;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in New Mexico.
 ...
 */
public final class HighYieldSavingsNMDisclosures {

    private final HighYieldSavingsNMProfile profile;

    public HighYieldSavingsNMDisclosures() {
        this.profile = new HighYieldSavingsNMProfile();
    }

    public HighYieldSavingsNMDisclosures(HighYieldSavingsNMProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — New Mexico State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

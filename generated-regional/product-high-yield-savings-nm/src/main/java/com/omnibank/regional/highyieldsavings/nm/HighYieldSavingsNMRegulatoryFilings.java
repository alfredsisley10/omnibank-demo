...
/**
 * State regulatory filing cadence for HighYieldSavings in New Mexico.
 ...
 */
public final class HighYieldSavingsNMRegulatoryFilings {
    ...
    public HighYieldSavingsNMRegulatoryFilings() {
        this(new HighYieldSavingsNMProfile());
    }

    public HighYieldSavingsNMRegulatoryFilings(HighYieldSavingsNMProfile profile) {

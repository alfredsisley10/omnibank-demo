...
/**
 * State-specific rate table overlay for HighYieldSavings offered in New Mexico.
 ...
 */
public final class HighYieldSavingsNMRateTable {
    ...
    public HighYieldSavingsNMRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NM-HighYieldSavings-2026Q1";

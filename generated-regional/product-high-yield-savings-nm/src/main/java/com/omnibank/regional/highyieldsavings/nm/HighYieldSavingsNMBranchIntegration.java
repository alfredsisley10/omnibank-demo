...
/**
 * Branch / channel integration metadata for HighYieldSavings in New Mexico.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNMBranchIntegration {
    ...
    public HighYieldSavingsNMBranchIntegration() {
        this.profile = new HighYieldSavingsNMProfile();
    }

    public HighYieldSavingsNMBranchIntegration(HighYieldSavingsNMProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNM jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNMProfile},
 * {@link HighYieldSavingsNMRateTable}, {@link HighYieldSavingsNMDisclosures},
 * {@link HighYieldSavingsNMRegulatoryFilings}, and {@link HighYieldSavingsNMBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNMProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNMScenarioMatrixTest {

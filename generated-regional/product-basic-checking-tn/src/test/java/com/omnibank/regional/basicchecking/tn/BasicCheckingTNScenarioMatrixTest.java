...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingTN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingTNProfile},
 * {@link BasicCheckingTNRateTable}, {@link BasicCheckingTNDisclosures},
 * {@link BasicCheckingTNRegulatoryFilings}, and {@link BasicCheckingTNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingTNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingTNScenarioMatrixTest {

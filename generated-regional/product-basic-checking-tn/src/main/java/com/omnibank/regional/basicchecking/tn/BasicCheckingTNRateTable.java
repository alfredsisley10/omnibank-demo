...
/**
 * State-specific rate table overlay for BasicChecking offered in Tennessee.
 ...
 */
public final class BasicCheckingTNRateTable {
    ...
    public BasicCheckingTNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TN-BasicChecking-2026Q1";

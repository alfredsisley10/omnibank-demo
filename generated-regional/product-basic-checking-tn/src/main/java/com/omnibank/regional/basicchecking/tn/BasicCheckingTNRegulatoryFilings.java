...
/**
 * State regulatory filing cadence for BasicChecking in Tennessee.
 ...
 */
public final class BasicCheckingTNRegulatoryFilings {
    ...
    public BasicCheckingTNRegulatoryFilings() {
        this(new BasicCheckingTNProfile());
    }

    public BasicCheckingTNRegulatoryFilings(BasicCheckingTNProfile profile) {

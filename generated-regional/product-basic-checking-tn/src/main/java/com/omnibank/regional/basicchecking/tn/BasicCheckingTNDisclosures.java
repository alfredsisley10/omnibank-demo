package com.omnibank.regional.basicchecking.tn;
...
/**
 * State-specific disclosure overlays for BasicChecking in Tennessee.
 ...
 */
public final class BasicCheckingTNDisclosures {

    private final BasicCheckingTNProfile profile;

    public BasicCheckingTNDisclosures() {
        this.profile = new BasicCheckingTNProfile();
    }

    public BasicCheckingTNDisclosures(BasicCheckingTNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Tennessee State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

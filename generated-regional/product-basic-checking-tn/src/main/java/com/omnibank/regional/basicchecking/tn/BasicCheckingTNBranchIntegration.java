...
public final class BasicCheckingTNBranchIntegration {
    ...
    public BasicCheckingTNBranchIntegration() {
        this.profile = new BasicCheckingTNProfile();
    }

    public BasicCheckingTNBranchIntegration(BasicCheckingTNProfile profile) {

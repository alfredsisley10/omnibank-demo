...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNHProfile},
 * {@link DigitalOnlyCheckingNHRateTable}, {@link DigitalOnlyCheckingNHDisclosures},
 * {@link DigitalOnlyCheckingNHRegulatoryFilings}, and {@link DigitalOnlyCheckingNHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNHScenarioMatrixTest {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in New Hampshire (NH).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNHProfile {
    ...
    public DigitalOnlyCheckingNHProfile() {
        this.stateCode = "NH";

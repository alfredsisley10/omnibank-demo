...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in New Hampshire.
 ...
 */
public final class DigitalOnlyCheckingNHRateTable {
    ...
    public DigitalOnlyCheckingNHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NH-DigitalOnlyChecking-2026Q1";

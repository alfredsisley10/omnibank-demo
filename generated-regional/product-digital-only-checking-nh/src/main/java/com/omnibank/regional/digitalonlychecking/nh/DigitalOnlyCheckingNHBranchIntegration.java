...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in New Hampshire.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNHBranchIntegration {
    ...
    public DigitalOnlyCheckingNHBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNHProfile();
    }

    public DigitalOnlyCheckingNHBranchIntegration(DigitalOnlyCheckingNHProfile profile) {

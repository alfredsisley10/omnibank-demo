...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in New Hampshire.
 ...
 */
public final class DigitalOnlyCheckingNHDisclosures {

    private final DigitalOnlyCheckingNHProfile profile;

    public DigitalOnlyCheckingNHDisclosures() {
        this.profile = new DigitalOnlyCheckingNHProfile();
    }

    public DigitalOnlyCheckingNHDisclosures(DigitalOnlyCheckingNHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — New Hampshire State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

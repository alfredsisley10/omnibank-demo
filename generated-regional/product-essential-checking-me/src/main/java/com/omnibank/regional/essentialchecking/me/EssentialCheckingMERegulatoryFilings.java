...
/**
 * State regulatory filing cadence for EssentialChecking in Maine.
 ...
 */
public final class EssentialCheckingMERegulatoryFilings {
    ...
    public EssentialCheckingMERegulatoryFilings() {
        this(new EssentialCheckingMEProfile());
    }

    public EssentialCheckingMERegulatoryFilings(EssentialCheckingMEProfile profile) {

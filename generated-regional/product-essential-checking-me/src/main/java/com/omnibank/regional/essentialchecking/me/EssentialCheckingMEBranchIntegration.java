...
/**
 * Branch / channel integration metadata for EssentialChecking in Maine.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMEBranchIntegration {
    ...
    public EssentialCheckingMEBranchIntegration() {
        this.profile = new EssentialCheckingMEProfile();
    }

    public EssentialCheckingMEBranchIntegration(EssentialCheckingMEProfile profile) {

...
/**
 * State-specific disclosure overlays for EssentialChecking in Maine.
 ...
 */
public final class EssentialCheckingMEDisclosures {

    private final EssentialCheckingMEProfile profile;

    public EssentialCheckingMEDisclosures() {
        this.profile = new EssentialCheckingMEProfile();
    }

    public EssentialCheckingMEDisclosures(EssentialCheckingMEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Maine State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

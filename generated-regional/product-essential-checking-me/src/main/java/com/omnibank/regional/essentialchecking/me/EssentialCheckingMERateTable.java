...
/**
 * State-specific rate table overlay for EssentialChecking offered in Maine.
 ...
 */
public final class EssentialCheckingMERateTable {
    ...
    public EssentialCheckingMERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ME-EssentialChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingWI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingWIProfile},
 * {@link BasicCheckingWIRateTable}, {@link BasicCheckingWIDisclosures},
 * {@link BasicCheckingWIRegulatoryFilings}, and {@link BasicCheckingWIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingWIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingWIScenarioMatrixTest {

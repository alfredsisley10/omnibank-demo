...
public final class BasicCheckingWIBranchIntegration {
    ...
    public BasicCheckingWIBranchIntegration() {
        this.profile = new BasicCheckingWIProfile();
    }

    public BasicCheckingWIBranchIntegration(BasicCheckingWIProfile profile) {

...
/**
 * State regulatory filing cadence for BasicChecking in Wisconsin.
 ...
 */
public final class BasicCheckingWIRegulatoryFilings {
    ...
    public BasicCheckingWIRegulatoryFilings() {
        this(new BasicCheckingWIProfile());
    }

    public BasicCheckingWIRegulatoryFilings(BasicCheckingWIProfile profile) {

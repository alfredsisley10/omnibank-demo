...
/**
 * State-specific rate table overlay for BasicChecking offered in Wisconsin.
 ...
 */
public final class BasicCheckingWIRateTable {
    ...
    public BasicCheckingWIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WI-BasicChecking-2026Q1";

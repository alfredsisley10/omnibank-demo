package com.omnibank.regional.basicchecking.wi;
...
/**
 * State-specific disclosure overlays for BasicChecking in Wisconsin.
 ...
 */
public final class BasicCheckingWIDisclosures {

    private final BasicCheckingWIProfile profile;

    public BasicCheckingWIDisclosures() {
        this.profile = new BasicCheckingWIProfile();
    }

    public BasicCheckingWIDisclosures(BasicCheckingWIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Wisconsin State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

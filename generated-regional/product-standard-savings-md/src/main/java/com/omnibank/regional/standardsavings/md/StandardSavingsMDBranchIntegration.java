...
/**
 * Branch / channel integration metadata for StandardSavings in Maryland.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMDBranchIntegration {
    ...
    public StandardSavingsMDBranchIntegration() {
        this.profile = new StandardSavingsMDProfile();
    }

    public StandardSavingsMDBranchIntegration(StandardSavingsMDProfile profile) {

...
/**
 * State regulatory filing cadence for StandardSavings in Maryland.
 ...
 */
public final class StandardSavingsMDRegulatoryFilings {
    ...
    public StandardSavingsMDRegulatoryFilings() {
        this(new StandardSavingsMDProfile());
    }

    public StandardSavingsMDRegulatoryFilings(StandardSavingsMDProfile profile) {

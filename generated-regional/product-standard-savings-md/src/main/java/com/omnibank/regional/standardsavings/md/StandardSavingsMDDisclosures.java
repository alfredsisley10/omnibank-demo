package com.omnibank.regional.standardsavings.md;
...
/**
 * State-specific disclosure overlays for StandardSavings in Maryland.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MD law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsMDDisclosures {

    private final StandardSavingsMDProfile profile;

    public StandardSavingsMDDisclosures() {
        this.profile = new StandardSavingsMDProfile();
    }

    public StandardSavingsMDDisclosures(StandardSavingsMDProfile profile) {
    ...
    public String stateHeader() {
        return "Maryland Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Maryland unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Maryland law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Maryland does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Maryland State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

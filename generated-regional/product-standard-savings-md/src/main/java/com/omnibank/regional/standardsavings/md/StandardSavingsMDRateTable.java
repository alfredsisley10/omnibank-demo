...
/**
 * State-specific rate table overlay for StandardSavings offered in Maryland.
 ...
 */
public final class StandardSavingsMDRateTable {
    ...
    public StandardSavingsMDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MD-StandardSavings-2026Q1";

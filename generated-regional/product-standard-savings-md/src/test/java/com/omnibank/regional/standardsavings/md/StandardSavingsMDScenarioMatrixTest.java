...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMDProfile},
 * {@link StandardSavingsMDRateTable}, {@link StandardSavingsMDDisclosures},
 * {@link StandardSavingsMDRegulatoryFilings}, and {@link StandardSavingsMDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMDScenarioMatrixTest {

...
class DigitalOnlyCheckingILProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingILProfile();
        assertThat(p.stateCode()).isEqualTo("IL");
        assertThat(p.stateName()).isEqualTo("Illinois");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingILRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingILDisclosures();
        assertThat(d.renderFullSupplement()).contains("Illinois");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingILRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingILBranchIntegration();

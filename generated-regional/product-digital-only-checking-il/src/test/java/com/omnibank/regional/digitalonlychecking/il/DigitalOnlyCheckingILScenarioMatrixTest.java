...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingIL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingILProfile},
 * {@link DigitalOnlyCheckingILRateTable}, {@link DigitalOnlyCheckingILDisclosures},
 * {@link DigitalOnlyCheckingILRegulatoryFilings}, and {@link DigitalOnlyCheckingILBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingILProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingILScenarioMatrixTest {

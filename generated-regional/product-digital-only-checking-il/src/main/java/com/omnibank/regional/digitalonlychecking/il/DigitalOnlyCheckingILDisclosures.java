package com.omnibank.regional.digitalonlychecking.il;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Illinois.
 ...
 */
public final class DigitalOnlyCheckingILDisclosures {

    private final DigitalOnlyCheckingILProfile profile;

    public DigitalOnlyCheckingILDisclosures() {
        this.profile = new DigitalOnlyCheckingILProfile();
    }

    public DigitalOnlyCheckingILDisclosures(DigitalOnlyCheckingILProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Illinois State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

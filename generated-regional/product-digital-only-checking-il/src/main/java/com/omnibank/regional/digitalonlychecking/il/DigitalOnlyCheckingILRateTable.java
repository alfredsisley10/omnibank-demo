...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Illinois.
 ...
 */
public final class DigitalOnlyCheckingILRateTable {
    ...
    public DigitalOnlyCheckingILRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IL-DigitalOnlyChecking-2026Q1";

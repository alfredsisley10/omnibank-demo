...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Illinois (IL).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingILProfile {
    ...
    public DigitalOnlyCheckingILProfile() {
        this.stateCode = "IL";
        this.stateName = "Illinois";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0625");

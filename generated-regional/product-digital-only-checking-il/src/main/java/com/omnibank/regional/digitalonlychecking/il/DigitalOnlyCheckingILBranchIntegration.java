...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Illinois.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingILBranchIntegration {
    ...
    public DigitalOnlyCheckingILBranchIntegration() {
        this.profile = new DigitalOnlyCheckingILProfile();
    }

    public DigitalOnlyCheckingILBranchIntegration(DigitalOnlyCheckingILProfile profile) {

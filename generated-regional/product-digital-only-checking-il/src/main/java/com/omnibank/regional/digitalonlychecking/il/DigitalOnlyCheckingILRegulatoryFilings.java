...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Illinois.
 ...
 */
public final class DigitalOnlyCheckingILRegulatoryFilings {
    ...
    public DigitalOnlyCheckingILRegulatoryFilings() {
        this(new DigitalOnlyCheckingILProfile());
    }

    public DigitalOnlyCheckingILRegulatoryFilings(DigitalOnlyCheckingILProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Illinois)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Illinois)",
                "ANNUAL",

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNYProfile},
 * {@link StandardSavingsNYRateTable}, {@link StandardSavingsNYDisclosures},
 * {@link StandardSavingsNYRegulatoryFilings}, and {@link StandardSavingsNYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNYScenarioMatrixTest {

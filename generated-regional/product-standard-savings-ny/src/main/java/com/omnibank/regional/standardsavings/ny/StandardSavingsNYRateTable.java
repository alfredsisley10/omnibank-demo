...
/**
 * State-specific rate table overlay for StandardSavings offered in New York.
 ...
 */
public final class StandardSavingsNYRateTable {
    ...
    public StandardSavingsNYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NY-StandardSavings-2026Q1";

...
/**
 * State-specific disclosure overlays for StandardSavings in New York.
 * Layered on top of the national disclosure, these capture
 * items that only apply under NY law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsNYDisclosures {

    private final StandardSavingsNYProfile profile;

    public StandardSavingsNYDisclosures() {
        this.profile = new StandardSavingsNYProfile();
    }

    public StandardSavingsNYDisclosures(StandardSavingsNYProfile profile) {
    ...
    public String stateHeader() {
        return "New York Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "New York unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by New York law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "New York does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — New York State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

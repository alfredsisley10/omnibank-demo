...
/**
 * State regulatory filing cadence for StandardSavings in New York.
 ...
 */
public final class StandardSavingsNYRegulatoryFilings {
    ...
    public StandardSavingsNYRegulatoryFilings() {
        this(new StandardSavingsNYProfile());
    }

    public StandardSavingsNYRegulatoryFilings(StandardSavingsNYProfile profile) {

...
/**
 * Branch / channel integration metadata for StandardSavings in New York.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNYBranchIntegration {
    ...
    public StandardSavingsNYBranchIntegration() {
        this.profile = new StandardSavingsNYProfile();
    }

    public StandardSavingsNYBranchIntegration(StandardSavingsNYProfile profile) {

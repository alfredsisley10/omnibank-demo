...
/**
 * State-specific rate table overlay for StandardSavings offered in Georgia.
 ...
 */
public final class StandardSavingsGARateTable {
    ...
    public StandardSavingsGARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-GA-StandardSavings-2026Q1";

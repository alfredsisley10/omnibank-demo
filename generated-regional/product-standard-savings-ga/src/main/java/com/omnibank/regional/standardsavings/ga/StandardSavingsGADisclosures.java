package com.omnibank.regional.standardsavings.ga;
...
/**
 * State-specific disclosure overlays for StandardSavings in Georgia.
 * Layered on top of the national disclosure, these capture
 * items that only apply under GA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsGADisclosures {

    private final StandardSavingsGAProfile profile;

    public StandardSavingsGADisclosures() {
        this.profile = new StandardSavingsGAProfile();
    }

    public StandardSavingsGADisclosures(StandardSavingsGAProfile profile) {
    ...
    public String stateHeader() {
        return "Georgia Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Georgia unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Georgia law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Georgia does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Georgia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
public final class StandardSavingsGABranchIntegration {
    ...
    public StandardSavingsGABranchIntegration() {
        this.profile = new StandardSavingsGAProfile();
    }

    public StandardSavingsGABranchIntegration(StandardSavingsGAProfile profile) {

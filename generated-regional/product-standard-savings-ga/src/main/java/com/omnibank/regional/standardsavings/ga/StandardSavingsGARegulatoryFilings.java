...
/**
 * State regulatory filing cadence for StandardSavings in Georgia.
 ...
 */
public final class StandardSavingsGARegulatoryFilings {
    ...
    public StandardSavingsGARegulatoryFilings() {
        this(new StandardSavingsGAProfile());
    }

    public StandardSavingsGARegulatoryFilings(StandardSavingsGAProfile profile) {

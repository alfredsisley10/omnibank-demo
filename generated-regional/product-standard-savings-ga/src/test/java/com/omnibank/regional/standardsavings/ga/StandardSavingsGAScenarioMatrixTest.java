...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsGA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsGAProfile},
 * {@link StandardSavingsGARateTable}, {@link StandardSavingsGADisclosures},
 * {@link StandardSavingsGARegulatoryFilings}, and {@link StandardSavingsGABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsGAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsGAScenarioMatrixTest {

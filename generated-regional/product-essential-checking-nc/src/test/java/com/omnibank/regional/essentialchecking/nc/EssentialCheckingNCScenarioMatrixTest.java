...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNCProfile},
 * {@link EssentialCheckingNCRateTable}, {@link EssentialCheckingNCDisclosures},
 * {@link EssentialCheckingNCRegulatoryFilings}, and {@link EssentialCheckingNCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNCScenarioMatrixTest {

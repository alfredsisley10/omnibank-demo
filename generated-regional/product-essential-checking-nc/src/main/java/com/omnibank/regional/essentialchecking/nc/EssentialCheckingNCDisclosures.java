...
/**
 * State-specific disclosure overlays for EssentialChecking in North Carolina.
 ...
 */
public final class EssentialCheckingNCDisclosures {

    private final EssentialCheckingNCProfile profile;

    public EssentialCheckingNCDisclosures() {
        this.profile = new EssentialCheckingNCProfile();
    }

    public EssentialCheckingNCDisclosures(EssentialCheckingNCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — North Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

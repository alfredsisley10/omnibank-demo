...
/**
 * State regulatory filing cadence for EssentialChecking in North Carolina.
 ...
 */
public final class EssentialCheckingNCRegulatoryFilings {
    ...
    private final EssentialCheckingNCProfile profile;

    public EssentialCheckingNCRegulatoryFilings() {
        this(new EssentialCheckingNCProfile());
    }

    public EssentialCheckingNCRegulatoryFilings(EssentialCheckingNCProfile profile) {

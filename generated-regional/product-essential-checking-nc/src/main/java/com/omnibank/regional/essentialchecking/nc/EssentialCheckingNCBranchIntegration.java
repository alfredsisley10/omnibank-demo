...
/**
 * Branch / channel integration metadata for EssentialChecking in North Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNCBranchIntegration {
    ...
    public EssentialCheckingNCBranchIntegration() {
        this.profile = new EssentialCheckingNCProfile();
    }

    public EssentialCheckingNCBranchIntegration(EssentialCheckingNCProfile profile) {

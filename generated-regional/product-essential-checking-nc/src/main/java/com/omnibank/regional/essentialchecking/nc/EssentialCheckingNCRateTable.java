...
/**
 * State-specific rate table overlay for EssentialChecking offered in North Carolina.
 ...
 */
public final class EssentialCheckingNCRateTable {
    ...
    public EssentialCheckingNCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NC-EssentialChecking-2026Q1";

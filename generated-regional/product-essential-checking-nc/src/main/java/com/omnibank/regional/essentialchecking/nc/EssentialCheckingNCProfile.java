...
/**
 * Jurisdiction profile for EssentialChecking as offered in North Carolina (NC).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingNCProfile {
    ...
    public EssentialCheckingNCProfile() {
        this.stateCode = "NC";

package com.omnibank.regional.digitalonlychecking.ct;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Connecticut.
 ...
 */
public final class DigitalOnlyCheckingCTDisclosures {

    private final DigitalOnlyCheckingCTProfile profile;

    public DigitalOnlyCheckingCTDisclosures() {
        this.profile = new DigitalOnlyCheckingCTProfile();
    }

    public DigitalOnlyCheckingCTDisclosures(DigitalOnlyCheckingCTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Connecticut State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

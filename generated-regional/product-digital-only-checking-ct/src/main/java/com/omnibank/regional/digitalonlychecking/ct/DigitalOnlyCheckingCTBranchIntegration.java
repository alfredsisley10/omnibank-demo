...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Connecticut.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingCTBranchIntegration {
    ...
    public DigitalOnlyCheckingCTBranchIntegration() {
        this.profile = new DigitalOnlyCheckingCTProfile();
    }

    public DigitalOnlyCheckingCTBranchIntegration(DigitalOnlyCheckingCTProfile profile) {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Connecticut (CT).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingCTProfile {
    ...
    public DigitalOnlyCheckingCTProfile() {
        this.stateCode = "CT";

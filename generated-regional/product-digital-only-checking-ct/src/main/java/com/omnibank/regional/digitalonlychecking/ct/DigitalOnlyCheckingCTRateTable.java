...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Connecticut.
 ...
 */
public final class DigitalOnlyCheckingCTRateTable {
    ...
    public DigitalOnlyCheckingCTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CT-DigitalOnlyChecking-2026Q1";

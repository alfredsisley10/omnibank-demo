...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Connecticut.
 ...
 */
public final class DigitalOnlyCheckingCTRegulatoryFilings {
    ...
    public DigitalOnlyCheckingCTRegulatoryFilings() {
        this(new DigitalOnlyCheckingCTProfile());
    }

    public DigitalOnlyCheckingCTRegulatoryFilings(DigitalOnlyCheckingCTProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Connecticut)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Connecticut)",
                "ANNUAL",

...
class DigitalOnlyCheckingCTProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingCTProfile();
        assertThat(p.stateCode()).isEqualTo("CT");
        assertThat(p.stateName()).isEqualTo("Connecticut");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingCTRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingCTDisclosures();
        assertThat(d.renderFullSupplement()).contains("Connecticut");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingCTRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingCTBranchIntegration();

...
/**
 * State regulatory filing cadence for HighYieldSavings in Maine.
 ...
 */
public final class HighYieldSavingsMERegulatoryFilings {
    ...
    public HighYieldSavingsMERegulatoryFilings() {
        this(new HighYieldSavingsMEProfile());
    }

    public HighYieldSavingsMERegulatoryFilings(HighYieldSavingsMEProfile profile) {

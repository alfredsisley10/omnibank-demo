...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Maine.
 ...
 */
public final class HighYieldSavingsMERateTable {
    ...
    public HighYieldSavingsMERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ME-HighYieldSavings-2026Q1";

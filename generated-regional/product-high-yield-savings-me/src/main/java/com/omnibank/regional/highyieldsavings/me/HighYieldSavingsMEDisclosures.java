package com.omnibank.regional.highyieldsavings.me;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Maine.
 ...
 */
public final class HighYieldSavingsMEDisclosures {

    private final HighYieldSavingsMEProfile profile;

    public HighYieldSavingsMEDisclosures() {
        this.profile = new HighYieldSavingsMEProfile();
    }

    public HighYieldSavingsMEDisclosures(HighYieldSavingsMEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Maine State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

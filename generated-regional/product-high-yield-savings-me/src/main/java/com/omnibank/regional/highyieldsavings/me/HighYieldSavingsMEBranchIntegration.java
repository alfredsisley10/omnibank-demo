...
public final class HighYieldSavingsMEBranchIntegration {
    ...
    public HighYieldSavingsMEBranchIntegration() {
        this.profile = new HighYieldSavingsMEProfile();
    }

    public HighYieldSavingsMEBranchIntegration(HighYieldSavingsMEProfile profile) {

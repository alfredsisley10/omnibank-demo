...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsME jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMEProfile},
 * {@link HighYieldSavingsMERateTable}, {@link HighYieldSavingsMEDisclosures},
 * {@link HighYieldSavingsMERegulatoryFilings}, and {@link HighYieldSavingsMEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMEScenarioMatrixTest {

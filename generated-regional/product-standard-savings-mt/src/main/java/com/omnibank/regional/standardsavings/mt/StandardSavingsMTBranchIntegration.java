...
public final class StandardSavingsMTBranchIntegration {
    ...
    public StandardSavingsMTBranchIntegration() {
        this.profile = new StandardSavingsMTProfile();
    }

    public StandardSavingsMTBranchIntegration(StandardSavingsMTProfile profile) {

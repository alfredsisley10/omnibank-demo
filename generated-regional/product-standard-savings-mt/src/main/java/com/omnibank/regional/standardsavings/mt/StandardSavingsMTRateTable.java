...
/**
 * State-specific rate table overlay for StandardSavings offered in Montana.
 ...
 */
public final class StandardSavingsMTRateTable {
    ...
    public StandardSavingsMTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MT-StandardSavings-2026Q1";

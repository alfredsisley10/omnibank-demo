...
/**
 * State-specific disclosure overlays for StandardSavings in Montana.
 ...
 */
public final class StandardSavingsMTDisclosures {

    private final StandardSavingsMTProfile profile;

    public StandardSavingsMTDisclosures() {
        this.profile = new StandardSavingsMTProfile();
    }

    public StandardSavingsMTDisclosures(StandardSavingsMTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Montana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

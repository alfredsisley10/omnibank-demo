...
/**
 * State regulatory filing cadence for StandardSavings in Montana.
 ...
 */
public final class StandardSavingsMTRegulatoryFilings {
    ...
    public StandardSavingsMTRegulatoryFilings() {
        this(new StandardSavingsMTProfile());
    }

    public StandardSavingsMTRegulatoryFilings(StandardSavingsMTProfile profile) {

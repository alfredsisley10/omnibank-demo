...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMTProfile},
 * {@link StandardSavingsMTRateTable}, {@link StandardSavingsMTDisclosures},
 * {@link StandardSavingsMTRegulatoryFilings}, and {@link StandardSavingsMTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMTScenarioMatrixTest {

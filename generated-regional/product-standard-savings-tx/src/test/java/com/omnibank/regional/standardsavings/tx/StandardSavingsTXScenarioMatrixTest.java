...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsTX jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsTXProfile},
 * {@link StandardSavingsTXRateTable}, {@link StandardSavingsTXDisclosures},
 * {@link StandardSavingsTXRegulatoryFilings}, and {@link StandardSavingsTXBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsTXProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsTXScenarioMatrixTest {

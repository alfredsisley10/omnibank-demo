...
public final class StandardSavingsTXBranchIntegration {
    ...
    public StandardSavingsTXBranchIntegration() {
        this.profile = new StandardSavingsTXProfile();
    }

    public StandardSavingsTXBranchIntegration(StandardSavingsTXProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Texas.
 ...
 */
public final class StandardSavingsTXRateTable {
    ...
    public StandardSavingsTXRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TX-StandardSavings-2026Q1";

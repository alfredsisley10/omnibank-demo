package com.omnibank.regional.standardsavings.tx;
...
/**
 * State-specific disclosure overlays for StandardSavings in Texas.
 * Layered on top of the national disclosure, these capture
 * items that only apply under TX law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsTXDisclosures {

    private final StandardSavingsTXProfile profile;

    public StandardSavingsTXDisclosures() {
        this.profile = new StandardSavingsTXProfile();
    }

    public StandardSavingsTXDisclosures(StandardSavingsTXProfile profile) {
    ...
    public String stateHeader() {
        return "Texas Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Texas unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Texas law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Texas does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Texas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

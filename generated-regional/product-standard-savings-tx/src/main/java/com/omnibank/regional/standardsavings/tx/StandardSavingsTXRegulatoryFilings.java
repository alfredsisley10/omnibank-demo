...
/**
 * State regulatory filing cadence for StandardSavings in Texas.
 ...
 */
public final class StandardSavingsTXRegulatoryFilings {
    ...
    public StandardSavingsTXRegulatoryFilings() {
        this(new StandardSavingsTXProfile());
    }

    public StandardSavingsTXRegulatoryFilings(StandardSavingsTXProfile profile) {

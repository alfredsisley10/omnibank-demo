package com.omnibank.regional.basicchecking.nd;
...
/**
 * State-specific disclosure overlays for BasicChecking in North Dakota.
 ...
 */
public final class BasicCheckingNDDisclosures {

    private final BasicCheckingNDProfile profile;

    public BasicCheckingNDDisclosures() {
        this.profile = new BasicCheckingNDProfile();
    }

    public BasicCheckingNDDisclosures(BasicCheckingNDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — North Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

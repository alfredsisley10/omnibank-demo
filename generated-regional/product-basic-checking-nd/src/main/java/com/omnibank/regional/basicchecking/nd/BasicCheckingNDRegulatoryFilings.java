...
/**
 * State regulatory filing cadence for BasicChecking in North Dakota.
 ...
 */
public final class BasicCheckingNDRegulatoryFilings {
    ...
    public BasicCheckingNDRegulatoryFilings() {
        this(new BasicCheckingNDProfile());
    }

    public BasicCheckingNDRegulatoryFilings(BasicCheckingNDProfile profile) {

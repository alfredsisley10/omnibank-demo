...
/**
 * State-specific rate table overlay for BasicChecking offered in North Dakota.
 ...
 */
public final class BasicCheckingNDRateTable {
    ...
    public BasicCheckingNDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ND-BasicChecking-2026Q1";

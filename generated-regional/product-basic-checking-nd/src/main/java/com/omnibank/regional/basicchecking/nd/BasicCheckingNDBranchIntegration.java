...
/**
 * Branch / channel integration metadata for BasicChecking in North Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingNDBranchIntegration {
    ...
    public BasicCheckingNDBranchIntegration() {
        this.profile = new BasicCheckingNDProfile();
    }

    public BasicCheckingNDBranchIntegration(BasicCheckingNDProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingND jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNDProfile},
 * {@link BasicCheckingNDRateTable}, {@link BasicCheckingNDDisclosures},
 * {@link BasicCheckingNDRegulatoryFilings}, and {@link BasicCheckingNDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNDScenarioMatrixTest {

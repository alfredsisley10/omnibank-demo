...
public final class HighYieldSavingsUTBranchIntegration {
    ...
    public HighYieldSavingsUTBranchIntegration() {
        this.profile = new HighYieldSavingsUTProfile();
    }

    public HighYieldSavingsUTBranchIntegration(HighYieldSavingsUTProfile profile) {

package com.omnibank.regional.highyieldsavings.ut;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Utah.
 ...
 */
public final class HighYieldSavingsUTDisclosures {

    private final HighYieldSavingsUTProfile profile;

    public HighYieldSavingsUTDisclosures() {
        this.profile = new HighYieldSavingsUTProfile();
    }

    public HighYieldSavingsUTDisclosures(HighYieldSavingsUTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Utah State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

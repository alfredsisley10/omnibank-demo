...
/**
 * State regulatory filing cadence for HighYieldSavings in Utah.
 ...
 */
public final class HighYieldSavingsUTRegulatoryFilings {
    ...
    public HighYieldSavingsUTRegulatoryFilings() {
        this(new HighYieldSavingsUTProfile());
    }

    public HighYieldSavingsUTRegulatoryFilings(HighYieldSavingsUTProfile profile) {

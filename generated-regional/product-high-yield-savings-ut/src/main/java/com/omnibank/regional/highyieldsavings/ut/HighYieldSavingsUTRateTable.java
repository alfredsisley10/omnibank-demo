...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Utah.
 ...
 */
public final class HighYieldSavingsUTRateTable {
    ...
    public HighYieldSavingsUTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-UT-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsUT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsUTProfile},
 * {@link HighYieldSavingsUTRateTable}, {@link HighYieldSavingsUTDisclosures},
 * {@link HighYieldSavingsUTRegulatoryFilings}, and {@link HighYieldSavingsUTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsUTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsUTScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for StandardSavings in Vermont.
 ...
 */
public final class StandardSavingsVTRegulatoryFilings {
    ...
    public StandardSavingsVTRegulatoryFilings() {
        this(new StandardSavingsVTProfile());
    }

    public StandardSavingsVTRegulatoryFilings(StandardSavingsVTProfile profile) {

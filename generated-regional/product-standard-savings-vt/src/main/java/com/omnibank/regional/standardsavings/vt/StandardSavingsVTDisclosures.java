package com.omnibank.regional.standardsavings.vt;
...
/**
 * State-specific disclosure overlays for StandardSavings in Vermont.
 * Layered on top of the national disclosure, these capture
 * items that only apply under VT law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsVTDisclosures {

    private final StandardSavingsVTProfile profile;

    public StandardSavingsVTDisclosures() {
        this.profile = new StandardSavingsVTProfile();
    }

    public StandardSavingsVTDisclosures(StandardSavingsVTProfile profile) {
    ...
    public String stateHeader() {
        return "Vermont Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Vermont unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Vermont law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Vermont does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Vermont State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

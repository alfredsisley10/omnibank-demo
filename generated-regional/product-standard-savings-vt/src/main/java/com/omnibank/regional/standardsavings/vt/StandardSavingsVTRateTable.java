...
/**
 * State-specific rate table overlay for StandardSavings offered in Vermont.
 ...
 */
public final class StandardSavingsVTRateTable {
    ...
    public StandardSavingsVTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VT-StandardSavings-2026Q1";

...
public final class StandardSavingsVTBranchIntegration {
    ...
    public StandardSavingsVTBranchIntegration() {
        this.profile = new StandardSavingsVTProfile();
    }

    public StandardSavingsVTBranchIntegration(StandardSavingsVTProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsVT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsVTProfile},
 * {@link StandardSavingsVTRateTable}, {@link StandardSavingsVTDisclosures},
 * {@link StandardSavingsVTRegulatoryFilings}, and {@link StandardSavingsVTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsVTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsVTScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingCA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingCAProfile},
 * {@link BasicCheckingCARateTable}, {@link BasicCheckingCADisclosures},
 * {@link BasicCheckingCARegulatoryFilings}, and {@link BasicCheckingCABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingCAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingCAScenarioMatrixTest {

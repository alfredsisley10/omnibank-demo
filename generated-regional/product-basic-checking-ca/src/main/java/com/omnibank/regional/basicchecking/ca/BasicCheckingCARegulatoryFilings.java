...
/**
 * State regulatory filing cadence for BasicChecking in California.
 ...
 */
public final class BasicCheckingCARegulatoryFilings {
    ...
    public BasicCheckingCARegulatoryFilings() {
        this(new BasicCheckingCAProfile());
    }

    public BasicCheckingCARegulatoryFilings(BasicCheckingCAProfile profile) {

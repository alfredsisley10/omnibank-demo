...
public final class BasicCheckingCABranchIntegration {
    ...
    public BasicCheckingCABranchIntegration() {
        this.profile = new BasicCheckingCAProfile();
    }

    public BasicCheckingCABranchIntegration(BasicCheckingCAProfile profile) {

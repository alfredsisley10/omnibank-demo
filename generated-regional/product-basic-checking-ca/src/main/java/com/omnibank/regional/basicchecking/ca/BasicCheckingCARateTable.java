...
/**
 * State-specific rate table overlay for BasicChecking offered in California.
 ...
 */
public final class BasicCheckingCARateTable {
    ...
    public BasicCheckingCARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CA-BasicChecking-2026Q1";

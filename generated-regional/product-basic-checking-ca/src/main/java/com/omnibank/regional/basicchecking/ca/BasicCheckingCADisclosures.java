package com.omnibank.regional.basicchecking.ca;
...
/**
 * State-specific disclosure overlays for BasicChecking in California.
 ...
 */
public final class BasicCheckingCADisclosures {

    private final BasicCheckingCAProfile profile;

    public BasicCheckingCADisclosures() {
        this.profile = new BasicCheckingCAProfile();
    }

    public BasicCheckingCADisclosures(BasicCheckingCAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — California State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

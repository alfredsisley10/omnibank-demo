...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNEProfile},
 * {@link EssentialCheckingNERateTable}, {@link EssentialCheckingNEDisclosures},
 * {@link EssentialCheckingNERegulatoryFilings}, and {@link EssentialCheckingNEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNEScenarioMatrixTest {

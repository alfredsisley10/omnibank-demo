...
/**
 * State-specific disclosure overlays for EssentialChecking in Nebraska.
 ...
 */
public final class EssentialCheckingNEDisclosures {

    private final EssentialCheckingNEProfile profile;

    public EssentialCheckingNEDisclosures() {
        this.profile = new EssentialCheckingNEProfile();
    }

    public EssentialCheckingNEDisclosures(EssentialCheckingNEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Nebraska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in Nebraska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNEBranchIntegration {
    ...
    public EssentialCheckingNEBranchIntegration() {
        this.profile = new EssentialCheckingNEProfile();
    }

    public EssentialCheckingNEBranchIntegration(EssentialCheckingNEProfile profile) {

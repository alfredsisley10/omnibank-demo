...
/**
 * State regulatory filing cadence for EssentialChecking in Nebraska.
 ...
 */
public final class EssentialCheckingNERegulatoryFilings {
    ...
    private final EssentialCheckingNEProfile profile;

    public EssentialCheckingNERegulatoryFilings() {
        this(new EssentialCheckingNEProfile());
    }

    public EssentialCheckingNERegulatoryFilings(EssentialCheckingNEProfile profile) {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Nebraska.
 ...
 */
public final class EssentialCheckingNERateTable {
    ...
    public EssentialCheckingNERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NE-EssentialChecking-2026Q1";

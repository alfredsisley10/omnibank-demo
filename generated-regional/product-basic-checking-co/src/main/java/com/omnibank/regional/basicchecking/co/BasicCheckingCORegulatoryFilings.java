...
/**
 * State regulatory filing cadence for BasicChecking in Colorado.
 ...
 */
public final class BasicCheckingCORegulatoryFilings {
    ...
    public BasicCheckingCORegulatoryFilings() {
        this(new BasicCheckingCOProfile());
    }

    public BasicCheckingCORegulatoryFilings(BasicCheckingCOProfile profile) {

package com.omnibank.regional.basicchecking.co;
...
/**
 * State-specific disclosure overlays for BasicChecking in Colorado.
 ...
 */
public final class BasicCheckingCODisclosures {

    private final BasicCheckingCOProfile profile;

    public BasicCheckingCODisclosures() {
        this.profile = new BasicCheckingCOProfile();
    }

    public BasicCheckingCODisclosures(BasicCheckingCOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Colorado State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

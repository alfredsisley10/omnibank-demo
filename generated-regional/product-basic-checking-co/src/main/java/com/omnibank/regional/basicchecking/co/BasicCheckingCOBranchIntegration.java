...
public final class BasicCheckingCOBranchIntegration {
    ...
    public BasicCheckingCOBranchIntegration() {
        this.profile = new BasicCheckingCOProfile();
    }

    public BasicCheckingCOBranchIntegration(BasicCheckingCOProfile profile) {

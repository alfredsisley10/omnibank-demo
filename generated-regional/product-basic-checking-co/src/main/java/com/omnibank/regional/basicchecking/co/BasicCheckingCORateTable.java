...
/**
 * State-specific rate table overlay for BasicChecking offered in Colorado.
 ...
 */
public final class BasicCheckingCORateTable {
    ...
    public BasicCheckingCORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CO-BasicChecking-2026Q1";

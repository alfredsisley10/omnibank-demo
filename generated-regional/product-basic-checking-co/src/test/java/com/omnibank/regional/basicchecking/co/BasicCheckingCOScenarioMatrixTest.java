...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingCO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingCOProfile},
 * {@link BasicCheckingCORateTable}, {@link BasicCheckingCODisclosures},
 * {@link BasicCheckingCORegulatoryFilings}, and {@link BasicCheckingCOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingCOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingCOScenarioMatrixTest {

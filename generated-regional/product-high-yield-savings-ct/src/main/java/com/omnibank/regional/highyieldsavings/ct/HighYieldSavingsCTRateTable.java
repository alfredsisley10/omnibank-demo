...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Connecticut.
 ...
 */
public final class HighYieldSavingsCTRateTable {
    ...
    public HighYieldSavingsCTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CT-HighYieldSavings-2026Q1";

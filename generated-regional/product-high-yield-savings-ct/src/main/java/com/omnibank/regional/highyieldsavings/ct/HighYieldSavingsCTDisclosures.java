package com.omnibank.regional.highyieldsavings.ct;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Connecticut.
 ...
 */
public final class HighYieldSavingsCTDisclosures {

    private final HighYieldSavingsCTProfile profile;

    public HighYieldSavingsCTDisclosures() {
        this.profile = new HighYieldSavingsCTProfile();
    }

    public HighYieldSavingsCTDisclosures(HighYieldSavingsCTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Connecticut State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

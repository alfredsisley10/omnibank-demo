...
/**
 * Branch / channel integration metadata for HighYieldSavings in Connecticut.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsCTBranchIntegration {
    ...
    public HighYieldSavingsCTBranchIntegration() {
        this.profile = new HighYieldSavingsCTProfile();
    }

    public HighYieldSavingsCTBranchIntegration(HighYieldSavingsCTProfile profile) {

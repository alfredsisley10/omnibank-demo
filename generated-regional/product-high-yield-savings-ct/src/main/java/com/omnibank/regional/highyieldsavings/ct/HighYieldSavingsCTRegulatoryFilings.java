...
/**
 * State regulatory filing cadence for HighYieldSavings in Connecticut.
 ...
 */
public final class HighYieldSavingsCTRegulatoryFilings {
    ...
    public HighYieldSavingsCTRegulatoryFilings() {
        this(new HighYieldSavingsCTProfile());
    }

    public HighYieldSavingsCTRegulatoryFilings(HighYieldSavingsCTProfile profile) {

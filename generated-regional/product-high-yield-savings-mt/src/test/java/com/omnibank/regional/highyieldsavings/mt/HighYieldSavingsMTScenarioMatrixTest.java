...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMTProfile},
 * {@link HighYieldSavingsMTRateTable}, {@link HighYieldSavingsMTDisclosures},
 * {@link HighYieldSavingsMTRegulatoryFilings}, and {@link HighYieldSavingsMTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMTScenarioMatrixTest {

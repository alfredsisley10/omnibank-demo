...
/**
 * State regulatory filing cadence for HighYieldSavings in Montana.
 ...
 */
public final class HighYieldSavingsMTRegulatoryFilings {
    ...
    public HighYieldSavingsMTRegulatoryFilings() {
        this(new HighYieldSavingsMTProfile());
    }

    public HighYieldSavingsMTRegulatoryFilings(HighYieldSavingsMTProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Montana.
 ...
 */
public final class HighYieldSavingsMTRateTable {
    ...
    public HighYieldSavingsMTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MT-HighYieldSavings-2026Q1";

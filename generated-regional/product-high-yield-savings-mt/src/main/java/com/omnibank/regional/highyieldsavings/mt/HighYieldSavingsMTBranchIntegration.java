...
/**
 * Branch / channel integration metadata for HighYieldSavings in Montana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMTBranchIntegration {
    ...
    public HighYieldSavingsMTBranchIntegration() {
        this.profile = new HighYieldSavingsMTProfile();
    }

    public HighYieldSavingsMTBranchIntegration(HighYieldSavingsMTProfile profile) {

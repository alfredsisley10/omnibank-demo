package com.omnibank.regional.highyieldsavings.mt;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Montana.
 ...
 */
public final class HighYieldSavingsMTDisclosures {

    private final HighYieldSavingsMTProfile profile;

    public HighYieldSavingsMTDisclosures() {
        this.profile = new HighYieldSavingsMTProfile();
    }

    public HighYieldSavingsMTDisclosures(HighYieldSavingsMTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Montana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

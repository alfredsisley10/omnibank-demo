...
/**
 * State regulatory filing cadence for HighYieldSavings in Florida.
 ...
 */
public final class HighYieldSavingsFLRegulatoryFilings {
    ...
    public HighYieldSavingsFLRegulatoryFilings() {
        this(new HighYieldSavingsFLProfile());
    }

    public HighYieldSavingsFLRegulatoryFilings(HighYieldSavingsFLProfile profile) {

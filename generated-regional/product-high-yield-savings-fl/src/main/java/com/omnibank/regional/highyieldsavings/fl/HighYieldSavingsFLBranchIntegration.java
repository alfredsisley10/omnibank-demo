...
/**
 * Branch / channel integration metadata for HighYieldSavings in Florida.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsFLBranchIntegration {
    ...
    public HighYieldSavingsFLBranchIntegration() {
        this.profile = new HighYieldSavingsFLProfile();
    }

    public HighYieldSavingsFLBranchIntegration(HighYieldSavingsFLProfile profile) {

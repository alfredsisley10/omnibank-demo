...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Florida.
 ...
 */
public final class HighYieldSavingsFLRateTable {
    ...
    public HighYieldSavingsFLRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-FL-HighYieldSavings-2026Q1";

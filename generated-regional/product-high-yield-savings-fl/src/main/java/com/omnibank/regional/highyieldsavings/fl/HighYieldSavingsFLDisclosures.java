package com.omnibank.regional.highyieldsavings.fl;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Florida.
 ...
 */
public final class HighYieldSavingsFLDisclosures {

    private final HighYieldSavingsFLProfile profile;

    public HighYieldSavingsFLDisclosures() {
        this.profile = new HighYieldSavingsFLProfile();
    }

    public HighYieldSavingsFLDisclosures(HighYieldSavingsFLProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Florida State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

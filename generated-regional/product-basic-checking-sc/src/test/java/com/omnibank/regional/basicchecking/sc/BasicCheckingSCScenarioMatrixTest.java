...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingSC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingSCProfile},
 * {@link BasicCheckingSCRateTable}, {@link BasicCheckingSCDisclosures},
 * {@link BasicCheckingSCRegulatoryFilings}, and {@link BasicCheckingSCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingSCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingSCScenarioMatrixTest {

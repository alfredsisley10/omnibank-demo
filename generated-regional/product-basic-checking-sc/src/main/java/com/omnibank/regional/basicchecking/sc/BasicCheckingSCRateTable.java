...
/**
 * State-specific rate table overlay for BasicChecking offered in South Carolina.
 ...
 */
public final class BasicCheckingSCRateTable {
    ...
    public BasicCheckingSCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SC-BasicChecking-2026Q1";

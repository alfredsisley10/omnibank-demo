package com.omnibank.regional.basicchecking.sc;
...
/**
 * State-specific disclosure overlays for BasicChecking in South Carolina.
 ...
 */
public final class BasicCheckingSCDisclosures {

    private final BasicCheckingSCProfile profile;

    public BasicCheckingSCDisclosures() {
        this.profile = new BasicCheckingSCProfile();
    }

    public BasicCheckingSCDisclosures(BasicCheckingSCProfile profile) {
    ...
    public String stateHeader() {
        return "South Carolina Residents Disclosure — Effective "
                ...
                + ". This supplement is part of the BasicChecking account agreement.";
    }
    ...
    public String electronicSignatureClause() {
        return "By consenting to electronic delivery, you agree that disclosures, "
                + "statements, and notices for this BasicChecking account may be delivered "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — South Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in South Carolina.
 ...
 */
public final class BasicCheckingSCRegulatoryFilings {
    ...
    public BasicCheckingSCRegulatoryFilings() {
        this(new BasicCheckingSCProfile());
    }

    public BasicCheckingSCRegulatoryFilings(BasicCheckingSCProfile profile) {

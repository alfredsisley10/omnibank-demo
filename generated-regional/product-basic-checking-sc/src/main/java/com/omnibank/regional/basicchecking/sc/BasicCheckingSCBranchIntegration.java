...
/**
 * Branch / channel integration metadata for BasicChecking in South Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingSCBranchIntegration {
    ...
    public BasicCheckingSCBranchIntegration() {
        this.profile = new BasicCheckingSCProfile();
    }

    public BasicCheckingSCBranchIntegration(BasicCheckingSCProfile profile) {

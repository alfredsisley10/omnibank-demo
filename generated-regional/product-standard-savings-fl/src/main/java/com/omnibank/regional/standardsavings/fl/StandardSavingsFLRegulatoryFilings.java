...
/**
 * State regulatory filing cadence for StandardSavings in Florida.
 ...
 */
public final class StandardSavingsFLRegulatoryFilings {
    ...
    public StandardSavingsFLRegulatoryFilings() {
        this(new StandardSavingsFLProfile());
    }

    public StandardSavingsFLRegulatoryFilings(StandardSavingsFLProfile profile) {

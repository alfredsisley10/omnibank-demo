package com.omnibank.regional.standardsavings.fl;
...
/**
 * State-specific disclosure overlays for StandardSavings in Florida.
 * Layered on top of the national disclosure, these capture
 * items that only apply under FL law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsFLDisclosures {

    private final StandardSavingsFLProfile profile;

    public StandardSavingsFLDisclosures() {
        this.profile = new StandardSavingsFLProfile();
    }

    public StandardSavingsFLDisclosures(StandardSavingsFLProfile profile) {
    ...
    public String stateHeader() {
        return "Florida Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Florida unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Florida law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Florida does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Florida State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

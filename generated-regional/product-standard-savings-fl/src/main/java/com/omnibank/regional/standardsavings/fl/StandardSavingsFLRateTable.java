...
/**
 * State-specific rate table overlay for StandardSavings offered in Florida.
 ...
 */
public final class StandardSavingsFLRateTable {
    ...
    public StandardSavingsFLRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-FL-StandardSavings-2026Q1";

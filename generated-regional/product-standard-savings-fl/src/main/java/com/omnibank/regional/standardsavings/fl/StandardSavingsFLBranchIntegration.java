...
public final class StandardSavingsFLBranchIntegration {
    ...
    public StandardSavingsFLBranchIntegration() {
        this.profile = new StandardSavingsFLProfile();
    }

    public StandardSavingsFLBranchIntegration(StandardSavingsFLProfile profile) {

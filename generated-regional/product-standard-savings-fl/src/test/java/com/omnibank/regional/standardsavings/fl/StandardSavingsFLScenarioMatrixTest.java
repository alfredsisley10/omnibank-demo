...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsFL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsFLProfile},
 * {@link StandardSavingsFLRateTable}, {@link StandardSavingsFLDisclosures},
 * {@link StandardSavingsFLRegulatoryFilings}, and {@link StandardSavingsFLBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsFLProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsFLScenarioMatrixTest {

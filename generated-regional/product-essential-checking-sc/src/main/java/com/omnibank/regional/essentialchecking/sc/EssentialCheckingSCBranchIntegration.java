...
/**
 * Branch / channel integration metadata for EssentialChecking in South Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingSCBranchIntegration {
    ...
    public EssentialCheckingSCBranchIntegration() {
        this.profile = new EssentialCheckingSCProfile();
    }

    public EssentialCheckingSCBranchIntegration(EssentialCheckingSCProfile profile) {

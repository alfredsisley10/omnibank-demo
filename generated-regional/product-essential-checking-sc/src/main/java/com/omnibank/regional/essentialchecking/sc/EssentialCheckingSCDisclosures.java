package com.omnibank.regional.essentialchecking.sc;
...
/**
 * State-specific disclosure overlays for EssentialChecking in South Carolina.
 ...
 */
public final class EssentialCheckingSCDisclosures {

    private final EssentialCheckingSCProfile profile;

    public EssentialCheckingSCDisclosures() {
        this.profile = new EssentialCheckingSCProfile();
    }

    public EssentialCheckingSCDisclosures(EssentialCheckingSCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — South Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

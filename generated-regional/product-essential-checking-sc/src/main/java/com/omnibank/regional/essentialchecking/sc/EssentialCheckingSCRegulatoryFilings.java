...
/**
 * State regulatory filing cadence for EssentialChecking in South Carolina.
 ...
 */
public final class EssentialCheckingSCRegulatoryFilings {
    ...
    public EssentialCheckingSCRegulatoryFilings() {
        this(new EssentialCheckingSCProfile());
    }

    public EssentialCheckingSCRegulatoryFilings(EssentialCheckingSCProfile profile) {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in South Carolina.
 ...
 */
public final class EssentialCheckingSCRateTable {
    ...
    public EssentialCheckingSCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SC-EssentialChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingSC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingSCProfile},
 * {@link EssentialCheckingSCRateTable}, {@link EssentialCheckingSCDisclosures},
 * {@link EssentialCheckingSCRegulatoryFilings}, and {@link EssentialCheckingSCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingSCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingSCScenarioMatrixTest {

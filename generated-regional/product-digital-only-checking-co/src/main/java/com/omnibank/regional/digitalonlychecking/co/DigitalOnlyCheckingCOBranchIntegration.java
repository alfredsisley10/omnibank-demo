...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Colorado.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingCOBranchIntegration {
    ...
    public DigitalOnlyCheckingCOBranchIntegration() {
        this.profile = new DigitalOnlyCheckingCOProfile();
    }

    public DigitalOnlyCheckingCOBranchIntegration(DigitalOnlyCheckingCOProfile profile) {

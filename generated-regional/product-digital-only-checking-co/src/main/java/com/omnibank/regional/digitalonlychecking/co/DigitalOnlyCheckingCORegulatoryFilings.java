...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Colorado.
 ...
 */
public final class DigitalOnlyCheckingCORegulatoryFilings {
    ...
    public DigitalOnlyCheckingCORegulatoryFilings() {
        this(new DigitalOnlyCheckingCOProfile());
    }

    public DigitalOnlyCheckingCORegulatoryFilings(DigitalOnlyCheckingCOProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Colorado)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Colorado)",
                "ANNUAL",

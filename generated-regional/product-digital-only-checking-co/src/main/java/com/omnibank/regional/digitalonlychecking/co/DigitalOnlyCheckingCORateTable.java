...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Colorado.
 ...
 */
public final class DigitalOnlyCheckingCORateTable {
    ...
    public DigitalOnlyCheckingCORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CO-DigitalOnlyChecking-2026Q1";

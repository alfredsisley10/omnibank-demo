package com.omnibank.regional.digitalonlychecking.co;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Colorado.
 ...
 */
public final class DigitalOnlyCheckingCODisclosures {

    private final DigitalOnlyCheckingCOProfile profile;

    public DigitalOnlyCheckingCODisclosures() {
        this.profile = new DigitalOnlyCheckingCOProfile();
    }

    public DigitalOnlyCheckingCODisclosures(DigitalOnlyCheckingCOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Colorado State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Colorado (CO).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingCOProfile {
    ...
    public DigitalOnlyCheckingCOProfile() {
        this.stateCode = "CO";
        this.stateName = "Colorado";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0290");

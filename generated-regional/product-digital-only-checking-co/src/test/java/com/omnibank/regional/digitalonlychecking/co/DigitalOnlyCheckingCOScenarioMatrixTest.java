...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingCO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingCOProfile},
 * {@link DigitalOnlyCheckingCORateTable}, {@link DigitalOnlyCheckingCODisclosures},
 * {@link DigitalOnlyCheckingCORegulatoryFilings}, and {@link DigitalOnlyCheckingCOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingCOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingCOScenarioMatrixTest {

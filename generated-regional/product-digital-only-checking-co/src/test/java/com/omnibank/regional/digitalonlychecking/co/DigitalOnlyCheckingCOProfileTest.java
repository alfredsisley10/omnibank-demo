...
class DigitalOnlyCheckingCOProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingCOProfile();
        assertThat(p.stateCode()).isEqualTo("CO");
        assertThat(p.stateName()).isEqualTo("Colorado");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingCORateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingCODisclosures();
        assertThat(d.renderFullSupplement()).contains("Colorado");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingCORegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingCOBranchIntegration();

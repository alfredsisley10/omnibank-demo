...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingKS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingKSProfile},
 * {@link DigitalOnlyCheckingKSRateTable}, {@link DigitalOnlyCheckingKSDisclosures},
 * {@link DigitalOnlyCheckingKSRegulatoryFilings}, and {@link DigitalOnlyCheckingKSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingKSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingKSScenarioMatrixTest {

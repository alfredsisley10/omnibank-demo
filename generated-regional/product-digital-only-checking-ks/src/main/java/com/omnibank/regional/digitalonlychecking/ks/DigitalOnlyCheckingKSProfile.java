...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Kansas (KS).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingKSProfile {
    ...
    public DigitalOnlyCheckingKSProfile() {
        this.stateCode = "KS";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Kansas.
 ...
 */
public final class DigitalOnlyCheckingKSRateTable {
    ...
    public DigitalOnlyCheckingKSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KS-DigitalOnlyChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Kansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingKSBranchIntegration {
    ...
    public DigitalOnlyCheckingKSBranchIntegration() {
        this.profile = new DigitalOnlyCheckingKSProfile();
    }

    public DigitalOnlyCheckingKSBranchIntegration(DigitalOnlyCheckingKSProfile profile) {

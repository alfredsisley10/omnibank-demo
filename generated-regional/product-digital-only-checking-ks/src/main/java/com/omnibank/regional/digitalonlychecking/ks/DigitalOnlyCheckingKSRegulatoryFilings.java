...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Kansas.
 ...
 */
public final class DigitalOnlyCheckingKSRegulatoryFilings {
    ...
    public DigitalOnlyCheckingKSRegulatoryFilings() {
        this(new DigitalOnlyCheckingKSProfile());
    }

    public DigitalOnlyCheckingKSRegulatoryFilings(DigitalOnlyCheckingKSProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Kansas)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Kansas)",
                "ANNUAL",

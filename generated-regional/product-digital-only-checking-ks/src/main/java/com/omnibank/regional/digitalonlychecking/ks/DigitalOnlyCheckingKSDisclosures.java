package com.omnibank.regional.digitalonlychecking.ks;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Kansas.
 ...
 */
public final class DigitalOnlyCheckingKSDisclosures {

    private final DigitalOnlyCheckingKSProfile profile;

    public DigitalOnlyCheckingKSDisclosures() {
        this.profile = new DigitalOnlyCheckingKSProfile();
    }

    public DigitalOnlyCheckingKSDisclosures(DigitalOnlyCheckingKSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Kansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

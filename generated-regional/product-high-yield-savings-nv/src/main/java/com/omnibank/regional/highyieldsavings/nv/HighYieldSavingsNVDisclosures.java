package com.omnibank.regional.highyieldsavings.nv;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Nevada.
 ...
 */
public final class HighYieldSavingsNVDisclosures {

    private final HighYieldSavingsNVProfile profile;

    public HighYieldSavingsNVDisclosures() {
        this.profile = new HighYieldSavingsNVProfile();
    }

    public HighYieldSavingsNVDisclosures(HighYieldSavingsNVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Nevada State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for HighYieldSavings in Nevada.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNVBranchIntegration {
    ...
    public HighYieldSavingsNVBranchIntegration() {
        this.profile = new HighYieldSavingsNVProfile();
    }

    public HighYieldSavingsNVBranchIntegration(HighYieldSavingsNVProfile profile) {

...
/**
 * State regulatory filing cadence for HighYieldSavings in Nevada.
 ...
 */
public final class HighYieldSavingsNVRegulatoryFilings {
    ...
    public HighYieldSavingsNVRegulatoryFilings() {
        this(new HighYieldSavingsNVProfile());
    }

    public HighYieldSavingsNVRegulatoryFilings(HighYieldSavingsNVProfile profile) {

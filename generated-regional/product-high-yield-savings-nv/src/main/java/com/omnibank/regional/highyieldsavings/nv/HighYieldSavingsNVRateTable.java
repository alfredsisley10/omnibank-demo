...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Nevada.
 ...
 */
public final class HighYieldSavingsNVRateTable {
    ...
    public HighYieldSavingsNVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NV-HighYieldSavings-2026Q1";

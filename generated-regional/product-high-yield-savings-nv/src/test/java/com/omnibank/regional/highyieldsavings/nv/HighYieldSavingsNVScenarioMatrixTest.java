...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNVProfile},
 * {@link HighYieldSavingsNVRateTable}, {@link HighYieldSavingsNVDisclosures},
 * {@link HighYieldSavingsNVRegulatoryFilings}, and {@link HighYieldSavingsNVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNVScenarioMatrixTest {

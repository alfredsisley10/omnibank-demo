package com.omnibank.regional.basicchecking.la;
...
/**
 * State-specific disclosure overlays for BasicChecking in Louisiana.
 ...
 */
public final class BasicCheckingLADisclosures {

    private final BasicCheckingLAProfile profile;

    public BasicCheckingLADisclosures() {
        this.profile = new BasicCheckingLAProfile();
    }

    public BasicCheckingLADisclosures(BasicCheckingLAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Louisiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

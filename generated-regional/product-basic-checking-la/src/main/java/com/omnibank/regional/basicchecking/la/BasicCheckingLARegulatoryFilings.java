...
/**
 * State regulatory filing cadence for BasicChecking in Louisiana.
 ...
 */
public final class BasicCheckingLARegulatoryFilings {
    ...
    public BasicCheckingLARegulatoryFilings() {
        this(new BasicCheckingLAProfile());
    }

    public BasicCheckingLARegulatoryFilings(BasicCheckingLAProfile profile) {

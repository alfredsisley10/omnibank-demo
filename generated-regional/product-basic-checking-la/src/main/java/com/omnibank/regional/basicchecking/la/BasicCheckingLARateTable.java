...
/**
 * State-specific rate table overlay for BasicChecking offered in Louisiana.
 ...
 */
public final class BasicCheckingLARateTable {
    ...
    public BasicCheckingLARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-LA-BasicChecking-2026Q1";

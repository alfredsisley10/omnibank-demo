...
public final class BasicCheckingLABranchIntegration {
    ...
    public BasicCheckingLABranchIntegration() {
        this.profile = new BasicCheckingLAProfile();
    }

    public BasicCheckingLABranchIntegration(BasicCheckingLAProfile profile) {

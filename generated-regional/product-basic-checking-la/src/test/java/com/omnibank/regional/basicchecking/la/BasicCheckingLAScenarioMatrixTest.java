...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingLA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingLAProfile},
 * {@link BasicCheckingLARateTable}, {@link BasicCheckingLADisclosures},
 * {@link BasicCheckingLARegulatoryFilings}, and {@link BasicCheckingLABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingLAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingLAScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Minnesota.
 ...
 */
public final class EssentialCheckingMNRateTable {
    ...
    public EssentialCheckingMNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MN-EssentialChecking-2026Q1";

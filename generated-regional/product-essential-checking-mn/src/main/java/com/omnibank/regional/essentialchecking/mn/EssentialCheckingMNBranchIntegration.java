...
/**
 * Branch / channel integration metadata for EssentialChecking in Minnesota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMNBranchIntegration {
    ...
    public EssentialCheckingMNBranchIntegration() {
        this.profile = new EssentialCheckingMNProfile();
    }

    public EssentialCheckingMNBranchIntegration(EssentialCheckingMNProfile profile) {

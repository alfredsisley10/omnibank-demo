package com.omnibank.regional.essentialchecking.mn;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Minnesota.
 ...
 */
public final class EssentialCheckingMNDisclosures {

    private final EssentialCheckingMNProfile profile;

    public EssentialCheckingMNDisclosures() {
        this.profile = new EssentialCheckingMNProfile();
    }

    public EssentialCheckingMNDisclosures(EssentialCheckingMNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Minnesota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

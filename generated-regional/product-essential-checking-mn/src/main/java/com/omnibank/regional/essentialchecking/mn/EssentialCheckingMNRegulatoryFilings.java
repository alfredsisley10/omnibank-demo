...
/**
 * State regulatory filing cadence for EssentialChecking in Minnesota.
 ...
 */
public final class EssentialCheckingMNRegulatoryFilings {
    ...
    public EssentialCheckingMNRegulatoryFilings() {
        this(new EssentialCheckingMNProfile());
    }

    public EssentialCheckingMNRegulatoryFilings(EssentialCheckingMNProfile profile) {

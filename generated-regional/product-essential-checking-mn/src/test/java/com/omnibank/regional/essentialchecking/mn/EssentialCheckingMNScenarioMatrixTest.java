...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMNProfile},
 * {@link EssentialCheckingMNRateTable}, {@link EssentialCheckingMNDisclosures},
 * {@link EssentialCheckingMNRegulatoryFilings}, and {@link EssentialCheckingMNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMNScenarioMatrixTest {

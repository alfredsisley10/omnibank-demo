...
/**
 * State regulatory filing cadence for StandardSavings in Nevada.
 ...
 */
public final class StandardSavingsNVRegulatoryFilings {
    ...
    public StandardSavingsNVRegulatoryFilings() {
        this(new StandardSavingsNVProfile());
    }

    public StandardSavingsNVRegulatoryFilings(StandardSavingsNVProfile profile) {

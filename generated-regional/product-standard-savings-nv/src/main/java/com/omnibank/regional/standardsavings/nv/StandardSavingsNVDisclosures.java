package com.omnibank.regional.standardsavings.nv;
...
/**
 * State-specific disclosure overlays for StandardSavings in Nevada.
 * Layered on top of the national disclosure, these capture
 * items that only apply under NV law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsNVDisclosures {

    private final StandardSavingsNVProfile profile;

    public StandardSavingsNVDisclosures() {
        this.profile = new StandardSavingsNVProfile();
    }

    public StandardSavingsNVDisclosures(StandardSavingsNVProfile profile) {
    ...
    public String stateHeader() {
        return "Nevada Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Nevada unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Nevada law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Nevada does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Nevada State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

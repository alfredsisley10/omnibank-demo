...
public final class StandardSavingsNVBranchIntegration {
    ...
    public StandardSavingsNVBranchIntegration() {
        this.profile = new StandardSavingsNVProfile();
    }

    public StandardSavingsNVBranchIntegration(StandardSavingsNVProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Nevada.
 ...
 */
public final class StandardSavingsNVRateTable {
    ...
    public StandardSavingsNVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NV-StandardSavings-2026Q1";

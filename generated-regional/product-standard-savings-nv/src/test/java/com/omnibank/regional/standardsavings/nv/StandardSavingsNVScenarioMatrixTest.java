...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNVProfile},
 * {@link StandardSavingsNVRateTable}, {@link StandardSavingsNVDisclosures},
 * {@link StandardSavingsNVRegulatoryFilings}, and {@link StandardSavingsNVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNVScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingWI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingWIProfile},
 * {@link EssentialCheckingWIRateTable}, {@link EssentialCheckingWIDisclosures},
 * {@link EssentialCheckingWIRegulatoryFilings}, and {@link EssentialCheckingWIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingWIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingWIScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for EssentialChecking in Wisconsin.
 ...
 */
public final class EssentialCheckingWIRegulatoryFilings {
    ...
    public EssentialCheckingWIRegulatoryFilings() {
        this(new EssentialCheckingWIProfile());
    }

    public EssentialCheckingWIRegulatoryFilings(EssentialCheckingWIProfile profile) {

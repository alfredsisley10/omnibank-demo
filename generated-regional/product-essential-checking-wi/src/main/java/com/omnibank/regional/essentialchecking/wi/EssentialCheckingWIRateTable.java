...
/**
 * State-specific rate table overlay for EssentialChecking offered in Wisconsin.
 ...
 */
public final class EssentialCheckingWIRateTable {
    ...
    public EssentialCheckingWIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WI-EssentialChecking-2026Q1";

package com.omnibank.regional.essentialchecking.wi;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Wisconsin.
 ...
 */
public final class EssentialCheckingWIDisclosures {

    private final EssentialCheckingWIProfile profile;

    public EssentialCheckingWIDisclosures() {
        this.profile = new EssentialCheckingWIProfile();
    }

    public EssentialCheckingWIDisclosures(EssentialCheckingWIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Wisconsin State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

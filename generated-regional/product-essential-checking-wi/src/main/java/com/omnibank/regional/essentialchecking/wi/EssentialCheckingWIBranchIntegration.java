...
/**
 * Branch / channel integration metadata for EssentialChecking in Wisconsin.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingWIBranchIntegration {
    ...
    public EssentialCheckingWIBranchIntegration() {
        this.profile = new EssentialCheckingWIProfile();
    }

    public EssentialCheckingWIBranchIntegration(EssentialCheckingWIProfile profile) {

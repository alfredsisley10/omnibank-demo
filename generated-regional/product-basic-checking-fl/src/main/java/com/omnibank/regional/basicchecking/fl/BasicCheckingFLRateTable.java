...
/**
 * State-specific rate table overlay for BasicChecking offered in Florida.
 ...
 */
public final class BasicCheckingFLRateTable {
    ...
    public BasicCheckingFLRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-FL-BasicChecking-2026Q1";

package com.omnibank.regional.basicchecking.fl;
...
/**
 * State-specific disclosure overlays for BasicChecking in Florida.
 ...
 */
public final class BasicCheckingFLDisclosures {

    private final BasicCheckingFLProfile profile;

    public BasicCheckingFLDisclosures() {
        this.profile = new BasicCheckingFLProfile();
    }

    public BasicCheckingFLDisclosures(BasicCheckingFLProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Florida State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

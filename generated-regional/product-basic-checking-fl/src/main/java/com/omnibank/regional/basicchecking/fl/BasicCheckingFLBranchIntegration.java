...
public final class BasicCheckingFLBranchIntegration {
    ...
    public BasicCheckingFLBranchIntegration() {
        this.profile = new BasicCheckingFLProfile();
    }

    public BasicCheckingFLBranchIntegration(BasicCheckingFLProfile profile) {

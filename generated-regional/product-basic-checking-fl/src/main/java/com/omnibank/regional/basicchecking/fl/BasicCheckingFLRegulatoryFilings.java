...
/**
 * State regulatory filing cadence for BasicChecking in Florida.
 ...
 */
public final class BasicCheckingFLRegulatoryFilings {
    ...
    public BasicCheckingFLRegulatoryFilings() {
        this(new BasicCheckingFLProfile());
    }

    public BasicCheckingFLRegulatoryFilings(BasicCheckingFLProfile profile) {

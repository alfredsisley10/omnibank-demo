...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsRI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsRIProfile},
 * {@link HighYieldSavingsRIRateTable}, {@link HighYieldSavingsRIDisclosures},
 * {@link HighYieldSavingsRIRegulatoryFilings}, and {@link HighYieldSavingsRIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsRIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsRIScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Rhode Island.
 ...
 */
public final class HighYieldSavingsRIRateTable {
    ...
    public HighYieldSavingsRIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-RI-HighYieldSavings-2026Q1";

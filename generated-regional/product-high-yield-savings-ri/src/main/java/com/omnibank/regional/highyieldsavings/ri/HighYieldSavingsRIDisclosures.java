...
/**
 * State-specific disclosure overlays for HighYieldSavings in Rhode Island.
 ...
 */
public final class HighYieldSavingsRIDisclosures {

    private final HighYieldSavingsRIProfile profile;

    public HighYieldSavingsRIDisclosures() {
        this.profile = new HighYieldSavingsRIProfile();
    }

    public HighYieldSavingsRIDisclosures(HighYieldSavingsRIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Rhode Island State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

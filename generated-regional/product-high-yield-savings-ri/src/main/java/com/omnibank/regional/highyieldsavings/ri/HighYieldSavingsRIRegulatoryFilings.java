...
/**
 * State regulatory filing cadence for HighYieldSavings in Rhode Island.
 ...
 */
public final class HighYieldSavingsRIRegulatoryFilings {
    ...
    public HighYieldSavingsRIRegulatoryFilings() {
        this(new HighYieldSavingsRIProfile());
    }

    public HighYieldSavingsRIRegulatoryFilings(HighYieldSavingsRIProfile profile) {

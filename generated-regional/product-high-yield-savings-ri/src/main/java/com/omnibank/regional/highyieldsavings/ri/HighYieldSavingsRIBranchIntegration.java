...
/**
 * Branch / channel integration metadata for HighYieldSavings in Rhode Island.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsRIBranchIntegration {
    ...
    public HighYieldSavingsRIBranchIntegration() {
        this.profile = new HighYieldSavingsRIProfile();
    }

    public HighYieldSavingsRIBranchIntegration(HighYieldSavingsRIProfile profile) {

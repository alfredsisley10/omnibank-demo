...
public final class BasicCheckingNEBranchIntegration {
    ...
    public BasicCheckingNEBranchIntegration() {
        this.profile = new BasicCheckingNEProfile();
    }

    public BasicCheckingNEBranchIntegration(BasicCheckingNEProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in Nebraska.
 ...
 */
public final class BasicCheckingNERateTable {
    ...
    public BasicCheckingNERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NE-BasicChecking-2026Q1";

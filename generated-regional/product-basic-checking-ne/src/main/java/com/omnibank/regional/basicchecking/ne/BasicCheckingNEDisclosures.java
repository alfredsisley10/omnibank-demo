package com.omnibank.regional.basicchecking.ne;
...
/**
 * State-specific disclosure overlays for BasicChecking in Nebraska.
 ...
 */
public final class BasicCheckingNEDisclosures {

    private final BasicCheckingNEProfile profile;

    public BasicCheckingNEDisclosures() {
        this.profile = new BasicCheckingNEProfile();
    }

    public BasicCheckingNEDisclosures(BasicCheckingNEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Nebraska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

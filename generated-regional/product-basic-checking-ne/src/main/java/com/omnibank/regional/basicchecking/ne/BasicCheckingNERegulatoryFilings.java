...
/**
 * State regulatory filing cadence for BasicChecking in Nebraska.
 ...
 */
public final class BasicCheckingNERegulatoryFilings {
    ...
    public BasicCheckingNERegulatoryFilings() {
        this(new BasicCheckingNEProfile());
    }

    public BasicCheckingNERegulatoryFilings(BasicCheckingNEProfile profile) {

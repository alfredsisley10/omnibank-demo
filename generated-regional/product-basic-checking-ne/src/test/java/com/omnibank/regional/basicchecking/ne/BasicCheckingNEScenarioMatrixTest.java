...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNEProfile},
 * {@link BasicCheckingNERateTable}, {@link BasicCheckingNEDisclosures},
 * {@link BasicCheckingNERegulatoryFilings}, and {@link BasicCheckingNEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNEScenarioMatrixTest {

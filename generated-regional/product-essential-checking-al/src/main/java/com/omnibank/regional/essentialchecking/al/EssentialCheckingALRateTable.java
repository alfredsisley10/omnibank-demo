...
/**
 * State-specific rate table overlay for EssentialChecking offered in Alabama.
 ...
 */
public final class EssentialCheckingALRateTable {
    ...
    public EssentialCheckingALRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AL-EssentialChecking-2026Q1";

package com.omnibank.regional.essentialchecking.al;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Alabama.
 ...
 */
public final class EssentialCheckingALDisclosures {

    private final EssentialCheckingALProfile profile;

    public EssentialCheckingALDisclosures() {
        this.profile = new EssentialCheckingALProfile();
    }

    public EssentialCheckingALDisclosures(EssentialCheckingALProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Alabama State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

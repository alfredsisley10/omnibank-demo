...
/**
 * Branch / channel integration metadata for EssentialChecking in Alabama.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingALBranchIntegration {
    ...
    public EssentialCheckingALBranchIntegration() {
        this.profile = new EssentialCheckingALProfile();
    }

    public EssentialCheckingALBranchIntegration(EssentialCheckingALProfile profile) {

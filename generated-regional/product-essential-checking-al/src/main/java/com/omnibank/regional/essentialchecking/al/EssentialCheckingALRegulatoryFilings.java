...
/**
 * State regulatory filing cadence for EssentialChecking in Alabama.
 ...
 */
public final class EssentialCheckingALRegulatoryFilings {
    ...
    public EssentialCheckingALRegulatoryFilings() {
        this(new EssentialCheckingALProfile());
    }

    public EssentialCheckingALRegulatoryFilings(EssentialCheckingALProfile profile) {

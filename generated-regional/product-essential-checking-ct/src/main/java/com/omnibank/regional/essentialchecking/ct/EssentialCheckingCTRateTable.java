...
/**
 * State-specific rate table overlay for EssentialChecking offered in Connecticut.
 ...
 */
public final class EssentialCheckingCTRateTable {
    ...
    public EssentialCheckingCTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CT-EssentialChecking-2026Q1";

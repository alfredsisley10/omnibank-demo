...
/**
 * State regulatory filing cadence for EssentialChecking in Connecticut.
 ...
 */
public final class EssentialCheckingCTRegulatoryFilings {
    ...
    public EssentialCheckingCTRegulatoryFilings() {
        this(new EssentialCheckingCTProfile());
    }

    public EssentialCheckingCTRegulatoryFilings(EssentialCheckingCTProfile profile) {

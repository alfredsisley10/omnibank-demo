...
/**
 * Branch / channel integration metadata for EssentialChecking in Connecticut.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingCTBranchIntegration {
    ...
    public EssentialCheckingCTBranchIntegration() {
        this.profile = new EssentialCheckingCTProfile();
    }

    public EssentialCheckingCTBranchIntegration(EssentialCheckingCTProfile profile) {

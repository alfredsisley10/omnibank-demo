...
/**
 * State-specific disclosure overlays for EssentialChecking in Connecticut.
 ...
 */
public final class EssentialCheckingCTDisclosures {

    private final EssentialCheckingCTProfile profile;

    public EssentialCheckingCTDisclosures() {
        this.profile = new EssentialCheckingCTProfile();
    }

    public EssentialCheckingCTDisclosures(EssentialCheckingCTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Connecticut State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

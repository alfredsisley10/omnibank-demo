...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingCT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingCTProfile},
 * {@link EssentialCheckingCTRateTable}, {@link EssentialCheckingCTDisclosures},
 * {@link EssentialCheckingCTRegulatoryFilings}, and {@link EssentialCheckingCTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingCTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingCTScenarioMatrixTest {

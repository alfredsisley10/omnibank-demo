...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingND jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNDProfile},
 * {@link DigitalOnlyCheckingNDRateTable}, {@link DigitalOnlyCheckingNDDisclosures},
 * {@link DigitalOnlyCheckingNDRegulatoryFilings}, and {@link DigitalOnlyCheckingNDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNDScenarioMatrixTest {

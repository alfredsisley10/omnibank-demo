...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in North Dakota (ND).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNDProfile {
    ...
    public DigitalOnlyCheckingNDProfile() {
        this.stateCode = "ND";
        this.stateName = "North Dakota";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0500");

package com.omnibank.regional.digitalonlychecking.nd;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in North Dakota.
 ...
 */
public final class DigitalOnlyCheckingNDDisclosures {

    private final DigitalOnlyCheckingNDProfile profile;

    public DigitalOnlyCheckingNDDisclosures() {
        this.profile = new DigitalOnlyCheckingNDProfile();
    }

    public DigitalOnlyCheckingNDDisclosures(DigitalOnlyCheckingNDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — North Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

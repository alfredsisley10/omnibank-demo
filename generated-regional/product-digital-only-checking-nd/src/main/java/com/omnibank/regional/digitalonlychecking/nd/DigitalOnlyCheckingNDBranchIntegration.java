...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in North Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNDBranchIntegration {
    ...
    public DigitalOnlyCheckingNDBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNDProfile();
    }

    public DigitalOnlyCheckingNDBranchIntegration(DigitalOnlyCheckingNDProfile profile) {

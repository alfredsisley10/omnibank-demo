...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in North Dakota.
 ...
 */
public final class DigitalOnlyCheckingNDRateTable {
    ...
    public DigitalOnlyCheckingNDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ND-DigitalOnlyChecking-2026Q1";

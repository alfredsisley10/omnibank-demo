...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in North Dakota.
 ...
 */
public final class DigitalOnlyCheckingNDRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNDRegulatoryFilings() {
        this(new DigitalOnlyCheckingNDProfile());
    }

    public DigitalOnlyCheckingNDRegulatoryFilings(DigitalOnlyCheckingNDProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (North Dakota)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (North Dakota)",
                "ANNUAL",

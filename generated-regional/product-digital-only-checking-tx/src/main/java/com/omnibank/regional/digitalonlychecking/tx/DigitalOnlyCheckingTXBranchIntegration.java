...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Texas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingTXBranchIntegration {
    ...
    public DigitalOnlyCheckingTXBranchIntegration() {
        this.profile = new DigitalOnlyCheckingTXProfile();
    }

    public DigitalOnlyCheckingTXBranchIntegration(DigitalOnlyCheckingTXProfile profile) {

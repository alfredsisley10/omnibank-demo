...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Texas.
 ...
 */
public final class DigitalOnlyCheckingTXRateTable {
    ...
    public DigitalOnlyCheckingTXRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TX-DigitalOnlyChecking-2026Q1";

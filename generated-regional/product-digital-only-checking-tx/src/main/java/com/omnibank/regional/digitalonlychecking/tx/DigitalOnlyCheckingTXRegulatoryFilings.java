...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Texas.
 ...
 */
public final class DigitalOnlyCheckingTXRegulatoryFilings {
    ...
    public DigitalOnlyCheckingTXRegulatoryFilings() {
        this(new DigitalOnlyCheckingTXProfile());
    }

    public DigitalOnlyCheckingTXRegulatoryFilings(DigitalOnlyCheckingTXProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Texas)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Texas)",
                "ANNUAL",

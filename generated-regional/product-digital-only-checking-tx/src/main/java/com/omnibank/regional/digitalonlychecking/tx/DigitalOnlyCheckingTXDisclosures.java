package com.omnibank.regional.digitalonlychecking.tx;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Texas.
 ...
 */
public final class DigitalOnlyCheckingTXDisclosures {

    private final DigitalOnlyCheckingTXProfile profile;

    public DigitalOnlyCheckingTXDisclosures() {
        this.profile = new DigitalOnlyCheckingTXProfile();
    }

    public DigitalOnlyCheckingTXDisclosures(DigitalOnlyCheckingTXProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Texas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

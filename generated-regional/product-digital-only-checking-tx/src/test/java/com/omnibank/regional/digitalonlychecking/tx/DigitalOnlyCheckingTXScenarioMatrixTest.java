...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingTX jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingTXProfile},
 * {@link DigitalOnlyCheckingTXRateTable}, {@link DigitalOnlyCheckingTXDisclosures},
 * {@link DigitalOnlyCheckingTXRegulatoryFilings}, and {@link DigitalOnlyCheckingTXBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingTXProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingTXScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for BasicChecking offered in North Carolina.
 ...
 */
public final class BasicCheckingNCRateTable {
    ...
    public BasicCheckingNCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NC-BasicChecking-2026Q1";

package com.omnibank.regional.basicchecking.nc;
...
/**
 * State-specific disclosure overlays for BasicChecking in North Carolina.
 ...
 */
public final class BasicCheckingNCDisclosures {

    private final BasicCheckingNCProfile profile;

    public BasicCheckingNCDisclosures() {
        this.profile = new BasicCheckingNCProfile();
    }

    public BasicCheckingNCDisclosures(BasicCheckingNCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — North Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

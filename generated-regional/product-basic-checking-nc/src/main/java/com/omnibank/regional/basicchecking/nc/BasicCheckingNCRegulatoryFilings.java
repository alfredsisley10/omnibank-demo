...
/**
 * State regulatory filing cadence for BasicChecking in North Carolina.
 ...
 */
public final class BasicCheckingNCRegulatoryFilings {
    ...
    public BasicCheckingNCRegulatoryFilings() {
        this(new BasicCheckingNCProfile());
    }

    public BasicCheckingNCRegulatoryFilings(BasicCheckingNCProfile profile) {

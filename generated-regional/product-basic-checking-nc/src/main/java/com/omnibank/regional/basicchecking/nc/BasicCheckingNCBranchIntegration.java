...
/**
 * Branch / channel integration metadata for BasicChecking in North Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingNCBranchIntegration {
    ...
    public BasicCheckingNCBranchIntegration() {
        this.profile = new BasicCheckingNCProfile();
    }

    public BasicCheckingNCBranchIntegration(BasicCheckingNCProfile profile) {

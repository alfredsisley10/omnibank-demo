...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNCProfile},
 * {@link BasicCheckingNCRateTable}, {@link BasicCheckingNCDisclosures},
 * {@link BasicCheckingNCRegulatoryFilings}, and {@link BasicCheckingNCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNCScenarioMatrixTest {

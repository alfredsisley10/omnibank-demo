...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMOProfile},
 * {@link HighYieldSavingsMORateTable}, {@link HighYieldSavingsMODisclosures},
 * {@link HighYieldSavingsMORegulatoryFilings}, and {@link HighYieldSavingsMOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMOScenarioMatrixTest {

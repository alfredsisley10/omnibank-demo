...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Missouri.
 ...
 */
public final class HighYieldSavingsMORateTable {
    ...
    public HighYieldSavingsMORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MO-HighYieldSavings-2026Q1";

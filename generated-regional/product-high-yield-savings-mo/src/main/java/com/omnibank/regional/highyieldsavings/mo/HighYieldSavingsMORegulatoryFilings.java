...
/**
 * State regulatory filing cadence for HighYieldSavings in Missouri.
 ...
 */
public final class HighYieldSavingsMORegulatoryFilings {
    ...
    public HighYieldSavingsMORegulatoryFilings() {
        this(new HighYieldSavingsMOProfile());
    }

    public HighYieldSavingsMORegulatoryFilings(HighYieldSavingsMOProfile profile) {

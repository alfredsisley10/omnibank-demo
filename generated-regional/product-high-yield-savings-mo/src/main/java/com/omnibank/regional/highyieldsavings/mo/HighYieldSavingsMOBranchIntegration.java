...
/**
 * Branch / channel integration metadata for HighYieldSavings in Missouri.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMOBranchIntegration {
    ...
    public HighYieldSavingsMOBranchIntegration() {
        this.profile = new HighYieldSavingsMOProfile();
    }

    public HighYieldSavingsMOBranchIntegration(HighYieldSavingsMOProfile profile) {

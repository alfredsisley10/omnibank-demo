package com.omnibank.regional.highyieldsavings.mo;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Missouri.
 ...
 */
public final class HighYieldSavingsMODisclosures {

    private final HighYieldSavingsMOProfile profile;

    public HighYieldSavingsMODisclosures() {
        this.profile = new HighYieldSavingsMOProfile();
    }

    public HighYieldSavingsMODisclosures(HighYieldSavingsMOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Missouri State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

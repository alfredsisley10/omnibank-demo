...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingDE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingDEProfile},
 * {@link DigitalOnlyCheckingDERateTable}, {@link DigitalOnlyCheckingDEDisclosures},
 * {@link DigitalOnlyCheckingDERegulatoryFilings}, and {@link DigitalOnlyCheckingDEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingDEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingDEScenarioMatrixTest {

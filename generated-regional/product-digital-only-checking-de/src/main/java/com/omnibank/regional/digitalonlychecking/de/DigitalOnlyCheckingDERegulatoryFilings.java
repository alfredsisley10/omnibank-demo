...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Delaware.
 ...
 */
public final class DigitalOnlyCheckingDERegulatoryFilings {
    ...
    public DigitalOnlyCheckingDERegulatoryFilings() {
        this(new DigitalOnlyCheckingDEProfile());
    }

    public DigitalOnlyCheckingDERegulatoryFilings(DigitalOnlyCheckingDEProfile profile) {

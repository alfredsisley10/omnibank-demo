...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Delaware.
 ...
 */
public final class DigitalOnlyCheckingDEDisclosures {

    private final DigitalOnlyCheckingDEProfile profile;

    public DigitalOnlyCheckingDEDisclosures() {
        this.profile = new DigitalOnlyCheckingDEProfile();
    }

    public DigitalOnlyCheckingDEDisclosures(DigitalOnlyCheckingDEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Delaware State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

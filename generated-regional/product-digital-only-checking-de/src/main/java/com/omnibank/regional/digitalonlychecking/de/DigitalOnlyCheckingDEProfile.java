...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Delaware (DE).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingDEProfile {
    ...
    public DigitalOnlyCheckingDEProfile() {
        this.stateCode = "DE";

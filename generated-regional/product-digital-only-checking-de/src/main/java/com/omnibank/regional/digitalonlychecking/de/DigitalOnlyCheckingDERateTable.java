...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Delaware.
 ...
 */
public final class DigitalOnlyCheckingDERateTable {
    ...
    public DigitalOnlyCheckingDERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-DE-DigitalOnlyChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsND jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNDProfile},
 * {@link HighYieldSavingsNDRateTable}, {@link HighYieldSavingsNDDisclosures},
 * {@link HighYieldSavingsNDRegulatoryFilings}, and {@link HighYieldSavingsNDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNDScenarioMatrixTest {

package com.omnibank.regional.highyieldsavings.nd;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in North Dakota.
 ...
 */
public final class HighYieldSavingsNDDisclosures {

    private final HighYieldSavingsNDProfile profile;

    public HighYieldSavingsNDDisclosures() {
        this.profile = new HighYieldSavingsNDProfile();
    }

    public HighYieldSavingsNDDisclosures(HighYieldSavingsNDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — North Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

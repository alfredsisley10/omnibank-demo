...
/**
 * State-specific rate table overlay for HighYieldSavings offered in North Dakota.
 ...
 */
public final class HighYieldSavingsNDRateTable {
    ...
    public HighYieldSavingsNDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ND-HighYieldSavings-2026Q1";

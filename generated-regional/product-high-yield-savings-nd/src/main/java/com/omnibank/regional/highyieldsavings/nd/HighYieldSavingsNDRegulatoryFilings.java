...
/**
 * State regulatory filing cadence for HighYieldSavings in North Dakota.
 ...
 */
public final class HighYieldSavingsNDRegulatoryFilings {
    ...
    public HighYieldSavingsNDRegulatoryFilings() {
        this(new HighYieldSavingsNDProfile());
    }

    public HighYieldSavingsNDRegulatoryFilings(HighYieldSavingsNDProfile profile) {

...
/**
 * Branch / channel integration metadata for HighYieldSavings in North Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNDBranchIntegration {
    ...
    public HighYieldSavingsNDBranchIntegration() {
        this.profile = new HighYieldSavingsNDProfile();
    }

    public HighYieldSavingsNDBranchIntegration(HighYieldSavingsNDProfile profile) {

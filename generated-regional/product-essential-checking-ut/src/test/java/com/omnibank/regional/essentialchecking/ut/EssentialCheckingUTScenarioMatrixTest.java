...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingUT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingUTProfile},
 * {@link EssentialCheckingUTRateTable}, {@link EssentialCheckingUTDisclosures},
 * {@link EssentialCheckingUTRegulatoryFilings}, and {@link EssentialCheckingUTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingUTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingUTScenarioMatrixTest {

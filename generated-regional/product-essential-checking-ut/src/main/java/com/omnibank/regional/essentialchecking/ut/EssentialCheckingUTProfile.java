...
/**
 * Jurisdiction profile for EssentialChecking as offered in Utah (UT).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingUTProfile {
    ...
    public EssentialCheckingUTProfile() {
        this.stateCode = "UT";
        this.stateName = "Utah";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0485");

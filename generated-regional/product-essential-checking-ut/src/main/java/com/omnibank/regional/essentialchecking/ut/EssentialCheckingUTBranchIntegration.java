...
/**
 * Branch / channel integration metadata for EssentialChecking in Utah.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingUTBranchIntegration {
    ...
    public EssentialCheckingUTBranchIntegration() {
        this.profile = new EssentialCheckingUTProfile();
    }

    public EssentialCheckingUTBranchIntegration(EssentialCheckingUTProfile profile) {

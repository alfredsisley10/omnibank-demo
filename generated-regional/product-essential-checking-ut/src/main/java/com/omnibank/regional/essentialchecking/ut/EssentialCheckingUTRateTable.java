...
/**
 * State-specific rate table overlay for EssentialChecking offered in Utah.
 ...
 */
public final class EssentialCheckingUTRateTable {
    ...
    public EssentialCheckingUTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-UT-EssentialChecking-2026Q1";

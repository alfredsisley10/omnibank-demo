package com.omnibank.regional.essentialchecking.ut;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Utah.
 ...
 */
public final class EssentialCheckingUTDisclosures {

    private final EssentialCheckingUTProfile profile;

    public EssentialCheckingUTDisclosures() {
        this.profile = new EssentialCheckingUTProfile();
    }

    public EssentialCheckingUTDisclosures(EssentialCheckingUTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Utah State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

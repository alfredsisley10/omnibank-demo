...
/**
 * State regulatory filing cadence for EssentialChecking in Utah.
 ...
 */
public final class EssentialCheckingUTRegulatoryFilings {
    ...
    public EssentialCheckingUTRegulatoryFilings() {
        this(new EssentialCheckingUTProfile());
    }

    public EssentialCheckingUTRegulatoryFilings(EssentialCheckingUTProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Utah)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Utah)",
                "ANNUAL",

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingOK jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingOKProfile},
 * {@link DigitalOnlyCheckingOKRateTable}, {@link DigitalOnlyCheckingOKDisclosures},
 * {@link DigitalOnlyCheckingOKRegulatoryFilings}, and {@link DigitalOnlyCheckingOKBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingOKProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingOKScenarioMatrixTest {

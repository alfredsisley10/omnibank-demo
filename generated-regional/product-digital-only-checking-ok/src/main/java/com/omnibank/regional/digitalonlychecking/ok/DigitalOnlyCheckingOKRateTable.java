...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Oklahoma.
 ...
 */
public final class DigitalOnlyCheckingOKRateTable {
    ...
    public DigitalOnlyCheckingOKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OK-DigitalOnlyChecking-2026Q1";

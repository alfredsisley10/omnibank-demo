package com.omnibank.regional.digitalonlychecking.ok;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Oklahoma.
 ...
 */
public final class DigitalOnlyCheckingOKDisclosures {

    private final DigitalOnlyCheckingOKProfile profile;

    public DigitalOnlyCheckingOKDisclosures() {
        this.profile = new DigitalOnlyCheckingOKProfile();
    }

    public DigitalOnlyCheckingOKDisclosures(DigitalOnlyCheckingOKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Oklahoma State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

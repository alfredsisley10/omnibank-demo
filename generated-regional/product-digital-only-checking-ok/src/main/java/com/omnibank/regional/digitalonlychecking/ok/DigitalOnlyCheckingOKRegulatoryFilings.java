...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Oklahoma.
 ...
 */
public final class DigitalOnlyCheckingOKRegulatoryFilings {
    ...
    public DigitalOnlyCheckingOKRegulatoryFilings() {
        this(new DigitalOnlyCheckingOKProfile());
    }

    public DigitalOnlyCheckingOKRegulatoryFilings(DigitalOnlyCheckingOKProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Oklahoma)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Oklahoma)",
                "ANNUAL",

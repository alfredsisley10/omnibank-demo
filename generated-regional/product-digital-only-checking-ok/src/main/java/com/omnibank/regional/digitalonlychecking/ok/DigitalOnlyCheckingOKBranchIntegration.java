...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Oklahoma.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingOKBranchIntegration {
    ...
    public DigitalOnlyCheckingOKBranchIntegration() {
        this.profile = new DigitalOnlyCheckingOKProfile();
    }

    public DigitalOnlyCheckingOKBranchIntegration(DigitalOnlyCheckingOKProfile profile) {

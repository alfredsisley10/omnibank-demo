...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Oklahoma (OK).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingOKProfile {
    ...
    public DigitalOnlyCheckingOKProfile() {
        this.stateCode = "OK";

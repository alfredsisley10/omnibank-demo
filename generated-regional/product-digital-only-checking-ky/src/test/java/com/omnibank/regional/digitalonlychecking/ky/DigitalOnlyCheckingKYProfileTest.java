...
class DigitalOnlyCheckingKYProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingKYProfile();
        assertThat(p.stateCode()).isEqualTo("KY");
        assertThat(p.stateName()).isEqualTo("Kentucky");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingKYRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingKYDisclosures();
        assertThat(d.renderFullSupplement()).contains("Kentucky");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingKYRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingKYBranchIntegration();

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingKY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingKYProfile},
 * {@link DigitalOnlyCheckingKYRateTable}, {@link DigitalOnlyCheckingKYDisclosures},
 * {@link DigitalOnlyCheckingKYRegulatoryFilings}, and {@link DigitalOnlyCheckingKYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingKYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingKYScenarioMatrixTest {

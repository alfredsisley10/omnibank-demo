...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Kentucky.
 ...
 */
public final class DigitalOnlyCheckingKYRateTable {
    ...
    public DigitalOnlyCheckingKYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KY-DigitalOnlyChecking-2026Q1";

package com.omnibank.regional.digitalonlychecking.ky;
...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Kentucky.
 ...
 */
public final class DigitalOnlyCheckingKYRegulatoryFilings {
    ...
    private final DigitalOnlyCheckingKYProfile profile;

    public DigitalOnlyCheckingKYRegulatoryFilings() {
        this(new DigitalOnlyCheckingKYProfile());
    }

    public DigitalOnlyCheckingKYRegulatoryFilings(DigitalOnlyCheckingKYProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Kentucky)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Kentucky)",
                "ANNUAL",

...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Kentucky.
 ...
 */
public final class DigitalOnlyCheckingKYDisclosures {

    private final DigitalOnlyCheckingKYProfile profile;

    public DigitalOnlyCheckingKYDisclosures() {
        this.profile = new DigitalOnlyCheckingKYProfile();
    }

    public DigitalOnlyCheckingKYDisclosures(DigitalOnlyCheckingKYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Kentucky State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Kentucky (KY).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingKYProfile {
    ...
    public DigitalOnlyCheckingKYProfile() {
        this.stateCode = "KY";

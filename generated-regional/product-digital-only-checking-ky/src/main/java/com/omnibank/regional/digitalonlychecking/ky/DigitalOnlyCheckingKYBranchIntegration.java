...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Kentucky.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingKYBranchIntegration {
    ...
    public DigitalOnlyCheckingKYBranchIntegration() {
        this.profile = new DigitalOnlyCheckingKYProfile();
    }

    public DigitalOnlyCheckingKYBranchIntegration(DigitalOnlyCheckingKYProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNV jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNVProfile},
 * {@link BasicCheckingNVRateTable}, {@link BasicCheckingNVDisclosures},
 * {@link BasicCheckingNVRegulatoryFilings}, and {@link BasicCheckingNVBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNVProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNVScenarioMatrixTest {

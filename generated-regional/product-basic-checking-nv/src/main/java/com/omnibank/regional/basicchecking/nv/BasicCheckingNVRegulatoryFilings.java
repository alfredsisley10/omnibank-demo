...
/**
 * State regulatory filing cadence for BasicChecking in Nevada.
 ...
 */
public final class BasicCheckingNVRegulatoryFilings {
    ...
    public BasicCheckingNVRegulatoryFilings() {
        this(new BasicCheckingNVProfile());
    }

    public BasicCheckingNVRegulatoryFilings(BasicCheckingNVProfile profile) {

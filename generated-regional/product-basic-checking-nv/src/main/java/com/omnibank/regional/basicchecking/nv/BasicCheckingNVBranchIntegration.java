...
public final class BasicCheckingNVBranchIntegration {
    ...
    public BasicCheckingNVBranchIntegration() {
        this.profile = new BasicCheckingNVProfile();
    }

    public BasicCheckingNVBranchIntegration(BasicCheckingNVProfile profile) {

package com.omnibank.regional.basicchecking.nv;
...
/**
 * State-specific disclosure overlays for BasicChecking in Nevada.
 ...
 */
public final class BasicCheckingNVDisclosures {

    private final BasicCheckingNVProfile profile;

    public BasicCheckingNVDisclosures() {
        this.profile = new BasicCheckingNVProfile();
    }

    public BasicCheckingNVDisclosures(BasicCheckingNVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Nevada State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

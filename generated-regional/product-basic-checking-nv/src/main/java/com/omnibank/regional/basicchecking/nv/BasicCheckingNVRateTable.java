...
/**
 * State-specific rate table overlay for BasicChecking offered in Nevada.
 ...
 */
public final class BasicCheckingNVRateTable {
    ...
    public BasicCheckingNVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NV-BasicChecking-2026Q1";

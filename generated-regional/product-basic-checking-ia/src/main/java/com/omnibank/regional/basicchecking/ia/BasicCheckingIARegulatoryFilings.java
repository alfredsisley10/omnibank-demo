...
/**
 * State regulatory filing cadence for BasicChecking in Iowa.
 ...
 */
public final class BasicCheckingIARegulatoryFilings {
    ...
    public BasicCheckingIARegulatoryFilings() {
        this(new BasicCheckingIAProfile());
    }

    public BasicCheckingIARegulatoryFilings(BasicCheckingIAProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in Iowa.
 ...
 */
public final class BasicCheckingIARateTable {
    ...
    public BasicCheckingIARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IA-BasicChecking-2026Q1";

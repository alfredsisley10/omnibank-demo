...
/**
 * State-specific disclosure overlays for BasicChecking in Iowa.
 ...
 */
public final class BasicCheckingIADisclosures {

    private final BasicCheckingIAProfile profile;

    public BasicCheckingIADisclosures() {
        this.profile = new BasicCheckingIAProfile();
    }

    public BasicCheckingIADisclosures(BasicCheckingIAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Iowa State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

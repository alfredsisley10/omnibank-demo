...
public final class BasicCheckingIABranchIntegration {
    ...
    public BasicCheckingIABranchIntegration() {
        this.profile = new BasicCheckingIAProfile();
    }

    public BasicCheckingIABranchIntegration(BasicCheckingIAProfile profile) {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Indiana (IN).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingINProfile {
    ...
    public DigitalOnlyCheckingINProfile() {
        this.stateCode = "IN";

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Indiana.
 ...
 */
public final class DigitalOnlyCheckingINRegulatoryFilings {
    ...
    public DigitalOnlyCheckingINRegulatoryFilings() {
        this(new DigitalOnlyCheckingINProfile());
    }

    public DigitalOnlyCheckingINRegulatoryFilings(DigitalOnlyCheckingINProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Indiana)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Indiana)",
                "ANNUAL",

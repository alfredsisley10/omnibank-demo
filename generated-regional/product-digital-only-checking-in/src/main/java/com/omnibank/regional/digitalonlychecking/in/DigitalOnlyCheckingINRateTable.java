...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Indiana.
 ...
 */
public final class DigitalOnlyCheckingINRateTable {
    ...
    public DigitalOnlyCheckingINRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IN-DigitalOnlyChecking-2026Q1";

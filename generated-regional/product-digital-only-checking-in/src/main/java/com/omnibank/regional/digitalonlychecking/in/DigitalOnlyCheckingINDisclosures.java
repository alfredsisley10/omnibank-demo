package com.omnibank.regional.digitalonlychecking.in;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Indiana.
 ...
 */
public final class DigitalOnlyCheckingINDisclosures {

    private final DigitalOnlyCheckingINProfile profile;

    public DigitalOnlyCheckingINDisclosures() {
        this.profile = new DigitalOnlyCheckingINProfile();
    }

    public DigitalOnlyCheckingINDisclosures(DigitalOnlyCheckingINProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Indiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

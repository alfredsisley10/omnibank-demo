...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Indiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingINBranchIntegration {
    ...
    public DigitalOnlyCheckingINBranchIntegration() {
        this.profile = new DigitalOnlyCheckingINProfile();
    }

    public DigitalOnlyCheckingINBranchIntegration(DigitalOnlyCheckingINProfile profile) {

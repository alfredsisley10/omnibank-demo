...
class DigitalOnlyCheckingINProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingINProfile();
        assertThat(p.stateCode()).isEqualTo("IN");
        assertThat(p.stateName()).isEqualTo("Indiana");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingINRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingINDisclosures();
        assertThat(d.renderFullSupplement()).contains("Indiana");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingINRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingINBranchIntegration();

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingIN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingINProfile},
 * {@link DigitalOnlyCheckingINRateTable}, {@link DigitalOnlyCheckingINDisclosures},
 * {@link DigitalOnlyCheckingINRegulatoryFilings}, and {@link DigitalOnlyCheckingINBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingINProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingINScenarioMatrixTest {

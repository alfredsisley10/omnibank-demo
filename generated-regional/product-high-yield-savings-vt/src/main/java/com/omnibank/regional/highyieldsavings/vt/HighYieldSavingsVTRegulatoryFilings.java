...
/**
 * State regulatory filing cadence for HighYieldSavings in Vermont.
 ...
 */
public final class HighYieldSavingsVTRegulatoryFilings {
    ...
    public HighYieldSavingsVTRegulatoryFilings() {
        this(new HighYieldSavingsVTProfile());
    }

    public HighYieldSavingsVTRegulatoryFilings(HighYieldSavingsVTProfile profile) {

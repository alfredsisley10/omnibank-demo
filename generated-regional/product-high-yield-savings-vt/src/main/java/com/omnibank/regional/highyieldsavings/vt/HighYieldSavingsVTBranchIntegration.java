...
/**
 * Branch / channel integration metadata for HighYieldSavings in Vermont.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsVTBranchIntegration {
    ...
    public HighYieldSavingsVTBranchIntegration() {
        this.profile = new HighYieldSavingsVTProfile();
    }

    public HighYieldSavingsVTBranchIntegration(HighYieldSavingsVTProfile profile) {

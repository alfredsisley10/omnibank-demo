package com.omnibank.regional.highyieldsavings.vt;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Vermont.
 ...
 */
public final class HighYieldSavingsVTDisclosures {

    private final HighYieldSavingsVTProfile profile;

    public HighYieldSavingsVTDisclosures() {
        this.profile = new HighYieldSavingsVTProfile();
    }

    public HighYieldSavingsVTDisclosures(HighYieldSavingsVTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Vermont State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

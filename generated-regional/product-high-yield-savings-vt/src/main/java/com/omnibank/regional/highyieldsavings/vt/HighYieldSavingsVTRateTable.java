...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Vermont.
 ...
 */
public final class HighYieldSavingsVTRateTable {
    ...
    public HighYieldSavingsVTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VT-HighYieldSavings-2026Q1";

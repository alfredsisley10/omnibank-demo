...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsVT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsVTProfile},
 * {@link HighYieldSavingsVTRateTable}, {@link HighYieldSavingsVTDisclosures},
 * {@link HighYieldSavingsVTRegulatoryFilings}, and {@link HighYieldSavingsVTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsVTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsVTScenarioMatrixTest {

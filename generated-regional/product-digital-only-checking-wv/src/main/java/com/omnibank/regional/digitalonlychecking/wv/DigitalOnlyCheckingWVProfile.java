...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in West Virginia (WV).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingWVProfile {
    ...
    public DigitalOnlyCheckingWVProfile() {
        this.stateCode = "WV";

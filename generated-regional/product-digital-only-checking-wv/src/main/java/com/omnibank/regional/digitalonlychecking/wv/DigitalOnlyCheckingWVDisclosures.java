...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in West Virginia.
 ...
 */
public final class DigitalOnlyCheckingWVDisclosures {

    private final DigitalOnlyCheckingWVProfile profile;

    public DigitalOnlyCheckingWVDisclosures() {
        this.profile = new DigitalOnlyCheckingWVProfile();
    }

    public DigitalOnlyCheckingWVDisclosures(DigitalOnlyCheckingWVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — West Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

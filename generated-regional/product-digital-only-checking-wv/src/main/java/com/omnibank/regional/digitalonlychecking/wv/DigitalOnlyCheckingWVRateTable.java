...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in West Virginia.
 ...
 */
public final class DigitalOnlyCheckingWVRateTable {
    ...
    public DigitalOnlyCheckingWVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WV-DigitalOnlyChecking-2026Q1";

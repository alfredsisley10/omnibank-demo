...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in West Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingWVBranchIntegration {
    ...
    public DigitalOnlyCheckingWVBranchIntegration() {
        this.profile = new DigitalOnlyCheckingWVProfile();
    }

    public DigitalOnlyCheckingWVBranchIntegration(DigitalOnlyCheckingWVProfile profile) {

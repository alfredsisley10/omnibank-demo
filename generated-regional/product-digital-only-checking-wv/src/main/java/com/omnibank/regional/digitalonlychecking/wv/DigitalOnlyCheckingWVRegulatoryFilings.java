...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in West Virginia.
 ...
 */
public final class DigitalOnlyCheckingWVRegulatoryFilings {
    ...
    public DigitalOnlyCheckingWVRegulatoryFilings() {
        this(new DigitalOnlyCheckingWVProfile());
    }

    public DigitalOnlyCheckingWVRegulatoryFilings(DigitalOnlyCheckingWVProfile profile) {

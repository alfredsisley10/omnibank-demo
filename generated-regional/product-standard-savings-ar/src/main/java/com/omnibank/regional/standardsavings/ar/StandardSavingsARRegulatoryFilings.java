...
/**
 * State regulatory filing cadence for StandardSavings in Arkansas.
 ...
 */
public final class StandardSavingsARRegulatoryFilings {
    ...
    public StandardSavingsARRegulatoryFilings() {
        this(new StandardSavingsARProfile());
    }

    public StandardSavingsARRegulatoryFilings(StandardSavingsARProfile profile) {

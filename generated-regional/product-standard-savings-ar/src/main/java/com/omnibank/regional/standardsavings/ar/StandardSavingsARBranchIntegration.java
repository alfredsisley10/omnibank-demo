...
/**
 * Branch / channel integration metadata for StandardSavings in Arkansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsARBranchIntegration {
    ...
    public StandardSavingsARBranchIntegration() {
        this.profile = new StandardSavingsARProfile();
    }

    public StandardSavingsARBranchIntegration(StandardSavingsARProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Arkansas.
 ...
 */
public final class StandardSavingsARRateTable {
    ...
    public StandardSavingsARRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AR-StandardSavings-2026Q1";

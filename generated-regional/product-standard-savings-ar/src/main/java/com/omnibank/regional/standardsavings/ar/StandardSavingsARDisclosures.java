package com.omnibank.regional.standardsavings.ar;
...
/**
 * State-specific disclosure overlays for StandardSavings in Arkansas.
 * Layered on top of the national disclosure, these capture
 * items that only apply under AR law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsARDisclosures {

    private final StandardSavingsARProfile profile;

    public StandardSavingsARDisclosures() {
        this.profile = new StandardSavingsARProfile();
    }

    public StandardSavingsARDisclosures(StandardSavingsARProfile profile) {
    ...
    public String stateHeader() {
        return "Arkansas Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Arkansas unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Arkansas law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Arkansas does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Arkansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

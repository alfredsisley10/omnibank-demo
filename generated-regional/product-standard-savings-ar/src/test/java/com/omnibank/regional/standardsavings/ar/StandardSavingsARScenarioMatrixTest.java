...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsAR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsARProfile},
 * {@link StandardSavingsARRateTable}, {@link StandardSavingsARDisclosures},
 * {@link StandardSavingsARRegulatoryFilings}, and {@link StandardSavingsARBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsARProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsARScenarioMatrixTest {

...
public final class StandardSavingsKSBranchIntegration {
    ...
    public StandardSavingsKSBranchIntegration() {
        this.profile = new StandardSavingsKSProfile();
    }

    public StandardSavingsKSBranchIntegration(StandardSavingsKSProfile profile) {

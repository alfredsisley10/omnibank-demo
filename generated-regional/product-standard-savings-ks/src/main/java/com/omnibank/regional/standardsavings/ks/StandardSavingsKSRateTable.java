...
/**
 * State-specific rate table overlay for StandardSavings offered in Kansas.
 ...
 */
public final class StandardSavingsKSRateTable {
    ...
    public StandardSavingsKSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KS-StandardSavings-2026Q1";

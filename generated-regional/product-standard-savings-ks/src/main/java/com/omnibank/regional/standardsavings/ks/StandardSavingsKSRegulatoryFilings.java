...
/**
 * State regulatory filing cadence for StandardSavings in Kansas.
 ...
 */
public final class StandardSavingsKSRegulatoryFilings {
    ...
    public StandardSavingsKSRegulatoryFilings() {
        this(new StandardSavingsKSProfile());
    }

    public StandardSavingsKSRegulatoryFilings(StandardSavingsKSProfile profile) {

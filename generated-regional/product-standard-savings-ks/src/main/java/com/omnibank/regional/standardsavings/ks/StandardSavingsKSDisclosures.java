...
/**
 * State-specific disclosure overlays for StandardSavings in Kansas.
 * Layered on top of the national disclosure, these capture
 * items that only apply under KS law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsKSDisclosures {

    private final StandardSavingsKSProfile profile;

    public StandardSavingsKSDisclosures() {
        this.profile = new StandardSavingsKSProfile();
    }

    public StandardSavingsKSDisclosures(StandardSavingsKSProfile profile) {
    ...
    public String stateHeader() {
        return "Kansas Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Kansas unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Kansas law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Kansas does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Kansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsKS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsKSProfile},
 * {@link StandardSavingsKSRateTable}, {@link StandardSavingsKSDisclosures},
 * {@link StandardSavingsKSRegulatoryFilings}, and {@link StandardSavingsKSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsKSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsKSScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNJ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNJProfile},
 * {@link EssentialCheckingNJRateTable}, {@link EssentialCheckingNJDisclosures},
 * {@link EssentialCheckingNJRegulatoryFilings}, and {@link EssentialCheckingNJBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNJProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNJScenarioMatrixTest {

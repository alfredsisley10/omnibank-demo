...
/**
 * State regulatory filing cadence for EssentialChecking in New Jersey.
 ...
 */
public final class EssentialCheckingNJRegulatoryFilings {
    ...
    public EssentialCheckingNJRegulatoryFilings() {
        this(new EssentialCheckingNJProfile());
    }

    public EssentialCheckingNJRegulatoryFilings(EssentialCheckingNJProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (New Jersey)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (New Jersey)",
                "ANNUAL",

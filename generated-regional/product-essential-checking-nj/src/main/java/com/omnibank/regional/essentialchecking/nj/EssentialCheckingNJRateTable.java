...
/**
 * State-specific rate table overlay for EssentialChecking offered in New Jersey.
 ...
 */
public final class EssentialCheckingNJRateTable {
    ...
    public EssentialCheckingNJRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NJ-EssentialChecking-2026Q1";

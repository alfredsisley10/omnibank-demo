...
/**
 * Jurisdiction profile for EssentialChecking as offered in New Jersey (NJ).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingNJProfile {
    ...
    public EssentialCheckingNJProfile() {
        this.stateCode = "NJ";
        this.stateName = "New Jersey";
        this.region = "NORTHEAST";
        this.salesTaxRate = new BigDecimal("0.0663");

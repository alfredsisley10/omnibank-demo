package com.omnibank.regional.essentialchecking.nj;
...
/**
 * State-specific disclosure overlays for EssentialChecking in New Jersey.
 ...
 */
public final class EssentialCheckingNJDisclosures {

    private final EssentialCheckingNJProfile profile;

    public EssentialCheckingNJDisclosures() {
        this.profile = new EssentialCheckingNJProfile();
    }

    public EssentialCheckingNJDisclosures(EssentialCheckingNJProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — New Jersey State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

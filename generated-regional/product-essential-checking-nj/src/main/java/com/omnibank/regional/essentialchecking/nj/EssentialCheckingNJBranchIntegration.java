...
/**
 * Branch / channel integration metadata for EssentialChecking in New Jersey.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNJBranchIntegration {
    ...
    public EssentialCheckingNJBranchIntegration() {
        this.profile = new EssentialCheckingNJProfile();
    }

    public EssentialCheckingNJBranchIntegration(EssentialCheckingNJProfile profile) {

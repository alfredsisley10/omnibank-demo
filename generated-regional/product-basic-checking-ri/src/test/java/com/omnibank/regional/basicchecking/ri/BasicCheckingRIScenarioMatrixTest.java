...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingRI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingRIProfile},
 * {@link BasicCheckingRIRateTable}, {@link BasicCheckingRIDisclosures},
 * {@link BasicCheckingRIRegulatoryFilings}, and {@link BasicCheckingRIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingRIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingRIScenarioMatrixTest {

package com.omnibank.regional.basicchecking.ri;
...
/**
 * State-specific disclosure overlays for BasicChecking in Rhode Island.
 ...
 */
public final class BasicCheckingRIDisclosures {

    private final BasicCheckingRIProfile profile;

    public BasicCheckingRIDisclosures() {
        this.profile = new BasicCheckingRIProfile();
    }

    public BasicCheckingRIDisclosures(BasicCheckingRIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Rhode Island State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

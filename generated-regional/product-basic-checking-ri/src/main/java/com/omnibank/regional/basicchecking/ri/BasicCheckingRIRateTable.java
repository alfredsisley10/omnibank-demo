...
/**
 * State-specific rate table overlay for BasicChecking offered in Rhode Island.
 ...
 */
public final class BasicCheckingRIRateTable {
    ...
    public BasicCheckingRIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-RI-BasicChecking-2026Q1";

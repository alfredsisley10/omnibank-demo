...
/**
 * State regulatory filing cadence for BasicChecking in Rhode Island.
 ...
 */
public final class BasicCheckingRIRegulatoryFilings {
    ...
    public BasicCheckingRIRegulatoryFilings() {
        this(new BasicCheckingRIProfile());
    }

    public BasicCheckingRIRegulatoryFilings(BasicCheckingRIProfile profile) {

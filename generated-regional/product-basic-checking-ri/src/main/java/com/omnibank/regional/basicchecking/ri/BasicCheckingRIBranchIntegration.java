...
/**
 * Branch / channel integration metadata for BasicChecking in Rhode Island.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingRIBranchIntegration {
    ...
    public BasicCheckingRIBranchIntegration() {
        this.profile = new BasicCheckingRIProfile();
    }

    public BasicCheckingRIBranchIntegration(BasicCheckingRIProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in Delaware.
 ...
 */
public final class BasicCheckingDERateTable {
    ...
    public BasicCheckingDERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-DE-BasicChecking-2026Q1";

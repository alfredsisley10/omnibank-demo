...
/**
 * State-specific disclosure overlays for BasicChecking in Delaware.
 ...
 */
public final class BasicCheckingDEDisclosures {

    private final BasicCheckingDEProfile profile;

    public BasicCheckingDEDisclosures() {
        this.profile = new BasicCheckingDEProfile();
    }

    public BasicCheckingDEDisclosures(BasicCheckingDEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Delaware State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

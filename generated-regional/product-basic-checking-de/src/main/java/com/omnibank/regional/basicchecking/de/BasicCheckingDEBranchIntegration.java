...
public final class BasicCheckingDEBranchIntegration {
    ...
    public BasicCheckingDEBranchIntegration() {
        this.profile = new BasicCheckingDEProfile();
    }

    public BasicCheckingDEBranchIntegration(BasicCheckingDEProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingDE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingDEProfile},
 * {@link BasicCheckingDERateTable}, {@link BasicCheckingDEDisclosures},
 * {@link BasicCheckingDERegulatoryFilings}, and {@link BasicCheckingDEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingDEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingDEScenarioMatrixTest {

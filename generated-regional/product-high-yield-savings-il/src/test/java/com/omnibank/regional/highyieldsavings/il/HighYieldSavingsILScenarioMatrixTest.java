...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsIL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsILProfile},
 * {@link HighYieldSavingsILRateTable}, {@link HighYieldSavingsILDisclosures},
 * {@link HighYieldSavingsILRegulatoryFilings}, and {@link HighYieldSavingsILBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsILProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsILScenarioMatrixTest {

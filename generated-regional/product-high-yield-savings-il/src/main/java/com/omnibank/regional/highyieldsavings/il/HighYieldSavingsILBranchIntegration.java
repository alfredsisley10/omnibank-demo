...
/**
 * Branch / channel integration metadata for HighYieldSavings in Illinois.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsILBranchIntegration {
    ...
    public HighYieldSavingsILBranchIntegration() {
        this.profile = new HighYieldSavingsILProfile();
    }

    public HighYieldSavingsILBranchIntegration(HighYieldSavingsILProfile profile) {

...
/**
 * State regulatory filing cadence for HighYieldSavings in Illinois.
 ...
 */
public final class HighYieldSavingsILRegulatoryFilings {
    ...
    public HighYieldSavingsILRegulatoryFilings() {
        this(new HighYieldSavingsILProfile());
    }

    public HighYieldSavingsILRegulatoryFilings(HighYieldSavingsILProfile profile) {

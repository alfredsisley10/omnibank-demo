package com.omnibank.regional.highyieldsavings.il;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Illinois.
 ...
 */
public final class HighYieldSavingsILDisclosures {

    private final HighYieldSavingsILProfile profile;

    public HighYieldSavingsILDisclosures() {
        this.profile = new HighYieldSavingsILProfile();
    }

    public HighYieldSavingsILDisclosures(HighYieldSavingsILProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Illinois State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Illinois.
 ...
 */
public final class HighYieldSavingsILRateTable {
    ...
    public HighYieldSavingsILRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IL-HighYieldSavings-2026Q1";

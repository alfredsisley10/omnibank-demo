...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMNProfile},
 * {@link DigitalOnlyCheckingMNRateTable}, {@link DigitalOnlyCheckingMNDisclosures},
 * {@link DigitalOnlyCheckingMNRegulatoryFilings}, and {@link DigitalOnlyCheckingMNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMNScenarioMatrixTest {

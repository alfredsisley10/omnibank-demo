...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Minnesota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMNBranchIntegration {
    ...
    public DigitalOnlyCheckingMNBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMNProfile();
    }

    public DigitalOnlyCheckingMNBranchIntegration(DigitalOnlyCheckingMNProfile profile) {

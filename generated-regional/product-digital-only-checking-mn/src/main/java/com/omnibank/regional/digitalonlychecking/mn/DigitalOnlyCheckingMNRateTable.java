...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Minnesota.
 ...
 */
public final class DigitalOnlyCheckingMNRateTable {
    ...
    public DigitalOnlyCheckingMNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MN-DigitalOnlyChecking-2026Q1";

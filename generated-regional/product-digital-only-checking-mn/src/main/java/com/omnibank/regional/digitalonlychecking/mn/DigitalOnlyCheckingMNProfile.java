...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Minnesota (MN).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMNProfile {
    ...
    public DigitalOnlyCheckingMNProfile() {
        this.stateCode = "MN";
        this.stateName = "Minnesota";
        this.region = "MIDWEST";
        this.salesTaxRate = new BigDecimal("0.0688");

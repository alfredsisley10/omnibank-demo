...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Minnesota.
 ...
 */
public final class DigitalOnlyCheckingMNDisclosures {

    private final DigitalOnlyCheckingMNProfile profile;

    public DigitalOnlyCheckingMNDisclosures() {
        this.profile = new DigitalOnlyCheckingMNProfile();
    }

    public DigitalOnlyCheckingMNDisclosures(DigitalOnlyCheckingMNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Minnesota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

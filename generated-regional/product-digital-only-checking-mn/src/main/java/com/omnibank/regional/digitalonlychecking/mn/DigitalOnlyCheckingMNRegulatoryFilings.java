...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Minnesota.
 ...
 */
public final class DigitalOnlyCheckingMNRegulatoryFilings {
    ...
    public DigitalOnlyCheckingMNRegulatoryFilings() {
        this(new DigitalOnlyCheckingMNProfile());
    }

    public DigitalOnlyCheckingMNRegulatoryFilings(DigitalOnlyCheckingMNProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Minnesota)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Minnesota)",
                "ANNUAL",

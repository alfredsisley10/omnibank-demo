...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsOH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsOHProfile},
 * {@link StandardSavingsOHRateTable}, {@link StandardSavingsOHDisclosures},
 * {@link StandardSavingsOHRegulatoryFilings}, and {@link StandardSavingsOHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsOHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsOHScenarioMatrixTest {

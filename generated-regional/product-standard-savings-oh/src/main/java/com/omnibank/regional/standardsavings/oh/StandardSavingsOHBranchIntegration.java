...
public final class StandardSavingsOHBranchIntegration {
    ...
    public StandardSavingsOHBranchIntegration() {
        this.profile = new StandardSavingsOHProfile();
    }

    public StandardSavingsOHBranchIntegration(StandardSavingsOHProfile profile) {

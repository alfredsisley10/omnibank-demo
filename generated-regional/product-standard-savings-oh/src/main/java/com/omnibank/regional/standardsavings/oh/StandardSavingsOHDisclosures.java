package com.omnibank.regional.standardsavings.oh;
...
/**
 * State-specific disclosure overlays for StandardSavings in Ohio.
 * Layered on top of the national disclosure, these capture
 * items that only apply under OH law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsOHDisclosures {

    private final StandardSavingsOHProfile profile;

    public StandardSavingsOHDisclosures() {
        this.profile = new StandardSavingsOHProfile();
    }

    public StandardSavingsOHDisclosures(StandardSavingsOHProfile profile) {
    ...
    public String stateHeader() {
        return "Ohio Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Ohio unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Ohio law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Ohio does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Ohio State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for StandardSavings offered in Ohio.
 ...
 */
public final class StandardSavingsOHRateTable {
    ...
    public StandardSavingsOHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OH-StandardSavings-2026Q1";

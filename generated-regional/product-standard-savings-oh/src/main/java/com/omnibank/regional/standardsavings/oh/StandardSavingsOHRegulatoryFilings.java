...
/**
 * State regulatory filing cadence for StandardSavings in Ohio.
 ...
 */
public final class StandardSavingsOHRegulatoryFilings {
    ...
    public StandardSavingsOHRegulatoryFilings() {
        this(new StandardSavingsOHProfile());
    }

    public StandardSavingsOHRegulatoryFilings(StandardSavingsOHProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingTX jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingTXProfile},
 * {@link EssentialCheckingTXRateTable}, {@link EssentialCheckingTXDisclosures},
 * {@link EssentialCheckingTXRegulatoryFilings}, and {@link EssentialCheckingTXBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingTXProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingTXScenarioMatrixTest {

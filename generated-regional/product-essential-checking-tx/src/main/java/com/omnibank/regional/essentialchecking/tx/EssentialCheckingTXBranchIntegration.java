...
/**
 * Branch / channel integration metadata for EssentialChecking in Texas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingTXBranchIntegration {
    ...
    public EssentialCheckingTXBranchIntegration() {
        this.profile = new EssentialCheckingTXProfile();
    }

    public EssentialCheckingTXBranchIntegration(EssentialCheckingTXProfile profile) {

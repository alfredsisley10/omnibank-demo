...
/**
 * State-specific disclosure overlays for EssentialChecking in Texas.
 ...
 */
public final class EssentialCheckingTXDisclosures {

    private final EssentialCheckingTXProfile profile;

    public EssentialCheckingTXDisclosures() {
        this.profile = new EssentialCheckingTXProfile();
    }

    public EssentialCheckingTXDisclosures(EssentialCheckingTXProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Texas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Texas.
 ...
 */
public final class EssentialCheckingTXRateTable {
    ...
    public EssentialCheckingTXRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TX-EssentialChecking-2026Q1";

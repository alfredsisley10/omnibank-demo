...
/**
 * State regulatory filing cadence for EssentialChecking in Texas.
 ...
 */
public final class EssentialCheckingTXRegulatoryFilings {
    ...
    public EssentialCheckingTXRegulatoryFilings() {
        this(new EssentialCheckingTXProfile());
    }

    public EssentialCheckingTXRegulatoryFilings(EssentialCheckingTXProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsOK jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsOKProfile},
 * {@link StandardSavingsOKRateTable}, {@link StandardSavingsOKDisclosures},
 * {@link StandardSavingsOKRegulatoryFilings}, and {@link StandardSavingsOKBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsOKProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsOKScenarioMatrixTest {

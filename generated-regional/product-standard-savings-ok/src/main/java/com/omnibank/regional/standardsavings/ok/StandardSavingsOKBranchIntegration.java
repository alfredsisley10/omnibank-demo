...
/**
 * Branch / channel integration metadata for StandardSavings in Oklahoma.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsOKBranchIntegration {
    ...
    public StandardSavingsOKBranchIntegration() {
        this.profile = new StandardSavingsOKProfile();
    }

    public StandardSavingsOKBranchIntegration(StandardSavingsOKProfile profile) {

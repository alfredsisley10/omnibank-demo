...
/**
 * State regulatory filing cadence for StandardSavings in Oklahoma.
 ...
 */
public final class StandardSavingsOKRegulatoryFilings {
    ...
    public StandardSavingsOKRegulatoryFilings() {
        this(new StandardSavingsOKProfile());
    }

    public StandardSavingsOKRegulatoryFilings(StandardSavingsOKProfile profile) {

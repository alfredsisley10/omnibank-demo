...
/**
 * State-specific rate table overlay for StandardSavings offered in Oklahoma.
 ...
 */
public final class StandardSavingsOKRateTable {
    ...
    public StandardSavingsOKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OK-StandardSavings-2026Q1";

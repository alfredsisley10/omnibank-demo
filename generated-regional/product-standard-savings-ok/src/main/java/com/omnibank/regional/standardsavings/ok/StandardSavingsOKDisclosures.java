...
/**
 * State-specific disclosure overlays for StandardSavings in Oklahoma.
 * Layered on top of the national disclosure, these capture
 * items that only apply under OK law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsOKDisclosures {

    private final StandardSavingsOKProfile profile;

    public StandardSavingsOKDisclosures() {
        this.profile = new StandardSavingsOKProfile();
    }

    public StandardSavingsOKDisclosures(StandardSavingsOKProfile profile) {
    ...
    public String stateHeader() {
        return "Oklahoma Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Oklahoma unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Oklahoma law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Oklahoma does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Oklahoma State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

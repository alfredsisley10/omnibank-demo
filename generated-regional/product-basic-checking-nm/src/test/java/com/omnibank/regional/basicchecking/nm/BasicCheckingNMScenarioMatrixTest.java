...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNM jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNMProfile},
 * {@link BasicCheckingNMRateTable}, {@link BasicCheckingNMDisclosures},
 * {@link BasicCheckingNMRegulatoryFilings}, and {@link BasicCheckingNMBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNMProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNMScenarioMatrixTest {

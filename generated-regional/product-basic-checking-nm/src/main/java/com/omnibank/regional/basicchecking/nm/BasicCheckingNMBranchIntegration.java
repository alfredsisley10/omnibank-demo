...
public final class BasicCheckingNMBranchIntegration {
    ...
    public BasicCheckingNMBranchIntegration() {
        this.profile = new BasicCheckingNMProfile();
    }

    public BasicCheckingNMBranchIntegration(BasicCheckingNMProfile profile) {

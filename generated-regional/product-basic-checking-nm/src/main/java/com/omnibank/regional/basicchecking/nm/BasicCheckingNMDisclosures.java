package com.omnibank.regional.basicchecking.nm;
...
/**
 * State-specific disclosure overlays for BasicChecking in New Mexico.
 ...
 */
public final class BasicCheckingNMDisclosures {

    private final BasicCheckingNMProfile profile;

    public BasicCheckingNMDisclosures() {
        this.profile = new BasicCheckingNMProfile();
    }

    public BasicCheckingNMDisclosures(BasicCheckingNMProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — New Mexico State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

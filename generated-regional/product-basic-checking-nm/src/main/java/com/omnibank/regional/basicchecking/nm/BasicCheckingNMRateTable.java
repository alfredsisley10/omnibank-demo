...
/**
 * State-specific rate table overlay for BasicChecking offered in New Mexico.
 ...
 */
public final class BasicCheckingNMRateTable {
    ...
    public BasicCheckingNMRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NM-BasicChecking-2026Q1";

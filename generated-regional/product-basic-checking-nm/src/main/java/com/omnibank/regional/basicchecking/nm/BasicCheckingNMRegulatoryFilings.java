...
/**
 * State regulatory filing cadence for BasicChecking in New Mexico.
 ...
 */
public final class BasicCheckingNMRegulatoryFilings {
    ...
    public BasicCheckingNMRegulatoryFilings() {
        this(new BasicCheckingNMProfile());
    }

    public BasicCheckingNMRegulatoryFilings(BasicCheckingNMProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingIA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingIAProfile},
 * {@link DigitalOnlyCheckingIARateTable}, {@link DigitalOnlyCheckingIADisclosures},
 * {@link DigitalOnlyCheckingIARegulatoryFilings}, and {@link DigitalOnlyCheckingIABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingIAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingIAScenarioMatrixTest {

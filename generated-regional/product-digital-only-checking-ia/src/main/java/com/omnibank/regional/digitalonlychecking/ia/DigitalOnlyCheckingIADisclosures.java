package com.omnibank.regional.digitalonlychecking.ia;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Iowa.
 ...
 */
public final class DigitalOnlyCheckingIADisclosures {

    private final DigitalOnlyCheckingIAProfile profile;

    public DigitalOnlyCheckingIADisclosures() {
        this.profile = new DigitalOnlyCheckingIAProfile();
    }

    public DigitalOnlyCheckingIADisclosures(DigitalOnlyCheckingIAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Iowa State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

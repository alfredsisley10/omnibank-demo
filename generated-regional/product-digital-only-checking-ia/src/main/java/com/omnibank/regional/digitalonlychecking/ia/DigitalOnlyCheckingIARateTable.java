...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Iowa.
 ...
 */
public final class DigitalOnlyCheckingIARateTable {
    ...
    public DigitalOnlyCheckingIARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IA-DigitalOnlyChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Iowa.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingIABranchIntegration {
    ...
    public DigitalOnlyCheckingIABranchIntegration() {
        this.profile = new DigitalOnlyCheckingIAProfile();
    }

    public DigitalOnlyCheckingIABranchIntegration(DigitalOnlyCheckingIAProfile profile) {

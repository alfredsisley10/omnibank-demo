...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Iowa.
 ...
 */
public final class DigitalOnlyCheckingIARegulatoryFilings {
    ...
    public DigitalOnlyCheckingIARegulatoryFilings() {
        this(new DigitalOnlyCheckingIAProfile());
    }

    public DigitalOnlyCheckingIARegulatoryFilings(DigitalOnlyCheckingIAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Iowa)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Iowa)",
                "ANNUAL",

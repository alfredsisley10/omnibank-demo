...
/**
 * State-specific rate table overlay for EssentialChecking offered in Wyoming.
 ...
 */
public final class EssentialCheckingWYRateTable {
    ...
    public EssentialCheckingWYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WY-EssentialChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for EssentialChecking in Wyoming.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingWYBranchIntegration {
    ...
    public EssentialCheckingWYBranchIntegration() {
        this.profile = new EssentialCheckingWYProfile();
    }

    public EssentialCheckingWYBranchIntegration(EssentialCheckingWYProfile profile) {

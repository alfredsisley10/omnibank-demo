package com.omnibank.regional.essentialchecking.wy;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Wyoming.
 ...
 */
public final class EssentialCheckingWYDisclosures {

    private final EssentialCheckingWYProfile profile;

    public EssentialCheckingWYDisclosures() {
        this.profile = new EssentialCheckingWYProfile();
    }

    public EssentialCheckingWYDisclosures(EssentialCheckingWYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Wyoming State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for EssentialChecking in Wyoming.
 ...
 */
public final class EssentialCheckingWYRegulatoryFilings {
    ...
    public EssentialCheckingWYRegulatoryFilings() {
        this(new EssentialCheckingWYProfile());
    }

    public EssentialCheckingWYRegulatoryFilings(EssentialCheckingWYProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in West Virginia.
 ...
 */
public final class BasicCheckingWVRateTable {
    ...
    public BasicCheckingWVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WV-BasicChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for BasicChecking in West Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingWVBranchIntegration {
    ...
    public BasicCheckingWVBranchIntegration() {
        this.profile = new BasicCheckingWVProfile();
    }

    public BasicCheckingWVBranchIntegration(BasicCheckingWVProfile profile) {

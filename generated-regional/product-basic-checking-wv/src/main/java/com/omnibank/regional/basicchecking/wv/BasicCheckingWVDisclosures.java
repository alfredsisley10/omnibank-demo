...
/**
 * State-specific disclosure overlays for BasicChecking in West Virginia.
 ...
 */
public final class BasicCheckingWVDisclosures {

    private final BasicCheckingWVProfile profile;

    public BasicCheckingWVDisclosures() {
        this.profile = new BasicCheckingWVProfile();
    }

    public BasicCheckingWVDisclosures(BasicCheckingWVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — West Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

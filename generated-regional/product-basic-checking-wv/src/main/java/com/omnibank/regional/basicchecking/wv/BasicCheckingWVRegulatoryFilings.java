...
/**
 * State regulatory filing cadence for BasicChecking in West Virginia.
 ...
 */
public final class BasicCheckingWVRegulatoryFilings {
    ...
    public BasicCheckingWVRegulatoryFilings() {
        this(new BasicCheckingWVProfile());
    }

    public BasicCheckingWVRegulatoryFilings(BasicCheckingWVProfile profile) {

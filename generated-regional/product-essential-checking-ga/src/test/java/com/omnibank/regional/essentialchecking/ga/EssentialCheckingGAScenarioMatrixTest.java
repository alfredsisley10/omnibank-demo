...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingGA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingGAProfile},
 * {@link EssentialCheckingGARateTable}, {@link EssentialCheckingGADisclosures},
 * {@link EssentialCheckingGARegulatoryFilings}, and {@link EssentialCheckingGABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingGAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingGAScenarioMatrixTest {

package com.omnibank.regional.essentialchecking.ga;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Georgia.
 ...
 */
public final class EssentialCheckingGADisclosures {

    private final EssentialCheckingGAProfile profile;

    public EssentialCheckingGADisclosures() {
        this.profile = new EssentialCheckingGAProfile();
    }

    public EssentialCheckingGADisclosures(EssentialCheckingGAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Georgia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

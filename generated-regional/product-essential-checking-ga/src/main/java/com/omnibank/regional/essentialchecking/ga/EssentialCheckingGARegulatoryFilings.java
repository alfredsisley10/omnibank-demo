...
/**
 * State regulatory filing cadence for EssentialChecking in Georgia.
 ...
 */
public final class EssentialCheckingGARegulatoryFilings {
    ...
    public EssentialCheckingGARegulatoryFilings() {
        this(new EssentialCheckingGAProfile());
    }

    public EssentialCheckingGARegulatoryFilings(EssentialCheckingGAProfile profile) {

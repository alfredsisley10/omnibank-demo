...
/**
 * State-specific rate table overlay for EssentialChecking offered in Georgia.
 ...
 */
public final class EssentialCheckingGARateTable {
    ...
    public EssentialCheckingGARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-GA-EssentialChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for EssentialChecking in Georgia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingGABranchIntegration {
    ...
    public EssentialCheckingGABranchIntegration() {
        this.profile = new EssentialCheckingGAProfile();
    }

    public EssentialCheckingGABranchIntegration(EssentialCheckingGAProfile profile) {

...
class DigitalOnlyCheckingVAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingVAProfile();
        assertThat(p.stateCode()).isEqualTo("VA");
        assertThat(p.stateName()).isEqualTo("Virginia");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingVARateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingVADisclosures();
        assertThat(d.renderFullSupplement()).contains("Virginia");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingVARegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingVABranchIntegration();

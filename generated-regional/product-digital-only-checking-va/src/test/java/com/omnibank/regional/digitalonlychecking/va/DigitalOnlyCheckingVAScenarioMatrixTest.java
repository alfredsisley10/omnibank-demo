...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingVA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingVAProfile},
 * {@link DigitalOnlyCheckingVARateTable}, {@link DigitalOnlyCheckingVADisclosures},
 * {@link DigitalOnlyCheckingVARegulatoryFilings}, and {@link DigitalOnlyCheckingVABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingVAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingVAScenarioMatrixTest {

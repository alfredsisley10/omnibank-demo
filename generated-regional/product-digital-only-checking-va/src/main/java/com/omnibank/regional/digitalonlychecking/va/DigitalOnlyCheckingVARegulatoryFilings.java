...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Virginia.
 ...
 */
public final class DigitalOnlyCheckingVARegulatoryFilings {
    ...
    public DigitalOnlyCheckingVARegulatoryFilings() {
        this(new DigitalOnlyCheckingVAProfile());
    }

    public DigitalOnlyCheckingVARegulatoryFilings(DigitalOnlyCheckingVAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Virginia)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Virginia)",
                "ANNUAL",

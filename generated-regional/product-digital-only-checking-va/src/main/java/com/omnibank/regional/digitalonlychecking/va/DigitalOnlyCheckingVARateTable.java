...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Virginia.
 ...
 */
public final class DigitalOnlyCheckingVARateTable {
    ...
    public DigitalOnlyCheckingVARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VA-DigitalOnlyChecking-2026Q1";

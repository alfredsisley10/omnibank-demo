...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Virginia (VA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingVAProfile {
    ...
    public DigitalOnlyCheckingVAProfile() {
        this.stateCode = "VA";
        this.stateName = "Virginia";
        this.region = "SOUTH";
        this.salesTaxRate = new BigDecimal("0.0530");

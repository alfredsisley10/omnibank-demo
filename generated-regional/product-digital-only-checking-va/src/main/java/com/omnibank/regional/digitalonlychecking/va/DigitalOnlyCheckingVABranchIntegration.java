...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingVABranchIntegration {
    ...
    public DigitalOnlyCheckingVABranchIntegration() {
        this.profile = new DigitalOnlyCheckingVAProfile();
    }

    public DigitalOnlyCheckingVABranchIntegration(DigitalOnlyCheckingVAProfile profile) {

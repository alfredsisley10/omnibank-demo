package com.omnibank.regional.digitalonlychecking.va;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Virginia.
 ...
 */
public final class DigitalOnlyCheckingVADisclosures {

    private final DigitalOnlyCheckingVAProfile profile;

    public DigitalOnlyCheckingVADisclosures() {
        this.profile = new DigitalOnlyCheckingVAProfile();
    }

    public DigitalOnlyCheckingVADisclosures(DigitalOnlyCheckingVAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

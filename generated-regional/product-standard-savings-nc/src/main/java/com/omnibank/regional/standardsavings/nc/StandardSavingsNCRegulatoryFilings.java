...
/**
 * State regulatory filing cadence for StandardSavings in North Carolina.
 ...
 */
public final class StandardSavingsNCRegulatoryFilings {
    ...
    public StandardSavingsNCRegulatoryFilings() {
        this(new StandardSavingsNCProfile());
    }

    public StandardSavingsNCRegulatoryFilings(StandardSavingsNCProfile profile) {

package com.omnibank.regional.standardsavings.nc;
...
/**
 * State-specific disclosure overlays for StandardSavings in North Carolina.
 ...
 */
public final class StandardSavingsNCDisclosures {

    private final StandardSavingsNCProfile profile;

    public StandardSavingsNCDisclosures() {
        this.profile = new StandardSavingsNCProfile();
    }

    public StandardSavingsNCDisclosures(StandardSavingsNCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — North Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

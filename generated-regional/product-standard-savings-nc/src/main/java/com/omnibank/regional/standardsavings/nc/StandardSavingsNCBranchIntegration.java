...
/**
 * Branch / channel integration metadata for StandardSavings in North Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNCBranchIntegration {
    ...
    public StandardSavingsNCBranchIntegration() {
        this.profile = new StandardSavingsNCProfile();
    }

    public StandardSavingsNCBranchIntegration(StandardSavingsNCProfile profile) {

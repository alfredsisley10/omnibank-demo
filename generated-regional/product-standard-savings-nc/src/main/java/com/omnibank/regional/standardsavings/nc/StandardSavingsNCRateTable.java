...
/**
 * State-specific rate table overlay for StandardSavings offered in North Carolina.
 ...
 */
public final class StandardSavingsNCRateTable {
    ...
    public StandardSavingsNCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NC-StandardSavings-2026Q1";

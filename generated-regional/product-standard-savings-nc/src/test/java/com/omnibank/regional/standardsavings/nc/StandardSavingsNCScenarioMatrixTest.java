...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNCProfile},
 * {@link StandardSavingsNCRateTable}, {@link StandardSavingsNCDisclosures},
 * {@link StandardSavingsNCRegulatoryFilings}, and {@link StandardSavingsNCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNCScenarioMatrixTest {

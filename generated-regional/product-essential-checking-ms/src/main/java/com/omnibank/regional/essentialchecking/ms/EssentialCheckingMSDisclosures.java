package com.omnibank.regional.essentialchecking.ms;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Mississippi.
 ...
 */
public final class EssentialCheckingMSDisclosures {

    private final EssentialCheckingMSProfile profile;

    public EssentialCheckingMSDisclosures() {
        this.profile = new EssentialCheckingMSProfile();
    }

    public EssentialCheckingMSDisclosures(EssentialCheckingMSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Mississippi State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

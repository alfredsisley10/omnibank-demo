...
/**
 * State regulatory filing cadence for EssentialChecking in Mississippi.
 ...
 */
public final class EssentialCheckingMSRegulatoryFilings {
    ...
    public EssentialCheckingMSRegulatoryFilings() {
        this(new EssentialCheckingMSProfile());
    }

    public EssentialCheckingMSRegulatoryFilings(EssentialCheckingMSProfile profile) {

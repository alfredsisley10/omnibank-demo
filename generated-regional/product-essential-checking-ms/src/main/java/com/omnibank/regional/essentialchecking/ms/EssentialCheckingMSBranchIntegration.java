...
/**
 * Branch / channel integration metadata for EssentialChecking in Mississippi.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMSBranchIntegration {
    ...
    public EssentialCheckingMSBranchIntegration() {
        this.profile = new EssentialCheckingMSProfile();
    }

    public EssentialCheckingMSBranchIntegration(EssentialCheckingMSProfile profile) {

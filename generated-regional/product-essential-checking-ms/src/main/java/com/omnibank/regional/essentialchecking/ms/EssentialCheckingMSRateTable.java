...
/**
 * State-specific rate table overlay for EssentialChecking offered in Mississippi.
 ...
 */
public final class EssentialCheckingMSRateTable {
    ...
    public EssentialCheckingMSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MS-EssentialChecking-2026Q1";

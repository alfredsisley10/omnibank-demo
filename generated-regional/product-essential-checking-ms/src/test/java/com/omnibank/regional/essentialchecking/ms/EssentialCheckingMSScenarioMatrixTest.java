...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMSProfile},
 * {@link EssentialCheckingMSRateTable}, {@link EssentialCheckingMSDisclosures},
 * {@link EssentialCheckingMSRegulatoryFilings}, and {@link EssentialCheckingMSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMSScenarioMatrixTest {

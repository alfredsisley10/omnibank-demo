...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingIL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingILProfile},
 * {@link BasicCheckingILRateTable}, {@link BasicCheckingILDisclosures},
 * {@link BasicCheckingILRegulatoryFilings}, and {@link BasicCheckingILBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingILProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingILScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for BasicChecking offered in Illinois.
 ...
 */
public final class BasicCheckingILRateTable {
    ...
    public BasicCheckingILRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IL-BasicChecking-2026Q1";

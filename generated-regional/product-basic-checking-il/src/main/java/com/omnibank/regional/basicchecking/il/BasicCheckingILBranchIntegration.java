...
public final class BasicCheckingILBranchIntegration {
    ...
    public BasicCheckingILBranchIntegration() {
        this.profile = new BasicCheckingILProfile();
    }

    public BasicCheckingILBranchIntegration(BasicCheckingILProfile profile) {

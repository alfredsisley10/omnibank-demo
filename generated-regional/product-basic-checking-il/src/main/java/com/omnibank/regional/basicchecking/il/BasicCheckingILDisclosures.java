...
/**
 * State-specific disclosure overlays for BasicChecking in Illinois.
 ...
 */
public final class BasicCheckingILDisclosures {

    private final BasicCheckingILProfile profile;

    public BasicCheckingILDisclosures() {
        this.profile = new BasicCheckingILProfile();
    }

    public BasicCheckingILDisclosures(BasicCheckingILProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Illinois State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

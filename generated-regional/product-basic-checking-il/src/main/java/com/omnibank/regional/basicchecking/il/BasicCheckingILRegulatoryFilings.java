...
/**
 * State regulatory filing cadence for BasicChecking in Illinois.
 ...
 */
public final class BasicCheckingILRegulatoryFilings {
    ...
    public BasicCheckingILRegulatoryFilings() {
        this(new BasicCheckingILProfile());
    }

    public BasicCheckingILRegulatoryFilings(BasicCheckingILProfile profile) {

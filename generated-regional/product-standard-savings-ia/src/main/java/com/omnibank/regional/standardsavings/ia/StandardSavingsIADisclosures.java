package com.omnibank.regional.standardsavings.ia;
...
/**
 * State-specific disclosure overlays for StandardSavings in Iowa.
 * Layered on top of the national disclosure, these capture
 * items that only apply under IA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsIADisclosures {

    private final StandardSavingsIAProfile profile;

    public StandardSavingsIADisclosures() {
        this.profile = new StandardSavingsIAProfile();
    }

    public StandardSavingsIADisclosures(StandardSavingsIAProfile profile) {
    ...
    public String stateHeader() {
        return "Iowa Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Iowa unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Iowa law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Iowa does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Iowa State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

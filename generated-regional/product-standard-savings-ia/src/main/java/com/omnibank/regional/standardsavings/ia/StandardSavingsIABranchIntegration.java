...
public final class StandardSavingsIABranchIntegration {
    ...
    public StandardSavingsIABranchIntegration() {
        this.profile = new StandardSavingsIAProfile();
    }

    public StandardSavingsIABranchIntegration(StandardSavingsIAProfile profile) {

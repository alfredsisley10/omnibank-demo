...
/**
 * State regulatory filing cadence for StandardSavings in Iowa.
 ...
 */
public final class StandardSavingsIARegulatoryFilings {
    ...
    public StandardSavingsIARegulatoryFilings() {
        this(new StandardSavingsIAProfile());
    }

    public StandardSavingsIARegulatoryFilings(StandardSavingsIAProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Iowa.
 ...
 */
public final class StandardSavingsIARateTable {
    ...
    public StandardSavingsIARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IA-StandardSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsIA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsIAProfile},
 * {@link StandardSavingsIARateTable}, {@link StandardSavingsIADisclosures},
 * {@link StandardSavingsIARegulatoryFilings}, and {@link StandardSavingsIABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsIAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsIAScenarioMatrixTest {

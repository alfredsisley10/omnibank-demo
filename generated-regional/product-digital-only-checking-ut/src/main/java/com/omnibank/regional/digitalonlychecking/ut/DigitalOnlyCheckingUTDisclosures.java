...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Utah.
 ...
 */
public final class DigitalOnlyCheckingUTDisclosures {

    private final DigitalOnlyCheckingUTProfile profile;

    public DigitalOnlyCheckingUTDisclosures() {
        this.profile = new DigitalOnlyCheckingUTProfile();
    }

    public DigitalOnlyCheckingUTDisclosures(DigitalOnlyCheckingUTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Utah State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Utah.
 ...
 */
public final class DigitalOnlyCheckingUTRateTable {
    ...
    public DigitalOnlyCheckingUTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-UT-DigitalOnlyChecking-2026Q1";

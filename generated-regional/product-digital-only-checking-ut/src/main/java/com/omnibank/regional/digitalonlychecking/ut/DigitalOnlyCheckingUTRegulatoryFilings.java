...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Utah.
 ...
 */
public final class DigitalOnlyCheckingUTRegulatoryFilings {
    ...
    public DigitalOnlyCheckingUTRegulatoryFilings() {
        this(new DigitalOnlyCheckingUTProfile());
    }

    public DigitalOnlyCheckingUTRegulatoryFilings(DigitalOnlyCheckingUTProfile profile) {

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Utah.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingUTBranchIntegration {
    ...
    public DigitalOnlyCheckingUTBranchIntegration() {
        this.profile = new DigitalOnlyCheckingUTProfile();
    }

    public DigitalOnlyCheckingUTBranchIntegration(DigitalOnlyCheckingUTProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingUT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingUTProfile},
 * {@link DigitalOnlyCheckingUTRateTable}, {@link DigitalOnlyCheckingUTDisclosures},
 * {@link DigitalOnlyCheckingUTRegulatoryFilings}, and {@link DigitalOnlyCheckingUTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingUTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingUTScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingWA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingWAProfile},
 * {@link EssentialCheckingWARateTable}, {@link EssentialCheckingWADisclosures},
 * {@link EssentialCheckingWARegulatoryFilings}, and {@link EssentialCheckingWABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingWAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingWAScenarioMatrixTest {

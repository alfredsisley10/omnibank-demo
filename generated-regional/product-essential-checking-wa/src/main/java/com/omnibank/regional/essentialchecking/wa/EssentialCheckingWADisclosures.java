package com.omnibank.regional.essentialchecking.wa;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Washington.
 ...
 */
public final class EssentialCheckingWADisclosures {

    private final EssentialCheckingWAProfile profile;

    public EssentialCheckingWADisclosures() {
        this.profile = new EssentialCheckingWAProfile();
    }

    public EssentialCheckingWADisclosures(EssentialCheckingWAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Washington State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

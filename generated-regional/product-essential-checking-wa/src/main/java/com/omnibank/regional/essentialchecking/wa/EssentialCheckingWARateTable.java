...
/**
 * State-specific rate table overlay for EssentialChecking offered in Washington.
 ...
 */
public final class EssentialCheckingWARateTable {
    ...
    public EssentialCheckingWARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WA-EssentialChecking-2026Q1";

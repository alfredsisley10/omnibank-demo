...
/**
 * State regulatory filing cadence for EssentialChecking in Washington.
 ...
 */
public final class EssentialCheckingWARegulatoryFilings {
    ...
    public EssentialCheckingWARegulatoryFilings() {
        this(new EssentialCheckingWAProfile());
    }

    public EssentialCheckingWARegulatoryFilings(EssentialCheckingWAProfile profile) {

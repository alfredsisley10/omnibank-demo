...
/**
 * Branch / channel integration metadata for EssentialChecking in Washington.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingWABranchIntegration {
    ...
    public EssentialCheckingWABranchIntegration() {
        this.profile = new EssentialCheckingWAProfile();
    }

    public EssentialCheckingWABranchIntegration(EssentialCheckingWAProfile profile) {

package com.omnibank.regional.digitalonlychecking.wi;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Wisconsin.
 ...
 */
public final class DigitalOnlyCheckingWIDisclosures {

    private final DigitalOnlyCheckingWIProfile profile;

    public DigitalOnlyCheckingWIDisclosures() {
        this.profile = new DigitalOnlyCheckingWIProfile();
    }

    public DigitalOnlyCheckingWIDisclosures(DigitalOnlyCheckingWIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Wisconsin State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

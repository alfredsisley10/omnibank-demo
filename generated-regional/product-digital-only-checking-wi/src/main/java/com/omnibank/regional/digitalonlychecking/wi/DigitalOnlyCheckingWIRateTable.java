...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Wisconsin.
 ...
 */
public final class DigitalOnlyCheckingWIRateTable {
    ...
    public DigitalOnlyCheckingWIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WI-DigitalOnlyChecking-2026Q1";

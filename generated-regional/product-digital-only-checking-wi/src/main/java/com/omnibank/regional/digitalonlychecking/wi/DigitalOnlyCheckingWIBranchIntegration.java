...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Wisconsin.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingWIBranchIntegration {
    ...
    public DigitalOnlyCheckingWIBranchIntegration() {
        this.profile = new DigitalOnlyCheckingWIProfile();
    }

    public DigitalOnlyCheckingWIBranchIntegration(DigitalOnlyCheckingWIProfile profile) {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Wisconsin (WI).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingWIProfile {

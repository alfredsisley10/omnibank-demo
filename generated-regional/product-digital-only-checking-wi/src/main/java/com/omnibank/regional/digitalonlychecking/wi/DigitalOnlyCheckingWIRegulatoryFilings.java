...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Wisconsin.
 ...
 */
public final class DigitalOnlyCheckingWIRegulatoryFilings {
    ...
    public DigitalOnlyCheckingWIRegulatoryFilings() {
        this(new DigitalOnlyCheckingWIProfile());
    }

    public DigitalOnlyCheckingWIRegulatoryFilings(DigitalOnlyCheckingWIProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Wisconsin)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Wisconsin)",
                "ANNUAL",

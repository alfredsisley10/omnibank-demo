...
class DigitalOnlyCheckingWIProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingWIProfile();
        assertThat(p.stateCode()).isEqualTo("WI");
        assertThat(p.stateName()).isEqualTo("Wisconsin");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingWIRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingWIDisclosures();
        assertThat(d.renderFullSupplement()).contains("Wisconsin");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingWIRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingWIBranchIntegration();

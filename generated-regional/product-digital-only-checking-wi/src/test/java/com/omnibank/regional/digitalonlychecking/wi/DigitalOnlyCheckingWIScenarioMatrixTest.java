...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingWI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingWIProfile},
 * {@link DigitalOnlyCheckingWIRateTable}, {@link DigitalOnlyCheckingWIDisclosures},
 * {@link DigitalOnlyCheckingWIRegulatoryFilings}, and {@link DigitalOnlyCheckingWIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingWIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingWIScenarioMatrixTest {

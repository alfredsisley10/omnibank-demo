...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsWI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsWIProfile},
 * {@link StandardSavingsWIRateTable}, {@link StandardSavingsWIDisclosures},
 * {@link StandardSavingsWIRegulatoryFilings}, and {@link StandardSavingsWIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsWIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsWIScenarioMatrixTest {

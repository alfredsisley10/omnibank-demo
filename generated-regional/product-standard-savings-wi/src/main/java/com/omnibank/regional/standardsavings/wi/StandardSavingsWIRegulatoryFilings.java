...
/**
 * State regulatory filing cadence for StandardSavings in Wisconsin.
 ...
 */
public final class StandardSavingsWIRegulatoryFilings {
    ...
    public StandardSavingsWIRegulatoryFilings() {
        this(new StandardSavingsWIProfile());
    }

    public StandardSavingsWIRegulatoryFilings(StandardSavingsWIProfile profile) {

...
/**
 * Branch / channel integration metadata for StandardSavings in Wisconsin.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsWIBranchIntegration {
    ...
    public StandardSavingsWIBranchIntegration() {
        this.profile = new StandardSavingsWIProfile();
    }

    public StandardSavingsWIBranchIntegration(StandardSavingsWIProfile profile) {

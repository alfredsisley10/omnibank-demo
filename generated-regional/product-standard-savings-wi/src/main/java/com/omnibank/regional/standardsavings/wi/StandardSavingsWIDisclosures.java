package com.omnibank.regional.standardsavings.wi;
...
/**
 * State-specific disclosure overlays for StandardSavings in Wisconsin.
 * Layered on top of the national disclosure, these capture
 * items that only apply under WI law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsWIDisclosures {

    private final StandardSavingsWIProfile profile;

    public StandardSavingsWIDisclosures() {
        this.profile = new StandardSavingsWIProfile();
    }

    public StandardSavingsWIDisclosures(StandardSavingsWIProfile profile) {
    ...
    public String stateHeader() {
        return "Wisconsin Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Wisconsin unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Wisconsin law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Wisconsin does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Wisconsin State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

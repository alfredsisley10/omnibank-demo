...
/**
 * State-specific rate table overlay for StandardSavings offered in Wisconsin.
 ...
 */
public final class StandardSavingsWIRateTable {
    ...
    public StandardSavingsWIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WI-StandardSavings-2026Q1";

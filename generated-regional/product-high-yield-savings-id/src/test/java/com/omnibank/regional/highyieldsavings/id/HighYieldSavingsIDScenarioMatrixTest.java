...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsID jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsIDProfile},
 * {@link HighYieldSavingsIDRateTable}, {@link HighYieldSavingsIDDisclosures},
 * {@link HighYieldSavingsIDRegulatoryFilings}, and {@link HighYieldSavingsIDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsIDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsIDScenarioMatrixTest {

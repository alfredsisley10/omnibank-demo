...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Idaho.
 ...
 */
public final class HighYieldSavingsIDRateTable {
    ...
    public HighYieldSavingsIDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ID-HighYieldSavings-2026Q1";

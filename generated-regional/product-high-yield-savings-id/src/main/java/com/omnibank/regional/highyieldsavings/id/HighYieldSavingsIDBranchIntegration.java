...
public final class HighYieldSavingsIDBranchIntegration {
    ...
    public HighYieldSavingsIDBranchIntegration() {
        this.profile = new HighYieldSavingsIDProfile();
    }

    public HighYieldSavingsIDBranchIntegration(HighYieldSavingsIDProfile profile) {

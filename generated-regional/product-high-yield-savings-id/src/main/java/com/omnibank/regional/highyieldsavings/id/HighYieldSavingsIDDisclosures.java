package com.omnibank.regional.highyieldsavings.id;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Idaho.
 ...
 */
public final class HighYieldSavingsIDDisclosures {

    private final HighYieldSavingsIDProfile profile;

    public HighYieldSavingsIDDisclosures() {
        this.profile = new HighYieldSavingsIDProfile();
    }

    public HighYieldSavingsIDDisclosures(HighYieldSavingsIDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Idaho State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

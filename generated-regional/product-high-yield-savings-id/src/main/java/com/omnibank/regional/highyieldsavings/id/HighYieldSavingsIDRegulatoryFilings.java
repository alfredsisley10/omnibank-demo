...
/**
 * State regulatory filing cadence for HighYieldSavings in Idaho.
 ...
 */
public final class HighYieldSavingsIDRegulatoryFilings {
    ...
    public HighYieldSavingsIDRegulatoryFilings() {
        this(new HighYieldSavingsIDProfile());
    }

    public HighYieldSavingsIDRegulatoryFilings(HighYieldSavingsIDProfile profile) {

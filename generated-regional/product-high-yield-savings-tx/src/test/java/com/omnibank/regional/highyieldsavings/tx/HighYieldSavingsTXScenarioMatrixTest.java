...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsTX jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsTXProfile},
 * {@link HighYieldSavingsTXRateTable}, {@link HighYieldSavingsTXDisclosures},
 * {@link HighYieldSavingsTXRegulatoryFilings}, and {@link HighYieldSavingsTXBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsTXProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsTXScenarioMatrixTest {

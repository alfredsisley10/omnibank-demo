...
class HighYieldSavingsTXProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new HighYieldSavingsTXProfile();
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new HighYieldSavingsTXRateTable();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new HighYieldSavingsTXBranchIntegration();

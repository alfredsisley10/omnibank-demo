package com.omnibank.regional.highyieldsavings.tx;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Texas.
 ...
 */
public final class HighYieldSavingsTXDisclosures {

    private final HighYieldSavingsTXProfile profile;

    public HighYieldSavingsTXDisclosures() {
        this.profile = new HighYieldSavingsTXProfile();
    }

    public HighYieldSavingsTXDisclosures(HighYieldSavingsTXProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Texas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
public final class HighYieldSavingsTXBranchIntegration {
    ...
    public HighYieldSavingsTXBranchIntegration() {
        this.profile = new HighYieldSavingsTXProfile();
    }

    public HighYieldSavingsTXBranchIntegration(HighYieldSavingsTXProfile profile) {

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Texas.
 ...
 */
public final class HighYieldSavingsTXRateTable {
    ...
    public HighYieldSavingsTXRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TX-HighYieldSavings-2026Q1";

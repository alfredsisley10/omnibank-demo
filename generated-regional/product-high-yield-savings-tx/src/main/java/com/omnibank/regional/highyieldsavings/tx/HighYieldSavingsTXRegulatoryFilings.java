...
/**
 * State regulatory filing cadence for HighYieldSavings in Texas.
 ...
 */
public final class HighYieldSavingsTXRegulatoryFilings {
    ...
    public HighYieldSavingsTXRegulatoryFilings() {
        this(new HighYieldSavingsTXProfile());
    }

    public HighYieldSavingsTXRegulatoryFilings(HighYieldSavingsTXProfile profile) {

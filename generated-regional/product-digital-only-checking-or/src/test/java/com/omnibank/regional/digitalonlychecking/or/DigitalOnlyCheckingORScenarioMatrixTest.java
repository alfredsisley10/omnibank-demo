...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingOR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingORProfile},
 * {@link DigitalOnlyCheckingORRateTable}, {@link DigitalOnlyCheckingORDisclosures},
 * {@link DigitalOnlyCheckingORRegulatoryFilings}, and {@link DigitalOnlyCheckingORBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingORProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingORScenarioMatrixTest {

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Oregon.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingORBranchIntegration {
    ...
    public DigitalOnlyCheckingORBranchIntegration() {
        this.profile = new DigitalOnlyCheckingORProfile();
    }

    public DigitalOnlyCheckingORBranchIntegration(DigitalOnlyCheckingORProfile profile) {

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Oregon.
 ...
 */
public final class DigitalOnlyCheckingORRegulatoryFilings {
    ...
    public DigitalOnlyCheckingORRegulatoryFilings() {
        this(new DigitalOnlyCheckingORProfile());
    }

    public DigitalOnlyCheckingORRegulatoryFilings(DigitalOnlyCheckingORProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Oregon)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Oregon)",
                "ANNUAL",

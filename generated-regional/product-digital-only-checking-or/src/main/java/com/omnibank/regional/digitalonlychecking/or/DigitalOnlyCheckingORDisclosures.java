package com.omnibank.regional.digitalonlychecking.or;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Oregon.
 ...
 */
public final class DigitalOnlyCheckingORDisclosures {

    private final DigitalOnlyCheckingORProfile profile;

    public DigitalOnlyCheckingORDisclosures() {
        this.profile = new DigitalOnlyCheckingORProfile();
    }

    public DigitalOnlyCheckingORDisclosures(DigitalOnlyCheckingORProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Oregon State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

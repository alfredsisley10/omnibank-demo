...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Oregon (OR).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingORProfile {
    ...
    public DigitalOnlyCheckingORProfile() {
        this.stateCode = "OR";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Oregon.
 ...
 */
public final class DigitalOnlyCheckingORRateTable {
    ...
    public DigitalOnlyCheckingORRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OR-DigitalOnlyChecking-2026Q1";

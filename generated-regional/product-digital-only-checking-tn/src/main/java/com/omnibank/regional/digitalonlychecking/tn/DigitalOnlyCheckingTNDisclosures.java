package com.omnibank.regional.digitalonlychecking.tn;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Tennessee.
 ...
 */
public final class DigitalOnlyCheckingTNDisclosures {

    private final DigitalOnlyCheckingTNProfile profile;

    public DigitalOnlyCheckingTNDisclosures() {
        this.profile = new DigitalOnlyCheckingTNProfile();
    }

    public DigitalOnlyCheckingTNDisclosures(DigitalOnlyCheckingTNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Tennessee State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

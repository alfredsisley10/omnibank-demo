...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Tennessee (TN).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingTNProfile {
    ...
    public DigitalOnlyCheckingTNProfile() {
        this.stateCode = "TN";

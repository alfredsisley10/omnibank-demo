...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Tennessee.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingTNBranchIntegration {
    ...
    public DigitalOnlyCheckingTNBranchIntegration() {
        this.profile = new DigitalOnlyCheckingTNProfile();
    }

    public DigitalOnlyCheckingTNBranchIntegration(DigitalOnlyCheckingTNProfile profile) {

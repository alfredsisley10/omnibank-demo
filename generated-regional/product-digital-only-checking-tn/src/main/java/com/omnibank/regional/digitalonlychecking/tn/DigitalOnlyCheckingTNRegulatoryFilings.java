...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Tennessee.
 ...
 */
public final class DigitalOnlyCheckingTNRegulatoryFilings {
    ...
    public DigitalOnlyCheckingTNRegulatoryFilings() {
        this(new DigitalOnlyCheckingTNProfile());
    }

    public DigitalOnlyCheckingTNRegulatoryFilings(DigitalOnlyCheckingTNProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Tennessee)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Tennessee)",
                "ANNUAL",

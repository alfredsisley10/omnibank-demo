...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Tennessee.
 ...
 */
public final class DigitalOnlyCheckingTNRateTable {
    ...
    public DigitalOnlyCheckingTNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TN-DigitalOnlyChecking-2026Q1";

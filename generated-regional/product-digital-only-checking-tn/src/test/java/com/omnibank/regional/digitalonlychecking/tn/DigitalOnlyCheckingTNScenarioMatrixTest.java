...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingTN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingTNProfile},
 * {@link DigitalOnlyCheckingTNRateTable}, {@link DigitalOnlyCheckingTNDisclosures},
 * {@link DigitalOnlyCheckingTNRegulatoryFilings}, and {@link DigitalOnlyCheckingTNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingTNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingTNScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingAR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingARProfile},
 * {@link DigitalOnlyCheckingARRateTable}, {@link DigitalOnlyCheckingARDisclosures},
 * {@link DigitalOnlyCheckingARRegulatoryFilings}, and {@link DigitalOnlyCheckingARBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingARProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingARScenarioMatrixTest {

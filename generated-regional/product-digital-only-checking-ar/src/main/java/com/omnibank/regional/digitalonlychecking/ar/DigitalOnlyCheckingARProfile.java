...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Arkansas (AR).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingARProfile {
    ...
    public DigitalOnlyCheckingARProfile() {
        this.stateCode = "AR";

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Arkansas.
 ...
 */
public final class DigitalOnlyCheckingARRegulatoryFilings {
    ...
    public DigitalOnlyCheckingARRegulatoryFilings() {
        this(new DigitalOnlyCheckingARProfile());
    }

    public DigitalOnlyCheckingARRegulatoryFilings(DigitalOnlyCheckingARProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Arkansas)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Arkansas)",
                "ANNUAL",

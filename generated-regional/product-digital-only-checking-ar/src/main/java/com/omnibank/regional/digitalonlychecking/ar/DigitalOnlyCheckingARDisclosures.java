package com.omnibank.regional.digitalonlychecking.ar;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Arkansas.
 ...
 */
public final class DigitalOnlyCheckingARDisclosures {

    private final DigitalOnlyCheckingARProfile profile;

    public DigitalOnlyCheckingARDisclosures() {
        this.profile = new DigitalOnlyCheckingARProfile();
    }

    public DigitalOnlyCheckingARDisclosures(DigitalOnlyCheckingARProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Arkansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

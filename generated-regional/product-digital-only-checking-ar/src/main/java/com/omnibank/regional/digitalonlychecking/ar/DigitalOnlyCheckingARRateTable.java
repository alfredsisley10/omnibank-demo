...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Arkansas.
 ...
 */
public final class DigitalOnlyCheckingARRateTable {
    ...
    public DigitalOnlyCheckingARRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AR-DigitalOnlyChecking-2026Q1";

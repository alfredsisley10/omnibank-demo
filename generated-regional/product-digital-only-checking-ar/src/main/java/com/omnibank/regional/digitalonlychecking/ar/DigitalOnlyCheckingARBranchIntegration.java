...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Arkansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingARBranchIntegration {
    ...
    public DigitalOnlyCheckingARBranchIntegration() {
        this.profile = new DigitalOnlyCheckingARProfile();
    }

    public DigitalOnlyCheckingARBranchIntegration(DigitalOnlyCheckingARProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Arizona.
 ...
 */
public final class StandardSavingsAZRateTable {
    ...
    public StandardSavingsAZRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AZ-StandardSavings-2026Q1";

...
public final class StandardSavingsAZBranchIntegration {
    ...
    public StandardSavingsAZBranchIntegration() {
        this.profile = new StandardSavingsAZProfile();
    }

    public StandardSavingsAZBranchIntegration(StandardSavingsAZProfile profile) {

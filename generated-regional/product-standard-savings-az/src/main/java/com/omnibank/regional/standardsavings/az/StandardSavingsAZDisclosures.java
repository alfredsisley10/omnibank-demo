package com.omnibank.regional.standardsavings.az;
...
/**
 * State-specific disclosure overlays for StandardSavings in Arizona.
 * Layered on top of the national disclosure, these capture
 * items that only apply under AZ law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsAZDisclosures {

    private final StandardSavingsAZProfile profile;

    public StandardSavingsAZDisclosures() {
        this.profile = new StandardSavingsAZProfile();
    }

    public StandardSavingsAZDisclosures(StandardSavingsAZProfile profile) {
    ...
    public String stateHeader() {
        return "Arizona Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Arizona unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Arizona law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Arizona does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Arizona State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

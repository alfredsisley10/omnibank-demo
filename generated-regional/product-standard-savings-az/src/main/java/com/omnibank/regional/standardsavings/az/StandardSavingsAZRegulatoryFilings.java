...
/**
 * State regulatory filing cadence for StandardSavings in Arizona.
 ...
 */
public final class StandardSavingsAZRegulatoryFilings {
    ...
    public StandardSavingsAZRegulatoryFilings() {
        this(new StandardSavingsAZProfile());
    }

    public StandardSavingsAZRegulatoryFilings(StandardSavingsAZProfile profile) {

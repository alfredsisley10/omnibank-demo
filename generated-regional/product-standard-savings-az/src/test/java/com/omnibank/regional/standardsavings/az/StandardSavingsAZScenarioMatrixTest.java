...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsAZ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsAZProfile},
 * {@link StandardSavingsAZRateTable}, {@link StandardSavingsAZDisclosures},
 * {@link StandardSavingsAZRegulatoryFilings}, and {@link StandardSavingsAZBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsAZProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsAZScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingAZ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingAZProfile},
 * {@link BasicCheckingAZRateTable}, {@link BasicCheckingAZDisclosures},
 * {@link BasicCheckingAZRegulatoryFilings}, and {@link BasicCheckingAZBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingAZProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingAZScenarioMatrixTest {

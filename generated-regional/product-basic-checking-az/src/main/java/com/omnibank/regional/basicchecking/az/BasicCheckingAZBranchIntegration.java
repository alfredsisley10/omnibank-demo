...
public final class BasicCheckingAZBranchIntegration {
    ...
    public BasicCheckingAZBranchIntegration() {
        this.profile = new BasicCheckingAZProfile();
    }

    public BasicCheckingAZBranchIntegration(BasicCheckingAZProfile profile) {

...
/**
 * State-specific disclosure overlays for BasicChecking in Arizona.
 ...
 */
public final class BasicCheckingAZDisclosures {

    private final BasicCheckingAZProfile profile;

    public BasicCheckingAZDisclosures() {
        this.profile = new BasicCheckingAZProfile();
    }

    public BasicCheckingAZDisclosures(BasicCheckingAZProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Arizona State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

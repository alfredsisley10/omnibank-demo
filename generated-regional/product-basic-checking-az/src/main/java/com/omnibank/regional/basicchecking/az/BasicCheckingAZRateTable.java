...
/**
 * State-specific rate table overlay for BasicChecking offered in Arizona.
 ...
 */
public final class BasicCheckingAZRateTable {
    ...
    public BasicCheckingAZRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AZ-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Arizona.
 ...
 */
public final class BasicCheckingAZRegulatoryFilings {
    ...
    public BasicCheckingAZRegulatoryFilings() {
        this(new BasicCheckingAZProfile());
    }

    public BasicCheckingAZRegulatoryFilings(BasicCheckingAZProfile profile) {

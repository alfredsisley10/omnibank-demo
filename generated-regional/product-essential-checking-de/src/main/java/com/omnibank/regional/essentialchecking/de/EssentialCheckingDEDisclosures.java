package com.omnibank.regional.essentialchecking.de;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Delaware.
 ...
 */
public final class EssentialCheckingDEDisclosures {

    private final EssentialCheckingDEProfile profile;

    public EssentialCheckingDEDisclosures() {
        this.profile = new EssentialCheckingDEProfile();
    }

    public EssentialCheckingDEDisclosures(EssentialCheckingDEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Delaware State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

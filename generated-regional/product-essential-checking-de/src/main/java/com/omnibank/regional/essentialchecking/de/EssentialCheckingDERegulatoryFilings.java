...
/**
 * State regulatory filing cadence for EssentialChecking in Delaware.
 ...
 */
public final class EssentialCheckingDERegulatoryFilings {
    ...
    public EssentialCheckingDERegulatoryFilings() {
        this(new EssentialCheckingDEProfile());
    }

    public EssentialCheckingDERegulatoryFilings(EssentialCheckingDEProfile profile) {

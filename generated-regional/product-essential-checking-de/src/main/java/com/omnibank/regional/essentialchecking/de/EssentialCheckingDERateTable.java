...
/**
 * State-specific rate table overlay for EssentialChecking offered in Delaware.
 ...
 */
public final class EssentialCheckingDERateTable {
    ...
    public EssentialCheckingDERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-DE-EssentialChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for EssentialChecking in Delaware.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingDEBranchIntegration {
    ...
    public EssentialCheckingDEBranchIntegration() {
        this.profile = new EssentialCheckingDEProfile();
    }

    public EssentialCheckingDEBranchIntegration(EssentialCheckingDEProfile profile) {

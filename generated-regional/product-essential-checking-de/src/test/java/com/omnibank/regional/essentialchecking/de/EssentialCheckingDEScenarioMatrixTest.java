...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingDE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingDEProfile},
 * {@link EssentialCheckingDERateTable}, {@link EssentialCheckingDEDisclosures},
 * {@link EssentialCheckingDERegulatoryFilings}, and {@link EssentialCheckingDEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingDEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingDEScenarioMatrixTest {

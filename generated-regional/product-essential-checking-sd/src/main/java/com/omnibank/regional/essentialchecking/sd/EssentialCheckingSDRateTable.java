...
/**
 * State-specific rate table overlay for EssentialChecking offered in South Dakota.
 ...
 */
public final class EssentialCheckingSDRateTable {
    ...
    public EssentialCheckingSDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SD-EssentialChecking-2026Q1";

...
/**
 * Jurisdiction profile for EssentialChecking as offered in South Dakota (SD).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingSDProfile {
    ...
    public EssentialCheckingSDProfile() {
        this.stateCode = "SD";

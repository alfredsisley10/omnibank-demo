...
/**
 * Branch / channel integration metadata for EssentialChecking in South Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingSDBranchIntegration {
    ...
    public EssentialCheckingSDBranchIntegration() {
        this.profile = new EssentialCheckingSDProfile();
    }

    public EssentialCheckingSDBranchIntegration(EssentialCheckingSDProfile profile) {

...
/**
 * State-specific disclosure overlays for EssentialChecking in South Dakota.
 ...
 */
public final class EssentialCheckingSDDisclosures {

    private final EssentialCheckingSDProfile profile;

    public EssentialCheckingSDDisclosures() {
        this.profile = new EssentialCheckingSDProfile();
    }

    public EssentialCheckingSDDisclosures(EssentialCheckingSDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — South Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

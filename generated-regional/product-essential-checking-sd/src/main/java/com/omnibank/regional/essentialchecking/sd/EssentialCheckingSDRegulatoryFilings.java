...
/**
 * State regulatory filing cadence for EssentialChecking in South Dakota.
 ...
 */
public final class EssentialCheckingSDRegulatoryFilings {
    ...
    public EssentialCheckingSDRegulatoryFilings() {
        this(new EssentialCheckingSDProfile());
    }

    public EssentialCheckingSDRegulatoryFilings(EssentialCheckingSDProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingSD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingSDProfile},
 * {@link EssentialCheckingSDRateTable}, {@link EssentialCheckingSDDisclosures},
 * {@link EssentialCheckingSDRegulatoryFilings}, and {@link EssentialCheckingSDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingSDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingSDScenarioMatrixTest {

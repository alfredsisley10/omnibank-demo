...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Oregon.
 ...
 */
public final class HighYieldSavingsORRateTable {
    ...
    public HighYieldSavingsORRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OR-HighYieldSavings-2026Q1";

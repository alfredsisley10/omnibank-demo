...
/**
 * State regulatory filing cadence for HighYieldSavings in Oregon.
 ...
 */
public final class HighYieldSavingsORRegulatoryFilings {
    ...
    public HighYieldSavingsORRegulatoryFilings() {
        this(new HighYieldSavingsORProfile());
    }

    public HighYieldSavingsORRegulatoryFilings(HighYieldSavingsORProfile profile) {

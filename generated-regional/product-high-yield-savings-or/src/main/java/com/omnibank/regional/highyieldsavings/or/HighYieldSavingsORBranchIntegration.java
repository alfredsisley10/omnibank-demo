...
/**
 * Branch / channel integration metadata for HighYieldSavings in Oregon.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsORBranchIntegration {
    ...
    public HighYieldSavingsORBranchIntegration() {
        this.profile = new HighYieldSavingsORProfile();
    }

    public HighYieldSavingsORBranchIntegration(HighYieldSavingsORProfile profile) {

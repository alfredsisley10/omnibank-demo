package com.omnibank.regional.highyieldsavings.or;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Oregon.
 ...
 */
public final class HighYieldSavingsORDisclosures {

    private final HighYieldSavingsORProfile profile;

    public HighYieldSavingsORDisclosures() {
        this.profile = new HighYieldSavingsORProfile();
    }

    public HighYieldSavingsORDisclosures(HighYieldSavingsORProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Oregon State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsOR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsORProfile},
 * {@link HighYieldSavingsORRateTable}, {@link HighYieldSavingsORDisclosures},
 * {@link HighYieldSavingsORRegulatoryFilings}, and {@link HighYieldSavingsORBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsORProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsORScenarioMatrixTest {

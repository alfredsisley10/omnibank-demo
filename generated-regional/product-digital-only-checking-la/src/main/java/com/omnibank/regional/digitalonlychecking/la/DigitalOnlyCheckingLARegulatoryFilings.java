...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Louisiana.
 ...
 */
public final class DigitalOnlyCheckingLARegulatoryFilings {
    ...
    public DigitalOnlyCheckingLARegulatoryFilings() {
        this(new DigitalOnlyCheckingLAProfile());
    }

    public DigitalOnlyCheckingLARegulatoryFilings(DigitalOnlyCheckingLAProfile profile) {

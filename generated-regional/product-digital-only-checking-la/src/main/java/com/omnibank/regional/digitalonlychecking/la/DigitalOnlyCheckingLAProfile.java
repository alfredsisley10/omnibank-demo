...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Louisiana (LA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingLAProfile {
    ...
    public DigitalOnlyCheckingLAProfile() {
        this.stateCode = "LA";
        this.stateName = "Louisiana";
        this.region = "SOUTH";
        this.salesTaxRate = new BigDecimal("0.0445");

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Louisiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingLABranchIntegration {
    ...
    public DigitalOnlyCheckingLABranchIntegration() {
        this.profile = new DigitalOnlyCheckingLAProfile();
    }

    public DigitalOnlyCheckingLABranchIntegration(DigitalOnlyCheckingLAProfile profile) {

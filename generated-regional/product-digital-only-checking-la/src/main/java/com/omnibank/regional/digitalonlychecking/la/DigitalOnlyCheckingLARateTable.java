...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Louisiana.
 ...
 */
public final class DigitalOnlyCheckingLARateTable {
    ...
    public DigitalOnlyCheckingLARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-LA-DigitalOnlyChecking-2026Q1";

package com.omnibank.regional.digitalonlychecking.la;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Louisiana.
 ...
 */
public final class DigitalOnlyCheckingLADisclosures {

    private final DigitalOnlyCheckingLAProfile profile;

    public DigitalOnlyCheckingLADisclosures() {
        this.profile = new DigitalOnlyCheckingLAProfile();
    }

    public DigitalOnlyCheckingLADisclosures(DigitalOnlyCheckingLAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Louisiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

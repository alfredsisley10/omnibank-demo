...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingLA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingLAProfile},
 * {@link DigitalOnlyCheckingLARateTable}, {@link DigitalOnlyCheckingLADisclosures},
 * {@link DigitalOnlyCheckingLARegulatoryFilings}, and {@link DigitalOnlyCheckingLABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingLAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingLAScenarioMatrixTest {

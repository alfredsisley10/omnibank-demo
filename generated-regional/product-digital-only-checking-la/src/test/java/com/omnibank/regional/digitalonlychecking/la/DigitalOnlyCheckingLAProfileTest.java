...
class DigitalOnlyCheckingLAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingLAProfile();
        assertThat(p.stateCode()).isEqualTo("LA");
        assertThat(p.stateName()).isEqualTo("Louisiana");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingLARateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingLADisclosures();
        assertThat(d.renderFullSupplement()).contains("Louisiana");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingLARegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingLABranchIntegration();

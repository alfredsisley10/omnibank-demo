...
public final class BasicCheckingMNBranchIntegration {
    ...
    public BasicCheckingMNBranchIntegration() {
        this.profile = new BasicCheckingMNProfile();
    }

    public BasicCheckingMNBranchIntegration(BasicCheckingMNProfile profile) {

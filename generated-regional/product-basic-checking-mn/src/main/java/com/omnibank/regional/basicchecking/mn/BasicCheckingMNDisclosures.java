package com.omnibank.regional.basicchecking.mn;
...
/**
 * State-specific disclosure overlays for BasicChecking in Minnesota.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MN law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingMNDisclosures {

    private final BasicCheckingMNProfile profile;

    public BasicCheckingMNDisclosures() {
        this.profile = new BasicCheckingMNProfile();
    }

    public BasicCheckingMNDisclosures(BasicCheckingMNProfile profile) {
    ...
    public String stateHeader() {
        return "Minnesota Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Minnesota unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Minnesota law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Minnesota does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Minnesota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for BasicChecking offered in Minnesota.
 ...
 */
public final class BasicCheckingMNRateTable {
    ...
    public BasicCheckingMNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MN-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Minnesota.
 ...
 */
public final class BasicCheckingMNRegulatoryFilings {
    ...
    public BasicCheckingMNRegulatoryFilings() {
        this(new BasicCheckingMNProfile());
    }

    public BasicCheckingMNRegulatoryFilings(BasicCheckingMNProfile profile) {

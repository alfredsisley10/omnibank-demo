...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMNProfile},
 * {@link BasicCheckingMNRateTable}, {@link BasicCheckingMNDisclosures},
 * {@link BasicCheckingMNRegulatoryFilings}, and {@link BasicCheckingMNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMNScenarioMatrixTest {

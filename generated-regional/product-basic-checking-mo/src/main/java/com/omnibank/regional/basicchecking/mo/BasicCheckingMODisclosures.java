package com.omnibank.regional.basicchecking.mo;
...
/**
 * State-specific disclosure overlays for BasicChecking in Missouri.
 ...
 */
public final class BasicCheckingMODisclosures {

    private final BasicCheckingMOProfile profile;

    public BasicCheckingMODisclosures() {
        this.profile = new BasicCheckingMOProfile();
    }

    public BasicCheckingMODisclosures(BasicCheckingMOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Missouri State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

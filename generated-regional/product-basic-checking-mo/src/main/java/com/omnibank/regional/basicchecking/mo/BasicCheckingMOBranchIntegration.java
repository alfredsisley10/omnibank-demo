...
public final class BasicCheckingMOBranchIntegration {
    ...
    public BasicCheckingMOBranchIntegration() {
        this.profile = new BasicCheckingMOProfile();
    }

    public BasicCheckingMOBranchIntegration(BasicCheckingMOProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in Missouri.
 ...
 */
public final class BasicCheckingMORateTable {
    ...
    public BasicCheckingMORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MO-BasicChecking-2026Q1";

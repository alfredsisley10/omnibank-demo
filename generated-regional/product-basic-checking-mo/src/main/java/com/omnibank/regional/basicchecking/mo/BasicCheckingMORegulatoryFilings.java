...
/**
 * State regulatory filing cadence for BasicChecking in Missouri.
 ...
 */
public final class BasicCheckingMORegulatoryFilings {
    ...
    public BasicCheckingMORegulatoryFilings() {
        this(new BasicCheckingMOProfile());
    }

    public BasicCheckingMORegulatoryFilings(BasicCheckingMOProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMOProfile},
 * {@link BasicCheckingMORateTable}, {@link BasicCheckingMODisclosures},
 * {@link BasicCheckingMORegulatoryFilings}, and {@link BasicCheckingMOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMOScenarioMatrixTest {

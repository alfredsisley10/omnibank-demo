...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsWY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsWYProfile},
 * {@link StandardSavingsWYRateTable}, {@link StandardSavingsWYDisclosures},
 * {@link StandardSavingsWYRegulatoryFilings}, and {@link StandardSavingsWYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsWYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsWYScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Wyoming.
 ...
 */
public final class StandardSavingsWYRateTable {
    ...
    public StandardSavingsWYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WY-StandardSavings-2026Q1";

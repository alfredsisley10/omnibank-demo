...
public final class StandardSavingsWYBranchIntegration {
    ...
    public StandardSavingsWYBranchIntegration() {
        this.profile = new StandardSavingsWYProfile();
    }

    public StandardSavingsWYBranchIntegration(StandardSavingsWYProfile profile) {

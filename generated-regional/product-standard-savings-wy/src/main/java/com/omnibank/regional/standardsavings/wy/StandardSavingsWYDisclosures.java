package com.omnibank.regional.standardsavings.wy;
...
/**
 * State-specific disclosure overlays for StandardSavings in Wyoming.
 * Layered on top of the national disclosure, these capture
 * items that only apply under WY law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsWYDisclosures {

    private final StandardSavingsWYProfile profile;

    public StandardSavingsWYDisclosures() {
        this.profile = new StandardSavingsWYProfile();
    }

    public StandardSavingsWYDisclosures(StandardSavingsWYProfile profile) {
    ...
    public String stateHeader() {
        return "Wyoming Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Wyoming unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Wyoming law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Wyoming does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Wyoming State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

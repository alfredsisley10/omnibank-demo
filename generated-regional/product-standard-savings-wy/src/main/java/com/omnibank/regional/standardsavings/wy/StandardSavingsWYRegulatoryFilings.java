...
/**
 * State regulatory filing cadence for StandardSavings in Wyoming.
 ...
 */
public final class StandardSavingsWYRegulatoryFilings {
    ...
    public StandardSavingsWYRegulatoryFilings() {
        this(new StandardSavingsWYProfile());
    }

    public StandardSavingsWYRegulatoryFilings(StandardSavingsWYProfile profile) {

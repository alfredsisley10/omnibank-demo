...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNJ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNJProfile},
 * {@link StandardSavingsNJRateTable}, {@link StandardSavingsNJDisclosures},
 * {@link StandardSavingsNJRegulatoryFilings}, and {@link StandardSavingsNJBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNJProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNJScenarioMatrixTest {

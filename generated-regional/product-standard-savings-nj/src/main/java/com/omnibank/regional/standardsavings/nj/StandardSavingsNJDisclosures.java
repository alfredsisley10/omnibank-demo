...
/**
 * State-specific disclosure overlays for StandardSavings in New Jersey.
 ...
 */
public final class StandardSavingsNJDisclosures {

    private final StandardSavingsNJProfile profile;

    public StandardSavingsNJDisclosures() {
        this.profile = new StandardSavingsNJProfile();
    }

    public StandardSavingsNJDisclosures(StandardSavingsNJProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — New Jersey State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for StandardSavings in New Jersey.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNJBranchIntegration {
    ...
    public StandardSavingsNJBranchIntegration() {
        this.profile = new StandardSavingsNJProfile();
    }

    public StandardSavingsNJBranchIntegration(StandardSavingsNJProfile profile) {

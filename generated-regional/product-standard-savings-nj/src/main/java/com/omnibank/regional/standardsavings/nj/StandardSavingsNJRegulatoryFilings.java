...
/**
 * State regulatory filing cadence for StandardSavings in New Jersey.
 ...
 */
public final class StandardSavingsNJRegulatoryFilings {
    ...
    public StandardSavingsNJRegulatoryFilings() {
        this(new StandardSavingsNJProfile());
    }

    public StandardSavingsNJRegulatoryFilings(StandardSavingsNJProfile profile) {

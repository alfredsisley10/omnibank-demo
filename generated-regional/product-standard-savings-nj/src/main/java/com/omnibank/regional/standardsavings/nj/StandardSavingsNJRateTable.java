...
/**
 * State-specific rate table overlay for StandardSavings offered in New Jersey.
 ...
 */
public final class StandardSavingsNJRateTable {
    ...
    public StandardSavingsNJRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NJ-StandardSavings-2026Q1";

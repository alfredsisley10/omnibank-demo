...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingRI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingRIProfile},
 * {@link EssentialCheckingRIRateTable}, {@link EssentialCheckingRIDisclosures},
 * {@link EssentialCheckingRIRegulatoryFilings}, and {@link EssentialCheckingRIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingRIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingRIScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Rhode Island.
 ...
 */
public final class EssentialCheckingRIRateTable {
    ...
    public EssentialCheckingRIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-RI-EssentialChecking-2026Q1";

package com.omnibank.regional.essentialchecking.ri;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Rhode Island.
 ...
 */
public final class EssentialCheckingRIDisclosures {

    private final EssentialCheckingRIProfile profile;

    public EssentialCheckingRIDisclosures() {
        this.profile = new EssentialCheckingRIProfile();
    }

    public EssentialCheckingRIDisclosures(EssentialCheckingRIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Rhode Island State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Jurisdiction profile for EssentialChecking as offered in Rhode Island (RI).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingRIProfile {
    ...
    public EssentialCheckingRIProfile() {
        this.stateCode = "RI";

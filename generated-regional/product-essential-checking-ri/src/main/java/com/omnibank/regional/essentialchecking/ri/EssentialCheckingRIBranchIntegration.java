...
/**
 * Branch / channel integration metadata for EssentialChecking in Rhode Island.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingRIBranchIntegration {
    ...
    public EssentialCheckingRIBranchIntegration() {
        this.profile = new EssentialCheckingRIProfile();
    }

    public EssentialCheckingRIBranchIntegration(EssentialCheckingRIProfile profile) {

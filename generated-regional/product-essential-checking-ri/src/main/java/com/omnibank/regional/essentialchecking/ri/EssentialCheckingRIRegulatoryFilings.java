...
/**
 * State regulatory filing cadence for EssentialChecking in Rhode Island.
 ...
 */
public final class EssentialCheckingRIRegulatoryFilings {
    ...
    public EssentialCheckingRIRegulatoryFilings() {
        this(new EssentialCheckingRIProfile());
    }

    public EssentialCheckingRIRegulatoryFilings(EssentialCheckingRIProfile profile) {

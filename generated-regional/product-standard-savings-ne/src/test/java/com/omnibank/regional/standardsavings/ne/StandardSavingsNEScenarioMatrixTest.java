...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNE jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNEProfile},
 * {@link StandardSavingsNERateTable}, {@link StandardSavingsNEDisclosures},
 * {@link StandardSavingsNERegulatoryFilings}, and {@link StandardSavingsNEBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNEProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNEScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Nebraska.
 ...
 */
public final class StandardSavingsNERateTable {
    ...
    public StandardSavingsNERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NE-StandardSavings-2026Q1";

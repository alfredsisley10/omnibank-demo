...
/**
 * Branch / channel integration metadata for StandardSavings in Nebraska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNEBranchIntegration {
    ...
    public StandardSavingsNEBranchIntegration() {
        this.profile = new StandardSavingsNEProfile();
    }

    public StandardSavingsNEBranchIntegration(StandardSavingsNEProfile profile) {

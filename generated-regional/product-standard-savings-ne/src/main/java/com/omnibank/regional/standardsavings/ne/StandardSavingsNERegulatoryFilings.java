...
/**
 * State regulatory filing cadence for StandardSavings in Nebraska.
 ...
 */
public final class StandardSavingsNERegulatoryFilings {
    ...
    public StandardSavingsNERegulatoryFilings() {
        this(new StandardSavingsNEProfile());
    }

    public StandardSavingsNERegulatoryFilings(StandardSavingsNEProfile profile) {

package com.omnibank.regional.standardsavings.ne;
...
/**
 * State-specific disclosure overlays for StandardSavings in Nebraska.
 ...
 */
public final class StandardSavingsNEDisclosures {

    private final StandardSavingsNEProfile profile;

    public StandardSavingsNEDisclosures() {
        this.profile = new StandardSavingsNEProfile();
    }

    public StandardSavingsNEDisclosures(StandardSavingsNEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Nebraska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

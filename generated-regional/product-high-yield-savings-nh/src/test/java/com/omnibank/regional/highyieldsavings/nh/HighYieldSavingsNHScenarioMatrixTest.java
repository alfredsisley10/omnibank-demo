...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNHProfile},
 * {@link HighYieldSavingsNHRateTable}, {@link HighYieldSavingsNHDisclosures},
 * {@link HighYieldSavingsNHRegulatoryFilings}, and {@link HighYieldSavingsNHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNHScenarioMatrixTest {

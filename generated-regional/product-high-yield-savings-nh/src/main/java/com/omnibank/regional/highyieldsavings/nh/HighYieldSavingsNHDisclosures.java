...
/**
 * State-specific disclosure overlays for HighYieldSavings in New Hampshire.
 ...
 */
public final class HighYieldSavingsNHDisclosures {

    private final HighYieldSavingsNHProfile profile;

    public HighYieldSavingsNHDisclosures() {
        this.profile = new HighYieldSavingsNHProfile();
    }

    public HighYieldSavingsNHDisclosures(HighYieldSavingsNHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — New Hampshire State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for HighYieldSavings in New Hampshire.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNHBranchIntegration {
    ...
    public HighYieldSavingsNHBranchIntegration() {
        this.profile = new HighYieldSavingsNHProfile();
    }

    public HighYieldSavingsNHBranchIntegration(HighYieldSavingsNHProfile profile) {

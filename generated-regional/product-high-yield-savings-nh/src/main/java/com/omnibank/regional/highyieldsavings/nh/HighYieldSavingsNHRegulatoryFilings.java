...
/**
 * State regulatory filing cadence for HighYieldSavings in New Hampshire.
 ...
 */
public final class HighYieldSavingsNHRegulatoryFilings {
    ...
    public HighYieldSavingsNHRegulatoryFilings() {
        this(new HighYieldSavingsNHProfile());
    }

    public HighYieldSavingsNHRegulatoryFilings(HighYieldSavingsNHProfile profile) {

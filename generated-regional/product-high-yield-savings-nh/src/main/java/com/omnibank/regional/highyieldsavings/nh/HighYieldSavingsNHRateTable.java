...
/**
 * State-specific rate table overlay for HighYieldSavings offered in New Hampshire.
 ...
 */
public final class HighYieldSavingsNHRateTable {
    ...
    public HighYieldSavingsNHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NH-HighYieldSavings-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingHI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingHIProfile},
 * {@link DigitalOnlyCheckingHIRateTable}, {@link DigitalOnlyCheckingHIDisclosures},
 * {@link DigitalOnlyCheckingHIRegulatoryFilings}, and {@link DigitalOnlyCheckingHIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingHIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingHIScenarioMatrixTest {

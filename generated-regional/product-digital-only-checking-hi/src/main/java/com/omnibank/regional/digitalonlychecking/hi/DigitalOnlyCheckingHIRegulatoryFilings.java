...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Hawaii.
 ...
 */
public final class DigitalOnlyCheckingHIRegulatoryFilings {
    ...
    public DigitalOnlyCheckingHIRegulatoryFilings() {
        this(new DigitalOnlyCheckingHIProfile());
    }

    public DigitalOnlyCheckingHIRegulatoryFilings(DigitalOnlyCheckingHIProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Hawaii)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Hawaii)",
                "ANNUAL",

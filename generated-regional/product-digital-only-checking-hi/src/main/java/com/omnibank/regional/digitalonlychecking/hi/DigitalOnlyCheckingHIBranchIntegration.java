...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Hawaii.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingHIBranchIntegration {
    ...
    public DigitalOnlyCheckingHIBranchIntegration() {
        this.profile = new DigitalOnlyCheckingHIProfile();
    }

    public DigitalOnlyCheckingHIBranchIntegration(DigitalOnlyCheckingHIProfile profile) {

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Hawaii (HI).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingHIProfile {
    ...
    public DigitalOnlyCheckingHIProfile() {
        this.stateCode = "HI";
        this.stateName = "Hawaii";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0400");

package com.omnibank.regional.digitalonlychecking.hi;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Hawaii.
 ...
 */
public final class DigitalOnlyCheckingHIDisclosures {

    private final DigitalOnlyCheckingHIProfile profile;

    public DigitalOnlyCheckingHIDisclosures() {
        this.profile = new DigitalOnlyCheckingHIProfile();
    }

    public DigitalOnlyCheckingHIDisclosures(DigitalOnlyCheckingHIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Hawaii State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

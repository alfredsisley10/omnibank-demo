...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Hawaii.
 ...
 */
public final class DigitalOnlyCheckingHIRateTable {
    ...
    public DigitalOnlyCheckingHIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-HI-DigitalOnlyChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMSProfile},
 * {@link BasicCheckingMSRateTable}, {@link BasicCheckingMSDisclosures},
 * {@link BasicCheckingMSRegulatoryFilings}, and {@link BasicCheckingMSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMSScenarioMatrixTest {

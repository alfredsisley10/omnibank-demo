...
public final class BasicCheckingMSBranchIntegration {
    ...
    public BasicCheckingMSBranchIntegration() {
        this.profile = new BasicCheckingMSProfile();
    }

    public BasicCheckingMSBranchIntegration(BasicCheckingMSProfile profile) {

package com.omnibank.regional.basicchecking.ms;
...
/**
 * State-specific disclosure overlays for BasicChecking in Mississippi.
 ...
 */
public final class BasicCheckingMSDisclosures {

    private final BasicCheckingMSProfile profile;

    public BasicCheckingMSDisclosures() {
        this.profile = new BasicCheckingMSProfile();
    }

    public BasicCheckingMSDisclosures(BasicCheckingMSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Mississippi State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

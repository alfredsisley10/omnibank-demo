...
/**
 * State regulatory filing cadence for BasicChecking in Mississippi.
 ...
 */
public final class BasicCheckingMSRegulatoryFilings {
    ...
    public BasicCheckingMSRegulatoryFilings() {
        this(new BasicCheckingMSProfile());
    }

    public BasicCheckingMSRegulatoryFilings(BasicCheckingMSProfile profile) {

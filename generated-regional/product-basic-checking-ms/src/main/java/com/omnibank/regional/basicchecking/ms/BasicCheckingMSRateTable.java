...
/**
 * State-specific rate table overlay for BasicChecking offered in Mississippi.
 ...
 */
public final class BasicCheckingMSRateTable {
    ...
    public BasicCheckingMSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MS-BasicChecking-2026Q1";

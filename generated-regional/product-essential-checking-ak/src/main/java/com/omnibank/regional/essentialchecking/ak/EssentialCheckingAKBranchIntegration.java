...
/**
 * Branch / channel integration metadata for EssentialChecking in Alaska.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingAKBranchIntegration {
    ...
    public EssentialCheckingAKBranchIntegration() {
        this.profile = new EssentialCheckingAKProfile();
    }

    public EssentialCheckingAKBranchIntegration(EssentialCheckingAKProfile profile) {

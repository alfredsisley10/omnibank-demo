...
/**
 * State-specific rate table overlay for EssentialChecking offered in Alaska.
 ...
 */
public final class EssentialCheckingAKRateTable {
    ...
    public EssentialCheckingAKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AK-EssentialChecking-2026Q1";

...
/**
 * State regulatory filing cadence for EssentialChecking in Alaska.
 ...
 */
public final class EssentialCheckingAKRegulatoryFilings {
    ...
    public EssentialCheckingAKRegulatoryFilings() {
        this(new EssentialCheckingAKProfile());
    }

    public EssentialCheckingAKRegulatoryFilings(EssentialCheckingAKProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Alaska)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Alaska)",
                "ANNUAL",

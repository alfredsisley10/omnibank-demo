package com.omnibank.regional.essentialchecking.ak;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Alaska.
 ...
 */
public final class EssentialCheckingAKDisclosures {

    private final EssentialCheckingAKProfile profile;

    public EssentialCheckingAKDisclosures() {
        this.profile = new EssentialCheckingAKProfile();
    }

    public EssentialCheckingAKDisclosures(EssentialCheckingAKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Alaska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

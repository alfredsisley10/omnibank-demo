...
/**
 * State-specific disclosure overlays for BasicChecking in Arkansas.
 ...
 */
public final class BasicCheckingARDisclosures {

    private final BasicCheckingARProfile profile;

    public BasicCheckingARDisclosures() {
        this.profile = new BasicCheckingARProfile();
    }

    public BasicCheckingARDisclosures(BasicCheckingARProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Arkansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for BasicChecking offered in Arkansas.
 ...
 */
public final class BasicCheckingARRateTable {
    ...
    public BasicCheckingARRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AR-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Arkansas.
 ...
 */
public final class BasicCheckingARRegulatoryFilings {
    ...
    public BasicCheckingARRegulatoryFilings() {
        this(new BasicCheckingARProfile());
    }

    public BasicCheckingARRegulatoryFilings(BasicCheckingARProfile profile) {

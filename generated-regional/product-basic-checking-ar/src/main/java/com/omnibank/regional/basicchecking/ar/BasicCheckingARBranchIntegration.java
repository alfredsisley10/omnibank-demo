...
public final class BasicCheckingARBranchIntegration {
    ...
    public BasicCheckingARBranchIntegration() {
        this.profile = new BasicCheckingARProfile();
    }

    public BasicCheckingARBranchIntegration(BasicCheckingARProfile profile) {

...
/**
 * State-specific disclosure overlays for StandardSavings in Alaska.
 ...
 */
public final class StandardSavingsAKDisclosures {

    private final StandardSavingsAKProfile profile;

    public StandardSavingsAKDisclosures() {
        this.profile = new StandardSavingsAKProfile();
    }

    public StandardSavingsAKDisclosures(StandardSavingsAKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Alaska State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

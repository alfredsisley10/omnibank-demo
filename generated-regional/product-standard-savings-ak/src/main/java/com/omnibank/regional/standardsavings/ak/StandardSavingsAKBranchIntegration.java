...
public final class StandardSavingsAKBranchIntegration {
    ...
    public StandardSavingsAKBranchIntegration() {
        this.profile = new StandardSavingsAKProfile();
    }

    public StandardSavingsAKBranchIntegration(StandardSavingsAKProfile profile) {

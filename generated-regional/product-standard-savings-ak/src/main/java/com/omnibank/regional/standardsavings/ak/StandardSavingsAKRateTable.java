...
/**
 * State-specific rate table overlay for StandardSavings offered in Alaska.
 ...
 */
public final class StandardSavingsAKRateTable {
    ...
    public StandardSavingsAKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AK-StandardSavings-2026Q1";

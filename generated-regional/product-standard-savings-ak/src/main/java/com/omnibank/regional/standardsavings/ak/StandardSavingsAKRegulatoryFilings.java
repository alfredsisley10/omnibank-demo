...
/**
 * State regulatory filing cadence for StandardSavings in Alaska.
 ...
 */
public final class StandardSavingsAKRegulatoryFilings {
    ...
    public StandardSavingsAKRegulatoryFilings() {
        this(new StandardSavingsAKProfile());
    }

    public StandardSavingsAKRegulatoryFilings(StandardSavingsAKProfile profile) {

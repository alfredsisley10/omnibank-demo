...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsAK jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsAKProfile},
 * {@link StandardSavingsAKRateTable}, {@link StandardSavingsAKDisclosures},
 * {@link StandardSavingsAKRegulatoryFilings}, and {@link StandardSavingsAKBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsAKProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsAKScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Maine.
 ...
 */
public final class DigitalOnlyCheckingMERegulatoryFilings {
    ...
    public DigitalOnlyCheckingMERegulatoryFilings() {
        this(new DigitalOnlyCheckingMEProfile());
    }

    public DigitalOnlyCheckingMERegulatoryFilings(DigitalOnlyCheckingMEProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Maine)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Maine)",
                "ANNUAL",

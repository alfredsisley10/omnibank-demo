...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Maine.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMEBranchIntegration {
    ...
    public DigitalOnlyCheckingMEBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMEProfile();
    }

    public DigitalOnlyCheckingMEBranchIntegration(DigitalOnlyCheckingMEProfile profile) {

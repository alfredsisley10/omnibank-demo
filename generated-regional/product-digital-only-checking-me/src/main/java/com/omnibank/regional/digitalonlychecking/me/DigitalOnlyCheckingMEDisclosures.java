package com.omnibank.regional.digitalonlychecking.me;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Maine.
 ...
 */
public final class DigitalOnlyCheckingMEDisclosures {

    private final DigitalOnlyCheckingMEProfile profile;

    public DigitalOnlyCheckingMEDisclosures() {
        this.profile = new DigitalOnlyCheckingMEProfile();
    }

    public DigitalOnlyCheckingMEDisclosures(DigitalOnlyCheckingMEProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Maine State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

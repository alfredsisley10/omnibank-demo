...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Maine.
 ...
 */
public final class DigitalOnlyCheckingMERateTable {
    ...
    public DigitalOnlyCheckingMERateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ME-DigitalOnlyChecking-2026Q1";

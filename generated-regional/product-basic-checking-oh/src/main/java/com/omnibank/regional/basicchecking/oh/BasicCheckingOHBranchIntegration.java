...
public final class BasicCheckingOHBranchIntegration {
    ...
    public BasicCheckingOHBranchIntegration() {
        this.profile = new BasicCheckingOHProfile();
    }

    public BasicCheckingOHBranchIntegration(BasicCheckingOHProfile profile) {

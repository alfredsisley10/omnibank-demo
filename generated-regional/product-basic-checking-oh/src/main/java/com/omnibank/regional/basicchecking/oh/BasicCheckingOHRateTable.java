...
/**
 * State-specific rate table overlay for BasicChecking offered in Ohio.
 ...
 */
public final class BasicCheckingOHRateTable {
    ...
    public BasicCheckingOHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OH-BasicChecking-2026Q1";

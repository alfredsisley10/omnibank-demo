package com.omnibank.regional.basicchecking.oh;
...
/**
 * State-specific disclosure overlays for BasicChecking in Ohio.
 ...
 */
public final class BasicCheckingOHDisclosures {

    private final BasicCheckingOHProfile profile;

    public BasicCheckingOHDisclosures() {
        this.profile = new BasicCheckingOHProfile();
    }

    public BasicCheckingOHDisclosures(BasicCheckingOHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Ohio State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for BasicChecking in Ohio.
 ...
 */
public final class BasicCheckingOHRegulatoryFilings {
    ...
    public BasicCheckingOHRegulatoryFilings() {
        this(new BasicCheckingOHProfile());
    }

    public BasicCheckingOHRegulatoryFilings(BasicCheckingOHProfile profile) {

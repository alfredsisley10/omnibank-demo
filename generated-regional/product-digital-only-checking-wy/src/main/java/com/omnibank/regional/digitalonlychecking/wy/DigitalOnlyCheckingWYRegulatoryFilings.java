...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Wyoming.
 ...
 */
public final class DigitalOnlyCheckingWYRegulatoryFilings {
    ...
    public DigitalOnlyCheckingWYRegulatoryFilings() {
        this(new DigitalOnlyCheckingWYProfile());
    }

    public DigitalOnlyCheckingWYRegulatoryFilings(DigitalOnlyCheckingWYProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Wyoming)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Wyoming)",
                "ANNUAL",

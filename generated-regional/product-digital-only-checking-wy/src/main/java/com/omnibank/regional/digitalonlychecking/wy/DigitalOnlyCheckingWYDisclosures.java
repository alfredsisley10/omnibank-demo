package com.omnibank.regional.digitalonlychecking.wy;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Wyoming.
 ...
 */
public final class DigitalOnlyCheckingWYDisclosures {

    private final DigitalOnlyCheckingWYProfile profile;

    public DigitalOnlyCheckingWYDisclosures() {
        this.profile = new DigitalOnlyCheckingWYProfile();
    }

    public DigitalOnlyCheckingWYDisclosures(DigitalOnlyCheckingWYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Wyoming State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

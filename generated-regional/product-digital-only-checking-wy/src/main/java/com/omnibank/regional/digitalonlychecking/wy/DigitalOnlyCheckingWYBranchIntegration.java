...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Wyoming.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingWYBranchIntegration {
    ...
    public DigitalOnlyCheckingWYBranchIntegration() {
        this.profile = new DigitalOnlyCheckingWYProfile();
    }

    public DigitalOnlyCheckingWYBranchIntegration(DigitalOnlyCheckingWYProfile profile) {

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Wyoming.
 ...
 */
public final class DigitalOnlyCheckingWYRateTable {
    ...
    public DigitalOnlyCheckingWYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WY-DigitalOnlyChecking-2026Q1";

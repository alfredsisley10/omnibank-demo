...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Wyoming (WY).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingWYProfile {
    ...
    public DigitalOnlyCheckingWYProfile() {
        this.stateCode = "WY";

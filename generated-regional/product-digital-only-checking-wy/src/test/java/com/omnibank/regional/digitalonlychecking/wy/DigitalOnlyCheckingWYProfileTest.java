...
class DigitalOnlyCheckingWYProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingWYProfile();
        assertThat(p.stateCode()).isEqualTo("WY");
        assertThat(p.stateName()).isEqualTo("Wyoming");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingWYRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingWYDisclosures();
        assertThat(d.renderFullSupplement()).contains("Wyoming");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingWYRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingWYBranchIntegration();

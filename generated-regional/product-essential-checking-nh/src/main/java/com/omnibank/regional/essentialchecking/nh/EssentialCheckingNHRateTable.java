...
/**
 * State-specific rate table overlay for EssentialChecking offered in New Hampshire.
 ...
 */
public final class EssentialCheckingNHRateTable {
    ...
    public EssentialCheckingNHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NH-EssentialChecking-2026Q1";

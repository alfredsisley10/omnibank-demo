...
/**
 * State regulatory filing cadence for EssentialChecking in New Hampshire.
 ...
 */
public final class EssentialCheckingNHRegulatoryFilings {
    ...
    public EssentialCheckingNHRegulatoryFilings() {
        this(new EssentialCheckingNHProfile());
    }

    public EssentialCheckingNHRegulatoryFilings(EssentialCheckingNHProfile profile) {

package com.omnibank.regional.essentialchecking.nh;
...
/**
 * State-specific disclosure overlays for EssentialChecking in New Hampshire.
 ...
 */
public final class EssentialCheckingNHDisclosures {

    private final EssentialCheckingNHProfile profile;

    public EssentialCheckingNHDisclosures() {
        this.profile = new EssentialCheckingNHProfile();
    }

    public EssentialCheckingNHDisclosures(EssentialCheckingNHProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — New Hampshire State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

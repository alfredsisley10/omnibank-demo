...
/**
 * Jurisdiction profile for EssentialChecking as offered in New Hampshire (NH).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingNHProfile {
    ...
    public EssentialCheckingNHProfile() {
        this.stateCode = "NH";

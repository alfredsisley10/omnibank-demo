...
/**
 * Branch / channel integration metadata for EssentialChecking in New Hampshire.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNHBranchIntegration {
    ...
    public EssentialCheckingNHBranchIntegration() {
        this.profile = new EssentialCheckingNHProfile();
    }

    public EssentialCheckingNHBranchIntegration(EssentialCheckingNHProfile profile) {

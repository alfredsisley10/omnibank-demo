...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNHProfile},
 * {@link EssentialCheckingNHRateTable}, {@link EssentialCheckingNHDisclosures},
 * {@link EssentialCheckingNHRegulatoryFilings}, and {@link EssentialCheckingNHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNHScenarioMatrixTest {

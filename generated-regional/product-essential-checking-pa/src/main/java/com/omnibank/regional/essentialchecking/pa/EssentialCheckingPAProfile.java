...
/**
 * Jurisdiction profile for EssentialChecking as offered in Pennsylvania (PA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingPAProfile {
    ...
    public EssentialCheckingPAProfile() {
        this.stateCode = "PA";

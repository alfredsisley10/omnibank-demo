...
/**
 * Branch / channel integration metadata for EssentialChecking in Pennsylvania.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingPABranchIntegration {
    ...
    public EssentialCheckingPABranchIntegration() {
        this.profile = new EssentialCheckingPAProfile();
    }

    public EssentialCheckingPABranchIntegration(EssentialCheckingPAProfile profile) {

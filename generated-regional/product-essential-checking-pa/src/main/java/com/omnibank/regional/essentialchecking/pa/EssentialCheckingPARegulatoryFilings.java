...
/**
 * State regulatory filing cadence for EssentialChecking in Pennsylvania.
 ...
 */
public final class EssentialCheckingPARegulatoryFilings {
    ...
    public EssentialCheckingPARegulatoryFilings() {
        this(new EssentialCheckingPAProfile());
    }

    public EssentialCheckingPARegulatoryFilings(EssentialCheckingPAProfile profile) {

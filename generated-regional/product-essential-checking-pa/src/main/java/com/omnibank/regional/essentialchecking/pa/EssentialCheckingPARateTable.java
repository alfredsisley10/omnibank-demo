...
/**
 * State-specific rate table overlay for EssentialChecking offered in Pennsylvania.
 ...
 */
public final class EssentialCheckingPARateTable {
    ...
    public EssentialCheckingPARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-PA-EssentialChecking-2026Q1";

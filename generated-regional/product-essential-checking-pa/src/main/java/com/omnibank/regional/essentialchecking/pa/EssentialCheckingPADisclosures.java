...
/**
 * State-specific disclosure overlays for EssentialChecking in Pennsylvania.
 ...
 */
public final class EssentialCheckingPADisclosures {

    private final EssentialCheckingPAProfile profile;

    public EssentialCheckingPADisclosures() {
        this.profile = new EssentialCheckingPAProfile();
    }

    public EssentialCheckingPADisclosures(EssentialCheckingPAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Pennsylvania State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

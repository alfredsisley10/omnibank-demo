...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsWA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsWAProfile},
 * {@link StandardSavingsWARateTable}, {@link StandardSavingsWADisclosures},
 * {@link StandardSavingsWARegulatoryFilings}, and {@link StandardSavingsWABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsWAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsWAScenarioMatrixTest {

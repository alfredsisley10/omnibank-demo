package com.omnibank.regional.standardsavings.wa;
...
/**
 * State-specific disclosure overlays for StandardSavings in Washington.
 * Layered on top of the national disclosure, these capture
 * items that only apply under WA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsWADisclosures {

    private final StandardSavingsWAProfile profile;

    public StandardSavingsWADisclosures() {
        this.profile = new StandardSavingsWAProfile();
    }

    public StandardSavingsWADisclosures(StandardSavingsWAProfile profile) {
    ...
    public String stateHeader() {
        return "Washington Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Washington unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Washington law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Washington does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Washington State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for StandardSavings in Washington.
 ...
 */
public final class StandardSavingsWARegulatoryFilings {
    ...
    public StandardSavingsWARegulatoryFilings() {
        this(new StandardSavingsWAProfile());
    }

    public StandardSavingsWARegulatoryFilings(StandardSavingsWAProfile profile) {

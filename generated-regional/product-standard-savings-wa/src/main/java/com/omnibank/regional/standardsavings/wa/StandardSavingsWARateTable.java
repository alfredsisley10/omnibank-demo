...
/**
 * State-specific rate table overlay for StandardSavings offered in Washington.
 ...
 */
public final class StandardSavingsWARateTable {
    ...
    public StandardSavingsWARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WA-StandardSavings-2026Q1";

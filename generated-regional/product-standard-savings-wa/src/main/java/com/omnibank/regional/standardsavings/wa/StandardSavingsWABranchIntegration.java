...
/**
 * Branch / channel integration metadata for StandardSavings in Washington.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsWABranchIntegration {
    ...
    public StandardSavingsWABranchIntegration() {
        this.profile = new StandardSavingsWAProfile();
    }

    public StandardSavingsWABranchIntegration(StandardSavingsWAProfile profile) {

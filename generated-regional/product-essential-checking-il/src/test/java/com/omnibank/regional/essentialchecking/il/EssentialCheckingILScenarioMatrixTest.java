...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingIL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingILProfile},
 * {@link EssentialCheckingILRateTable}, {@link EssentialCheckingILDisclosures},
 * {@link EssentialCheckingILRegulatoryFilings}, and {@link EssentialCheckingILBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingILProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingILScenarioMatrixTest {

...
/**
 * Branch / channel integration metadata for EssentialChecking in Illinois.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingILBranchIntegration {
    ...
    public EssentialCheckingILBranchIntegration() {
        this.profile = new EssentialCheckingILProfile();
    }

    public EssentialCheckingILBranchIntegration(EssentialCheckingILProfile profile) {

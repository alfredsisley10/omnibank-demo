...
/**
 * State-specific rate table overlay for EssentialChecking offered in Illinois.
 ...
 */
public final class EssentialCheckingILRateTable {
    ...
    public EssentialCheckingILRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IL-EssentialChecking-2026Q1";

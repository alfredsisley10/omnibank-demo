package com.omnibank.regional.essentialchecking.il;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Illinois.
 ...
 */
public final class EssentialCheckingILDisclosures {

    private final EssentialCheckingILProfile profile;

    public EssentialCheckingILDisclosures() {
        this.profile = new EssentialCheckingILProfile();
    }

    public EssentialCheckingILDisclosures(EssentialCheckingILProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Illinois State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

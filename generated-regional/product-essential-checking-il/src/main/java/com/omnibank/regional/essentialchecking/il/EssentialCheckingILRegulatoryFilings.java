...
/**
 * State regulatory filing cadence for EssentialChecking in Illinois.
 ...
 */
public final class EssentialCheckingILRegulatoryFilings {
    ...
    public EssentialCheckingILRegulatoryFilings() {
        this(new EssentialCheckingILProfile());
    }

    public EssentialCheckingILRegulatoryFilings(EssentialCheckingILProfile profile) {

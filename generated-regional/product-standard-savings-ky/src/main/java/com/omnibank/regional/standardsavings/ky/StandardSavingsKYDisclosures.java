package com.omnibank.regional.standardsavings.ky;
...
/**
 * State-specific disclosure overlays for StandardSavings in Kentucky.
 ...
 */
public final class StandardSavingsKYDisclosures {

    private final StandardSavingsKYProfile profile;

    public StandardSavingsKYDisclosures() {
        this.profile = new StandardSavingsKYProfile();
    }

    public StandardSavingsKYDisclosures(StandardSavingsKYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Kentucky State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for StandardSavings offered in Kentucky.
 ...
 */
public final class StandardSavingsKYRateTable {
    ...
    public StandardSavingsKYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KY-StandardSavings-2026Q1";

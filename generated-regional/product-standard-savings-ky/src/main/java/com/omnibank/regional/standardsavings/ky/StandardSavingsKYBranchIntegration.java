...
/**
 * Branch / channel integration metadata for StandardSavings in Kentucky.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsKYBranchIntegration {
    ...
    public StandardSavingsKYBranchIntegration() {
        this.profile = new StandardSavingsKYProfile();
    }

    public StandardSavingsKYBranchIntegration(StandardSavingsKYProfile profile) {

...
/**
 * State regulatory filing cadence for StandardSavings in Kentucky.
 ...
 */
public final class StandardSavingsKYRegulatoryFilings {
    ...
    public StandardSavingsKYRegulatoryFilings() {
        this(new StandardSavingsKYProfile());
    }

    public StandardSavingsKYRegulatoryFilings(StandardSavingsKYProfile profile) {

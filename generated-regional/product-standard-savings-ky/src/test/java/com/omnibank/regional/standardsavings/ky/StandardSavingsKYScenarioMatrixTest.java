...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsKY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsKYProfile},
 * {@link StandardSavingsKYRateTable}, {@link StandardSavingsKYDisclosures},
 * {@link StandardSavingsKYRegulatoryFilings}, and {@link StandardSavingsKYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsKYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsKYScenarioMatrixTest {

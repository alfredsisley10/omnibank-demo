...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingUT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingUTProfile},
 * {@link BasicCheckingUTRateTable}, {@link BasicCheckingUTDisclosures},
 * {@link BasicCheckingUTRegulatoryFilings}, and {@link BasicCheckingUTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingUTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingUTScenarioMatrixTest {

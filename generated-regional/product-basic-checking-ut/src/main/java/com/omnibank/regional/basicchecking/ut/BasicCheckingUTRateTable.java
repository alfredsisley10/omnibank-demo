...
/**
 * State-specific rate table overlay for BasicChecking offered in Utah.
 ...
 */
public final class BasicCheckingUTRateTable {
    ...
    public BasicCheckingUTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-UT-BasicChecking-2026Q1";

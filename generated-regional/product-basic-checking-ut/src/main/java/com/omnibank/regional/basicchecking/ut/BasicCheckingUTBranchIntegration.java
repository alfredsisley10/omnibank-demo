...
public final class BasicCheckingUTBranchIntegration {
    ...
    public BasicCheckingUTBranchIntegration() {
        this.profile = new BasicCheckingUTProfile();
    }

    public BasicCheckingUTBranchIntegration(BasicCheckingUTProfile profile) {

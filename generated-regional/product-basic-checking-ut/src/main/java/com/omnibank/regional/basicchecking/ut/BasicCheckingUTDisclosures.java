package com.omnibank.regional.basicchecking.ut;
...
/**
 * State-specific disclosure overlays for BasicChecking in Utah.
 ...
 */
public final class BasicCheckingUTDisclosures {

    private final BasicCheckingUTProfile profile;

    public BasicCheckingUTDisclosures() {
        this.profile = new BasicCheckingUTProfile();
    }

    public BasicCheckingUTDisclosures(BasicCheckingUTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Utah State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

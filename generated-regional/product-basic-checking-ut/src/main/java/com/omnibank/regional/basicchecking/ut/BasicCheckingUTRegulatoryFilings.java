...
/**
 * State regulatory filing cadence for BasicChecking in Utah.
 ...
 */
public final class BasicCheckingUTRegulatoryFilings {
    ...
    public BasicCheckingUTRegulatoryFilings() {
        this(new BasicCheckingUTProfile());
    }

    public BasicCheckingUTRegulatoryFilings(BasicCheckingUTProfile profile) {

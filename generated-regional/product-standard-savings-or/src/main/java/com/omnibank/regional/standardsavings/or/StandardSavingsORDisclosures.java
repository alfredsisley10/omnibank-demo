...
/**
 * State-specific disclosure overlays for StandardSavings in Oregon.
 ...
 */
public final class StandardSavingsORDisclosures {

    private final StandardSavingsORProfile profile;

    public StandardSavingsORDisclosures() {
        this.profile = new StandardSavingsORProfile();
    }

    public StandardSavingsORDisclosures(StandardSavingsORProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Oregon State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

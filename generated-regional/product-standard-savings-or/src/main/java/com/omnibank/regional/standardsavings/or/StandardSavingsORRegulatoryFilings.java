...
/**
 * State regulatory filing cadence for StandardSavings in Oregon.
 ...
 */
public final class StandardSavingsORRegulatoryFilings {
    ...
    public StandardSavingsORRegulatoryFilings() {
        this(new StandardSavingsORProfile());
    }

    public StandardSavingsORRegulatoryFilings(StandardSavingsORProfile profile) {

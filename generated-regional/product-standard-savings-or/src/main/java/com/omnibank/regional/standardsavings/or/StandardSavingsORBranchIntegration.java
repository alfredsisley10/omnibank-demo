...
public final class StandardSavingsORBranchIntegration {
    ...
    public StandardSavingsORBranchIntegration() {
        this.profile = new StandardSavingsORProfile();
    }

    public StandardSavingsORBranchIntegration(StandardSavingsORProfile profile) {

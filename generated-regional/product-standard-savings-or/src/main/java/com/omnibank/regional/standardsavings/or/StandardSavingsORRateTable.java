...
/**
 * State-specific rate table overlay for StandardSavings offered in Oregon.
 ...
 */
public final class StandardSavingsORRateTable {
    ...
    public StandardSavingsORRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OR-StandardSavings-2026Q1";

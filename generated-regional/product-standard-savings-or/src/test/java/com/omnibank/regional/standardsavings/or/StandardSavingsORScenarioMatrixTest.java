...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsOR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsORProfile},
 * {@link StandardSavingsORRateTable}, {@link StandardSavingsORDisclosures},
 * {@link StandardSavingsORRegulatoryFilings}, and {@link StandardSavingsORBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsORProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsORScenarioMatrixTest {

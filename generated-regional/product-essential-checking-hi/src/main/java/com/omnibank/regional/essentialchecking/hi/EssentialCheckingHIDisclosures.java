package com.omnibank.regional.essentialchecking.hi;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Hawaii.
 ...
 */
public final class EssentialCheckingHIDisclosures {

    private final EssentialCheckingHIProfile profile;

    public EssentialCheckingHIDisclosures() {
        this.profile = new EssentialCheckingHIProfile();
    }

    public EssentialCheckingHIDisclosures(EssentialCheckingHIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Hawaii State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

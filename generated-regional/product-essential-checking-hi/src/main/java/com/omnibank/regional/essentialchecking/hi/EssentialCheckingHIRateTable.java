...
/**
 * State-specific rate table overlay for EssentialChecking offered in Hawaii.
 ...
 */
public final class EssentialCheckingHIRateTable {
    ...
    public EssentialCheckingHIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-HI-EssentialChecking-2026Q1";

...
/**
 * State regulatory filing cadence for EssentialChecking in Hawaii.
 ...
 */
public final class EssentialCheckingHIRegulatoryFilings {
    ...
    public EssentialCheckingHIRegulatoryFilings() {
        this(new EssentialCheckingHIProfile());
    }

    public EssentialCheckingHIRegulatoryFilings(EssentialCheckingHIProfile profile) {

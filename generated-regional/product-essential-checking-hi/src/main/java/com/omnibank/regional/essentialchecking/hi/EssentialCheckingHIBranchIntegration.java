...
/**
 * Branch / channel integration metadata for EssentialChecking in Hawaii.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingHIBranchIntegration {
    ...
    public EssentialCheckingHIBranchIntegration() {
        this.profile = new EssentialCheckingHIProfile();
    }

    public EssentialCheckingHIBranchIntegration(EssentialCheckingHIProfile profile) {

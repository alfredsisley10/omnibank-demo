...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingHI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingHIProfile},
 * {@link EssentialCheckingHIRateTable}, {@link EssentialCheckingHIDisclosures},
 * {@link EssentialCheckingHIRegulatoryFilings}, and {@link EssentialCheckingHIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingHIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingHIScenarioMatrixTest {

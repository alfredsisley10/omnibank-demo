package com.omnibank.regional.essentialchecking.va;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Virginia.
 ...
 */
public final class EssentialCheckingVADisclosures {

    private final EssentialCheckingVAProfile profile;

    public EssentialCheckingVADisclosures() {
        this.profile = new EssentialCheckingVAProfile();
    }

    public EssentialCheckingVADisclosures(EssentialCheckingVAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

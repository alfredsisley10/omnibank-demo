...
/**
 * State-specific rate table overlay for EssentialChecking offered in Virginia.
 ...
 */
public final class EssentialCheckingVARateTable {
    ...
    public EssentialCheckingVARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VA-EssentialChecking-2026Q1";

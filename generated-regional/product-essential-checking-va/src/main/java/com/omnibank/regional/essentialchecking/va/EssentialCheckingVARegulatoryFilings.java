...
/**
 * State regulatory filing cadence for EssentialChecking in Virginia.
 ...
 */
public final class EssentialCheckingVARegulatoryFilings {
    ...
    public EssentialCheckingVARegulatoryFilings() {
        this(new EssentialCheckingVAProfile());
    }

    public EssentialCheckingVARegulatoryFilings(EssentialCheckingVAProfile profile) {

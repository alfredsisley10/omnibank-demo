...
/**
 * Branch / channel integration metadata for EssentialChecking in Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingVABranchIntegration {
    ...
    public EssentialCheckingVABranchIntegration() {
        this.profile = new EssentialCheckingVAProfile();
    }

    public EssentialCheckingVABranchIntegration(EssentialCheckingVAProfile profile) {

...
/**
 * Branch / channel integration metadata for StandardSavings in California.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsCABranchIntegration {
    ...
    public StandardSavingsCABranchIntegration() {
        this.profile = new StandardSavingsCAProfile();
    }

    public StandardSavingsCABranchIntegration(StandardSavingsCAProfile profile) {

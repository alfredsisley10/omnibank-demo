...
/**
 * State-specific rate table overlay for StandardSavings offered in California.
 ...
 */
public final class StandardSavingsCARateTable {
    ...
    public StandardSavingsCARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CA-StandardSavings-2026Q1";

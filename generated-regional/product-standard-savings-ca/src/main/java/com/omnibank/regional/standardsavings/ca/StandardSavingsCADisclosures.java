...
/**
 * State-specific disclosure overlays for StandardSavings in California.
 * Layered on top of the national disclosure, these capture
 * items that only apply under CA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsCADisclosures {

    private final StandardSavingsCAProfile profile;

    public StandardSavingsCADisclosures() {
        this.profile = new StandardSavingsCAProfile();
    }

    public StandardSavingsCADisclosures(StandardSavingsCAProfile profile) {
    ...
    public String stateHeader() {
        return "California Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "California unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by California law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "California does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — California State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

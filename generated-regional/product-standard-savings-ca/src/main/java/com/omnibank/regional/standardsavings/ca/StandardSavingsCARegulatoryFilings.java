...
/**
 * State regulatory filing cadence for StandardSavings in California.
 ...
 */
public final class StandardSavingsCARegulatoryFilings {
    ...
    public StandardSavingsCARegulatoryFilings() {
        this(new StandardSavingsCAProfile());
    }

    public StandardSavingsCARegulatoryFilings(StandardSavingsCAProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsCA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsCAProfile},
 * {@link StandardSavingsCARateTable}, {@link StandardSavingsCADisclosures},
 * {@link StandardSavingsCARegulatoryFilings}, and {@link StandardSavingsCABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsCAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsCAScenarioMatrixTest {

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Pennsylvania.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingPABranchIntegration {
    ...
    public DigitalOnlyCheckingPABranchIntegration() {
        this.profile = new DigitalOnlyCheckingPAProfile();
    }

    public DigitalOnlyCheckingPABranchIntegration(DigitalOnlyCheckingPAProfile profile) {

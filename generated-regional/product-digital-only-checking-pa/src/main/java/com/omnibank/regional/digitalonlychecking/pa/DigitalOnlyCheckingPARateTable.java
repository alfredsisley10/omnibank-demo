...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Pennsylvania.
 ...
 */
public final class DigitalOnlyCheckingPARateTable {
    ...
    public DigitalOnlyCheckingPARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-PA-DigitalOnlyChecking-2026Q1";

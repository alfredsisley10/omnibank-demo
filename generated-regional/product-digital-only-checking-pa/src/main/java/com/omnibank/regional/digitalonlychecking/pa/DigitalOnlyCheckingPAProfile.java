...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Pennsylvania (PA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingPAProfile {
    ...
    public DigitalOnlyCheckingPAProfile() {
        this.stateCode = "PA";

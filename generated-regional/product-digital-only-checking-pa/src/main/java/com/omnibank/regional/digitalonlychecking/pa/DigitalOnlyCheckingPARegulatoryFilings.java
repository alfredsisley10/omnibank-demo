...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Pennsylvania.
 ...
 */
public final class DigitalOnlyCheckingPARegulatoryFilings {
    ...
    public DigitalOnlyCheckingPARegulatoryFilings() {
        this(new DigitalOnlyCheckingPAProfile());
    }

    public DigitalOnlyCheckingPARegulatoryFilings(DigitalOnlyCheckingPAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Pennsylvania)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Pennsylvania)",
                "ANNUAL",

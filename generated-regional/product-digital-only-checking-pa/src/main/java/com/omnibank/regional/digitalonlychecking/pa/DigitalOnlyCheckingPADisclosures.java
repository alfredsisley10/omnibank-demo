package com.omnibank.regional.digitalonlychecking.pa;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Pennsylvania.
 ...
 */
public final class DigitalOnlyCheckingPADisclosures {

    private final DigitalOnlyCheckingPAProfile profile;

    public DigitalOnlyCheckingPADisclosures() {
        this.profile = new DigitalOnlyCheckingPAProfile();
    }

    public DigitalOnlyCheckingPADisclosures(DigitalOnlyCheckingPAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Pennsylvania State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

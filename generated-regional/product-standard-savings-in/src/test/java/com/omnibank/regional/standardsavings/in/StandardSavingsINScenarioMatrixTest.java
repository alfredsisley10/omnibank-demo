...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsIN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsINProfile},
 * {@link StandardSavingsINRateTable}, {@link StandardSavingsINDisclosures},
 * {@link StandardSavingsINRegulatoryFilings}, and {@link StandardSavingsINBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsINProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsINScenarioMatrixTest {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Indiana.
 ...
 */
public final class StandardSavingsINRateTable {
    ...
    public StandardSavingsINRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IN-StandardSavings-2026Q1";

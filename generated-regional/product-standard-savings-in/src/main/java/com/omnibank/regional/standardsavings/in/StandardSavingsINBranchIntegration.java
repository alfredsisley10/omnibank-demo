...
public final class StandardSavingsINBranchIntegration {
    ...
    public StandardSavingsINBranchIntegration() {
        this.profile = new StandardSavingsINProfile();
    }

    public StandardSavingsINBranchIntegration(StandardSavingsINProfile profile) {

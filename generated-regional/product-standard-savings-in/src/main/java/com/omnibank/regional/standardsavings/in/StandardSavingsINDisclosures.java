package com.omnibank.regional.standardsavings.in;
...
/**
 * State-specific disclosure overlays for StandardSavings in Indiana.
 * Layered on top of the national disclosure, these capture
 * items that only apply under IN law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsINDisclosures {

    private final StandardSavingsINProfile profile;

    public StandardSavingsINDisclosures() {
        this.profile = new StandardSavingsINProfile();
    }

    public StandardSavingsINDisclosures(StandardSavingsINProfile profile) {
    ...
    public String stateHeader() {
        return "Indiana Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Indiana unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Indiana law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Indiana does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Indiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

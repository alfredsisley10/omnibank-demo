...
/**
 * State regulatory filing cadence for StandardSavings in Indiana.
 ...
 */
public final class StandardSavingsINRegulatoryFilings {
    ...
    public StandardSavingsINRegulatoryFilings() {
        this(new StandardSavingsINProfile());
    }

    public StandardSavingsINRegulatoryFilings(StandardSavingsINProfile profile) {

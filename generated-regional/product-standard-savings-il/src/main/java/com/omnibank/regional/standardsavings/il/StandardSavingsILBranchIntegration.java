...
/**
 * Branch / channel integration metadata for StandardSavings in Illinois.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsILBranchIntegration {
    ...
    public StandardSavingsILBranchIntegration() {
        this.profile = new StandardSavingsILProfile();
    }

    public StandardSavingsILBranchIntegration(StandardSavingsILProfile profile) {

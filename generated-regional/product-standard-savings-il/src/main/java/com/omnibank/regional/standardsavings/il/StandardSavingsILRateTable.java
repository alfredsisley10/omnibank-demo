...
/**
 * State-specific rate table overlay for StandardSavings offered in Illinois.
 ...
 */
public final class StandardSavingsILRateTable {
    ...
    public StandardSavingsILRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IL-StandardSavings-2026Q1";

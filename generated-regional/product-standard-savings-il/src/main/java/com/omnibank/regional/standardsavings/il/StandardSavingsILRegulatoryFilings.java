...
/**
 * State regulatory filing cadence for StandardSavings in Illinois.
 ...
 */
public final class StandardSavingsILRegulatoryFilings {
    ...
    public StandardSavingsILRegulatoryFilings() {
        this(new StandardSavingsILProfile());
    }

    public StandardSavingsILRegulatoryFilings(StandardSavingsILProfile profile) {

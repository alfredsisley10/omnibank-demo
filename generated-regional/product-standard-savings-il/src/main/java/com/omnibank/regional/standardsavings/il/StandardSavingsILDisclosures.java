package com.omnibank.regional.standardsavings.il;
...
/**
 * State-specific disclosure overlays for StandardSavings in Illinois.
 * Layered on top of the national disclosure, these capture
 * items that only apply under IL law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsILDisclosures {

    private final StandardSavingsILProfile profile;

    public StandardSavingsILDisclosures() {
        this.profile = new StandardSavingsILProfile();
    }

    public StandardSavingsILDisclosures(StandardSavingsILProfile profile) {
    ...
    public String stateHeader() {
        return "Illinois Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Illinois unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Illinois law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Illinois does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Illinois State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

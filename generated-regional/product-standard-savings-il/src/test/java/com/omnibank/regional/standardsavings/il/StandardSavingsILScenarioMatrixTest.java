...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsIL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsILProfile},
 * {@link StandardSavingsILRateTable}, {@link StandardSavingsILDisclosures},
 * {@link StandardSavingsILRegulatoryFilings}, and {@link StandardSavingsILBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsILProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsILScenarioMatrixTest {

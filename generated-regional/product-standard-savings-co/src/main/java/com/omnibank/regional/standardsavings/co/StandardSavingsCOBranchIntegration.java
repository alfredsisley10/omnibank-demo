...
/**
 * Branch / channel integration metadata for StandardSavings in Colorado.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsCOBranchIntegration {
    ...
    public StandardSavingsCOBranchIntegration() {
        this.profile = new StandardSavingsCOProfile();
    }

    public StandardSavingsCOBranchIntegration(StandardSavingsCOProfile profile) {

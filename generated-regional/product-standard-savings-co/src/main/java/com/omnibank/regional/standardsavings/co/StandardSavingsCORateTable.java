...
/**
 * State-specific rate table overlay for StandardSavings offered in Colorado.
 ...
 */
public final class StandardSavingsCORateTable {
    ...
    public StandardSavingsCORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CO-StandardSavings-2026Q1";

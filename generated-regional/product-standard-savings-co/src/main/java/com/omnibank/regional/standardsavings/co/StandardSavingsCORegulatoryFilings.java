...
/**
 * State regulatory filing cadence for StandardSavings in Colorado.
 ...
 */
public final class StandardSavingsCORegulatoryFilings {
    ...
    public StandardSavingsCORegulatoryFilings() {
        this(new StandardSavingsCOProfile());
    }

    public StandardSavingsCORegulatoryFilings(StandardSavingsCOProfile profile) {

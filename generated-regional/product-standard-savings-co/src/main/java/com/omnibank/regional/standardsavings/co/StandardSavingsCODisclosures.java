package com.omnibank.regional.standardsavings.co;
...
/**
 * State-specific disclosure overlays for StandardSavings in Colorado.
 * Layered on top of the national disclosure, these capture
 * items that only apply under CO law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsCODisclosures {

    private final StandardSavingsCOProfile profile;

    public StandardSavingsCODisclosures() {
        this.profile = new StandardSavingsCOProfile();
    }

    public StandardSavingsCODisclosures(StandardSavingsCOProfile profile) {
    ...
    public String stateHeader() {
        return "Colorado Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Colorado unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Colorado law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Colorado does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Colorado State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

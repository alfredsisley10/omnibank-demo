...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsCO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsCOProfile},
 * {@link StandardSavingsCORateTable}, {@link StandardSavingsCODisclosures},
 * {@link StandardSavingsCORegulatoryFilings}, and {@link StandardSavingsCOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsCOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsCOScenarioMatrixTest {

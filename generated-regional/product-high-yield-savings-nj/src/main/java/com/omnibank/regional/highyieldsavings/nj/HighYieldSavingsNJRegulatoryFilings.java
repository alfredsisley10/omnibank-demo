...
/**
 * State regulatory filing cadence for HighYieldSavings in New Jersey.
 ...
 */
public final class HighYieldSavingsNJRegulatoryFilings {
    ...
    public HighYieldSavingsNJRegulatoryFilings() {
        this(new HighYieldSavingsNJProfile());
    }

    public HighYieldSavingsNJRegulatoryFilings(HighYieldSavingsNJProfile profile) {

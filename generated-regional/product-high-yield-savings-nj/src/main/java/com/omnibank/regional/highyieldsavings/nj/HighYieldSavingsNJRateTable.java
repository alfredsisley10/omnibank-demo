...
/**
 * State-specific rate table overlay for HighYieldSavings offered in New Jersey.
 ...
 */
public final class HighYieldSavingsNJRateTable {
    ...
    public HighYieldSavingsNJRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NJ-HighYieldSavings-2026Q1";

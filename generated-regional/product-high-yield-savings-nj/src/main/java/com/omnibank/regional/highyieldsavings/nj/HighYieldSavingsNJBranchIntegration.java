...
/**
 * Branch / channel integration metadata for HighYieldSavings in New Jersey.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNJBranchIntegration {
    ...
    public HighYieldSavingsNJBranchIntegration() {
        this.profile = new HighYieldSavingsNJProfile();
    }

    public HighYieldSavingsNJBranchIntegration(HighYieldSavingsNJProfile profile) {

package com.omnibank.regional.highyieldsavings.nj;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in New Jersey.
 ...
 */
public final class HighYieldSavingsNJDisclosures {

    private final HighYieldSavingsNJProfile profile;

    public HighYieldSavingsNJDisclosures() {
        this.profile = new HighYieldSavingsNJProfile();
    }

    public HighYieldSavingsNJDisclosures(HighYieldSavingsNJProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — New Jersey State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

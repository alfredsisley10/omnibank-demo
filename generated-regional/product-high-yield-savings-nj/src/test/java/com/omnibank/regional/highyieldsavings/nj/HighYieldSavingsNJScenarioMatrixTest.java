...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNJ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNJProfile},
 * {@link HighYieldSavingsNJRateTable}, {@link HighYieldSavingsNJDisclosures},
 * {@link HighYieldSavingsNJRegulatoryFilings}, and {@link HighYieldSavingsNJBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNJProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNJScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsVA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsVAProfile},
 * {@link HighYieldSavingsVARateTable}, {@link HighYieldSavingsVADisclosures},
 * {@link HighYieldSavingsVARegulatoryFilings}, and {@link HighYieldSavingsVABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsVAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsVAScenarioMatrixTest {

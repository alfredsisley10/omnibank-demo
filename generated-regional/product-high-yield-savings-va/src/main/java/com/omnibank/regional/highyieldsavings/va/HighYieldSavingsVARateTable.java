...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Virginia.
 ...
 */
public final class HighYieldSavingsVARateTable {
    ...
    public HighYieldSavingsVARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VA-HighYieldSavings-2026Q1";

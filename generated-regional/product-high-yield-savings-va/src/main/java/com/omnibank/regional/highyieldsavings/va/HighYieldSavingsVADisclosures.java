package com.omnibank.regional.highyieldsavings.va;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Virginia.
 ...
 */
public final class HighYieldSavingsVADisclosures {

    private final HighYieldSavingsVAProfile profile;

    public HighYieldSavingsVADisclosures() {
        this.profile = new HighYieldSavingsVAProfile();
    }

    public HighYieldSavingsVADisclosures(HighYieldSavingsVAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

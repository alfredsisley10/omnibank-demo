...
/**
 * Branch / channel integration metadata for HighYieldSavings in Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsVABranchIntegration {
    ...
    public HighYieldSavingsVABranchIntegration() {
        this.profile = new HighYieldSavingsVAProfile();
    }

    public HighYieldSavingsVABranchIntegration(HighYieldSavingsVAProfile profile) {

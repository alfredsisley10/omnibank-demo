...
/**
 * State regulatory filing cadence for HighYieldSavings in Virginia.
 ...
 */
public final class HighYieldSavingsVARegulatoryFilings {
    ...
    public HighYieldSavingsVARegulatoryFilings() {
        this(new HighYieldSavingsVAProfile());
    }

    public HighYieldSavingsVARegulatoryFilings(HighYieldSavingsVAProfile profile) {

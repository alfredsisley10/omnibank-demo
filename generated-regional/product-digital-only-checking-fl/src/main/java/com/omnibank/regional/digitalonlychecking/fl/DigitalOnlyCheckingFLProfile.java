...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Florida (FL).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingFLProfile {
    ...
    public DigitalOnlyCheckingFLProfile() {
        this.stateCode = "FL";

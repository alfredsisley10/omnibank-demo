...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Florida.
 ...
 */
public final class DigitalOnlyCheckingFLRateTable {
    ...
    public DigitalOnlyCheckingFLRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-FL-DigitalOnlyChecking-2026Q1";

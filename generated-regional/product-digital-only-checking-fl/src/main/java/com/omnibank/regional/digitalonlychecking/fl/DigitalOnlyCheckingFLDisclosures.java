package com.omnibank.regional.digitalonlychecking.fl;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Florida.
 ...
 */
public final class DigitalOnlyCheckingFLDisclosures {

    private final DigitalOnlyCheckingFLProfile profile;

    public DigitalOnlyCheckingFLDisclosures() {
        this.profile = new DigitalOnlyCheckingFLProfile();
    }

    public DigitalOnlyCheckingFLDisclosures(DigitalOnlyCheckingFLProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Florida State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Florida.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingFLBranchIntegration {
    ...
    public DigitalOnlyCheckingFLBranchIntegration() {
        this.profile = new DigitalOnlyCheckingFLProfile();
    }

    public DigitalOnlyCheckingFLBranchIntegration(DigitalOnlyCheckingFLProfile profile) {

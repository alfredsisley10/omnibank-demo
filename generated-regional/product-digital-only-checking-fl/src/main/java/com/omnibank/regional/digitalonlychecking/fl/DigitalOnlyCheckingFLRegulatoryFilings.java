...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Florida.
 ...
 */
public final class DigitalOnlyCheckingFLRegulatoryFilings {
    ...
    public DigitalOnlyCheckingFLRegulatoryFilings() {
        this(new DigitalOnlyCheckingFLProfile());
    }

    public DigitalOnlyCheckingFLRegulatoryFilings(DigitalOnlyCheckingFLProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Florida)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Florida)",
                "ANNUAL",

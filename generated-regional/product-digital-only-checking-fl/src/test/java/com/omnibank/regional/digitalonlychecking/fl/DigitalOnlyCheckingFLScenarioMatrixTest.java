...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingFL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingFLProfile},
 * {@link DigitalOnlyCheckingFLRateTable}, {@link DigitalOnlyCheckingFLDisclosures},
 * {@link DigitalOnlyCheckingFLRegulatoryFilings}, and {@link DigitalOnlyCheckingFLBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingFLProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingFLScenarioMatrixTest {

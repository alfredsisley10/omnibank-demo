...
class DigitalOnlyCheckingFLProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new DigitalOnlyCheckingFLProfile();
        assertThat(p.stateCode()).isEqualTo("FL");
        assertThat(p.stateName()).isEqualTo("Florida");
    }
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new DigitalOnlyCheckingFLRateTable();
    ...
    void disclosures_contain_state_name() {
        var d = new DigitalOnlyCheckingFLDisclosures();
        assertThat(d.renderFullSupplement()).contains("Florida");
    }

    @Test
    void regulatory_filings_produced_for_quarter() {
        var f = new DigitalOnlyCheckingFLRegulatoryFilings();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new DigitalOnlyCheckingFLBranchIntegration();

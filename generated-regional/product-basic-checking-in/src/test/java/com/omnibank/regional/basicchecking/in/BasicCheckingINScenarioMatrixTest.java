...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingIN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingINProfile},
 * {@link BasicCheckingINRateTable}, {@link BasicCheckingINDisclosures},
 * {@link BasicCheckingINRegulatoryFilings}, and {@link BasicCheckingINBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingINProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingINScenarioMatrixTest {

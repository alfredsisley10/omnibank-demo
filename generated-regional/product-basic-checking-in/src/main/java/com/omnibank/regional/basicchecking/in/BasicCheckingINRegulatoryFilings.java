...
/**
 * State regulatory filing cadence for BasicChecking in Indiana.
 ...
 */
public final class BasicCheckingINRegulatoryFilings {
    ...
    public BasicCheckingINRegulatoryFilings() {
        this(new BasicCheckingINProfile());
    }

    public BasicCheckingINRegulatoryFilings(BasicCheckingINProfile profile) {

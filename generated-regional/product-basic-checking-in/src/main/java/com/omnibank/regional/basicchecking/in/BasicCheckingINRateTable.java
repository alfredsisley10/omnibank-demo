...
/**
 * State-specific rate table overlay for BasicChecking offered in Indiana.
 ...
 */
public final class BasicCheckingINRateTable {
    ...
    public BasicCheckingINRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IN-BasicChecking-2026Q1";

package com.omnibank.regional.basicchecking.in;
...
/**
 * State-specific disclosure overlays for BasicChecking in Indiana.
 ...
 */
public final class BasicCheckingINDisclosures {

    private final BasicCheckingINProfile profile;

    public BasicCheckingINDisclosures() {
        this.profile = new BasicCheckingINProfile();
    }

    public BasicCheckingINDisclosures(BasicCheckingINProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Indiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

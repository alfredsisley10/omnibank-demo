...
public final class BasicCheckingINBranchIntegration {
    ...
    public BasicCheckingINBranchIntegration() {
        this.profile = new BasicCheckingINProfile();
    }

    public BasicCheckingINBranchIntegration(BasicCheckingINProfile profile) {

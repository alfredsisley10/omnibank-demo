package com.omnibank.regional.standardsavings.nm;
...
/**
 * State-specific disclosure overlays for StandardSavings in New Mexico.
 * Layered on top of the national disclosure, these capture
 * items that only apply under NM law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsNMDisclosures {

    private final StandardSavingsNMProfile profile;

    public StandardSavingsNMDisclosures() {
        this.profile = new StandardSavingsNMProfile();
    }

    public StandardSavingsNMDisclosures(StandardSavingsNMProfile profile) {
    ...
    public String stateHeader() {
        return "New Mexico Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "New Mexico unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by New Mexico law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "New Mexico does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — New Mexico State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

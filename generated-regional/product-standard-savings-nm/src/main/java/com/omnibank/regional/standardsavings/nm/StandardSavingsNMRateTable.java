...
/**
 * State-specific rate table overlay for StandardSavings offered in New Mexico.
 ...
 */
public final class StandardSavingsNMRateTable {
    ...
    public StandardSavingsNMRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NM-StandardSavings-2026Q1";

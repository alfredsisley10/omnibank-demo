...
/**
 * State regulatory filing cadence for StandardSavings in New Mexico.
 ...
 */
public final class StandardSavingsNMRegulatoryFilings {
    ...
    public StandardSavingsNMRegulatoryFilings() {
        this(new StandardSavingsNMProfile());
    }

    public StandardSavingsNMRegulatoryFilings(StandardSavingsNMProfile profile) {

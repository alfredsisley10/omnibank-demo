...
/**
 * Branch / channel integration metadata for StandardSavings in New Mexico.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsNMBranchIntegration {
    ...
    public StandardSavingsNMBranchIntegration() {
        this.profile = new StandardSavingsNMProfile();
    }

    public StandardSavingsNMBranchIntegration(StandardSavingsNMProfile profile) {

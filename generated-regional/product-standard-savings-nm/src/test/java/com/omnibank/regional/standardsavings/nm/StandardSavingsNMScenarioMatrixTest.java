...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsNM jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsNMProfile},
 * {@link StandardSavingsNMRateTable}, {@link StandardSavingsNMDisclosures},
 * {@link StandardSavingsNMRegulatoryFilings}, and {@link StandardSavingsNMBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsNMProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsNMScenarioMatrixTest {

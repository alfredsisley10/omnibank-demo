...
/**
 * State regulatory filing cadence for EssentialChecking in West Virginia.
 ...
 */
public final class EssentialCheckingWVRegulatoryFilings {
    ...
    public EssentialCheckingWVRegulatoryFilings() {
        this(new EssentialCheckingWVProfile());
    }

    public EssentialCheckingWVRegulatoryFilings(EssentialCheckingWVProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                ...
                "West Virginia Condition Report",
                "QUARTERLY",
                dueDate,
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (West Virginia)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (West Virginia)",
                "ANNUAL",

...
/**
 * State-specific rate table overlay for EssentialChecking offered in West Virginia.
 ...
 */
public final class EssentialCheckingWVRateTable {
    ...
    public EssentialCheckingWVRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WV-EssentialChecking-2026Q1";

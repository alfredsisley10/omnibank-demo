...
/**
 * Jurisdiction profile for EssentialChecking as offered in West Virginia (WV).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingWVProfile {
    ...
    public EssentialCheckingWVProfile() {
        this.stateCode = "WV";

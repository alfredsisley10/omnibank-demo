...
/**
 * Branch / channel integration metadata for EssentialChecking in West Virginia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingWVBranchIntegration {
    ...
    public EssentialCheckingWVBranchIntegration() {
        this.profile = new EssentialCheckingWVProfile();
    }

    public EssentialCheckingWVBranchIntegration(EssentialCheckingWVProfile profile) {

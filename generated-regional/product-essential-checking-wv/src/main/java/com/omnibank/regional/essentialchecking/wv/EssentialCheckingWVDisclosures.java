package com.omnibank.regional.essentialchecking.wv;
...
/**
 * State-specific disclosure overlays for EssentialChecking in West Virginia.
 ...
 */
public final class EssentialCheckingWVDisclosures {

    private final EssentialCheckingWVProfile profile;

    public EssentialCheckingWVDisclosures() {
        this.profile = new EssentialCheckingWVProfile();
    }

    public EssentialCheckingWVDisclosures(EssentialCheckingWVProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — West Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

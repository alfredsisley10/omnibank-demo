...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNCProfile},
 * {@link DigitalOnlyCheckingNCRateTable}, {@link DigitalOnlyCheckingNCDisclosures},
 * {@link DigitalOnlyCheckingNCRegulatoryFilings}, and {@link DigitalOnlyCheckingNCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNCScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in North Carolina.
 ...
 */
public final class DigitalOnlyCheckingNCRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNCRegulatoryFilings() {
        this(new DigitalOnlyCheckingNCProfile());
    }

    public DigitalOnlyCheckingNCRegulatoryFilings(DigitalOnlyCheckingNCProfile profile) {

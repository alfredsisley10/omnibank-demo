...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in North Carolina (NC).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNCProfile {
    ...
    public DigitalOnlyCheckingNCProfile() {
        this.stateCode = "NC";

...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in North Carolina.
 ...
 */
public final class DigitalOnlyCheckingNCRateTable {
    ...
    public DigitalOnlyCheckingNCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NC-DigitalOnlyChecking-2026Q1";

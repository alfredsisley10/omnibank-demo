...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in North Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNCBranchIntegration {
    ...
    public DigitalOnlyCheckingNCBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNCProfile();
    }

    public DigitalOnlyCheckingNCBranchIntegration(DigitalOnlyCheckingNCProfile profile) {

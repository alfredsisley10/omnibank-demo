...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsRI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsRIProfile},
 * {@link StandardSavingsRIRateTable}, {@link StandardSavingsRIDisclosures},
 * {@link StandardSavingsRIRegulatoryFilings}, and {@link StandardSavingsRIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsRIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsRIScenarioMatrixTest {

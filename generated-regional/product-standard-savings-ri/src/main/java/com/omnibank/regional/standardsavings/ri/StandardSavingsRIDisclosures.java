package com.omnibank.regional.standardsavings.ri;
...
/**
 * State-specific disclosure overlays for StandardSavings in Rhode Island.
 * Layered on top of the national disclosure, these capture
 * items that only apply under RI law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsRIDisclosures {

    private final StandardSavingsRIProfile profile;

    public StandardSavingsRIDisclosures() {
        this.profile = new StandardSavingsRIProfile();
    }

    public StandardSavingsRIDisclosures(StandardSavingsRIProfile profile) {
    ...
    public String stateHeader() {
        return "Rhode Island Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Rhode Island unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Rhode Island law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Rhode Island does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Rhode Island State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for StandardSavings in Rhode Island.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsRIBranchIntegration {
    ...
    public StandardSavingsRIBranchIntegration() {
        this.profile = new StandardSavingsRIProfile();
    }

    public StandardSavingsRIBranchIntegration(StandardSavingsRIProfile profile) {

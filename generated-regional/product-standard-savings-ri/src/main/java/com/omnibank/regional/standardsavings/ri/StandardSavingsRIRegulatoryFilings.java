...
/**
 * State regulatory filing cadence for StandardSavings in Rhode Island.
 ...
 */
public final class StandardSavingsRIRegulatoryFilings {
    ...
    public StandardSavingsRIRegulatoryFilings() {
        this(new StandardSavingsRIProfile());
    }

    public StandardSavingsRIRegulatoryFilings(StandardSavingsRIProfile profile) {

...
/**
 * State-specific rate table overlay for StandardSavings offered in Rhode Island.
 ...
 */
public final class StandardSavingsRIRateTable {
    ...
    public StandardSavingsRIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-RI-StandardSavings-2026Q1";

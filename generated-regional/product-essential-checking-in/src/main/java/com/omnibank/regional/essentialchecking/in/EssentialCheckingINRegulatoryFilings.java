...
/**
 * State regulatory filing cadence for EssentialChecking in Indiana.
 ...
 */
public final class EssentialCheckingINRegulatoryFilings {
    ...
    public EssentialCheckingINRegulatoryFilings() {
        this(new EssentialCheckingINProfile());
    }

    public EssentialCheckingINRegulatoryFilings(EssentialCheckingINProfile profile) {

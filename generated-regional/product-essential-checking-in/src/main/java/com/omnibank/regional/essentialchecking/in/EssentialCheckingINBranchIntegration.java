...
/**
 * Branch / channel integration metadata for EssentialChecking in Indiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingINBranchIntegration {
    ...
    public EssentialCheckingINBranchIntegration() {
        this.profile = new EssentialCheckingINProfile();
    }

    public EssentialCheckingINBranchIntegration(EssentialCheckingINProfile profile) {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Indiana.
 ...
 */
public final class EssentialCheckingINRateTable {
    ...
    public EssentialCheckingINRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IN-EssentialChecking-2026Q1";

package com.omnibank.regional.essentialchecking.in;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Indiana.
 ...
 */
public final class EssentialCheckingINDisclosures {

    private final EssentialCheckingINProfile profile;

    public EssentialCheckingINDisclosures() {
        this.profile = new EssentialCheckingINProfile();
    }

    public EssentialCheckingINDisclosures(EssentialCheckingINProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Indiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

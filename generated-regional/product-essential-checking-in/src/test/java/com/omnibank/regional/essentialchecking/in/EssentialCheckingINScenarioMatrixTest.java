...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingIN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingINProfile},
 * {@link EssentialCheckingINRateTable}, {@link EssentialCheckingINDisclosures},
 * {@link EssentialCheckingINRegulatoryFilings}, and {@link EssentialCheckingINBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingINProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingINScenarioMatrixTest {

...
/**
 * Branch / channel integration metadata for EssentialChecking in Arizona.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingAZBranchIntegration {
    ...
    public EssentialCheckingAZBranchIntegration() {
        this.profile = new EssentialCheckingAZProfile();
    }

    public EssentialCheckingAZBranchIntegration(EssentialCheckingAZProfile profile) {

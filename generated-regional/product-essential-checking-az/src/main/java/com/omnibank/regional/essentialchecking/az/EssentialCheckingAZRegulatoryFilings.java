...
/**
 * State regulatory filing cadence for EssentialChecking in Arizona.
 ...
 */
public final class EssentialCheckingAZRegulatoryFilings {
    ...
    public EssentialCheckingAZRegulatoryFilings() {
        this(new EssentialCheckingAZProfile());
    }

    public EssentialCheckingAZRegulatoryFilings(EssentialCheckingAZProfile profile) {

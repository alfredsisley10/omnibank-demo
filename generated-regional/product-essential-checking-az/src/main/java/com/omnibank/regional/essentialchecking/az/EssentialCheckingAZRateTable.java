...
/**
 * State-specific rate table overlay for EssentialChecking offered in Arizona.
 ...
 */
public final class EssentialCheckingAZRateTable {
    ...
    public EssentialCheckingAZRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AZ-EssentialChecking-2026Q1";

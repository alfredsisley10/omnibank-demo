package com.omnibank.regional.essentialchecking.az;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Arizona.
 ...
 */
public final class EssentialCheckingAZDisclosures {

    private final EssentialCheckingAZProfile profile;

    public EssentialCheckingAZDisclosures() {
        this.profile = new EssentialCheckingAZProfile();
    }

    public EssentialCheckingAZDisclosures(EssentialCheckingAZProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Arizona State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingAZ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingAZProfile},
 * {@link EssentialCheckingAZRateTable}, {@link EssentialCheckingAZDisclosures},
 * {@link EssentialCheckingAZRegulatoryFilings}, and {@link EssentialCheckingAZBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingAZProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingAZScenarioMatrixTest {

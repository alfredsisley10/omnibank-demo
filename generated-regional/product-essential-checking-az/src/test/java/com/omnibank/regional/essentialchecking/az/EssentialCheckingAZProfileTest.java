...
class EssentialCheckingAZProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new EssentialCheckingAZProfile();
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new EssentialCheckingAZRateTable();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new EssentialCheckingAZBranchIntegration();

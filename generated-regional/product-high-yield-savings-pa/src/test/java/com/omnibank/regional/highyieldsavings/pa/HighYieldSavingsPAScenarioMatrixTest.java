...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsPA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsPAProfile},
 * {@link HighYieldSavingsPARateTable}, {@link HighYieldSavingsPADisclosures},
 * {@link HighYieldSavingsPARegulatoryFilings}, and {@link HighYieldSavingsPABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsPAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsPAScenarioMatrixTest {

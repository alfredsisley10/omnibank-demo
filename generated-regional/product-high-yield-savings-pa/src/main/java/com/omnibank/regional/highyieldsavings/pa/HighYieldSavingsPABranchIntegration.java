...
/**
 * Branch / channel integration metadata for HighYieldSavings in Pennsylvania.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsPABranchIntegration {
    ...
    public HighYieldSavingsPABranchIntegration() {
        this.profile = new HighYieldSavingsPAProfile();
    }

    public HighYieldSavingsPABranchIntegration(HighYieldSavingsPAProfile profile) {

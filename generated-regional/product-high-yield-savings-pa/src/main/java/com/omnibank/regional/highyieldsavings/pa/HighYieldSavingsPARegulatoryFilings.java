...
/**
 * State regulatory filing cadence for HighYieldSavings in Pennsylvania.
 ...
 */
public final class HighYieldSavingsPARegulatoryFilings {
    ...
    public HighYieldSavingsPARegulatoryFilings() {
        this(new HighYieldSavingsPAProfile());
    }

    public HighYieldSavingsPARegulatoryFilings(HighYieldSavingsPAProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Pennsylvania.
 ...
 */
public final class HighYieldSavingsPADisclosures {

    private final HighYieldSavingsPAProfile profile;

    public HighYieldSavingsPADisclosures() {
        this.profile = new HighYieldSavingsPAProfile();
    }

    public HighYieldSavingsPADisclosures(HighYieldSavingsPAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Pennsylvania State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

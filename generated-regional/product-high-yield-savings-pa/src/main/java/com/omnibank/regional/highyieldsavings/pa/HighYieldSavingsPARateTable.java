...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Pennsylvania.
 ...
 */
public final class HighYieldSavingsPARateTable {
    ...
    public HighYieldSavingsPARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-PA-HighYieldSavings-2026Q1";

...
public final class BasicCheckingVABranchIntegration {
    ...
    public BasicCheckingVABranchIntegration() {
        this.profile = new BasicCheckingVAProfile();
    }

    public BasicCheckingVABranchIntegration(BasicCheckingVAProfile profile) {

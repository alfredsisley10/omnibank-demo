...
/**
 * State regulatory filing cadence for BasicChecking in Virginia.
 ...
 */
public final class BasicCheckingVARegulatoryFilings {
    ...
    public BasicCheckingVARegulatoryFilings() {
        this(new BasicCheckingVAProfile());
    }

    public BasicCheckingVARegulatoryFilings(BasicCheckingVAProfile profile) {

...
/**
 * State-specific disclosure overlays for BasicChecking in Virginia.
 ...
 */
public final class BasicCheckingVADisclosures {

    private final BasicCheckingVAProfile profile;

    public BasicCheckingVADisclosures() {
        this.profile = new BasicCheckingVAProfile();
    }

    public BasicCheckingVADisclosures(BasicCheckingVAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Virginia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

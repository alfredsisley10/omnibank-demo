...
/**
 * State-specific rate table overlay for BasicChecking offered in Virginia.
 ...
 */
public final class BasicCheckingVARateTable {
    ...
    public BasicCheckingVARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VA-BasicChecking-2026Q1";

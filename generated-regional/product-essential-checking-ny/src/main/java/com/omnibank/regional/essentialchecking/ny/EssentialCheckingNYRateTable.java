...
/**
 * State-specific rate table overlay for EssentialChecking offered in New York.
 ...
 */
public final class EssentialCheckingNYRateTable {
    ...
    public EssentialCheckingNYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NY-EssentialChecking-2026Q1";

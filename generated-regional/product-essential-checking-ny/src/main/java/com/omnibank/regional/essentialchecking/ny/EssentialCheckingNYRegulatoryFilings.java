...
/**
 * State regulatory filing cadence for EssentialChecking in New York.
 ...
 */
public final class EssentialCheckingNYRegulatoryFilings {
    ...
    public EssentialCheckingNYRegulatoryFilings() {
        this(new EssentialCheckingNYProfile());
    }

    public EssentialCheckingNYRegulatoryFilings(EssentialCheckingNYProfile profile) {

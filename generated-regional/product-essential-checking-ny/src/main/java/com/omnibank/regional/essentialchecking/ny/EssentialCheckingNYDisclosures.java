package com.omnibank.regional.essentialchecking.ny;
...
/**
 * State-specific disclosure overlays for EssentialChecking in New York.
 ...
 */
public final class EssentialCheckingNYDisclosures {

    private final EssentialCheckingNYProfile profile;

    public EssentialCheckingNYDisclosures() {
        this.profile = new EssentialCheckingNYProfile();
    }

    public EssentialCheckingNYDisclosures(EssentialCheckingNYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — New York State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

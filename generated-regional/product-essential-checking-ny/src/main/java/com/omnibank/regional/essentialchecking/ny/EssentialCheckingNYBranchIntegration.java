...
/**
 * Branch / channel integration metadata for EssentialChecking in New York.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNYBranchIntegration {
    ...
    public EssentialCheckingNYBranchIntegration() {
        this.profile = new EssentialCheckingNYProfile();
    }

    public EssentialCheckingNYBranchIntegration(EssentialCheckingNYProfile profile) {

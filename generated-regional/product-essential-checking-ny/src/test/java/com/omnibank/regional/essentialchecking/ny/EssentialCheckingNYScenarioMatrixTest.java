...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNYProfile},
 * {@link EssentialCheckingNYRateTable}, {@link EssentialCheckingNYDisclosures},
 * {@link EssentialCheckingNYRegulatoryFilings}, and {@link EssentialCheckingNYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNYScenarioMatrixTest {

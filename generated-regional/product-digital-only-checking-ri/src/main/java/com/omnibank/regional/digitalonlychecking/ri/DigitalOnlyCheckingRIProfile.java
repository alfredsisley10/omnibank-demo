...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Rhode Island (RI).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingRIProfile {
    ...
    public DigitalOnlyCheckingRIProfile() {
        this.stateCode = "RI";

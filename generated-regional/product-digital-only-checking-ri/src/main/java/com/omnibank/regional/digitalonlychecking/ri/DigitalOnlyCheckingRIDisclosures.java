package com.omnibank.regional.digitalonlychecking.ri;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Rhode Island.
 ...
 */
public final class DigitalOnlyCheckingRIDisclosures {

    private final DigitalOnlyCheckingRIProfile profile;

    public DigitalOnlyCheckingRIDisclosures() {
        this.profile = new DigitalOnlyCheckingRIProfile();
    }

    public DigitalOnlyCheckingRIDisclosures(DigitalOnlyCheckingRIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Rhode Island State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

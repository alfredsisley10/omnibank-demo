...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Rhode Island.
 ...
 */
public final class DigitalOnlyCheckingRIRateTable {
    ...
    public DigitalOnlyCheckingRIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-RI-DigitalOnlyChecking-2026Q1";

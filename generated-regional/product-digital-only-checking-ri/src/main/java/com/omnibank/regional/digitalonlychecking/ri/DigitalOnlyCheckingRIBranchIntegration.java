...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Rhode Island.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingRIBranchIntegration {
    ...
    public DigitalOnlyCheckingRIBranchIntegration() {
        this.profile = new DigitalOnlyCheckingRIProfile();
    }

    public DigitalOnlyCheckingRIBranchIntegration(DigitalOnlyCheckingRIProfile profile) {

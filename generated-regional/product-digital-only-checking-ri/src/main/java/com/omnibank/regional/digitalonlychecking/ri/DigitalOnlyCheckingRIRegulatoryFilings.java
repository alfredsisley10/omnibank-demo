...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Rhode Island.
 ...
 */
public final class DigitalOnlyCheckingRIRegulatoryFilings {
    ...
    public DigitalOnlyCheckingRIRegulatoryFilings() {
        this(new DigitalOnlyCheckingRIProfile());
    }

    public DigitalOnlyCheckingRIRegulatoryFilings(DigitalOnlyCheckingRIProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Rhode Island)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Rhode Island)",
                "ANNUAL",

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingRI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingRIProfile},
 * {@link DigitalOnlyCheckingRIRateTable}, {@link DigitalOnlyCheckingRIDisclosures},
 * {@link DigitalOnlyCheckingRIRegulatoryFilings}, and {@link DigitalOnlyCheckingRIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingRIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingRIScenarioMatrixTest {

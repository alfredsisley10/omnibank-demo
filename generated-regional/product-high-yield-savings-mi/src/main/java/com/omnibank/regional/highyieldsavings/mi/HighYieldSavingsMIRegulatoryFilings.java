package com.omnibank.regional.highyieldsavings.mi;
...
/**
 * State regulatory filing cadence for HighYieldSavings in Michigan.
 ...
 */
public final class HighYieldSavingsMIRegulatoryFilings {
    ...
    private final HighYieldSavingsMIProfile profile;

    public HighYieldSavingsMIRegulatoryFilings() {
        this(new HighYieldSavingsMIProfile());
    }

    public HighYieldSavingsMIRegulatoryFilings(HighYieldSavingsMIProfile profile) {

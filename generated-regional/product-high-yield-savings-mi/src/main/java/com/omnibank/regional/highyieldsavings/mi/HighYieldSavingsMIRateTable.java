...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Michigan.
 ...
 */
public final class HighYieldSavingsMIRateTable {
    ...
    public HighYieldSavingsMIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MI-HighYieldSavings-2026Q1";

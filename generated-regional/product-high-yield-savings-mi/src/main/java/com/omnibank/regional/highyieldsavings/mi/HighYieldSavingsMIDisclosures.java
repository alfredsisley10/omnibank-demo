...
/**
 * State-specific disclosure overlays for HighYieldSavings in Michigan.
 ...
 */
public final class HighYieldSavingsMIDisclosures {

    private final HighYieldSavingsMIProfile profile;

    public HighYieldSavingsMIDisclosures() {
        this.profile = new HighYieldSavingsMIProfile();
    }

    public HighYieldSavingsMIDisclosures(HighYieldSavingsMIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Michigan State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

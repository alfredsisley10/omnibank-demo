...
/**
 * Branch / channel integration metadata for HighYieldSavings in Michigan.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMIBranchIntegration {
    ...
    public HighYieldSavingsMIBranchIntegration() {
        this.profile = new HighYieldSavingsMIProfile();
    }

    public HighYieldSavingsMIBranchIntegration(HighYieldSavingsMIProfile profile) {

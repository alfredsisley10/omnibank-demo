...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMIProfile},
 * {@link HighYieldSavingsMIRateTable}, {@link HighYieldSavingsMIDisclosures},
 * {@link HighYieldSavingsMIRegulatoryFilings}, and {@link HighYieldSavingsMIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMIScenarioMatrixTest {

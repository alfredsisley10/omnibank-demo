...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingMD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingMDProfile},
 * {@link EssentialCheckingMDRateTable}, {@link EssentialCheckingMDDisclosures},
 * {@link EssentialCheckingMDRegulatoryFilings}, and {@link EssentialCheckingMDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingMDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingMDScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for EssentialChecking in Maryland.
 ...
 */
public final class EssentialCheckingMDRegulatoryFilings {
    ...
    public EssentialCheckingMDRegulatoryFilings() {
        this(new EssentialCheckingMDProfile());
    }

    public EssentialCheckingMDRegulatoryFilings(EssentialCheckingMDProfile profile) {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Maryland.
 ...
 */
public final class EssentialCheckingMDRateTable {
    ...
    public EssentialCheckingMDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MD-EssentialChecking-2026Q1";

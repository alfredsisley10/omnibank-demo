...
/**
 * Branch / channel integration metadata for EssentialChecking in Maryland.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingMDBranchIntegration {
    ...
    public EssentialCheckingMDBranchIntegration() {
        this.profile = new EssentialCheckingMDProfile();
    }

    public EssentialCheckingMDBranchIntegration(EssentialCheckingMDProfile profile) {

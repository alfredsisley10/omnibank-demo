package com.omnibank.regional.essentialchecking.md;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Maryland.
 ...
 */
public final class EssentialCheckingMDDisclosures {

    private final EssentialCheckingMDProfile profile;

    public EssentialCheckingMDDisclosures() {
        this.profile = new EssentialCheckingMDProfile();
    }

    public EssentialCheckingMDDisclosures(EssentialCheckingMDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Maryland State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

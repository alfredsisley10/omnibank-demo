...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMIProfile},
 * {@link StandardSavingsMIRateTable}, {@link StandardSavingsMIDisclosures},
 * {@link StandardSavingsMIRegulatoryFilings}, and {@link StandardSavingsMIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMIScenarioMatrixTest {

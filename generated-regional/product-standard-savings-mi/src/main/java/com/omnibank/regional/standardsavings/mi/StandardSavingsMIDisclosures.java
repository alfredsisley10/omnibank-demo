package com.omnibank.regional.standardsavings.mi;
...
/**
 * State-specific disclosure overlays for StandardSavings in Michigan.
 ...
 */
public final class StandardSavingsMIDisclosures {

    private final StandardSavingsMIProfile profile;

    public StandardSavingsMIDisclosures() {
        this.profile = new StandardSavingsMIProfile();
    }

    public StandardSavingsMIDisclosures(StandardSavingsMIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Michigan State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

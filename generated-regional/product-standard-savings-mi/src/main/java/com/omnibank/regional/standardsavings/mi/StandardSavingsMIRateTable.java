...
/**
 * State-specific rate table overlay for StandardSavings offered in Michigan.
 ...
 */
public final class StandardSavingsMIRateTable {
    ...
    public StandardSavingsMIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MI-StandardSavings-2026Q1";

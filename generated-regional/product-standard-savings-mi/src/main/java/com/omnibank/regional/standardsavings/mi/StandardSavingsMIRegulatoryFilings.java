...
/**
 * State regulatory filing cadence for StandardSavings in Michigan.
 ...
 */
public final class StandardSavingsMIRegulatoryFilings {
    ...
    public StandardSavingsMIRegulatoryFilings() {
        this(new StandardSavingsMIProfile());
    }

    public StandardSavingsMIRegulatoryFilings(StandardSavingsMIProfile profile) {

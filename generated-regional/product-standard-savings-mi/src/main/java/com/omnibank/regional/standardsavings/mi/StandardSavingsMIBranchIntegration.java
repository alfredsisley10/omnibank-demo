...
/**
 * Branch / channel integration metadata for StandardSavings in Michigan.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMIBranchIntegration {
    ...
    public StandardSavingsMIBranchIntegration() {
        this.profile = new StandardSavingsMIProfile();
    }

    public StandardSavingsMIBranchIntegration(StandardSavingsMIProfile profile) {

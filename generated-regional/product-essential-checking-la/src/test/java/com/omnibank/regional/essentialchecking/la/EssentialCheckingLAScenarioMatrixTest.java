...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingLA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingLAProfile},
 * {@link EssentialCheckingLARateTable}, {@link EssentialCheckingLADisclosures},
 * {@link EssentialCheckingLARegulatoryFilings}, and {@link EssentialCheckingLABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingLAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingLAScenarioMatrixTest {

package com.omnibank.regional.essentialchecking.la;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Louisiana.
 ...
 */
public final class EssentialCheckingLADisclosures {

    private final EssentialCheckingLAProfile profile;

    public EssentialCheckingLADisclosures() {
        this.profile = new EssentialCheckingLAProfile();
    }

    public EssentialCheckingLADisclosures(EssentialCheckingLAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Louisiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

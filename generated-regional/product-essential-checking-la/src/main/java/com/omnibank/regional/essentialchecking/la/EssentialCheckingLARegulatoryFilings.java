...
/**
 * State regulatory filing cadence for EssentialChecking in Louisiana.
 ...
 */
public final class EssentialCheckingLARegulatoryFilings {
    ...
    public EssentialCheckingLARegulatoryFilings() {
        this(new EssentialCheckingLAProfile());
    }

    public EssentialCheckingLARegulatoryFilings(EssentialCheckingLAProfile profile) {

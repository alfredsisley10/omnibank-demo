...
/**
 * State-specific rate table overlay for EssentialChecking offered in Louisiana.
 ...
 */
public final class EssentialCheckingLARateTable {
    ...
    public EssentialCheckingLARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-LA-EssentialChecking-2026Q1";

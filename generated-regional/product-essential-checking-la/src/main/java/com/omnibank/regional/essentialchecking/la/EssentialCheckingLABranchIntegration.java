...
/**
 * Branch / channel integration metadata for EssentialChecking in Louisiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingLABranchIntegration {
    ...
    public EssentialCheckingLABranchIntegration() {
        this.profile = new EssentialCheckingLAProfile();
    }

    public EssentialCheckingLABranchIntegration(EssentialCheckingLAProfile profile) {

...
/**
 * Branch / channel integration metadata for StandardSavings in Mississippi.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMSBranchIntegration {
    ...
    public StandardSavingsMSBranchIntegration() {
        this.profile = new StandardSavingsMSProfile();
    }

    public StandardSavingsMSBranchIntegration(StandardSavingsMSProfile profile) {

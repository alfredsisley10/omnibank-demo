...
/**
 * State regulatory filing cadence for StandardSavings in Mississippi.
 ...
 */
public final class StandardSavingsMSRegulatoryFilings {
    ...
    public StandardSavingsMSRegulatoryFilings() {
        this(new StandardSavingsMSProfile());
    }

    public StandardSavingsMSRegulatoryFilings(StandardSavingsMSProfile profile) {

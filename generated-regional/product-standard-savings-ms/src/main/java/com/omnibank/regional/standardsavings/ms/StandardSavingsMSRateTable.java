...
/**
 * State-specific rate table overlay for StandardSavings offered in Mississippi.
 ...
 */
public final class StandardSavingsMSRateTable {
    ...
    public StandardSavingsMSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MS-StandardSavings-2026Q1";

package com.omnibank.regional.standardsavings.ms;
...
/**
 * State-specific disclosure overlays for StandardSavings in Mississippi.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MS law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsMSDisclosures {

    private final StandardSavingsMSProfile profile;

    public StandardSavingsMSDisclosures() {
        this.profile = new StandardSavingsMSProfile();
    }

    public StandardSavingsMSDisclosures(StandardSavingsMSProfile profile) {
    ...
    public String stateHeader() {
        return "Mississippi Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Mississippi unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Mississippi law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Mississippi does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Mississippi State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMSProfile},
 * {@link StandardSavingsMSRateTable}, {@link StandardSavingsMSDisclosures},
 * {@link StandardSavingsMSRegulatoryFilings}, and {@link StandardSavingsMSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMSScenarioMatrixTest {

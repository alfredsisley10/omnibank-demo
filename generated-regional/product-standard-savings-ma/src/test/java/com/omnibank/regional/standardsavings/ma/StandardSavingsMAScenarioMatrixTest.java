...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsMA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsMAProfile},
 * {@link StandardSavingsMARateTable}, {@link StandardSavingsMADisclosures},
 * {@link StandardSavingsMARegulatoryFilings}, and {@link StandardSavingsMABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsMAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsMAScenarioMatrixTest {

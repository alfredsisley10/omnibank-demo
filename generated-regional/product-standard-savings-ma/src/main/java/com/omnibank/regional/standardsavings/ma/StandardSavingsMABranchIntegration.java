...
/**
 * Branch / channel integration metadata for StandardSavings in Massachusetts.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsMABranchIntegration {
    ...
    public StandardSavingsMABranchIntegration() {
        this.profile = new StandardSavingsMAProfile();
    }

    public StandardSavingsMABranchIntegration(StandardSavingsMAProfile profile) {

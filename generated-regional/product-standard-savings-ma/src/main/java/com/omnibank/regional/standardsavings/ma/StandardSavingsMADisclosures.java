package com.omnibank.regional.standardsavings.ma;
...
/**
 * State-specific disclosure overlays for StandardSavings in Massachusetts.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsMADisclosures {

    private final StandardSavingsMAProfile profile;

    public StandardSavingsMADisclosures() {
        this.profile = new StandardSavingsMAProfile();
    }

    public StandardSavingsMADisclosures(StandardSavingsMAProfile profile) {
    ...
    public String stateHeader() {
        return "Massachusetts Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Massachusetts unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Massachusetts law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Massachusetts does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Massachusetts State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for StandardSavings in Massachusetts.
 ...
 */
public final class StandardSavingsMARegulatoryFilings {
    ...
    public StandardSavingsMARegulatoryFilings() {
        this(new StandardSavingsMAProfile());
    }

    public StandardSavingsMARegulatoryFilings(StandardSavingsMAProfile profile) {

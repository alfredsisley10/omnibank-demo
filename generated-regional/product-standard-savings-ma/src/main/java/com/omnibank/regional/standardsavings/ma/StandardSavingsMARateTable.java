...
/**
 * State-specific rate table overlay for StandardSavings offered in Massachusetts.
 ...
 */
public final class StandardSavingsMARateTable {
    ...
    public StandardSavingsMARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MA-StandardSavings-2026Q1";

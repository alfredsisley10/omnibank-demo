...
/**
 * State regulatory filing cadence for StandardSavings in Alabama.
 ...
 */
public final class StandardSavingsALRegulatoryFilings {
    ...
    public StandardSavingsALRegulatoryFilings() {
        this(new StandardSavingsALProfile());
    }

    public StandardSavingsALRegulatoryFilings(StandardSavingsALProfile profile) {

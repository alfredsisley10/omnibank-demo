...
/**
 * State-specific disclosure overlays for StandardSavings in Alabama.
 ...
 */
public final class StandardSavingsALDisclosures {

    private final StandardSavingsALProfile profile;

    public StandardSavingsALDisclosures() {
        this.profile = new StandardSavingsALProfile();
    }

    public StandardSavingsALDisclosures(StandardSavingsALProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Alabama State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

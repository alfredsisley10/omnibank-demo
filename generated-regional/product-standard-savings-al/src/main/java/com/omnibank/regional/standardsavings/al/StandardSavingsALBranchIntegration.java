...
public final class StandardSavingsALBranchIntegration {
    ...
    public StandardSavingsALBranchIntegration() {
        this.profile = new StandardSavingsALProfile();
    }

    public StandardSavingsALBranchIntegration(StandardSavingsALProfile profile) {

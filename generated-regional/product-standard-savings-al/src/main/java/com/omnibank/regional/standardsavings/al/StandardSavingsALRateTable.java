...
/**
 * State-specific rate table overlay for StandardSavings offered in Alabama.
 ...
 */
public final class StandardSavingsALRateTable {
    ...
    public StandardSavingsALRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AL-StandardSavings-2026Q1";

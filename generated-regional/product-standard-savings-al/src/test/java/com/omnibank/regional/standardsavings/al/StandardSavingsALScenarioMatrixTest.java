...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsAL jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsALProfile},
 * {@link StandardSavingsALRateTable}, {@link StandardSavingsALDisclosures},
 * {@link StandardSavingsALRegulatoryFilings}, and {@link StandardSavingsALBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsALProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsALScenarioMatrixTest {

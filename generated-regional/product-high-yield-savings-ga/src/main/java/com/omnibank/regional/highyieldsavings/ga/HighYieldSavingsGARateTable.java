...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Georgia.
 ...
 */
public final class HighYieldSavingsGARateTable {
    ...
    public HighYieldSavingsGARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-GA-HighYieldSavings-2026Q1";

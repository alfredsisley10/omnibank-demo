...
/**
 * Branch / channel integration metadata for HighYieldSavings in Georgia.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsGABranchIntegration {
    ...
    public HighYieldSavingsGABranchIntegration() {
        this.profile = new HighYieldSavingsGAProfile();
    }

    public HighYieldSavingsGABranchIntegration(HighYieldSavingsGAProfile profile) {

package com.omnibank.regional.highyieldsavings.ga;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Georgia.
 ...
 */
public final class HighYieldSavingsGADisclosures {

    private final HighYieldSavingsGAProfile profile;

    public HighYieldSavingsGADisclosures() {
        this.profile = new HighYieldSavingsGAProfile();
    }

    public HighYieldSavingsGADisclosures(HighYieldSavingsGAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Georgia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

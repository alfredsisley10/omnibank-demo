...
/**
 * State regulatory filing cadence for HighYieldSavings in Georgia.
 ...
 */
public final class HighYieldSavingsGARegulatoryFilings {
    ...
    public HighYieldSavingsGARegulatoryFilings() {
        this(new HighYieldSavingsGAProfile());
    }

    public HighYieldSavingsGARegulatoryFilings(HighYieldSavingsGAProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsGA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsGAProfile},
 * {@link HighYieldSavingsGARateTable}, {@link HighYieldSavingsGADisclosures},
 * {@link HighYieldSavingsGARegulatoryFilings}, and {@link HighYieldSavingsGABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsGAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsGAScenarioMatrixTest {

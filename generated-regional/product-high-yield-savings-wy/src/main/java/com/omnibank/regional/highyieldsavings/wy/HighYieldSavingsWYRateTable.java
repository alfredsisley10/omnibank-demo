...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Wyoming.
 ...
 */
public final class HighYieldSavingsWYRateTable {
    ...
    public HighYieldSavingsWYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-WY-HighYieldSavings-2026Q1";

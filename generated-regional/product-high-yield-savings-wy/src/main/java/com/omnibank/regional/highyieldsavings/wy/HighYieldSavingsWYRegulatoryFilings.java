...
/**
 * State regulatory filing cadence for HighYieldSavings in Wyoming.
 ...
 */
public final class HighYieldSavingsWYRegulatoryFilings {
    ...
    public HighYieldSavingsWYRegulatoryFilings() {
        this(new HighYieldSavingsWYProfile());
    }

    public HighYieldSavingsWYRegulatoryFilings(HighYieldSavingsWYProfile profile) {

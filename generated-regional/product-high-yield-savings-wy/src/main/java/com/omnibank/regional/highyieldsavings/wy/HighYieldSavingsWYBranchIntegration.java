...
/**
 * Branch / channel integration metadata for HighYieldSavings in Wyoming.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsWYBranchIntegration {
    ...
    public HighYieldSavingsWYBranchIntegration() {
        this.profile = new HighYieldSavingsWYProfile();
    }

    public HighYieldSavingsWYBranchIntegration(HighYieldSavingsWYProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in Wyoming.
 ...
 */
public final class HighYieldSavingsWYDisclosures {

    private final HighYieldSavingsWYProfile profile;

    public HighYieldSavingsWYDisclosures() {
        this.profile = new HighYieldSavingsWYProfile();
    }

    public HighYieldSavingsWYDisclosures(HighYieldSavingsWYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Wyoming State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

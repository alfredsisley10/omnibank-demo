...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingTN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingTNProfile},
 * {@link EssentialCheckingTNRateTable}, {@link EssentialCheckingTNDisclosures},
 * {@link EssentialCheckingTNRegulatoryFilings}, and {@link EssentialCheckingTNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingTNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingTNScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for EssentialChecking in Tennessee.
 ...
 */
public final class EssentialCheckingTNRegulatoryFilings {
    ...
    public EssentialCheckingTNRegulatoryFilings() {
        this(new EssentialCheckingTNProfile());
    }

    public EssentialCheckingTNRegulatoryFilings(EssentialCheckingTNProfile profile) {

...
/**
 * State-specific rate table overlay for EssentialChecking offered in Tennessee.
 ...
 */
public final class EssentialCheckingTNRateTable {
    ...
    public EssentialCheckingTNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-TN-EssentialChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for EssentialChecking in Tennessee.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingTNBranchIntegration {
    ...
    public EssentialCheckingTNBranchIntegration() {
        this.profile = new EssentialCheckingTNProfile();
    }

    public EssentialCheckingTNBranchIntegration(EssentialCheckingTNProfile profile) {

...
/**
 * State-specific disclosure overlays for EssentialChecking in Tennessee.
 ...
 */
public final class EssentialCheckingTNDisclosures {

    private final EssentialCheckingTNProfile profile;

    public EssentialCheckingTNDisclosures() {
        this.profile = new EssentialCheckingTNProfile();
    }

    public EssentialCheckingTNDisclosures(EssentialCheckingTNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Tennessee State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

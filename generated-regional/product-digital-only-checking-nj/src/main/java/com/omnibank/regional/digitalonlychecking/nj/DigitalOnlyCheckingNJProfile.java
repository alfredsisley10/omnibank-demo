...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in New Jersey (NJ).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNJProfile {
    ...
    public DigitalOnlyCheckingNJProfile() {
        this.stateCode = "NJ";

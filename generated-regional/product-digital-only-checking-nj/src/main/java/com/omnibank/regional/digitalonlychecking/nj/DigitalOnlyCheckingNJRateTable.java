...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in New Jersey.
 ...
 */
public final class DigitalOnlyCheckingNJRateTable {
    ...
    public DigitalOnlyCheckingNJRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NJ-DigitalOnlyChecking-2026Q1";

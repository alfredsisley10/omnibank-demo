...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in New Jersey.
 ...
 */
public final class DigitalOnlyCheckingNJDisclosures {

    private final DigitalOnlyCheckingNJProfile profile;

    public DigitalOnlyCheckingNJDisclosures() {
        this.profile = new DigitalOnlyCheckingNJProfile();
    }

    public DigitalOnlyCheckingNJDisclosures(DigitalOnlyCheckingNJProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — New Jersey State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

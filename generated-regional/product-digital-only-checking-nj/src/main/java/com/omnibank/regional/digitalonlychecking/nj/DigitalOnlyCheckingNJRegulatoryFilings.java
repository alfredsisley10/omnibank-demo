...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in New Jersey.
 ...
 */
public final class DigitalOnlyCheckingNJRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNJRegulatoryFilings() {
        this(new DigitalOnlyCheckingNJProfile());
    }

    public DigitalOnlyCheckingNJRegulatoryFilings(DigitalOnlyCheckingNJProfile profile) {

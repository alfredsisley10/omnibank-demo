...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNJ jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNJProfile},
 * {@link DigitalOnlyCheckingNJRateTable}, {@link DigitalOnlyCheckingNJDisclosures},
 * {@link DigitalOnlyCheckingNJRegulatoryFilings}, and {@link DigitalOnlyCheckingNJBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNJProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNJScenarioMatrixTest {

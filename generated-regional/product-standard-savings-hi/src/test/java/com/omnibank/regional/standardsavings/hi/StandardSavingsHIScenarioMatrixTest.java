...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsHI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsHIProfile},
 * {@link StandardSavingsHIRateTable}, {@link StandardSavingsHIDisclosures},
 * {@link StandardSavingsHIRegulatoryFilings}, and {@link StandardSavingsHIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsHIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsHIScenarioMatrixTest {

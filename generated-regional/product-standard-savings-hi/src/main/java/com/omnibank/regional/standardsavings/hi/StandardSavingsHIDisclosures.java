...
/**
 * State-specific disclosure overlays for StandardSavings in Hawaii.
 ...
 */
public final class StandardSavingsHIDisclosures {

    private final StandardSavingsHIProfile profile;

    public StandardSavingsHIDisclosures() {
        this.profile = new StandardSavingsHIProfile();
    }

    public StandardSavingsHIDisclosures(StandardSavingsHIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Hawaii State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

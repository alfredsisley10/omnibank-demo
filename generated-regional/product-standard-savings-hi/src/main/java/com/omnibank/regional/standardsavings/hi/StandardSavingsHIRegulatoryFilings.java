...
/**
 * State regulatory filing cadence for StandardSavings in Hawaii.
 ...
 */
public final class StandardSavingsHIRegulatoryFilings {
    ...
    public StandardSavingsHIRegulatoryFilings() {
        this(new StandardSavingsHIProfile());
    }

    public StandardSavingsHIRegulatoryFilings(StandardSavingsHIProfile profile) {

...
public final class StandardSavingsHIBranchIntegration {
    ...
    public StandardSavingsHIBranchIntegration() {
        this.profile = new StandardSavingsHIProfile();
    }

    public StandardSavingsHIBranchIntegration(StandardSavingsHIProfile profile) {

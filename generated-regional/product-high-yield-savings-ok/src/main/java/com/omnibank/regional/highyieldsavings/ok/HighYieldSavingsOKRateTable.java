...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Oklahoma.
 ...
 */
public final class HighYieldSavingsOKRateTable {
    ...
    public HighYieldSavingsOKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OK-HighYieldSavings-2026Q1";

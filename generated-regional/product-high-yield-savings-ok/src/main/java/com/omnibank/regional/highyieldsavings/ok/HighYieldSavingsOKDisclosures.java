...
/**
 * State-specific disclosure overlays for HighYieldSavings in Oklahoma.
 ...
 */
public final class HighYieldSavingsOKDisclosures {

    private final HighYieldSavingsOKProfile profile;

    public HighYieldSavingsOKDisclosures() {
        this.profile = new HighYieldSavingsOKProfile();
    }

    public HighYieldSavingsOKDisclosures(HighYieldSavingsOKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Oklahoma State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

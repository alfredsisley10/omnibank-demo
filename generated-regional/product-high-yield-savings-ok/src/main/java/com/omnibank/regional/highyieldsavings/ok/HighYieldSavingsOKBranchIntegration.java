...
/**
 * Branch / channel integration metadata for HighYieldSavings in Oklahoma.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsOKBranchIntegration {
    ...
    public HighYieldSavingsOKBranchIntegration() {
        this.profile = new HighYieldSavingsOKProfile();
    }

    public HighYieldSavingsOKBranchIntegration(HighYieldSavingsOKProfile profile) {

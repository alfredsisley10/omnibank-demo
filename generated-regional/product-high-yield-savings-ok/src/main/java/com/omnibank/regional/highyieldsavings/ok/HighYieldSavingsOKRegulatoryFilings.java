...
/**
 * State regulatory filing cadence for HighYieldSavings in Oklahoma.
 ...
 */
public final class HighYieldSavingsOKRegulatoryFilings {
    ...
    public HighYieldSavingsOKRegulatoryFilings() {
        this(new HighYieldSavingsOKProfile());
    }

    public HighYieldSavingsOKRegulatoryFilings(HighYieldSavingsOKProfile profile) {

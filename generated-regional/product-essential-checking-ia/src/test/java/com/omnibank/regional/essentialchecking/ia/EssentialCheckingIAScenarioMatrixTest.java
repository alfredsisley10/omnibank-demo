...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingIA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingIAProfile},
 * {@link EssentialCheckingIARateTable}, {@link EssentialCheckingIADisclosures},
 * {@link EssentialCheckingIARegulatoryFilings}, and {@link EssentialCheckingIABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingIAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingIAScenarioMatrixTest {

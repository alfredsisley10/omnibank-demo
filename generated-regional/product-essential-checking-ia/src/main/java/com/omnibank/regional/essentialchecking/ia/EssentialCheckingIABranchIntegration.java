...
/**
 * Branch / channel integration metadata for EssentialChecking in Iowa.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingIABranchIntegration {
    ...
    public EssentialCheckingIABranchIntegration() {
        this.profile = new EssentialCheckingIAProfile();
    }

    public EssentialCheckingIABranchIntegration(EssentialCheckingIAProfile profile) {

package com.omnibank.regional.essentialchecking.ia;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Iowa.
 ...
 */
public final class EssentialCheckingIADisclosures {

    private final EssentialCheckingIAProfile profile;

    public EssentialCheckingIADisclosures() {
        this.profile = new EssentialCheckingIAProfile();
    }

    public EssentialCheckingIADisclosures(EssentialCheckingIAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Iowa State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

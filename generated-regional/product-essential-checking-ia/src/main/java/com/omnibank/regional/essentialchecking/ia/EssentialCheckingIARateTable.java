...
/**
 * State-specific rate table overlay for EssentialChecking offered in Iowa.
 ...
 */
public final class EssentialCheckingIARateTable {
    ...
    public EssentialCheckingIARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-IA-EssentialChecking-2026Q1";

...
/**
 * State regulatory filing cadence for EssentialChecking in Iowa.
 ...
 */
public final class EssentialCheckingIARegulatoryFilings {
    ...
    public EssentialCheckingIARegulatoryFilings() {
        this(new EssentialCheckingIAProfile());
    }

    public EssentialCheckingIARegulatoryFilings(EssentialCheckingIAProfile profile) {

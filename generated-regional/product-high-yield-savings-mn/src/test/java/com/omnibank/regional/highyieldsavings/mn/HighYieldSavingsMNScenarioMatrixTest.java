...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsMN jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsMNProfile},
 * {@link HighYieldSavingsMNRateTable}, {@link HighYieldSavingsMNDisclosures},
 * {@link HighYieldSavingsMNRegulatoryFilings}, and {@link HighYieldSavingsMNBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsMNProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsMNScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for HighYieldSavings in Minnesota.
 ...
 */
public final class HighYieldSavingsMNRegulatoryFilings {
    ...
    public HighYieldSavingsMNRegulatoryFilings() {
        this(new HighYieldSavingsMNProfile());
    }

    public HighYieldSavingsMNRegulatoryFilings(HighYieldSavingsMNProfile profile) {

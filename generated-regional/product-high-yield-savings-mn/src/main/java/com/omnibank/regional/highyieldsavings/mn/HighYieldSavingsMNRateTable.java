...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Minnesota.
 ...
 */
public final class HighYieldSavingsMNRateTable {
    ...
    public HighYieldSavingsMNRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MN-HighYieldSavings-2026Q1";

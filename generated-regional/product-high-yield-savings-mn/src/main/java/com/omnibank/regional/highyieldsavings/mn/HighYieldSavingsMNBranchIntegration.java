...
/**
 * Branch / channel integration metadata for HighYieldSavings in Minnesota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsMNBranchIntegration {
    ...
    public HighYieldSavingsMNBranchIntegration() {
        this.profile = new HighYieldSavingsMNProfile();
    }

    public HighYieldSavingsMNBranchIntegration(HighYieldSavingsMNProfile profile) {

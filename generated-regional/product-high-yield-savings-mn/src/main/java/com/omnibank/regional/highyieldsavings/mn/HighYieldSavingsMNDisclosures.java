package com.omnibank.regional.highyieldsavings.mn;
...
/**
 * State-specific disclosure overlays for HighYieldSavings in Minnesota.
 ...
 */
public final class HighYieldSavingsMNDisclosures {

    private final HighYieldSavingsMNProfile profile;

    public HighYieldSavingsMNDisclosures() {
        this.profile = new HighYieldSavingsMNProfile();
    }

    public HighYieldSavingsMNDisclosures(HighYieldSavingsMNProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Minnesota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingCA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingCAProfile},
 * {@link DigitalOnlyCheckingCARateTable}, {@link DigitalOnlyCheckingCADisclosures},
 * {@link DigitalOnlyCheckingCARegulatoryFilings}, and {@link DigitalOnlyCheckingCABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingCAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingCAScenarioMatrixTest {

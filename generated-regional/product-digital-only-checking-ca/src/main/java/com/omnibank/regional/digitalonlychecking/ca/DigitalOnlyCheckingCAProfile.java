...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in California (CA).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingCAProfile {
    ...
    public DigitalOnlyCheckingCAProfile() {
        this.stateCode = "CA";
        this.stateName = "California";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0725");

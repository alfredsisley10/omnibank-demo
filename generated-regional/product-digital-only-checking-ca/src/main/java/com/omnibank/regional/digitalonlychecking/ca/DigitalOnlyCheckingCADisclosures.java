package com.omnibank.regional.digitalonlychecking.ca;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in California.
 ...
 */
public final class DigitalOnlyCheckingCADisclosures {

    private final DigitalOnlyCheckingCAProfile profile;

    public DigitalOnlyCheckingCADisclosures() {
        this.profile = new DigitalOnlyCheckingCAProfile();
    }

    public DigitalOnlyCheckingCADisclosures(DigitalOnlyCheckingCAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — California State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

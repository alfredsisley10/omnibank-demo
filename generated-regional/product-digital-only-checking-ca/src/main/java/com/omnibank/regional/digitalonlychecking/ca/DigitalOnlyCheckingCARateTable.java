...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in California.
 ...
 */
public final class DigitalOnlyCheckingCARateTable {
    ...
    public DigitalOnlyCheckingCARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CA-DigitalOnlyChecking-2026Q1";

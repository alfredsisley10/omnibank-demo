...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in California.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingCABranchIntegration {
    ...
    public DigitalOnlyCheckingCABranchIntegration() {
        this.profile = new DigitalOnlyCheckingCAProfile();
    }

    public DigitalOnlyCheckingCABranchIntegration(DigitalOnlyCheckingCAProfile profile) {

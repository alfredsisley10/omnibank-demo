...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in California.
 ...
 */
public final class DigitalOnlyCheckingCARegulatoryFilings {
    ...
    public DigitalOnlyCheckingCARegulatoryFilings() {
        this(new DigitalOnlyCheckingCAProfile());
    }

    public DigitalOnlyCheckingCARegulatoryFilings(DigitalOnlyCheckingCAProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (California)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (California)",
                "ANNUAL",

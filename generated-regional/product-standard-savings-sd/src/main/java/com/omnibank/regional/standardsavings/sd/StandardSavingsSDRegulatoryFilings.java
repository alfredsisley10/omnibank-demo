...
/**
 * State regulatory filing cadence for StandardSavings in South Dakota.
 ...
 */
public final class StandardSavingsSDRegulatoryFilings {
    ...
    public StandardSavingsSDRegulatoryFilings() {
        this(new StandardSavingsSDProfile());
    }

    public StandardSavingsSDRegulatoryFilings(StandardSavingsSDProfile profile) {

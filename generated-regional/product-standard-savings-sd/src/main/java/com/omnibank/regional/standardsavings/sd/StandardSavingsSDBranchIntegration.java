...
/**
 * Branch / channel integration metadata for StandardSavings in South Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsSDBranchIntegration {
    ...
    public StandardSavingsSDBranchIntegration() {
        this.profile = new StandardSavingsSDProfile();
    }

    public StandardSavingsSDBranchIntegration(StandardSavingsSDProfile profile) {

package com.omnibank.regional.standardsavings.sd;
...
/**
 * State-specific disclosure overlays for StandardSavings in South Dakota.
 * Layered on top of the national disclosure, these capture
 * items that only apply under SD law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsSDDisclosures {

    private final StandardSavingsSDProfile profile;

    public StandardSavingsSDDisclosures() {
        this.profile = new StandardSavingsSDProfile();
    }

    public StandardSavingsSDDisclosures(StandardSavingsSDProfile profile) {
    ...
    public String stateHeader() {
        return "South Dakota Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "South Dakota unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by South Dakota law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "South Dakota does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — South Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

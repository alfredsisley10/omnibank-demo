...
/**
 * State-specific rate table overlay for StandardSavings offered in South Dakota.
 ...
 */
public final class StandardSavingsSDRateTable {
    ...
    public StandardSavingsSDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SD-StandardSavings-2026Q1";

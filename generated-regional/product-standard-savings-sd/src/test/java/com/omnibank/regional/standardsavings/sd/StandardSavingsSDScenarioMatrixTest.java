...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsSD jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsSDProfile},
 * {@link StandardSavingsSDRateTable}, {@link StandardSavingsSDDisclosures},
 * {@link StandardSavingsSDRegulatoryFilings}, and {@link StandardSavingsSDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsSDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsSDScenarioMatrixTest {

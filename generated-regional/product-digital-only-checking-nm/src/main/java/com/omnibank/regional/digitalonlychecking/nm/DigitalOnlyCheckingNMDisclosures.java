package com.omnibank.regional.digitalonlychecking.nm;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in New Mexico.
 ...
 */
public final class DigitalOnlyCheckingNMDisclosures {

    private final DigitalOnlyCheckingNMProfile profile;

    public DigitalOnlyCheckingNMDisclosures() {
        this.profile = new DigitalOnlyCheckingNMProfile();
    }

    public DigitalOnlyCheckingNMDisclosures(DigitalOnlyCheckingNMProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — New Mexico State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

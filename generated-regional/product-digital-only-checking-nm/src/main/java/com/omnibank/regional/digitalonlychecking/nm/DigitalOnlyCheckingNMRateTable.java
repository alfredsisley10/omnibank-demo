...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in New Mexico.
 ...
 */
public final class DigitalOnlyCheckingNMRateTable {
    ...
    public DigitalOnlyCheckingNMRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NM-DigitalOnlyChecking-2026Q1";

...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in New Mexico (NM).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingNMProfile {
    ...
    public DigitalOnlyCheckingNMProfile() {
        this.stateCode = "NM";
        this.stateName = "New Mexico";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0513");

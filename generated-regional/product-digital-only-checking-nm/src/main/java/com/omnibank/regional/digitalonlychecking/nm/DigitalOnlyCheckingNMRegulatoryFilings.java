...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in New Mexico.
 ...
 */
public final class DigitalOnlyCheckingNMRegulatoryFilings {
    ...
    public DigitalOnlyCheckingNMRegulatoryFilings() {
        this(new DigitalOnlyCheckingNMProfile());
    }

    public DigitalOnlyCheckingNMRegulatoryFilings(DigitalOnlyCheckingNMProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (New Mexico)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (New Mexico)",
                "ANNUAL",

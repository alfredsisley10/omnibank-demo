...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in New Mexico.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingNMBranchIntegration {
    ...
    public DigitalOnlyCheckingNMBranchIntegration() {
        this.profile = new DigitalOnlyCheckingNMProfile();
    }

    public DigitalOnlyCheckingNMBranchIntegration(DigitalOnlyCheckingNMProfile profile) {

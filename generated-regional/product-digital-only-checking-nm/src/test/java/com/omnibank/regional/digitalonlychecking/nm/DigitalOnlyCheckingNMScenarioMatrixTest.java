...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingNM jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingNMProfile},
 * {@link DigitalOnlyCheckingNMRateTable}, {@link DigitalOnlyCheckingNMDisclosures},
 * {@link DigitalOnlyCheckingNMRegulatoryFilings}, and {@link DigitalOnlyCheckingNMBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingNMProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingNMScenarioMatrixTest {

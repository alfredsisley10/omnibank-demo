...
/**
 * State regulatory filing cadence for BasicChecking in Montana.
 ...
 */
public final class BasicCheckingMTRegulatoryFilings {
    ...
    public BasicCheckingMTRegulatoryFilings() {
        this(new BasicCheckingMTProfile());
    }

    public BasicCheckingMTRegulatoryFilings(BasicCheckingMTProfile profile) {

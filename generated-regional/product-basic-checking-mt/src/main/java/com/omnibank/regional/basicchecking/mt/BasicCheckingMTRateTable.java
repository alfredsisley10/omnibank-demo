...
/**
 * State-specific rate table overlay for BasicChecking offered in Montana.
 ...
 */
public final class BasicCheckingMTRateTable {
    ...
    public BasicCheckingMTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MT-BasicChecking-2026Q1";

...
public final class BasicCheckingMTBranchIntegration {
    ...
    public BasicCheckingMTBranchIntegration() {
        this.profile = new BasicCheckingMTProfile();
    }

    public BasicCheckingMTBranchIntegration(BasicCheckingMTProfile profile) {

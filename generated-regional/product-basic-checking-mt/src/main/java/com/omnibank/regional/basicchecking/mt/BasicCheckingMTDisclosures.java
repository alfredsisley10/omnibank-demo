package com.omnibank.regional.basicchecking.mt;
...
/**
 * State-specific disclosure overlays for BasicChecking in Montana.
 * Layered on top of the national disclosure, these capture
 * items that only apply under MT law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingMTDisclosures {

    private final BasicCheckingMTProfile profile;

    public BasicCheckingMTDisclosures() {
        this.profile = new BasicCheckingMTProfile();
    }

    public BasicCheckingMTDisclosures(BasicCheckingMTProfile profile) {
    ...
    public String stateHeader() {
        return "Montana Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Montana unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Montana law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Montana does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Montana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMTProfile},
 * {@link BasicCheckingMTRateTable}, {@link BasicCheckingMTDisclosures},
 * {@link BasicCheckingMTRegulatoryFilings}, and {@link BasicCheckingMTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMTScenarioMatrixTest {

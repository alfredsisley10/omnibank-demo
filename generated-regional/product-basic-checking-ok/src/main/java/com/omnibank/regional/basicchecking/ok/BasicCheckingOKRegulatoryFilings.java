...
/**
 * State regulatory filing cadence for BasicChecking in Oklahoma.
 ...
 */
public final class BasicCheckingOKRegulatoryFilings {
    ...
    public BasicCheckingOKRegulatoryFilings() {
        this(new BasicCheckingOKProfile());
    }

    public BasicCheckingOKRegulatoryFilings(BasicCheckingOKProfile profile) {

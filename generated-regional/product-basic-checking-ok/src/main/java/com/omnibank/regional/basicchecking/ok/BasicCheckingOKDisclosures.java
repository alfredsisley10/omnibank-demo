...
/**
 * State-specific disclosure overlays for BasicChecking in Oklahoma.
 ...
 */
public final class BasicCheckingOKDisclosures {

    private final BasicCheckingOKProfile profile;

    public BasicCheckingOKDisclosures() {
        this.profile = new BasicCheckingOKProfile();
    }

    public BasicCheckingOKDisclosures(BasicCheckingOKProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Oklahoma State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

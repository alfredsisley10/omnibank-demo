...
public final class BasicCheckingOKBranchIntegration {
    ...
    public BasicCheckingOKBranchIntegration() {
        this.profile = new BasicCheckingOKProfile();
    }

    public BasicCheckingOKBranchIntegration(BasicCheckingOKProfile profile) {

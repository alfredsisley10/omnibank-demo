...
/**
 * State-specific rate table overlay for BasicChecking offered in Oklahoma.
 ...
 */
public final class BasicCheckingOKRateTable {
    ...
    public BasicCheckingOKRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-OK-BasicChecking-2026Q1";

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingOK jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingOKProfile},
 * {@link BasicCheckingOKRateTable}, {@link BasicCheckingOKDisclosures},
 * {@link BasicCheckingOKRegulatoryFilings}, and {@link BasicCheckingOKBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingOKProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingOKScenarioMatrixTest {

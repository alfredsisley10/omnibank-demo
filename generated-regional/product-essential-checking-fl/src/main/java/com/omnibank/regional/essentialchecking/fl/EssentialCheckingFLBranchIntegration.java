...
/**
 * Branch / channel integration metadata for EssentialChecking in Florida.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingFLBranchIntegration {
    ...
    public EssentialCheckingFLBranchIntegration() {
        this.profile = new EssentialCheckingFLProfile();
    }

    public EssentialCheckingFLBranchIntegration(EssentialCheckingFLProfile profile) {

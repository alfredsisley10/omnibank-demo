...
/**
 * State-specific rate table overlay for EssentialChecking offered in Florida.
 ...
 */
public final class EssentialCheckingFLRateTable {
    ...
    public EssentialCheckingFLRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-FL-EssentialChecking-2026Q1";

...
/**
 * State regulatory filing cadence for EssentialChecking in Florida.
 ...
 */
public final class EssentialCheckingFLRegulatoryFilings {
    ...
    public EssentialCheckingFLRegulatoryFilings() {
        this(new EssentialCheckingFLProfile());
    }

    public EssentialCheckingFLRegulatoryFilings(EssentialCheckingFLProfile profile) {

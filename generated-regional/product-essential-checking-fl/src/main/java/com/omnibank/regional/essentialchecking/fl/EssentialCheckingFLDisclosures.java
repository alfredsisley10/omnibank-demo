package com.omnibank.regional.essentialchecking.fl;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Florida.
 ...
 */
public final class EssentialCheckingFLDisclosures {

    private final EssentialCheckingFLProfile profile;

    public EssentialCheckingFLDisclosures() {
        this.profile = new EssentialCheckingFLProfile();
    }

    public EssentialCheckingFLDisclosures(EssentialCheckingFLProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Florida State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

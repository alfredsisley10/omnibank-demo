...
/**
 * Branch / channel integration metadata for HighYieldSavings in South Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsSCBranchIntegration {
    ...
    public HighYieldSavingsSCBranchIntegration() {
        this.profile = new HighYieldSavingsSCProfile();
    }

    public HighYieldSavingsSCBranchIntegration(HighYieldSavingsSCProfile profile) {

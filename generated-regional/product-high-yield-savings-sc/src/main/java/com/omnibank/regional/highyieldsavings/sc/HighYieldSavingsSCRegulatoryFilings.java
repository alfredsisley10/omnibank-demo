...
/**
 * State regulatory filing cadence for HighYieldSavings in South Carolina.
 ...
 */
public final class HighYieldSavingsSCRegulatoryFilings {
    ...
    public HighYieldSavingsSCRegulatoryFilings() {
        this(new HighYieldSavingsSCProfile());
    }

    public HighYieldSavingsSCRegulatoryFilings(HighYieldSavingsSCProfile profile) {

...
/**
 * State-specific disclosure overlays for HighYieldSavings in South Carolina.
 ...
 */
public final class HighYieldSavingsSCDisclosures {

    private final HighYieldSavingsSCProfile profile;

    public HighYieldSavingsSCDisclosures() {
        this.profile = new HighYieldSavingsSCProfile();
    }

    public HighYieldSavingsSCDisclosures(HighYieldSavingsSCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — South Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State-specific rate table overlay for HighYieldSavings offered in South Carolina.
 ...
 */
public final class HighYieldSavingsSCRateTable {
    ...
    public HighYieldSavingsSCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-SC-HighYieldSavings-2026Q1";

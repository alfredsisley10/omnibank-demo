...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsSC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsSCProfile},
 * {@link HighYieldSavingsSCRateTable}, {@link HighYieldSavingsSCDisclosures},
 * {@link HighYieldSavingsSCRegulatoryFilings}, and {@link HighYieldSavingsSCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsSCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsSCScenarioMatrixTest {

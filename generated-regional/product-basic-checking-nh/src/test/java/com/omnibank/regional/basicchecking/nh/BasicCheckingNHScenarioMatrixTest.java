...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingNH jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingNHProfile},
 * {@link BasicCheckingNHRateTable}, {@link BasicCheckingNHDisclosures},
 * {@link BasicCheckingNHRegulatoryFilings}, and {@link BasicCheckingNHBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingNHProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingNHScenarioMatrixTest {

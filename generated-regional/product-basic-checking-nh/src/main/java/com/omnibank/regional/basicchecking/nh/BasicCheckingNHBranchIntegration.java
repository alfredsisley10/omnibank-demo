...
/**
 * Branch / channel integration metadata for BasicChecking in New Hampshire.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingNHBranchIntegration {
    ...
    public BasicCheckingNHBranchIntegration() {
        this.profile = new BasicCheckingNHProfile();
    }

    public BasicCheckingNHBranchIntegration(BasicCheckingNHProfile profile) {

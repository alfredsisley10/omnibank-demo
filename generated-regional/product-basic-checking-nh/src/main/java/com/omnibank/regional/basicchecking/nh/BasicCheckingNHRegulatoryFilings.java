...
/**
 * State regulatory filing cadence for BasicChecking in New Hampshire.
 ...
 */
public final class BasicCheckingNHRegulatoryFilings {
    ...
    public BasicCheckingNHRegulatoryFilings() {
        this(new BasicCheckingNHProfile());
    }

    public BasicCheckingNHRegulatoryFilings(BasicCheckingNHProfile profile) {

...
/**
 * State-specific rate table overlay for BasicChecking offered in New Hampshire.
 ...
 */
public final class BasicCheckingNHRateTable {
    ...
    public BasicCheckingNHRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NH-BasicChecking-2026Q1";

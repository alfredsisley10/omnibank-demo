package com.omnibank.regional.basicchecking.nh;
...
/**
 * State-specific disclosure overlays for BasicChecking in New Hampshire.
 * Layered on top of the national disclosure, these capture
 * items that only apply under NH law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class BasicCheckingNHDisclosures {

    private final BasicCheckingNHProfile profile;

    public BasicCheckingNHDisclosures() {
        this.profile = new BasicCheckingNHProfile();
    }

    public BasicCheckingNHDisclosures(BasicCheckingNHProfile profile) {
    ...
    public String stateHeader() {
        return "New Hampshire Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "New Hampshire unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by New Hampshire law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "New Hampshire does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — New Hampshire State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

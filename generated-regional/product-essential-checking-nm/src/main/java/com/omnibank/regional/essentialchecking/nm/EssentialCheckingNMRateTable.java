...
/**
 * State-specific rate table overlay for EssentialChecking offered in New Mexico.
 ...
 */
public final class EssentialCheckingNMRateTable {
    ...
    public EssentialCheckingNMRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NM-EssentialChecking-2026Q1";

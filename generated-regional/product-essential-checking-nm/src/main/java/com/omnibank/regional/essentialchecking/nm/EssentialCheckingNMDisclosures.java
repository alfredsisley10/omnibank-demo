package com.omnibank.regional.essentialchecking.nm;
...
/**
 * State-specific disclosure overlays for EssentialChecking in New Mexico.
 ...
 */
public final class EssentialCheckingNMDisclosures {

    private final EssentialCheckingNMProfile profile;

    public EssentialCheckingNMDisclosures() {
        this.profile = new EssentialCheckingNMProfile();
    }

    public EssentialCheckingNMDisclosures(EssentialCheckingNMProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — New Mexico State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in New Mexico.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNMBranchIntegration {
    ...
    public EssentialCheckingNMBranchIntegration() {
        this.profile = new EssentialCheckingNMProfile();
    }

    public EssentialCheckingNMBranchIntegration(EssentialCheckingNMProfile profile) {

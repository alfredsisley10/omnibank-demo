...
/**
 * State regulatory filing cadence for EssentialChecking in New Mexico.
 ...
 */
public final class EssentialCheckingNMRegulatoryFilings {
    ...
    public EssentialCheckingNMRegulatoryFilings() {
        this(new EssentialCheckingNMProfile());
    }

    public EssentialCheckingNMRegulatoryFilings(EssentialCheckingNMProfile profile) {

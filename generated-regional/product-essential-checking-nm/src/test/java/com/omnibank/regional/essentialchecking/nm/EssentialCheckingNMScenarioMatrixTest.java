...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingNM jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNMProfile},
 * {@link EssentialCheckingNMRateTable}, {@link EssentialCheckingNMDisclosures},
 * {@link EssentialCheckingNMRegulatoryFilings}, and {@link EssentialCheckingNMBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNMProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNMScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingVT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingVTProfile},
 * {@link EssentialCheckingVTRateTable}, {@link EssentialCheckingVTDisclosures},
 * {@link EssentialCheckingVTRegulatoryFilings}, and {@link EssentialCheckingVTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingVTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingVTScenarioMatrixTest {

...
/**
 * State regulatory filing cadence for EssentialChecking in Vermont.
 ...
 */
public final class EssentialCheckingVTRegulatoryFilings {
    ...
    public EssentialCheckingVTRegulatoryFilings() {
        this(new EssentialCheckingVTProfile());
    }

    public EssentialCheckingVTRegulatoryFilings(EssentialCheckingVTProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Vermont)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Vermont)",
                "ANNUAL",

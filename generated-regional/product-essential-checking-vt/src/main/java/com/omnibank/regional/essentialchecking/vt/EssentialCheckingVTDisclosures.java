package com.omnibank.regional.essentialchecking.vt;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Vermont.
 ...
 */
public final class EssentialCheckingVTDisclosures {

    private final EssentialCheckingVTProfile profile;

    public EssentialCheckingVTDisclosures() {
        this.profile = new EssentialCheckingVTProfile();
    }

    public EssentialCheckingVTDisclosures(EssentialCheckingVTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Vermont State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Branch / channel integration metadata for EssentialChecking in Vermont.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingVTBranchIntegration {
    ...
    public EssentialCheckingVTBranchIntegration() {
        this.profile = new EssentialCheckingVTProfile();
    }

    public EssentialCheckingVTBranchIntegration(EssentialCheckingVTProfile profile) {

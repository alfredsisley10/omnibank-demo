...
/**
 * State-specific rate table overlay for EssentialChecking offered in Vermont.
 ...
 */
public final class EssentialCheckingVTRateTable {
    ...
    public EssentialCheckingVTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VT-EssentialChecking-2026Q1";

package com.omnibank.regional.standardsavings.la;
...
/**
 * State-specific disclosure overlays for StandardSavings in Louisiana.
 * Layered on top of the national disclosure, these capture
 * items that only apply under LA law (UDAP, UIPA, unclaimed
 * property reporting, language access, electronic signature).
 */
public final class StandardSavingsLADisclosures {

    private final StandardSavingsLAProfile profile;

    public StandardSavingsLADisclosures() {
        this.profile = new StandardSavingsLAProfile();
    }

    public StandardSavingsLADisclosures(StandardSavingsLAProfile profile) {
    ...
    public String stateHeader() {
        return "Louisiana Residents Disclosure — Effective "
    ...
    public String unclaimedPropertyClause() {
        return "Louisiana unclaimed property law requires abandoned funds to be "
    ...
    public String printedCopyRequiredClause() {
        return "A printed copy of this disclosure will be provided at account opening "
                + "as required by Louisiana law, in addition to any electronic copy delivered.";
    }

    public String noSalesTaxClause() {
        return "Louisiana does not impose sales tax on bank service fees; "
    ...
    public String renderFullSupplement() {
        ...
        sb.append("StandardSavings — Louisiana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * State regulatory filing cadence for StandardSavings in Louisiana.
 ...
 */
public final class StandardSavingsLARegulatoryFilings {
    ...
    public StandardSavingsLARegulatoryFilings() {
        this(new StandardSavingsLAProfile());
    }

    public StandardSavingsLARegulatoryFilings(StandardSavingsLAProfile profile) {

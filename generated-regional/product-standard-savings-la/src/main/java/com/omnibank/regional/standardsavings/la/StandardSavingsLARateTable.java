...
/**
 * State-specific rate table overlay for StandardSavings offered in Louisiana.
 ...
 */
public final class StandardSavingsLARateTable {
    ...
    public StandardSavingsLARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-LA-StandardSavings-2026Q1";

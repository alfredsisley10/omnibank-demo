...
/**
 * Branch / channel integration metadata for StandardSavings in Louisiana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class StandardSavingsLABranchIntegration {
    ...
    public StandardSavingsLABranchIntegration() {
        this.profile = new StandardSavingsLAProfile();
    }

    public StandardSavingsLABranchIntegration(StandardSavingsLAProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the StandardSavingsLA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link StandardSavingsLAProfile},
 * {@link StandardSavingsLARateTable}, {@link StandardSavingsLADisclosures},
 * {@link StandardSavingsLARegulatoryFilings}, and {@link StandardSavingsLABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code StandardSavingsLAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class StandardSavingsLAScenarioMatrixTest {

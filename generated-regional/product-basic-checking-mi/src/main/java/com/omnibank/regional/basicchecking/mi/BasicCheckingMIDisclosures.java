...
/**
 * State-specific disclosure overlays for BasicChecking in Michigan.
 ...
 */
public final class BasicCheckingMIDisclosures {

    private final BasicCheckingMIProfile profile;

    public BasicCheckingMIDisclosures() {
        this.profile = new BasicCheckingMIProfile();
    }

    public BasicCheckingMIDisclosures(BasicCheckingMIProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Michigan State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

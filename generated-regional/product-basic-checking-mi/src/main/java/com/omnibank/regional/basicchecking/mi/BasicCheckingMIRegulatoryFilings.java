...
/**
 * State regulatory filing cadence for BasicChecking in Michigan.
 ...
 */
public final class BasicCheckingMIRegulatoryFilings {
    ...
    public BasicCheckingMIRegulatoryFilings() {
        this(new BasicCheckingMIProfile());
    }

    public BasicCheckingMIRegulatoryFilings(BasicCheckingMIProfile profile) {

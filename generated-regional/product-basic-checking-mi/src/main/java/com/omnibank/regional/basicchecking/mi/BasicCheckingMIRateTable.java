...
/**
 * State-specific rate table overlay for BasicChecking offered in Michigan.
 ...
 */
public final class BasicCheckingMIRateTable {
    ...
    public BasicCheckingMIRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MI-BasicChecking-2026Q1";

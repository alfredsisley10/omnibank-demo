...
public final class BasicCheckingMIBranchIntegration {
    ...
    public BasicCheckingMIBranchIntegration() {
        this.profile = new BasicCheckingMIProfile();
    }

    public BasicCheckingMIBranchIntegration(BasicCheckingMIProfile profile) {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMI jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMIProfile},
 * {@link BasicCheckingMIRateTable}, {@link BasicCheckingMIDisclosures},
 * {@link BasicCheckingMIRegulatoryFilings}, and {@link BasicCheckingMIBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMIProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMIScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingGA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingGAProfile},
 * {@link BasicCheckingGARateTable}, {@link BasicCheckingGADisclosures},
 * {@link BasicCheckingGARegulatoryFilings}, and {@link BasicCheckingGABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingGAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingGAScenarioMatrixTest {

package com.omnibank.regional.basicchecking.ga;
...
/**
 * State-specific disclosure overlays for BasicChecking in Georgia.
 ...
 */
public final class BasicCheckingGADisclosures {

    private final BasicCheckingGAProfile profile;

    public BasicCheckingGADisclosures() {
        this.profile = new BasicCheckingGAProfile();
    }

    public BasicCheckingGADisclosures(BasicCheckingGAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Georgia State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

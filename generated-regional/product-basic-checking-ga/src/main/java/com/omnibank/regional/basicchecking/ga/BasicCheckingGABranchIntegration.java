...
public final class BasicCheckingGABranchIntegration {
    ...
    public BasicCheckingGABranchIntegration() {
        this.profile = new BasicCheckingGAProfile();
    }

    public BasicCheckingGABranchIntegration(BasicCheckingGAProfile profile) {

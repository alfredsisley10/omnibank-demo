...
/**
 * State regulatory filing cadence for BasicChecking in Georgia.
 ...
 */
public final class BasicCheckingGARegulatoryFilings {
    ...
    public BasicCheckingGARegulatoryFilings() {
        this(new BasicCheckingGAProfile());
    }

    public BasicCheckingGARegulatoryFilings(BasicCheckingGAProfile profile) {

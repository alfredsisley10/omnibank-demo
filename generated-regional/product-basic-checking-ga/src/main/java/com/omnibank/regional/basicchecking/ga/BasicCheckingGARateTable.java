...
/**
 * State-specific rate table overlay for BasicChecking offered in Georgia.
 ...
 */
public final class BasicCheckingGARateTable {
    ...
    public BasicCheckingGARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-GA-BasicChecking-2026Q1";

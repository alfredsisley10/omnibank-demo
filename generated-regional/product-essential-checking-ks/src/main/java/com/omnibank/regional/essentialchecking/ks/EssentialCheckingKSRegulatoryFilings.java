...
/**
 * State regulatory filing cadence for EssentialChecking in Kansas.
 ...
 */
public final class EssentialCheckingKSRegulatoryFilings {
    ...
    public EssentialCheckingKSRegulatoryFilings() {
        this(new EssentialCheckingKSProfile());
    }

    public EssentialCheckingKSRegulatoryFilings(EssentialCheckingKSProfile profile) {

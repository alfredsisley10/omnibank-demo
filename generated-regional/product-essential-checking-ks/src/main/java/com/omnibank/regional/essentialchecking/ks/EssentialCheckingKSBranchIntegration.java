...
/**
 * Branch / channel integration metadata for EssentialChecking in Kansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingKSBranchIntegration {
    ...
    public EssentialCheckingKSBranchIntegration() {
        this.profile = new EssentialCheckingKSProfile();
    }

    public EssentialCheckingKSBranchIntegration(EssentialCheckingKSProfile profile) {

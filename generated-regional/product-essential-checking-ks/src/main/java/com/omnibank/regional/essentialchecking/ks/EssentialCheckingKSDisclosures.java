...
/**
 * State-specific disclosure overlays for EssentialChecking in Kansas.
 ...
 */
public final class EssentialCheckingKSDisclosures {

    private final EssentialCheckingKSProfile profile;

    public EssentialCheckingKSDisclosures() {
        this.profile = new EssentialCheckingKSProfile();
    }

    public EssentialCheckingKSDisclosures(EssentialCheckingKSProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Kansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

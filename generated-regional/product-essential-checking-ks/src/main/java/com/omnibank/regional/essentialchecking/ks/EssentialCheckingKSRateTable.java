...
/**
 * State-specific rate table overlay for EssentialChecking offered in Kansas.
 ...
 */
public final class EssentialCheckingKSRateTable {
    ...
    public EssentialCheckingKSRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KS-EssentialChecking-2026Q1";

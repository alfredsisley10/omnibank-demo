...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingKS jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingKSProfile},
 * {@link EssentialCheckingKSRateTable}, {@link EssentialCheckingKSDisclosures},
 * {@link EssentialCheckingKSRegulatoryFilings}, and {@link EssentialCheckingKSBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingKSProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingKSScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsNC jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsNCProfile},
 * {@link HighYieldSavingsNCRateTable}, {@link HighYieldSavingsNCDisclosures},
 * {@link HighYieldSavingsNCRegulatoryFilings}, and {@link HighYieldSavingsNCBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsNCProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsNCScenarioMatrixTest {

...
class HighYieldSavingsNCProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new HighYieldSavingsNCProfile();
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new HighYieldSavingsNCRateTable();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new HighYieldSavingsNCBranchIntegration();

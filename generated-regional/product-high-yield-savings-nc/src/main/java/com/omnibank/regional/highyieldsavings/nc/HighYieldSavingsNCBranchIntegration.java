...
/**
 * Branch / channel integration metadata for HighYieldSavings in North Carolina.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsNCBranchIntegration {
    ...
    public HighYieldSavingsNCBranchIntegration() {
        this.profile = new HighYieldSavingsNCProfile();
    }

    public HighYieldSavingsNCBranchIntegration(HighYieldSavingsNCProfile profile) {

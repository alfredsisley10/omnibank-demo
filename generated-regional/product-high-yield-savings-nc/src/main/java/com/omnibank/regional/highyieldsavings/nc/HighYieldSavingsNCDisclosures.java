...
/**
 * State-specific disclosure overlays for HighYieldSavings in North Carolina.
 ...
 */
public final class HighYieldSavingsNCDisclosures {

    private final HighYieldSavingsNCProfile profile;

    public HighYieldSavingsNCDisclosures() {
        this.profile = new HighYieldSavingsNCProfile();
    }

    public HighYieldSavingsNCDisclosures(HighYieldSavingsNCProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — North Carolina State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

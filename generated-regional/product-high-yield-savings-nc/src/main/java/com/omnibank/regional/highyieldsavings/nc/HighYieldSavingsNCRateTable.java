...
/**
 * State-specific rate table overlay for HighYieldSavings offered in North Carolina.
 ...
 */
public final class HighYieldSavingsNCRateTable {
    ...
    public HighYieldSavingsNCRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-NC-HighYieldSavings-2026Q1";

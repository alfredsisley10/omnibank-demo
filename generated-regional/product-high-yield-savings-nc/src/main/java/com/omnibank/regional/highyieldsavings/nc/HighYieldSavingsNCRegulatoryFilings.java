package com.omnibank.regional.highyieldsavings.nc;
...
/**
 * State regulatory filing cadence for HighYieldSavings in North Carolina.
 ...
 */
public final class HighYieldSavingsNCRegulatoryFilings {
    ...
    private final HighYieldSavingsNCProfile profile;

    public HighYieldSavingsNCRegulatoryFilings() {
        this(new HighYieldSavingsNCProfile());
    }

    public HighYieldSavingsNCRegulatoryFilings(HighYieldSavingsNCProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                ...
                "North Carolina Condition Report",
                "QUARTERLY",
                dueDate,
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (North Carolina)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (North Carolina)",
                "ANNUAL",

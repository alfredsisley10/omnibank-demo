...
/**
 * Jurisdiction profile for HighYieldSavings as offered in North Carolina (NC).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class HighYieldSavingsNCProfile {
    ...
    public HighYieldSavingsNCProfile() {
        this.stateCode = "NC";
        this.stateName = "North Carolina";
        this.region = "SOUTH";
        this.salesTaxRate = new BigDecimal("0.0475");

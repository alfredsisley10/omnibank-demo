...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Montana.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingMTBranchIntegration {
    ...
    public DigitalOnlyCheckingMTBranchIntegration() {
        this.profile = new DigitalOnlyCheckingMTProfile();
    }

    public DigitalOnlyCheckingMTBranchIntegration(DigitalOnlyCheckingMTProfile profile) {

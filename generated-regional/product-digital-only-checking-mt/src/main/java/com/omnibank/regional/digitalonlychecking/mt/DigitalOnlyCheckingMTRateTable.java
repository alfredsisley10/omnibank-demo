...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Montana.
 ...
 */
public final class DigitalOnlyCheckingMTRateTable {
    ...
    public DigitalOnlyCheckingMTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MT-DigitalOnlyChecking-2026Q1";

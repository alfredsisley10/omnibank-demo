...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Montana (MT).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingMTProfile {
    ...
    public DigitalOnlyCheckingMTProfile() {
        this.stateCode = "MT";
        this.stateName = "Montana";
        this.region = "WEST";
        this.salesTaxRate = new BigDecimal("0.0000");

...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Montana.
 ...
 */
public final class DigitalOnlyCheckingMTRegulatoryFilings {
    ...
    public DigitalOnlyCheckingMTRegulatoryFilings() {
        this(new DigitalOnlyCheckingMTProfile());
    }

    public DigitalOnlyCheckingMTRegulatoryFilings(DigitalOnlyCheckingMTProfile profile) {
    ...
    public List<Filing> quarterlyFilings(YearMonth quarter) {
        ...
        filings.add(new Filing(
                "UNCLAIMED_PROPERTY",
                "Unclaimed Property Pre-Notice (Montana)",
                "ANNUAL",
    ...
    public List<Filing> annualFilings(int year) {
        ...
        filings.add(new Filing(
                ...
                "Unclaimed Property Remittance (Montana)",
                "ANNUAL",

package com.omnibank.regional.digitalonlychecking.mt;
...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Montana.
 ...
 */
public final class DigitalOnlyCheckingMTDisclosures {

    private final DigitalOnlyCheckingMTProfile profile;

    public DigitalOnlyCheckingMTDisclosures() {
        this.profile = new DigitalOnlyCheckingMTProfile();
    }

    public DigitalOnlyCheckingMTDisclosures(DigitalOnlyCheckingMTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Montana State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

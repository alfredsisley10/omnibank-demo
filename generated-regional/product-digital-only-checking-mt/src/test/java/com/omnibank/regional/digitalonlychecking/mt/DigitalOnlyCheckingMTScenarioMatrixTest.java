...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingMT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingMTProfile},
 * {@link DigitalOnlyCheckingMTRateTable}, {@link DigitalOnlyCheckingMTDisclosures},
 * {@link DigitalOnlyCheckingMTRegulatoryFilings}, and {@link DigitalOnlyCheckingMTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingMTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingMTScenarioMatrixTest {

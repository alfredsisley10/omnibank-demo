...
/**
 * Branch / channel integration metadata for BasicChecking in Massachusetts.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class BasicCheckingMABranchIntegration {
    ...
    public BasicCheckingMABranchIntegration() {
        this.profile = new BasicCheckingMAProfile();
    }

    public BasicCheckingMABranchIntegration(BasicCheckingMAProfile profile) {

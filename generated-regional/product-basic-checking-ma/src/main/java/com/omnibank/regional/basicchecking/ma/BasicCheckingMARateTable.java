...
/**
 * State-specific rate table overlay for BasicChecking offered in Massachusetts.
 ...
 */
public final class BasicCheckingMARateTable {
    ...
    public BasicCheckingMARateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-MA-BasicChecking-2026Q1";

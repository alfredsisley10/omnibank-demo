...
/**
 * State regulatory filing cadence for BasicChecking in Massachusetts.
 ...
 */
public final class BasicCheckingMARegulatoryFilings {
    ...
    public BasicCheckingMARegulatoryFilings() {
        this(new BasicCheckingMAProfile());
    }

    public BasicCheckingMARegulatoryFilings(BasicCheckingMAProfile profile) {

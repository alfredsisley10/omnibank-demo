package com.omnibank.regional.basicchecking.ma;
...
/**
 * State-specific disclosure overlays for BasicChecking in Massachusetts.
 ...
 */
public final class BasicCheckingMADisclosures {

    private final BasicCheckingMAProfile profile;

    public BasicCheckingMADisclosures() {
        this.profile = new BasicCheckingMAProfile();
    }

    public BasicCheckingMADisclosures(BasicCheckingMAProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("BasicChecking — Massachusetts State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
class BasicCheckingMAProfileTest {

    @Test
    void profile_reports_expected_state_code() {
        var p = new BasicCheckingMAProfile();
    ...
    void rate_table_returns_positive_apy_for_low_balance() {
        var rt = new BasicCheckingMARateTable();
    ...
    void channel_integration_lists_web_and_mobile() {
        var b = new BasicCheckingMABranchIntegration();

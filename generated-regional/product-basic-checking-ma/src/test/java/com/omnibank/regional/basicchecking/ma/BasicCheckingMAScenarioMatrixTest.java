...
/**
 * Auto-generated scenario-matrix tests for the BasicCheckingMA jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link BasicCheckingMAProfile},
 * {@link BasicCheckingMARateTable}, {@link BasicCheckingMADisclosures},
 * {@link BasicCheckingMARegulatoryFilings}, and {@link BasicCheckingMABranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code BasicCheckingMAProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class BasicCheckingMAScenarioMatrixTest {

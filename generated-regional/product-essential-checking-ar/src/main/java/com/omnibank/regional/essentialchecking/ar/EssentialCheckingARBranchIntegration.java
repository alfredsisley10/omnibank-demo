...
/**
 * Branch / channel integration metadata for EssentialChecking in Arkansas.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingARBranchIntegration {
    ...
    public EssentialCheckingARBranchIntegration() {
        this.profile = new EssentialCheckingARProfile();
    }

    public EssentialCheckingARBranchIntegration(EssentialCheckingARProfile profile) {

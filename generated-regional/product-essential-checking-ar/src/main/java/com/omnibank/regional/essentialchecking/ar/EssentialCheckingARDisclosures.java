package com.omnibank.regional.essentialchecking.ar;
...
/**
 * State-specific disclosure overlays for EssentialChecking in Arkansas.
 ...
 */
public final class EssentialCheckingARDisclosures {

    private final EssentialCheckingARProfile profile;

    public EssentialCheckingARDisclosures() {
        this.profile = new EssentialCheckingARProfile();
    }

    public EssentialCheckingARDisclosures(EssentialCheckingARProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Arkansas State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

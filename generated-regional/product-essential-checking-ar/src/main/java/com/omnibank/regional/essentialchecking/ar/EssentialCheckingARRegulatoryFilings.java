...
/**
 * State regulatory filing cadence for EssentialChecking in Arkansas.
 ...
 */
public final class EssentialCheckingARRegulatoryFilings {
    ...
    public EssentialCheckingARRegulatoryFilings() {
        this(new EssentialCheckingARProfile());
    }

    public EssentialCheckingARRegulatoryFilings(EssentialCheckingARProfile profile) {

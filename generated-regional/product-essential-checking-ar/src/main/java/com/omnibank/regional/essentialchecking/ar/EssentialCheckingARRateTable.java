...
/**
 * State-specific rate table overlay for EssentialChecking offered in Arkansas.
 ...
 */
public final class EssentialCheckingARRateTable {
    ...
    public EssentialCheckingARRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-AR-EssentialChecking-2026Q1";

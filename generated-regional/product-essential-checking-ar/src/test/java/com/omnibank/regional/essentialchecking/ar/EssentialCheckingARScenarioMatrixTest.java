...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingAR jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingARProfile},
 * {@link EssentialCheckingARRateTable}, {@link EssentialCheckingARDisclosures},
 * {@link EssentialCheckingARRegulatoryFilings}, and {@link EssentialCheckingARBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingARProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingARScenarioMatrixTest {

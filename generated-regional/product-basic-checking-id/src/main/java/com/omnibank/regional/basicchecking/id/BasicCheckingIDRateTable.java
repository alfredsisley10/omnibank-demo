...
/**
 * State-specific rate table overlay for BasicChecking offered in Idaho.
 ...
 */
public final class BasicCheckingIDRateTable {
    ...
    public BasicCheckingIDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ID-BasicChecking-2026Q1";

...
/**
 * State regulatory filing cadence for BasicChecking in Idaho.
 ...
 */
public final class BasicCheckingIDRegulatoryFilings {
    ...
    public BasicCheckingIDRegulatoryFilings() {
        this(new BasicCheckingIDProfile());
    }

    public BasicCheckingIDRegulatoryFilings(BasicCheckingIDProfile profile) {

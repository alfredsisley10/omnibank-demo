...
public final class BasicCheckingIDBranchIntegration {
    ...
    public BasicCheckingIDBranchIntegration() {
        this.profile = new BasicCheckingIDProfile();
    }

    public BasicCheckingIDBranchIntegration(BasicCheckingIDProfile profile) {

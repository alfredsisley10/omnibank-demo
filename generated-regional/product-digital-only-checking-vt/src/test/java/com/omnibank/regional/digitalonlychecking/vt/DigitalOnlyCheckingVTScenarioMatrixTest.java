...
/**
 * Auto-generated scenario-matrix tests for the DigitalOnlyCheckingVT jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link DigitalOnlyCheckingVTProfile},
 * {@link DigitalOnlyCheckingVTRateTable}, {@link DigitalOnlyCheckingVTDisclosures},
 * {@link DigitalOnlyCheckingVTRegulatoryFilings}, and {@link DigitalOnlyCheckingVTBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code DigitalOnlyCheckingVTProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class DigitalOnlyCheckingVTScenarioMatrixTest {

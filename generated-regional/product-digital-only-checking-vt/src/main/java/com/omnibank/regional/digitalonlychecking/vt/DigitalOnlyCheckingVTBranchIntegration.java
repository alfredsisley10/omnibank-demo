...
/**
 * Branch / channel integration metadata for DigitalOnlyChecking in Vermont.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class DigitalOnlyCheckingVTBranchIntegration {
    ...
    public DigitalOnlyCheckingVTBranchIntegration() {
        this.profile = new DigitalOnlyCheckingVTProfile();
    }

    public DigitalOnlyCheckingVTBranchIntegration(DigitalOnlyCheckingVTProfile profile) {

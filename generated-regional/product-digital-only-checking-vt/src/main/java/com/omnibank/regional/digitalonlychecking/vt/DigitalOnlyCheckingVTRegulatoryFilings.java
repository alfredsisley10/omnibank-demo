...
/**
 * State regulatory filing cadence for DigitalOnlyChecking in Vermont.
 ...
 */
public final class DigitalOnlyCheckingVTRegulatoryFilings {
    ...
    public DigitalOnlyCheckingVTRegulatoryFilings() {
        this(new DigitalOnlyCheckingVTProfile());
    }

    public DigitalOnlyCheckingVTRegulatoryFilings(DigitalOnlyCheckingVTProfile profile) {

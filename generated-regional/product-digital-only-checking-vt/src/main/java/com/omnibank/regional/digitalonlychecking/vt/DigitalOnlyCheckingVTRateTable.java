...
/**
 * State-specific rate table overlay for DigitalOnlyChecking offered in Vermont.
 ...
 */
public final class DigitalOnlyCheckingVTRateTable {
    ...
    public DigitalOnlyCheckingVTRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-VT-DigitalOnlyChecking-2026Q1";

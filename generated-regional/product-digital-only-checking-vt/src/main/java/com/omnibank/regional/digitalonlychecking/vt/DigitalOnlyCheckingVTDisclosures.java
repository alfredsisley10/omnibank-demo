...
/**
 * State-specific disclosure overlays for DigitalOnlyChecking in Vermont.
 ...
 */
public final class DigitalOnlyCheckingVTDisclosures {

    private final DigitalOnlyCheckingVTProfile profile;

    public DigitalOnlyCheckingVTDisclosures() {
        this.profile = new DigitalOnlyCheckingVTProfile();
    }

    public DigitalOnlyCheckingVTDisclosures(DigitalOnlyCheckingVTProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("DigitalOnlyChecking — Vermont State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

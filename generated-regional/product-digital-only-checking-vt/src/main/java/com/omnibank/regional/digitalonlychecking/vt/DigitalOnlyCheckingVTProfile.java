...
/**
 * Jurisdiction profile for DigitalOnlyChecking as offered in Vermont (VT).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class DigitalOnlyCheckingVTProfile {
    ...
    public DigitalOnlyCheckingVTProfile() {
        this.stateCode = "VT";

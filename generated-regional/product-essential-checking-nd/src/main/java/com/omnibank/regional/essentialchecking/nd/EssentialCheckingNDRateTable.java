...
/**
 * State-specific rate table overlay for EssentialChecking offered in North Dakota.
 ...
 */
public final class EssentialCheckingNDRateTable {
    ...
    public EssentialCheckingNDRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-ND-EssentialChecking-2026Q1";

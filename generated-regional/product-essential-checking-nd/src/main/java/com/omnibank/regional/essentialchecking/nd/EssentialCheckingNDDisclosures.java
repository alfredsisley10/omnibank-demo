...
/**
 * State-specific disclosure overlays for EssentialChecking in North Dakota.
 ...
 */
public final class EssentialCheckingNDDisclosures {

    private final EssentialCheckingNDProfile profile;

    public EssentialCheckingNDDisclosures() {
        this.profile = new EssentialCheckingNDProfile();
    }

    public EssentialCheckingNDDisclosures(EssentialCheckingNDProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — North Dakota State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

...
/**
 * Jurisdiction profile for EssentialChecking as offered in North Dakota (ND).
 * Captures state-specific overrides that diverge from the
 * national product specification.
 */
public final class EssentialCheckingNDProfile {
    ...
    public EssentialCheckingNDProfile() {
        this.stateCode = "ND";

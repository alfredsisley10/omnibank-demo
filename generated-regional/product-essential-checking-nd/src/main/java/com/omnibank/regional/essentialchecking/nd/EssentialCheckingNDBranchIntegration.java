...
/**
 * Branch / channel integration metadata for EssentialChecking in North Dakota.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingNDBranchIntegration {
    ...
    public EssentialCheckingNDBranchIntegration() {
        this.profile = new EssentialCheckingNDProfile();
    }

    public EssentialCheckingNDBranchIntegration(EssentialCheckingNDProfile profile) {

...
/**
 * State regulatory filing cadence for EssentialChecking in North Dakota.
 ...
 */
public final class EssentialCheckingNDRegulatoryFilings {
    ...
    public EssentialCheckingNDRegulatoryFilings() {
        this(new EssentialCheckingNDProfile());
    }

    public EssentialCheckingNDRegulatoryFilings(EssentialCheckingNDProfile profile) {

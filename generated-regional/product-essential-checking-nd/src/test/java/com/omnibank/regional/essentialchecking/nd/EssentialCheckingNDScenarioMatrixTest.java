...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingND jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingNDProfile},
 * {@link EssentialCheckingNDRateTable}, {@link EssentialCheckingNDDisclosures},
 * {@link EssentialCheckingNDRegulatoryFilings}, and {@link EssentialCheckingNDBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingNDProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingNDScenarioMatrixTest {

...
/**
 * Auto-generated scenario-matrix tests for the HighYieldSavingsCO jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link HighYieldSavingsCOProfile},
 * {@link HighYieldSavingsCORateTable}, {@link HighYieldSavingsCODisclosures},
 * {@link HighYieldSavingsCORegulatoryFilings}, and {@link HighYieldSavingsCOBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code HighYieldSavingsCOProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class HighYieldSavingsCOScenarioMatrixTest {

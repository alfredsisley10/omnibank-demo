...
/**
 * State-specific disclosure overlays for HighYieldSavings in Colorado.
 ...
 */
public final class HighYieldSavingsCODisclosures {

    private final HighYieldSavingsCOProfile profile;

    public HighYieldSavingsCODisclosures() {
        this.profile = new HighYieldSavingsCOProfile();
    }

    public HighYieldSavingsCODisclosures(HighYieldSavingsCOProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("HighYieldSavings — Colorado State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

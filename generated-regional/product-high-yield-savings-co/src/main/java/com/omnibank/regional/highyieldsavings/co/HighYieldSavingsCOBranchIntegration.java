...
/**
 * Branch / channel integration metadata for HighYieldSavings in Colorado.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class HighYieldSavingsCOBranchIntegration {
    ...
    public HighYieldSavingsCOBranchIntegration() {
        this.profile = new HighYieldSavingsCOProfile();
    }

    public HighYieldSavingsCOBranchIntegration(HighYieldSavingsCOProfile profile) {

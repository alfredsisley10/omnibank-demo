...
/**
 * State-specific rate table overlay for HighYieldSavings offered in Colorado.
 ...
 */
public final class HighYieldSavingsCORateTable {
    ...
    public HighYieldSavingsCORateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-CO-HighYieldSavings-2026Q1";

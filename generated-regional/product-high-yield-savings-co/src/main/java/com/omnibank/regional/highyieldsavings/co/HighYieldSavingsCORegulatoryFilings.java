...
/**
 * State regulatory filing cadence for HighYieldSavings in Colorado.
 ...
 */
public final class HighYieldSavingsCORegulatoryFilings {
    ...
    public HighYieldSavingsCORegulatoryFilings() {
        this(new HighYieldSavingsCOProfile());
    }

    public HighYieldSavingsCORegulatoryFilings(HighYieldSavingsCOProfile profile) {

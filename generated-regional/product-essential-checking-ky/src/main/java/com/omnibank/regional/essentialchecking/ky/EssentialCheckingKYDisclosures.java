...
/**
 * State-specific disclosure overlays for EssentialChecking in Kentucky.
 ...
 */
public final class EssentialCheckingKYDisclosures {

    private final EssentialCheckingKYProfile profile;

    public EssentialCheckingKYDisclosures() {
        this.profile = new EssentialCheckingKYProfile();
    }

    public EssentialCheckingKYDisclosures(EssentialCheckingKYProfile profile) {
    ...
    public String renderFullSupplement() {
        ...
        sb.append("EssentialChecking — Kentucky State Disclosure Supplement\n");
        sb.append("=".repeat(70)).append("\n\n");

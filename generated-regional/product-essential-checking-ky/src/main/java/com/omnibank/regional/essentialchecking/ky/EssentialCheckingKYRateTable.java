...
/**
 * State-specific rate table overlay for EssentialChecking offered in Kentucky.
 ...
 */
public final class EssentialCheckingKYRateTable {
    ...
    public EssentialCheckingKYRateTable() {
        this.effectiveFrom = LocalDate.of(2026, 1, 1);
        this.rateSheetRef = "RATE-KY-EssentialChecking-2026Q1";

...
/**
 * Branch / channel integration metadata for EssentialChecking in Kentucky.
 * Tells the customer-portal and in-branch teller system which
 * workflows to show and which regional call-center queue to use.
 */
public final class EssentialCheckingKYBranchIntegration {
    ...
    public EssentialCheckingKYBranchIntegration() {
        this.profile = new EssentialCheckingKYProfile();
    }

    public EssentialCheckingKYBranchIntegration(EssentialCheckingKYProfile profile) {

package com.omnibank.regional.essentialchecking.ky;
...
/**
 * State regulatory filing cadence for EssentialChecking in Kentucky.
 ...
 */
public final class EssentialCheckingKYRegulatoryFilings {
    ...
    private final EssentialCheckingKYProfile profile;

    public EssentialCheckingKYRegulatoryFilings() {
        this(new EssentialCheckingKYProfile());
    }

    public EssentialCheckingKYRegulatoryFilings(EssentialCheckingKYProfile profile) {

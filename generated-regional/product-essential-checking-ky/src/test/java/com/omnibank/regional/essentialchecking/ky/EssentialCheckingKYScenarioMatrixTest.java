...
/**
 * Auto-generated scenario-matrix tests for the EssentialCheckingKY jurisdictional
 * fork. Generated by {@code com.aibench.codegen.RegionalScenarioTestGenerator}
 * from the public APIs of the existing {@link EssentialCheckingKYProfile},
 * {@link EssentialCheckingKYRateTable}, {@link EssentialCheckingKYDisclosures},
 * {@link EssentialCheckingKYRegulatoryFilings}, and {@link EssentialCheckingKYBranchIntegration}.
 *
 * <p>Tests here cover boundary scenarios that the hand-written
 * {@code EssentialCheckingKYProfileTest} does not exercise: rate-band tier
 * monotonicity, sales-tax rounding precision, channel availability
 * vs. profile flags, multi-quarter regulatory filings.
 */
class EssentialCheckingKYScenarioMatrixTest {

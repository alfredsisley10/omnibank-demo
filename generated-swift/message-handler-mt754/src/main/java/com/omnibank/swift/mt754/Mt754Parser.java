...
/**
 * Parser for SWIFT MT754 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT754; unknown tags are preserved as raw strings.
 */
public final class Mt754Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt754Message parse(String rawBlock4) {

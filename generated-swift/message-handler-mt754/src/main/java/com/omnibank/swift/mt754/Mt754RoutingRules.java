...
/**
 * Routing rules for MT754. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt754RoutingRules {
    ...
    public Destination routeFor(Mt754Message message) {
    ...
    public String priorityQueueOverride(Mt754Message message) {

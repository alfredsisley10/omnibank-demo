...
/**
 * Parser for SWIFT MT422 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT422; unknown tags are preserved as raw strings.
 */
public final class Mt422Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt422Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT422. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt422RoutingRules {
    ...
    public Destination routeFor(Mt422Message message) {
    ...
    public String priorityQueueOverride(Mt422Message message) {

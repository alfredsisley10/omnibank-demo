...
class Mt422HandlerTest {

    private final Mt422Handler handler = new Mt422Handler();
    ...
    void parser_accepts_basic_block() {
        ...
        assertThat(msg.messageReference()).isEqualTo("REF-MT422");
    }
    ...
    void routing_rules_produce_a_destination() {
        ...
        String block4 = """
                ...
                """;
        var msg = parser.parse(block4);
        var rules = new Mt422RoutingRules();

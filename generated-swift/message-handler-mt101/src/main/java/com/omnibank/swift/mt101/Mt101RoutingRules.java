...
/**
 * Routing rules for MT101. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt101RoutingRules {
    ...
    public Destination routeFor(Mt101Message message) {
    ...
    public String priorityQueueOverride(Mt101Message message) {

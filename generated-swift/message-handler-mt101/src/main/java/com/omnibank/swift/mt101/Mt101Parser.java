...
/**
 * Parser for SWIFT MT101 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT101; unknown tags are preserved as raw strings.
 */
public final class Mt101Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt101Message parse(String rawBlock4) {

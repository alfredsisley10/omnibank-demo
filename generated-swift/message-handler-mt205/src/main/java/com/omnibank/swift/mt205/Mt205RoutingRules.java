...
/**
 * Routing rules for MT205. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt205RoutingRules {
    ...
    public Destination routeFor(Mt205Message message) {
    ...
    public String priorityQueueOverride(Mt205Message message) {

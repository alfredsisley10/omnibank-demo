...
/**
 * Parser for SWIFT MT205 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT205; unknown tags are preserved as raw strings.
 */
public final class Mt205Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt205Message parse(String rawBlock4) {

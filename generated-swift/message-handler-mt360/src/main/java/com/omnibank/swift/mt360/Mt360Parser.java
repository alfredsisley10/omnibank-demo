...
/**
 * Parser for SWIFT MT360 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT360; unknown tags are preserved as raw strings.
 */
public final class Mt360Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt360Message parse(String rawBlock4) {

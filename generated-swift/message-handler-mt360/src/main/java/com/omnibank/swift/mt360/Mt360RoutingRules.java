...
/**
 * Routing rules for MT360. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt360RoutingRules {
    ...
    public Destination routeFor(Mt360Message message) {
    ...
    public String priorityQueueOverride(Mt360Message message) {

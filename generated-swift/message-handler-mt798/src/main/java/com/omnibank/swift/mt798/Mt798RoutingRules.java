...
/**
 * Routing rules for MT798. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt798RoutingRules {
    ...
    public Destination routeFor(Mt798Message message) {
    ...
    public String priorityQueueOverride(Mt798Message message) {

...
/**
 * Parser for SWIFT MT798 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT798; unknown tags are preserved as raw strings.
 */
public final class Mt798Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt798Message parse(String rawBlock4) {

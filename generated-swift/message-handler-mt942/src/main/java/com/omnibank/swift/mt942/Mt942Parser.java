...
/**
 * Parser for SWIFT MT942 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT942; unknown tags are preserved as raw strings.
 */
public final class Mt942Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt942Message parse(String rawBlock4) {

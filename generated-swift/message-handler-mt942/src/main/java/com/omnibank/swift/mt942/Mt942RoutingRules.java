...
/**
 * Routing rules for MT942. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt942RoutingRules {
    ...
    public Destination routeFor(Mt942Message message) {
    ...
    public String priorityQueueOverride(Mt942Message message) {

...
/**
 * Routing rules for MT707. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt707RoutingRules {
    ...
    public Destination routeFor(Mt707Message message) {
    ...
    public String priorityQueueOverride(Mt707Message message) {

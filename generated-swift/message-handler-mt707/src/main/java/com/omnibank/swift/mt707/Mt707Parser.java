...
/**
 * Parser for SWIFT MT707 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT707; unknown tags are preserved as raw strings.
 */
public final class Mt707Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt707Message parse(String rawBlock4) {

...
/**
 * Parser for SWIFT MT110 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT110; unknown tags are preserved as raw strings.
 */
public final class Mt110Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt110Message parse(String rawBlock4) {

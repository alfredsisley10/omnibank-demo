...
/**
 * Routing rules for MT110. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt110RoutingRules {
    ...
    public Destination routeFor(Mt110Message message) {
    ...
    public String priorityQueueOverride(Mt110Message message) {

...
/**
 * Routing rules for MT730. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt730RoutingRules {
    ...
    public Destination routeFor(Mt730Message message) {
    ...
    public String priorityQueueOverride(Mt730Message message) {

...
/**
 * Parser for SWIFT MT730 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT730; unknown tags are preserved as raw strings.
 */
public final class Mt730Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt730Message parse(String rawBlock4) {

...
class Mt730HandlerTest {

    private final Mt730Handler handler = new Mt730Handler();
    ...
    void parser_accepts_basic_block() {
        ...
        assertThat(msg.messageReference()).isEqualTo("REF-MT730");
    }
    ...
    void routing_rules_produce_a_destination() {
        ...
        String block4 = """
                ...
                """;
        var msg = parser.parse(block4);
        var rules = new Mt730RoutingRules();

...
/**
 * Routing rules for MT920. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt920RoutingRules {
    ...
    public Destination routeFor(Mt920Message message) {
    ...
    public String priorityQueueOverride(Mt920Message message) {

...
/**
 * Parser for SWIFT MT920 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT920; unknown tags are preserved as raw strings.
 */
public final class Mt920Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt920Message parse(String rawBlock4) {

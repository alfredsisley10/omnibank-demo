...
/**
 * Routing rules for MT410. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt410RoutingRules {
    ...
    public Destination routeFor(Mt410Message message) {
    ...
    public String priorityQueueOverride(Mt410Message message) {

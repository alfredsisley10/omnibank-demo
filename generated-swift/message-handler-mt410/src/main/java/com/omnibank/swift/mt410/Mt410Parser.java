...
/**
 * Parser for SWIFT MT410 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT410; unknown tags are preserved as raw strings.
 */
public final class Mt410Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt410Message parse(String rawBlock4) {

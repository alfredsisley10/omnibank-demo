...
/**
 * Parser for SWIFT MT412 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT412; unknown tags are preserved as raw strings.
 */
public final class Mt412Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt412Message parse(String rawBlock4) {

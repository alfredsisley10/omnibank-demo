...
/**
 * Parser for SWIFT MT705 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT705; unknown tags are preserved as raw strings.
 */
public final class Mt705Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt705Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT705. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt705RoutingRules {
    ...
    public Destination routeFor(Mt705Message message) {
    ...
    public String priorityQueueOverride(Mt705Message message) {

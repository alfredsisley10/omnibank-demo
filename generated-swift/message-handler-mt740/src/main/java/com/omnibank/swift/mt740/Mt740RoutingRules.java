...
/**
 * Routing rules for MT740. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt740RoutingRules {
    ...
    public Destination routeFor(Mt740Message message) {
    ...
    public String priorityQueueOverride(Mt740Message message) {

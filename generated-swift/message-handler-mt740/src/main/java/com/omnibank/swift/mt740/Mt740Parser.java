...
/**
 * Parser for SWIFT MT740 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT740; unknown tags are preserved as raw strings.
 */
public final class Mt740Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt740Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT112. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt112RoutingRules {
    ...
    public Destination routeFor(Mt112Message message) {
    ...
    public String priorityQueueOverride(Mt112Message message) {

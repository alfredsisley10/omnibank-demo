...
/**
 * Parser for SWIFT MT112 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT112; unknown tags are preserved as raw strings.
 */
public final class Mt112Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt112Message parse(String rawBlock4) {

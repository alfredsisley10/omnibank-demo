...
/**
 * Parser for SWIFT MT941 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT941; unknown tags are preserved as raw strings.
 */
public final class Mt941Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt941Message parse(String rawBlock4) {

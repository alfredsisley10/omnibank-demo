...
/**
 * Routing rules for MT941. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt941RoutingRules {
    ...
    public Destination routeFor(Mt941Message message) {
    ...
    public String priorityQueueOverride(Mt941Message message) {

...
/**
 * Parser for SWIFT MT102 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT102; unknown tags are preserved as raw strings.
 */
public final class Mt102Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt102Message parse(String rawBlock4) {

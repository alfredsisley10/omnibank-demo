...
/**
 * Routing rules for MT102. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt102RoutingRules {
    ...
    public Destination routeFor(Mt102Message message) {
    ...
    public String priorityQueueOverride(Mt102Message message) {

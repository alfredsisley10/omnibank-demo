...
/**
 * Parser for SWIFT MT700 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT700; unknown tags are preserved as raw strings.
 */
public final class Mt700Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt700Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT700. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt700RoutingRules {
    ...
    public Destination routeFor(Mt700Message message) {
    ...
    public String priorityQueueOverride(Mt700Message message) {

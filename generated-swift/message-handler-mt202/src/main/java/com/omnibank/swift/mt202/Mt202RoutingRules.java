...
/**
 * Routing rules for MT202. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt202RoutingRules {
    ...
    public Destination routeFor(Mt202Message message) {
    ...
    public String priorityQueueOverride(Mt202Message message) {

...
/**
 * Parser for SWIFT MT330 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT330; unknown tags are preserved as raw strings.
 */
public final class Mt330Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt330Message parse(String rawBlock4) {

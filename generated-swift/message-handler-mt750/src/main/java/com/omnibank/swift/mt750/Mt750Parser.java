...
/**
 * Parser for SWIFT MT750 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT750; unknown tags are preserved as raw strings.
 */
public final class Mt750Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt750Message parse(String rawBlock4) {

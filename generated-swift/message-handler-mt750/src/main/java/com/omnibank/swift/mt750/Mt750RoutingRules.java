...
/**
 * Routing rules for MT750. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt750RoutingRules {
    ...
    public Destination routeFor(Mt750Message message) {
    ...
    public String priorityQueueOverride(Mt750Message message) {

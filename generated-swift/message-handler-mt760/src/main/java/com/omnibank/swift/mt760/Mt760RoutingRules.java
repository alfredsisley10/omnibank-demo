...
/**
 * Routing rules for MT760. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt760RoutingRules {
    ...
    public Destination routeFor(Mt760Message message) {
    ...
    public String priorityQueueOverride(Mt760Message message) {

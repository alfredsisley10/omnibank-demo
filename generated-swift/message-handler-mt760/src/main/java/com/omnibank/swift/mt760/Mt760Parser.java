...
/**
 * Parser for SWIFT MT760 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT760; unknown tags are preserved as raw strings.
 */
public final class Mt760Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt760Message parse(String rawBlock4) {

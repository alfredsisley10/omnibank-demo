...
/**
 * Parser for SWIFT MT111 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT111; unknown tags are preserved as raw strings.
 */
public final class Mt111Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt111Message parse(String rawBlock4) {

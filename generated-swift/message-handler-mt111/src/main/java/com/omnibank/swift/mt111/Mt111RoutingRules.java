...
/**
 * Routing rules for MT111. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt111RoutingRules {
    ...
    public Destination routeFor(Mt111Message message) {
    ...
    public String priorityQueueOverride(Mt111Message message) {

...
class Mt910HandlerTest {

    private final Mt910Handler handler = new Mt910Handler();
    ...
    void parser_accepts_basic_block() {
        ...
        assertThat(msg.messageReference()).isEqualTo("REF-MT910");
    }
    ...
    void routing_rules_produce_a_destination() {
        ...
        String block4 = """
                ...
                """;
        var msg = parser.parse(block4);
        var rules = new Mt910RoutingRules();

...
/**
 * Parser for SWIFT MT910 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT910; unknown tags are preserved as raw strings.
 */
public final class Mt910Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt910Message parse(String rawBlock4) {

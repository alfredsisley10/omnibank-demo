...
/**
 * Routing rules for MT910. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt910RoutingRules {
    ...
    public Destination routeFor(Mt910Message message) {
    ...
    public String priorityQueueOverride(Mt910Message message) {

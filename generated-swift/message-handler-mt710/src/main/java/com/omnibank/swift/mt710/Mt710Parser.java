...
/**
 * Parser for SWIFT MT710 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT710; unknown tags are preserved as raw strings.
 */
public final class Mt710Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt710Message parse(String rawBlock4) {

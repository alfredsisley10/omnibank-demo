...
/**
 * Routing rules for MT710. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt710RoutingRules {
    ...
    public Destination routeFor(Mt710Message message) {
    ...
    public String priorityQueueOverride(Mt710Message message) {

...
/**
 * Routing rules for MT210. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt210RoutingRules {
    ...
    public Destination routeFor(Mt210Message message) {
    ...
    public String priorityQueueOverride(Mt210Message message) {

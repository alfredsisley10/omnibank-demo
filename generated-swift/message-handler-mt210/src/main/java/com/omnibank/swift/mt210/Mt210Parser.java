...
/**
 * Parser for SWIFT MT210 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT210; unknown tags are preserved as raw strings.
 */
public final class Mt210Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt210Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT203. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt203RoutingRules {
    ...
    public Destination routeFor(Mt203Message message) {
    ...
    public String priorityQueueOverride(Mt203Message message) {

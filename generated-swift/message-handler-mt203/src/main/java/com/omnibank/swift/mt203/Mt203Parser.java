...
/**
 * Parser for SWIFT MT203 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT203; unknown tags are preserved as raw strings.
 */
public final class Mt203Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt203Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT900. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt900RoutingRules {
    ...
    public Destination routeFor(Mt900Message message) {
    ...
    public String priorityQueueOverride(Mt900Message message) {

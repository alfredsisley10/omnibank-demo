...
/**
 * Parser for SWIFT MT900 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT900; unknown tags are preserved as raw strings.
 */
public final class Mt900Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt900Message parse(String rawBlock4) {

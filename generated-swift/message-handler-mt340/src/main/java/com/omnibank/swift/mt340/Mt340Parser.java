...
/**
 * Parser for SWIFT MT340 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT340; unknown tags are preserved as raw strings.
 */
public final class Mt340Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt340Message parse(String rawBlock4) {

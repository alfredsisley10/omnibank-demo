...
/**
 * Routing rules for MT340. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt340RoutingRules {
    ...
    public Destination routeFor(Mt340Message message) {
    ...
    public String priorityQueueOverride(Mt340Message message) {

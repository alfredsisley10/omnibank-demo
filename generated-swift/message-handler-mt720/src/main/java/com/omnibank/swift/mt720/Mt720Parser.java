...
/**
 * Parser for SWIFT MT720 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT720; unknown tags are preserved as raw strings.
 */
public final class Mt720Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt720Message parse(String rawBlock4) {

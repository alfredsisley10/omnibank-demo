...
/**
 * Routing rules for MT720. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt720RoutingRules {
    ...
    public Destination routeFor(Mt720Message message) {
    ...
    public String priorityQueueOverride(Mt720Message message) {

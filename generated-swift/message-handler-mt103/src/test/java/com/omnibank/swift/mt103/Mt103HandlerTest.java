...
class Mt103HandlerTest {

    private final Mt103Handler handler = new Mt103Handler();
    ...
    void parser_accepts_basic_block() {
        ...
        assertThat(msg.messageReference()).isEqualTo("REF-MT103");
    }
    ...
    void routing_rules_produce_a_destination() {
        ...
        String block4 = """
                ...
                """;
        var msg = parser.parse(block4);
        var rules = new Mt103RoutingRules();

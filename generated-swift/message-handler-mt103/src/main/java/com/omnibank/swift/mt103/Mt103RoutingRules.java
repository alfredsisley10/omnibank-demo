...
/**
 * Routing rules for MT103. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt103RoutingRules {
    ...
    public Destination routeFor(Mt103Message message) {
    ...
    public String priorityQueueOverride(Mt103Message message) {

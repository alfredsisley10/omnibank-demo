...
/**
 * Parser for SWIFT MT103 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT103; unknown tags are preserved as raw strings.
 */
public final class Mt103Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt103Message parse(String rawBlock4) {

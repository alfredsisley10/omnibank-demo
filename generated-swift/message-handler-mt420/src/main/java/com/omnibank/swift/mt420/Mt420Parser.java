...
/**
 * Parser for SWIFT MT420 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT420; unknown tags are preserved as raw strings.
 */
public final class Mt420Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt420Message parse(String rawBlock4) {

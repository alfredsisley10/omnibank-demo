...
/**
 * Routing rules for MT420. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt420RoutingRules {
    ...
    public Destination routeFor(Mt420Message message) {
    ...
    public String priorityQueueOverride(Mt420Message message) {

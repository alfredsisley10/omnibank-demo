...
/**
 * Parser for SWIFT MT950 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT950; unknown tags are preserved as raw strings.
 */
public final class Mt950Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt950Message parse(String rawBlock4) {

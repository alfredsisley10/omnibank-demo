...
/**
 * Routing rules for MT950. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt950RoutingRules {
    ...
    public Destination routeFor(Mt950Message message) {
    ...
    public String priorityQueueOverride(Mt950Message message) {

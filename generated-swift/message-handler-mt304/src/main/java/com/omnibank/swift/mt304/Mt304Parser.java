...
/**
 * Parser for SWIFT MT304 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT304; unknown tags are preserved as raw strings.
 */
public final class Mt304Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt304Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT400. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt400RoutingRules {
    ...
    public Destination routeFor(Mt400Message message) {
    ...
    public String priorityQueueOverride(Mt400Message message) {

...
/**
 * Parser for SWIFT MT400 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT400; unknown tags are preserved as raw strings.
 */
public final class Mt400Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt400Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT940. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt940RoutingRules {
    ...
    public Destination routeFor(Mt940Message message) {
    ...
    public String priorityQueueOverride(Mt940Message message) {

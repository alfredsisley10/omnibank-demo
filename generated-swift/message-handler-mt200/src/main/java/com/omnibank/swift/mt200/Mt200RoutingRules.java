...
/**
 * Routing rules for MT200. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt200RoutingRules {
    ...
    public Destination routeFor(Mt200Message message) {
    ...
    public String priorityQueueOverride(Mt200Message message) {

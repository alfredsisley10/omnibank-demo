...
/**
 * Parser for SWIFT MT200 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT200; unknown tags are preserved as raw strings.
 */
public final class Mt200Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt200Message parse(String rawBlock4) {

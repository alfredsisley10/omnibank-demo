...
/**
 * Parser for SWIFT MT202COV messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT202COV; unknown tags are preserved as raw strings.
 */
public final class Mt202COVParser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt202COVMessage parse(String rawBlock4) {

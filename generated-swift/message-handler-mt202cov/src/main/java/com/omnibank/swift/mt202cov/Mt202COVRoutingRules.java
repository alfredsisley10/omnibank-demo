...
/**
 * Routing rules for MT202COV. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt202COVRoutingRules {
    ...
    public Destination routeFor(Mt202COVMessage message) {
    ...
    public String priorityQueueOverride(Mt202COVMessage message) {

...
/**
 * Routing rules for MT104. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt104RoutingRules {
    ...
    public Destination routeFor(Mt104Message message) {
    ...
    public String priorityQueueOverride(Mt104Message message) {

...
/**
 * Parser for SWIFT MT104 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT104; unknown tags are preserved as raw strings.
 */
public final class Mt104Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt104Message parse(String rawBlock4) {

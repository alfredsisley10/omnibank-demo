...
/**
 * Routing rules for MT290. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt290RoutingRules {
    ...
    public Destination routeFor(Mt290Message message) {
    ...
    public String priorityQueueOverride(Mt290Message message) {

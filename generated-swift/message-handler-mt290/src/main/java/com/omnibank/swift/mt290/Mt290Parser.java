...
/**
 * Parser for SWIFT MT290 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT290; unknown tags are preserved as raw strings.
 */
public final class Mt290Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt290Message parse(String rawBlock4) {

...
/**
 * Parser for SWIFT MT300 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT300; unknown tags are preserved as raw strings.
 */
public final class Mt300Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt300Message parse(String rawBlock4) {

...
/**
 * Routing rules for MT300. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt300RoutingRules {
    ...
    public Destination routeFor(Mt300Message message) {
    ...
    public String priorityQueueOverride(Mt300Message message) {

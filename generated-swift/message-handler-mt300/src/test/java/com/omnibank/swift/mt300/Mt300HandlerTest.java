...
class Mt300HandlerTest {

    private final Mt300Handler handler = new Mt300Handler();
    ...
    void parser_accepts_basic_block() {
        ...
        assertThat(msg.messageReference()).isEqualTo("REF-MT300");
    }
    ...
    void routing_rules_produce_a_destination() {
        ...
        String block4 = """
                ...
                """;
        var msg = parser.parse(block4);
        var rules = new Mt300RoutingRules();

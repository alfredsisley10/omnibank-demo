...
/**
 * Parser for SWIFT MT107 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT107; unknown tags are preserved as raw strings.
 */
public final class Mt107Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt107Message parse(String rawBlock4) {

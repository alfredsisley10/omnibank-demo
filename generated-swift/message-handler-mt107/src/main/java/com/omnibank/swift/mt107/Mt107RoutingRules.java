...
/**
 * Routing rules for MT107. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt107RoutingRules {
    ...
    public Destination routeFor(Mt107Message message) {
    ...
    public String priorityQueueOverride(Mt107Message message) {

...
/**
 * Parser for SWIFT MT450 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT450; unknown tags are preserved as raw strings.
 */
public final class Mt450Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt450Message parse(String rawBlock4) {

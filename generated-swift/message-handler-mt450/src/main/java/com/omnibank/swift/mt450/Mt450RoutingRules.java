...
/**
 * Routing rules for MT450. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt450RoutingRules {
    ...
    public Destination routeFor(Mt450Message message) {
    ...
    public String priorityQueueOverride(Mt450Message message) {

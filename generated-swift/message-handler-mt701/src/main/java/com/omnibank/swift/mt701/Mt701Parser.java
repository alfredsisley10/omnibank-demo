...
/**
 * Parser for SWIFT MT701 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT701; unknown tags are preserved as raw strings.
 */
public final class Mt701Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt701Message parse(String rawBlock4) {

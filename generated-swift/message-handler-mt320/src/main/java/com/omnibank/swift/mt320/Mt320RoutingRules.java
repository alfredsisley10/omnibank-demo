...
/**
 * Routing rules for MT320. Determines which downstream handler
 * queue gets the parsed message based on BIC and payment profile.
 */
public final class Mt320RoutingRules {
    ...
    public Destination routeFor(Mt320Message message) {
    ...
    public String priorityQueueOverride(Mt320Message message) {

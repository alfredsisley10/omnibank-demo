...
/**
 * Parser for SWIFT MT320 messages in the block-4 tag format.
 * This implementation understands the subset of tags typically
 * present in a MT320; unknown tags are preserved as raw strings.
 */
public final class Mt320Parser {

    private static final DateTimeFormatter DATE = DateTimeFormatter.ofPattern("yyMMdd");

    public Mt320Message parse(String rawBlock4) {

...
/**
 * Eligibility rule engine for the Jumbo 12 Month CD product. Evaluates age,
 ...
 */
public final class JumboCd12MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Jumbo 12 Month CD",
                        Finding.Severity.BLOCKER));
            }

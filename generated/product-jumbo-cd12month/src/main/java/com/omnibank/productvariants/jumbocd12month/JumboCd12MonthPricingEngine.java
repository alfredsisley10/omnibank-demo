...
/**
 * Pricing and interest accrual for the Jumbo 12 Month CD product. Uses simple
 ...
 * engine.
 */
public final class JumboCd12MonthPricingEngine {
    ...
    public JumboCd12MonthPricingEngine() {
        this(new BigDecimal("0.0485"));
    }

    public JumboCd12MonthPricingEngine(BigDecimal baseRate) {

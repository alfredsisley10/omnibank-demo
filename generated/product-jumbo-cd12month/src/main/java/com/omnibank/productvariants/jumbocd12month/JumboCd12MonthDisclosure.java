...
/**
 * Regulation-mandated disclosure text for the Jumbo 12 Month CD product.
 ...
 */
public final class JumboCd12MonthDisclosure {

    public String title() {
        return "Jumbo 12 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $100000.00",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (90 <= 0) {
            return List.of("No early withdrawal penalty applies to the Jumbo 12 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Jumbo 12 Month CD.",
                "Penalty equals interest on the amount withdrawn for 90 days.",

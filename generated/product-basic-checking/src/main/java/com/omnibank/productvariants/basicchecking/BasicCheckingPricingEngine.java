...
/**
 * Pricing and interest accrual for the Basic Checking product. Uses simple
 ...
 * engine.
 */
public final class BasicCheckingPricingEngine {
    ...
    public BasicCheckingPricingEngine() {
        this(new BigDecimal("0.0005"));
    }

    public BasicCheckingPricingEngine(BigDecimal baseRate) {

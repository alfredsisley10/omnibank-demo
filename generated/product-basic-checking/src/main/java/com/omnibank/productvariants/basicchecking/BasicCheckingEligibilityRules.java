...
/**
 * Eligibility rule engine for the Basic Checking product. Evaluates age,
 ...
 */
public final class BasicCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Basic Checking",
                        Finding.Severity.BLOCKER));
            }

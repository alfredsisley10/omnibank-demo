...
/**
 * Regulation-mandated disclosure text for the Basic Checking product.
 ...
 */
public final class BasicCheckingDisclosure {

    public String title() {
        return "Basic Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Basic Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Basic Checking.",

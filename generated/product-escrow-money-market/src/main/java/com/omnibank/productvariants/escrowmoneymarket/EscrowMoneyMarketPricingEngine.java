...
/**
 * Pricing and interest accrual for the Escrow Money Market product. Uses simple
 ...
 * engine.
 */
public final class EscrowMoneyMarketPricingEngine {
    ...
    public EscrowMoneyMarketPricingEngine() {
        this(new BigDecimal("0.0350"));
    }

    public EscrowMoneyMarketPricingEngine(BigDecimal baseRate) {

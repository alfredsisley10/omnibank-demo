...
/**
 * Immutable descriptor for the Escrow Money Market product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record EscrowMoneyMarketProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static EscrowMoneyMarketProduct defaults() {
        return new EscrowMoneyMarketProduct(
                UUID.fromString("00000000-0000-0000-0000-54f4cb770000"),
                "MON-ESCROWMONEYMARKET",
                "Escrow Money Market",
                "MONEY_MARKET",
                "COMMERCIAL",
                "US",
    ...
    public EscrowMoneyMarketProduct {

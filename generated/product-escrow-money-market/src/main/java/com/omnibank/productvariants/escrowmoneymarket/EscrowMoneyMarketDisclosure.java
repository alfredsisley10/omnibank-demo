...
/**
 * Regulation-mandated disclosure text for the Escrow Money Market product.
 ...
 */
public final class EscrowMoneyMarketDisclosure {

    public String title() {
        return "Escrow Money Market — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $5000.00",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Escrow Money Market.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Escrow Money Market.",

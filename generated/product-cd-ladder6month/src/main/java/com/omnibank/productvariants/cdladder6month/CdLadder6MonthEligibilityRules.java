...
/**
 * Eligibility rule engine for the 6 Month CD product. Evaluates age,
 ...
 */
public final class CdLadder6MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening 6 Month CD",
                        Finding.Severity.BLOCKER));
            }

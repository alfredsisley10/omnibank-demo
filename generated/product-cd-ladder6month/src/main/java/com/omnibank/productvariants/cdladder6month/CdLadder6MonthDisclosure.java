...
/**
 * Regulation-mandated disclosure text for the 6 Month CD product.
 ...
 */
public final class CdLadder6MonthDisclosure {

    public String title() {
        return "6 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (45 <= 0) {
            return List.of("No early withdrawal penalty applies to the 6 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the 6 Month CD.",
                "Penalty equals interest on the amount withdrawn for 45 days.",

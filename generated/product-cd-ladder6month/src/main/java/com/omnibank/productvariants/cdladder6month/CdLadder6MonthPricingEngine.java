...
/**
 * Pricing and interest accrual for the 6 Month CD product. Uses simple
 ...
 * engine.
 */
public final class CdLadder6MonthPricingEngine {
    ...
    public CdLadder6MonthPricingEngine() {
        this(new BigDecimal("0.0400"));
    }

    public CdLadder6MonthPricingEngine(BigDecimal baseRate) {

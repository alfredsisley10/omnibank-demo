...
/**
 * Pricing and interest accrual for the Auto Down Payment Savings product. Uses simple
 ...
 * engine.
 */
public final class AutoDownPaymentSavingsPricingEngine {
    ...
    public AutoDownPaymentSavingsPricingEngine() {
        this(new BigDecimal("0.0175"));
    }

    public AutoDownPaymentSavingsPricingEngine(BigDecimal baseRate) {

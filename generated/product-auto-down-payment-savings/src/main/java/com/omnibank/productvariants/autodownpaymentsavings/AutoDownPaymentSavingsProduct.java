...
/**
 * Immutable descriptor for the Auto Down Payment Savings product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record AutoDownPaymentSavingsProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static AutoDownPaymentSavingsProduct defaults() {
        return new AutoDownPaymentSavingsProduct(
                UUID.fromString("00000000-0000-0000-0000-53dfdabc0000"),
                "SAV-AUTODOWNPAYMENTSAVINGS",
                "Auto Down Payment Savings",
                "SAVINGS",
                "ADULT",
                "US",
    ...
    public AutoDownPaymentSavingsProduct {

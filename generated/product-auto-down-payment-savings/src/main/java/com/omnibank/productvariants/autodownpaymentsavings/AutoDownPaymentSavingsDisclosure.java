...
/**
 * Regulation-mandated disclosure text for the Auto Down Payment Savings product.
 ...
 */
public final class AutoDownPaymentSavingsDisclosure {

    public String title() {
        return "Auto Down Payment Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Auto Down Payment Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Auto Down Payment Savings.",

...
/**
 * Pricing and interest accrual for the Commercial Money Market Sweep product. Uses simple
 ...
 * engine.
 */
public final class CommercialMoneyMarketPricingEngine {
    ...
    public CommercialMoneyMarketPricingEngine() {
        this(new BigDecimal("0.0400"));
    }

    public CommercialMoneyMarketPricingEngine(BigDecimal baseRate) {

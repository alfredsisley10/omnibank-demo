...
/**
 * Regulation-mandated disclosure text for the Commercial Money Market Sweep product.
 ...
 */
public final class CommercialMoneyMarketDisclosure {

    public String title() {
        return "Commercial Money Market Sweep — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $25000.00",
                "Minimum daily balance to avoid fee: see fee schedule",
                "Monthly maintenance fee: $15.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Commercial Money Market Sweep.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Commercial Money Market Sweep.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $100000.00 or more",

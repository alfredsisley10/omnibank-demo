...
/**
 * Eligibility rule engine for the Commercial Money Market Sweep product. Evaluates age,
 ...
 */
public final class CommercialMoneyMarketEligibilityRules {
    ...
    public Assessment evaluate(Applicant applicant, LocalDate asOf) {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Commercial Money Market Sweep",
                        Finding.Severity.BLOCKER));
            }
        ...
        String expectedSegment = "COMMERCIAL";

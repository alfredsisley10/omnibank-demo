...
/**
 * Immutable descriptor for the High-Yield Online Savings product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record HighYieldSavingsProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static HighYieldSavingsProduct defaults() {
        return new HighYieldSavingsProduct(
                UUID.fromString("00000000-0000-0000-0000-24b50f4e0000"),
                "SAV-HIGHYIELDSAVINGS",
    ...
    public HighYieldSavingsProduct {

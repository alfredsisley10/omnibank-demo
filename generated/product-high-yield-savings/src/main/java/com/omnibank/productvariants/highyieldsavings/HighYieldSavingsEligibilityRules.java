...
/**
 * Eligibility rule engine for the High-Yield Online Savings product. Evaluates age,
 ...
 */
public final class HighYieldSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening High-Yield Online Savings",
                        Finding.Severity.BLOCKER));
            }

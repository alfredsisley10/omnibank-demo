...
/**
 * Regulation-mandated disclosure text for the High-Yield Online Savings product.
 ...
 */
public final class HighYieldSavingsDisclosure {

    public String title() {
        return "High-Yield Online Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the High-Yield Online Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the High-Yield Online Savings.",

...
/**
 * Pricing and interest accrual for the High-Yield Online Savings product. Uses simple
 ...
 * engine.
 */
public final class HighYieldSavingsPricingEngine {
    ...
    public HighYieldSavingsPricingEngine() {
        this(new BigDecimal("0.0485"));
    }

    public HighYieldSavingsPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Trust Managed Savings product. Evaluates age,
 ...
 */
public final class TrustManagedSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Trust Managed Savings",
                        Finding.Severity.BLOCKER));
            }

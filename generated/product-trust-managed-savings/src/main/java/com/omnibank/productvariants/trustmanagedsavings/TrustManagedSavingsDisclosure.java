...
/**
 * Regulation-mandated disclosure text for the Trust Managed Savings product.
 ...
 */
public final class TrustManagedSavingsDisclosure {

    public String title() {
        return "Trust Managed Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $50000.00",
                "Minimum daily balance to avoid fee: see fee schedule",
                "Monthly maintenance fee: $25.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Trust Managed Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Trust Managed Savings.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $250000.00 or more",

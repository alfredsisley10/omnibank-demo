...
/**
 * Pricing and interest accrual for the Trust Managed Savings product. Uses simple
 ...
 * engine.
 */
public final class TrustManagedSavingsPricingEngine {
    ...
    public TrustManagedSavingsPricingEngine() {
        this(new BigDecimal("0.0275"));
    }

    public TrustManagedSavingsPricingEngine(BigDecimal baseRate) {

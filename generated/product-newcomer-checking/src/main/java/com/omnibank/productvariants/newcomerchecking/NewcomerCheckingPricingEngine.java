...
/**
 * Pricing and interest accrual for the Newcomer to US Checking product. Uses simple
 ...
 * engine.
 */
public final class NewcomerCheckingPricingEngine {
    ...
    public NewcomerCheckingPricingEngine() {
        this(new BigDecimal("0.0050"));
    }

    public NewcomerCheckingPricingEngine(BigDecimal baseRate) {

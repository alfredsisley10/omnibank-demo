...
/**
 * Regulation-mandated disclosure text for the Newcomer to US Checking product.
 ...
 */
public final class NewcomerCheckingDisclosure {

    public String title() {
        return "Newcomer to US Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Newcomer to US Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Newcomer to US Checking.",

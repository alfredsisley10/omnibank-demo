...
/**
 * Eligibility rule engine for the Small Business Checking product. Evaluates age,
 ...
 */
public final class SmallBizCheckingEligibilityRules {
    ...
    public Assessment evaluate(Applicant applicant, LocalDate asOf) {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Small Business Checking",
                        Finding.Severity.BLOCKER));
            }
        ...
        String expectedSegment = "SMALL_BUSINESS";

...
/**
 * Pricing and interest accrual for the Small Business Checking product. Uses simple
 ...
 * engine.
 */
public final class SmallBizCheckingPricingEngine {
    ...
    public SmallBizCheckingPricingEngine() {
        this(new BigDecimal("0.0025"));
    }

    public SmallBizCheckingPricingEngine(BigDecimal baseRate) {

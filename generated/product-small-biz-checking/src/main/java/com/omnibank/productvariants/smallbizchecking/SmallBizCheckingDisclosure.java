...
/**
 * Regulation-mandated disclosure text for the Small Business Checking product.
 ...
 */
public final class SmallBizCheckingDisclosure {

    public String title() {
        return "Small Business Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Small Business Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Small Business Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $3000.00 or more",

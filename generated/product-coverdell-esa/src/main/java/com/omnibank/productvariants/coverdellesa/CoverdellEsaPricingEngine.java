...
/**
 * Pricing and interest accrual for the Coverdell Education Savings product. Uses simple
 ...
 * engine.
 */
public final class CoverdellEsaPricingEngine {
    ...
    public CoverdellEsaPricingEngine() {
        this(new BigDecimal("0.0300"));
    }

    public CoverdellEsaPricingEngine(BigDecimal baseRate) {

...
/**
 * Regulation-mandated disclosure text for the Coverdell Education Savings product.
 ...
 */
public final class CoverdellEsaDisclosure {

    public String title() {
        return "Coverdell Education Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Coverdell Education Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Coverdell Education Savings.",

...
/**
 * Eligibility rule engine for the Spanish-Language Basic Checking product. Evaluates age,
 ...
 */
public final class SpanishLanguageCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Spanish-Language Basic Checking",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Regulation-mandated disclosure text for the Spanish-Language Basic Checking product.
 ...
 */
public final class SpanishLanguageCheckingDisclosure {

    public String title() {
        return "Spanish-Language Basic Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Monthly maintenance fee: $10.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Spanish-Language Basic Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Spanish-Language Basic Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $1500.00 or more",

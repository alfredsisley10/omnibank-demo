...
/**
 * Pricing and interest accrual for the Spanish-Language Basic Checking product. Uses simple
 ...
 * engine.
 */
public final class SpanishLanguageCheckingPricingEngine {
    ...
    public SpanishLanguageCheckingPricingEngine() {
        this(new BigDecimal("0.0025"));
    }

    public SpanishLanguageCheckingPricingEngine(BigDecimal baseRate) {

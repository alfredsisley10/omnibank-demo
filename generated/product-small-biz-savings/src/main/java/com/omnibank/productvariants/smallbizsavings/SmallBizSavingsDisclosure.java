...
/**
 * Regulation-mandated disclosure text for the Small Business Savings product.
 ...
 */
public final class SmallBizSavingsDisclosure {

    public String title() {
        return "Small Business Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $250.00",
                "Minimum daily balance to avoid fee: see fee schedule",
                "Monthly maintenance fee: $5.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Small Business Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Small Business Savings.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $1000.00 or more",

...
/**
 * Pricing and interest accrual for the Small Business Savings product. Uses simple
 ...
 * engine.
 */
public final class SmallBizSavingsPricingEngine {
    ...
    public SmallBizSavingsPricingEngine() {
        this(new BigDecimal("0.0150"));
    }

    public SmallBizSavingsPricingEngine(BigDecimal baseRate) {

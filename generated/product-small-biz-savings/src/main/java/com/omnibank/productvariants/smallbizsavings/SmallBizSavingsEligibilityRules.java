...
/**
 * Eligibility rule engine for the Small Business Savings product. Evaluates age,
 ...
 */
public final class SmallBizSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Small Business Savings",
                        Finding.Severity.BLOCKER));
            }

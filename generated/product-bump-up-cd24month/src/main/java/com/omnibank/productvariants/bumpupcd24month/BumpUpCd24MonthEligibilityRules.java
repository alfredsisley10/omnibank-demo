...
/**
 * Eligibility rule engine for the Bump-Up 24 Month CD product. Evaluates age,
 ...
 */
public final class BumpUpCd24MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Bump-Up 24 Month CD",
                        Finding.Severity.BLOCKER));
            }

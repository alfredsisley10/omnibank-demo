...
/**
 * Pricing and interest accrual for the Bump-Up 24 Month CD product. Uses simple
 ...
 * engine.
 */
public final class BumpUpCd24MonthPricingEngine {
    ...
    public BumpUpCd24MonthPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public BumpUpCd24MonthPricingEngine(BigDecimal baseRate) {

...
/**
 * Regulation-mandated disclosure text for the Bump-Up 24 Month CD product.
 ...
 */
public final class BumpUpCd24MonthDisclosure {

    public String title() {
        return "Bump-Up 24 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $2500.00",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (180 <= 0) {
            return List.of("No early withdrawal penalty applies to the Bump-Up 24 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Bump-Up 24 Month CD.",

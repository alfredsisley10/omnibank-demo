...
/**
 * Regulation-mandated disclosure text for the Prestige Private Client Checking product.
 ...
 */
public final class PrestigeCheckingDisclosure {

    public String title() {
        return "Prestige Private Client Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Prestige Private Client Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Prestige Private Client Checking.",

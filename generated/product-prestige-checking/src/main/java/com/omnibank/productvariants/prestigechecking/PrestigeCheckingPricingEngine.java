...
/**
 * Pricing and interest accrual for the Prestige Private Client Checking product. Uses simple
 ...
 * engine.
 */
public final class PrestigeCheckingPricingEngine {
    ...
    public PrestigeCheckingPricingEngine() {
        this(new BigDecimal("0.0125"));
    }

    public PrestigeCheckingPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Prestige Private Client Checking product. Evaluates age,
 ...
 */
public final class PrestigeCheckingEligibilityRules {
    ...
    public Assessment evaluate(Applicant applicant, LocalDate asOf) {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Prestige Private Client Checking",
                        Finding.Severity.BLOCKER));
            }
        ...
        String expectedSegment = "HIGH_NET_WORTH";

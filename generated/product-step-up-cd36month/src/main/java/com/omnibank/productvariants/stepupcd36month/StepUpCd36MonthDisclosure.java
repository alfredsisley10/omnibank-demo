...
/**
 * Regulation-mandated disclosure text for the Step-Up 36 Month CD product.
 ...
 */
public final class StepUpCd36MonthDisclosure {

    public String title() {
        return "Step-Up 36 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (270 <= 0) {
            return List.of("No early withdrawal penalty applies to the Step-Up 36 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Step-Up 36 Month CD.",
                "Penalty equals interest on the amount withdrawn for 270 days.",

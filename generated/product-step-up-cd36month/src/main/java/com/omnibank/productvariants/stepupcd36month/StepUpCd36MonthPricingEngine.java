...
/**
 * Pricing and interest accrual for the Step-Up 36 Month CD product. Uses simple
 ...
 * engine.
 */
public final class StepUpCd36MonthPricingEngine {
    ...
    public StepUpCd36MonthPricingEngine() {
        this(new BigDecimal("0.0400"));
    }

    public StepUpCd36MonthPricingEngine(BigDecimal baseRate) {

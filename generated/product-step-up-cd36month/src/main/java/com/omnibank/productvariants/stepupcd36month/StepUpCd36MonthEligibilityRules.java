...
/**
 * Eligibility rule engine for the Step-Up 36 Month CD product. Evaluates age,
 ...
 */
public final class StepUpCd36MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Step-Up 36 Month CD",
                        Finding.Severity.BLOCKER));
            }

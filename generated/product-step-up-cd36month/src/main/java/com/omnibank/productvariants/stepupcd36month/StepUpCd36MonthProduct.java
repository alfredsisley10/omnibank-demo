...
/**
 * Immutable descriptor for the Step-Up 36 Month CD product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record StepUpCd36MonthProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static StepUpCd36MonthProduct defaults() {
        return new StepUpCd36MonthProduct(
                UUID.fromString("00000000-0000-0000-0000-718f288b0000"),
                "CER-STEPUPCD36MONTH",
                "Step-Up 36 Month CD",
                "CERTIFICATE",
                "ADULT",

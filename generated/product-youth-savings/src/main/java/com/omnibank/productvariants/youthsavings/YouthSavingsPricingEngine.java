...
/**
 * Pricing and interest accrual for the Youth Savings product. Uses simple
 ...
 * engine.
 */
public final class YouthSavingsPricingEngine {
    ...
    public YouthSavingsPricingEngine() {
        this(new BigDecimal("0.0200"));
    }

    public YouthSavingsPricingEngine(BigDecimal baseRate) {

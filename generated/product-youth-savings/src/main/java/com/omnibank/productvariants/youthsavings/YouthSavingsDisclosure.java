...
/**
 * Regulation-mandated disclosure text for the Youth Savings product.
 ...
 */
public final class YouthSavingsDisclosure {

    public String title() {
        return "Youth Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Youth Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Youth Savings.",

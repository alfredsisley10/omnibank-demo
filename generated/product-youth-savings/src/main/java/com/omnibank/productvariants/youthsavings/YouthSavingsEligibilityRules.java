...
/**
 * Eligibility rule engine for the Youth Savings product. Evaluates age,
 ...
 */
public final class YouthSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Youth Savings",
                        Finding.Severity.BLOCKER));
            }

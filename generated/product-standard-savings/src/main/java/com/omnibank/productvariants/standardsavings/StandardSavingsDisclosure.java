...
/**
 * Regulation-mandated disclosure text for the Standard Savings product.
 ...
 */
public final class StandardSavingsDisclosure {

    public String title() {
        return "Standard Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Monthly maintenance fee: $3.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Standard Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Standard Savings.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $300.00 or more",

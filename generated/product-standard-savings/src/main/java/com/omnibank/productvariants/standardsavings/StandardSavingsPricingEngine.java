...
/**
 * Pricing and interest accrual for the Standard Savings product. Uses simple
 ...
 * engine.
 */
public final class StandardSavingsPricingEngine {
    ...
    public StandardSavingsPricingEngine() {
        this(new BigDecimal("0.0050"));
    }

    public StandardSavingsPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Roth IRA product. Evaluates age,
 ...
 */
public final class RothIraEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Roth IRA",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Pricing and interest accrual for the Roth IRA product. Uses simple
 ...
 * engine.
 */
public final class RothIraPricingEngine {
    ...
    public RothIraPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public RothIraPricingEngine(BigDecimal baseRate) {

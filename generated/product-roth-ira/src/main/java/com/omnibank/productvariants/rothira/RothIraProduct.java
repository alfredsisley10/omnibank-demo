...
public record RothIraProduct(
    ...
    public static RothIraProduct defaults() {
        return new RothIraProduct(
                UUID.fromString("00000000-0000-0000-0000-4a440af90000"),
                "RET-ROTHIRA",
                "Roth IRA",
                "RETIREMENT",
                "ADULT",

...
/**
 * Eligibility rule engine for the Inherited IRA product. Evaluates age,
 ...
 */
public final class InheritedIraEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Inherited IRA",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Immutable descriptor for the Inherited IRA product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record InheritedIraProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static InheritedIraProduct defaults() {
        return new InheritedIraProduct(
                UUID.fromString("00000000-0000-0000-0000-56d8fcc20000"),
                "RET-INHERITEDIRA",
                "Inherited IRA",
                "RETIREMENT",
                "ADULT",

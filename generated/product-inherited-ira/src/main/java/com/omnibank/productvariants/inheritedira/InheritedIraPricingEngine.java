...
/**
 * Pricing and interest accrual for the Inherited IRA product. Uses simple
 ...
 * engine.
 */
public final class InheritedIraPricingEngine {
    ...
    public InheritedIraPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public InheritedIraPricingEngine(BigDecimal baseRate) {

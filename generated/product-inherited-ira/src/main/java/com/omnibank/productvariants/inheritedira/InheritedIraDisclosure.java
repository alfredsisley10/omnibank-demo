...
/**
 * Regulation-mandated disclosure text for the Inherited IRA product.
 ...
 */
public final class InheritedIraDisclosure {

    public String title() {
        return "Inherited IRA — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Inherited IRA.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Inherited IRA.",

...
/**
 * Eligibility rule engine for the HSA Money Market product. Evaluates age,
 ...
 */
public final class HsaMoneyMarketEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening HSA Money Market",
                        Finding.Severity.BLOCKER));
            }

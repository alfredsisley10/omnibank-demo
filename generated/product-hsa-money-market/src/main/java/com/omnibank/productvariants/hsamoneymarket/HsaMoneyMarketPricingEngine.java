...
/**
 * Pricing and interest accrual for the HSA Money Market product. Uses simple
 ...
 * engine.
 */
public final class HsaMoneyMarketPricingEngine {
    ...
    public HsaMoneyMarketPricingEngine() {
        this(new BigDecimal("0.0245"));
    }

    public HsaMoneyMarketPricingEngine(BigDecimal baseRate) {

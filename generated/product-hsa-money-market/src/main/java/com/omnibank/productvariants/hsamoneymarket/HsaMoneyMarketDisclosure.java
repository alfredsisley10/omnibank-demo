...
/**
 * Regulation-mandated disclosure text for the HSA Money Market product.
 ...
 */
public final class HsaMoneyMarketDisclosure {

    public String title() {
        return "HSA Money Market — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Monthly maintenance fee: $3.50 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the HSA Money Market.");
        }
        return List.of(
                "An early withdrawal penalty applies to the HSA Money Market.",
    ...
    public List<String> feeSummary() {
        return List.of(
                "Monthly maintenance: $3.50",
                "Waived with qualifying daily balance of $5000.00 or more",

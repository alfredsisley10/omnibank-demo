...
/**
 * Eligibility rule engine for the SIMPLE IRA product. Evaluates age,
 ...
 */
public final class SimpleIraEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening SIMPLE IRA",
                        Finding.Severity.BLOCKER));
            }

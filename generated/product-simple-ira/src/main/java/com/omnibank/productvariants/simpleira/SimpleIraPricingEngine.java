...
/**
 * Pricing and interest accrual for the SIMPLE IRA product. Uses simple
 ...
 * engine.
 */
public final class SimpleIraPricingEngine {
    ...
    public SimpleIraPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public SimpleIraPricingEngine(BigDecimal baseRate) {

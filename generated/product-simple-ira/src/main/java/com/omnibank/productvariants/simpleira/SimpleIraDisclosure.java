...
/**
 * Regulation-mandated disclosure text for the SIMPLE IRA product.
 ...
 */
public final class SimpleIraDisclosure {

    public String title() {
        return "SIMPLE IRA — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the SIMPLE IRA.");
        }
        return List.of(
                "An early withdrawal penalty applies to the SIMPLE IRA.",

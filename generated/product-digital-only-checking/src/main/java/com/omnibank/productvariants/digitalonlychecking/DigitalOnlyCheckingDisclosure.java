...
/**
 * Regulation-mandated disclosure text for the Digital-Only Checking product.
 ...
 */
public final class DigitalOnlyCheckingDisclosure {

    public String title() {
        return "Digital-Only Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Digital-Only Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Digital-Only Checking.",

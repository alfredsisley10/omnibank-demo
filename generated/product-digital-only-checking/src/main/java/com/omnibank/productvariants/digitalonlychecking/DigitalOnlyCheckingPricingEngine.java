...
/**
 * Pricing and interest accrual for the Digital-Only Checking product. Uses simple
 ...
 * engine.
 */
public final class DigitalOnlyCheckingPricingEngine {
    ...
    public DigitalOnlyCheckingPricingEngine() {
        this(new BigDecimal("0.0075"));
    }

    public DigitalOnlyCheckingPricingEngine(BigDecimal baseRate) {

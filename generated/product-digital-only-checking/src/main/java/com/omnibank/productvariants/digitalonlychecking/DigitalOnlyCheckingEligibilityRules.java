...
/**
 * Eligibility rule engine for the Digital-Only Checking product. Evaluates age,
 ...
 */
public final class DigitalOnlyCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Digital-Only Checking",
                        Finding.Severity.BLOCKER));
            }

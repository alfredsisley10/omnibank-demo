...
/**
 * Eligibility rule engine for the Emergency Fund Savings product. Evaluates age,
 ...
 */
public final class EmergencyFundSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Emergency Fund Savings",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Regulation-mandated disclosure text for the Emergency Fund Savings product.
 ...
 */
public final class EmergencyFundSavingsDisclosure {

    public String title() {
        return "Emergency Fund Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Emergency Fund Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Emergency Fund Savings.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $500.00 or more",

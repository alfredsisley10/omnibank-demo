...
/**
 * Pricing and interest accrual for the Emergency Fund Savings product. Uses simple
 ...
 * engine.
 */
public final class EmergencyFundSavingsPricingEngine {
    ...
    public EmergencyFundSavingsPricingEngine() {
        this(new BigDecimal("0.0325"));
    }

    public EmergencyFundSavingsPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Veteran Rewards Checking product. Evaluates age,
 ...
 */
public final class VeteranCheckingEligibilityRules {
    ...
    public Assessment evaluate(Applicant applicant, LocalDate asOf) {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Veteran Rewards Checking",
                        Finding.Severity.BLOCKER));
            }
        ...
        String expectedSegment = "VETERAN";

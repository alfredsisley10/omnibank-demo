...
/**
 * Immutable descriptor for the Veteran Rewards Checking product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record VeteranCheckingProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static VeteranCheckingProduct defaults() {
        return new VeteranCheckingProduct(
                UUID.fromString("00000000-0000-0000-0000-5b3431990000"),
                "CHE-VETERANCHECKING",
                "Veteran Rewards Checking",
                "CHECKING",
                "VETERAN",
                "US",

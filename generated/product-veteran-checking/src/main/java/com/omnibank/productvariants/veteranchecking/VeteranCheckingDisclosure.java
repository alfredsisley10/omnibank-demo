...
/**
 * Regulation-mandated disclosure text for the Veteran Rewards Checking product.
 ...
 */
public final class VeteranCheckingDisclosure {

    public String title() {
        return "Veteran Rewards Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Veteran Rewards Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Veteran Rewards Checking.",

...
/**
 * Pricing and interest accrual for the Veteran Rewards Checking product. Uses simple
 ...
 * engine.
 */
public final class VeteranCheckingPricingEngine {
    ...
    public VeteranCheckingPricingEngine() {
        this(new BigDecimal("0.0050"));
    }

    public VeteranCheckingPricingEngine(BigDecimal baseRate) {

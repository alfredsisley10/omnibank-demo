...
/**
 * Immutable descriptor for the Rewards Checking product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record RewardsCheckingProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static RewardsCheckingProduct defaults() {
        return new RewardsCheckingProduct(
                UUID.fromString("00000000-0000-0000-0000-62bb84fe0000"),
                "CHE-REWARDSCHECKING",
                "Rewards Checking",
                "CHECKING",
                "ADULT",

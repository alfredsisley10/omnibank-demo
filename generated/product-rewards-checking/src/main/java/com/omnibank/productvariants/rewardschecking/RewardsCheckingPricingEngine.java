...
/**
 * Pricing and interest accrual for the Rewards Checking product. Uses simple
 ...
 * engine.
 */
public final class RewardsCheckingPricingEngine {
    ...
    public RewardsCheckingPricingEngine() {
        this(new BigDecimal("0.0075"));
    }

    public RewardsCheckingPricingEngine(BigDecimal baseRate) {

...
/**
 * Regulation-mandated disclosure text for the Rewards Checking product.
 ...
 */
public final class RewardsCheckingDisclosure {

    public String title() {
        return "Rewards Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Rewards Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Rewards Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $10000.00 or more",

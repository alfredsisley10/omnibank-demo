...
/**
 * Eligibility rule engine for the Rewards Checking product. Evaluates age,
 ...
 */
public final class RewardsCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Rewards Checking",
                        Finding.Severity.BLOCKER));
            }

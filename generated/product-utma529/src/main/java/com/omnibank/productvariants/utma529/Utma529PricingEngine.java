...
/**
 * Pricing and interest accrual for the UTMA 529 Plan product. Uses simple
 ...
 * engine.
 */
public final class Utma529PricingEngine {
    ...
    public Utma529PricingEngine() {
        this(new BigDecimal("0.0350"));
    }

    public Utma529PricingEngine(BigDecimal baseRate) {

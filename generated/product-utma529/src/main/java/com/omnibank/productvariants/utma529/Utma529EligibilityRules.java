...
/**
 * Eligibility rule engine for the UTMA 529 Plan product. Evaluates age,
 ...
 */
public final class Utma529EligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening UTMA 529 Plan",
                        Finding.Severity.BLOCKER));
            }

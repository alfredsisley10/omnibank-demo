...
/**
 * Regulation-mandated disclosure text for the UTMA 529 Plan product.
 ...
 */
public final class Utma529Disclosure {

    public String title() {
        return "UTMA 529 Plan — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the UTMA 529 Plan.");
        }
        return List.of(
                "An early withdrawal penalty applies to the UTMA 529 Plan.",

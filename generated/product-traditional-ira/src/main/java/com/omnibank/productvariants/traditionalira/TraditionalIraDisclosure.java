...
/**
 * Regulation-mandated disclosure text for the Traditional IRA product.
 ...
 */
public final class TraditionalIraDisclosure {

    public String title() {
        return "Traditional IRA — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Traditional IRA.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Traditional IRA.",

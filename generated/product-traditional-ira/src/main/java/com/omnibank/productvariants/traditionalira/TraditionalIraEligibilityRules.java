...
/**
 * Eligibility rule engine for the Traditional IRA product. Evaluates age,
 ...
 */
public final class TraditionalIraEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Traditional IRA",
                        Finding.Severity.BLOCKER));
            }

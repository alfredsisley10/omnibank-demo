...
/**
 * Pricing and interest accrual for the Traditional IRA product. Uses simple
 ...
 * engine.
 */
public final class TraditionalIraPricingEngine {
    ...
    public TraditionalIraPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public TraditionalIraPricingEngine(BigDecimal baseRate) {

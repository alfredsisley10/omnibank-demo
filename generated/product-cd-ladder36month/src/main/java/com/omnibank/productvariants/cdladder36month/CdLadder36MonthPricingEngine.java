...
/**
 * Pricing and interest accrual for the 36 Month CD product. Uses simple
 ...
 * engine.
 */
public final class CdLadder36MonthPricingEngine {
    ...
    public CdLadder36MonthPricingEngine() {
        this(new BigDecimal("0.0475"));
    }

    public CdLadder36MonthPricingEngine(BigDecimal baseRate) {

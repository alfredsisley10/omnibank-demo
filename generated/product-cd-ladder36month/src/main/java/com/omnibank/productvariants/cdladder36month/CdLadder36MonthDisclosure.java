...
/**
 * Regulation-mandated disclosure text for the 36 Month CD product.
 ...
 */
public final class CdLadder36MonthDisclosure {

    public String title() {
        return "36 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (270 <= 0) {
            return List.of("No early withdrawal penalty applies to the 36 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the 36 Month CD.",

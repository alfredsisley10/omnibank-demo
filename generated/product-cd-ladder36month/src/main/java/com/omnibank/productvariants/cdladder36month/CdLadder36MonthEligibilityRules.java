...
/**
 * Eligibility rule engine for the 36 Month CD product. Evaluates age,
 ...
 */
public final class CdLadder36MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening 36 Month CD",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Eligibility rule engine for the No-Penalty 11 Month CD product. Evaluates age,
 ...
 */
public final class NoPenaltyCd11MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening No-Penalty 11 Month CD",
                        Finding.Severity.BLOCKER));
            }

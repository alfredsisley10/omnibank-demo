...
/**
 * Pricing and interest accrual for the No-Penalty 11 Month CD product. Uses simple
 ...
 * engine.
 */
public final class NoPenaltyCd11MonthPricingEngine {
    ...
    public NoPenaltyCd11MonthPricingEngine() {
        this(new BigDecimal("0.0350"));
    }

    public NoPenaltyCd11MonthPricingEngine(BigDecimal baseRate) {

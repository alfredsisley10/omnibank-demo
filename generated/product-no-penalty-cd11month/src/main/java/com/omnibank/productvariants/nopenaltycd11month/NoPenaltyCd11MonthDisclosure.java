...
/**
 * Regulation-mandated disclosure text for the No-Penalty 11 Month CD product.
 ...
 */
public final class NoPenaltyCd11MonthDisclosure {

    public String title() {
        return "No-Penalty 11 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the No-Penalty 11 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the No-Penalty 11 Month CD.",

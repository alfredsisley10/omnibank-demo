...
/**
 * Regulation-mandated disclosure text for the First Home Savings Program product.
 ...
 */
public final class FirstHomeSavingsDisclosure {

    public String title() {
        return "First Home Savings Program — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the First Home Savings Program.");
        }
        return List.of(
                "An early withdrawal penalty applies to the First Home Savings Program.",

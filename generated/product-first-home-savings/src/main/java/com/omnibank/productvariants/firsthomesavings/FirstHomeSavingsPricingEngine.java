...
/**
 * Pricing and interest accrual for the First Home Savings Program product. Uses simple
 ...
 * engine.
 */
public final class FirstHomeSavingsPricingEngine {
    ...
    public FirstHomeSavingsPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public FirstHomeSavingsPricingEngine(BigDecimal baseRate) {

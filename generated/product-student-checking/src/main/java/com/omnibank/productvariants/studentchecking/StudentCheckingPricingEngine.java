...
/**
 * Pricing and interest accrual for the Student Checking product. Uses simple
 ...
 * engine.
 */
public final class StudentCheckingPricingEngine {
    ...
    public StudentCheckingPricingEngine() {
        this(new BigDecimal("0.0010"));
    }

    public StudentCheckingPricingEngine(BigDecimal baseRate) {

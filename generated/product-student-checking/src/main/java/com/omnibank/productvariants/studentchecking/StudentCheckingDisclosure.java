...
/**
 * Regulation-mandated disclosure text for the Student Checking product.
 ...
 */
public final class StudentCheckingDisclosure {

    public String title() {
        return "Student Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Student Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Student Checking.",

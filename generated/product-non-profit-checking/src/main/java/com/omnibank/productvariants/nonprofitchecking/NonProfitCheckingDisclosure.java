...
/**
 * Regulation-mandated disclosure text for the Non-Profit Business Checking product.
 ...
 */
public final class NonProfitCheckingDisclosure {

    public String title() {
        return "Non-Profit Business Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Monthly maintenance fee: $8.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Non-Profit Business Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Non-Profit Business Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $2500.00 or more",

...
/**
 * Pricing and interest accrual for the Non-Profit Business Checking product. Uses simple
 ...
 * engine.
 */
public final class NonProfitCheckingPricingEngine {
    ...
    public NonProfitCheckingPricingEngine() {
        this(new BigDecimal("0.0025"));
    }

    public NonProfitCheckingPricingEngine(BigDecimal baseRate) {

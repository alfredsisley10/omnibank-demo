...
/**
 * Eligibility rule engine for the Non-Profit Business Checking product. Evaluates age,
 ...
 */
public final class NonProfitCheckingEligibilityRules {
    ...
    public Assessment evaluate(Applicant applicant, LocalDate asOf) {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Non-Profit Business Checking",
                        Finding.Severity.BLOCKER));
            }
        ...
        String expectedSegment = "BUSINESS";

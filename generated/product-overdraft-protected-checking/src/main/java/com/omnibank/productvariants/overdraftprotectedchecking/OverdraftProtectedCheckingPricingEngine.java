...
/**
 * Pricing and interest accrual for the Overdraft-Protected Checking product. Uses simple
 ...
 * engine.
 */
public final class OverdraftProtectedCheckingPricingEngine {
    ...
    public OverdraftProtectedCheckingPricingEngine() {
        this(new BigDecimal("0.0010"));
    }

    public OverdraftProtectedCheckingPricingEngine(BigDecimal baseRate) {

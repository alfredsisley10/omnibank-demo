...
/**
 * Regulation-mandated disclosure text for the Overdraft-Protected Checking product.
 ...
 */
public final class OverdraftProtectedCheckingDisclosure {

    public String title() {
        return "Overdraft-Protected Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Monthly maintenance fee: $12.00 (may be waived based on balance)",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Overdraft-Protected Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Overdraft-Protected Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $2000.00 or more",

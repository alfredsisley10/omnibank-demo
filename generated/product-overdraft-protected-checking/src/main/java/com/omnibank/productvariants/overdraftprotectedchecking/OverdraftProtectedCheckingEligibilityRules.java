...
/**
 * Eligibility rule engine for the Overdraft-Protected Checking product. Evaluates age,
 ...
 */
public final class OverdraftProtectedCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Overdraft-Protected Checking",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Pricing and interest accrual for the Senior 60+ Checking product. Uses simple
 ...
 * engine.
 */
public final class SeniorCheckingPricingEngine {
    ...
    public SeniorCheckingPricingEngine() {
        this(new BigDecimal("0.0015"));
    }

    public SeniorCheckingPricingEngine(BigDecimal baseRate) {

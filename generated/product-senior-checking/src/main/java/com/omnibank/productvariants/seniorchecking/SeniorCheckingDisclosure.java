...
/**
 * Regulation-mandated disclosure text for the Senior 60+ Checking product.
 ...
 */
public final class SeniorCheckingDisclosure {

    public String title() {
        return "Senior 60+ Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Senior 60+ Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Senior 60+ Checking.",

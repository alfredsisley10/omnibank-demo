...
/**
 * Regulation-mandated disclosure text for the Commercial Checking product.
 ...
 */
public final class CommercialCheckingDisclosure {

    public String title() {
        return "Commercial Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $1000.00",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Commercial Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Commercial Checking.",
    ...
    public List<String> feeSummary() {
        return List.of(
                ...
                "Waived with qualifying daily balance of $25000.00 or more",

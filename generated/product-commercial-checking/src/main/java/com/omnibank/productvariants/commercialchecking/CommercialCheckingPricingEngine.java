...
/**
 * Pricing and interest accrual for the Commercial Checking product. Uses simple
 ...
 * engine.
 */
public final class CommercialCheckingPricingEngine {
    ...
    public CommercialCheckingPricingEngine() {
        this(new BigDecimal("0.0015"));
    }

    public CommercialCheckingPricingEngine(BigDecimal baseRate) {

...
/**
 * Regulation-mandated disclosure text for the Vacation Club Savings product.
 ...
 */
public final class VacationClubDisclosure {

    public String title() {
        return "Vacation Club Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (180 <= 0) {
            return List.of("No early withdrawal penalty applies to the Vacation Club Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Vacation Club Savings.",

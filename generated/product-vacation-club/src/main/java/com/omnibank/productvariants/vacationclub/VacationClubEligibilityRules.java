...
/**
 * Eligibility rule engine for the Vacation Club Savings product. Evaluates age,
 ...
 */
public final class VacationClubEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Vacation Club Savings",
                        Finding.Severity.BLOCKER));
            }

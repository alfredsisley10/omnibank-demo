...
/**
 * Pricing and interest accrual for the Vacation Club Savings product. Uses simple
 ...
 * engine.
 */
public final class VacationClubPricingEngine {
    ...
    public VacationClubPricingEngine() {
        this(new BigDecimal("0.0125"));
    }

    public VacationClubPricingEngine(BigDecimal baseRate) {

...
/**
 * Pricing and interest accrual for the Market-Indexed 24 Month CD product. Uses simple
 ...
 * engine.
 */
public final class IndexedCd24MonthPricingEngine {
    ...
    public IndexedCd24MonthPricingEngine() {
        this(new BigDecimal("0.0350"));
    }

    public IndexedCd24MonthPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Market-Indexed 24 Month CD product. Evaluates age,
 ...
 */
public final class IndexedCd24MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Market-Indexed 24 Month CD",
                        Finding.Severity.BLOCKER));
            }

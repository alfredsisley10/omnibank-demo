...
/**
 * Regulation-mandated disclosure text for the Market-Indexed 24 Month CD product.
 ...
 */
public final class IndexedCd24MonthDisclosure {

    public String title() {
        return "Market-Indexed 24 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> keyTerms() {
        return List.of(
                ...
                "Minimum balance to open the account: $10000.00",
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (180 <= 0) {
            return List.of("No early withdrawal penalty applies to the Market-Indexed 24 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Market-Indexed 24 Month CD.",
                "Penalty equals interest on the amount withdrawn for 180 days.",

...
/**
 * Pricing and interest accrual for the 60 Month CD product. Uses simple
 ...
 * engine.
 */
public final class CdLadder60MonthPricingEngine {
    ...
    public CdLadder60MonthPricingEngine() {
        this(new BigDecimal("0.0510"));
    }

    public CdLadder60MonthPricingEngine(BigDecimal baseRate) {

...
/**
 * Regulation-mandated disclosure text for the 60 Month CD product.
 ...
 */
public final class CdLadder60MonthDisclosure {

    public String title() {
        return "60 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (365 <= 0) {
            return List.of("No early withdrawal penalty applies to the 60 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the 60 Month CD.",
                "Penalty equals interest on the amount withdrawn for 365 days.",

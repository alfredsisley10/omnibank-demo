...
/**
 * Regulation-mandated disclosure text for the Essential Checking product.
 ...
 */
public final class EssentialCheckingDisclosure {

    public String title() {
        return "Essential Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Essential Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Essential Checking.",

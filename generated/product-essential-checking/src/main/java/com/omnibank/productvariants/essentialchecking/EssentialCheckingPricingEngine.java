...
/**
 * Pricing and interest accrual for the Essential Checking product. Uses simple
 ...
 * engine.
 */
public final class EssentialCheckingPricingEngine {
    ...
    public EssentialCheckingPricingEngine() {
        this(new BigDecimal("0.0010"));
    }

    public EssentialCheckingPricingEngine(BigDecimal baseRate) {

...
/**
 * Immutable descriptor for the Essential Checking product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record EssentialCheckingProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static EssentialCheckingProduct defaults() {
        return new EssentialCheckingProduct(
                UUID.fromString("00000000-0000-0000-0000-13221f280000"),
                "CHE-ESSENTIALCHECKING",
                "Essential Checking",
                "CHECKING",
                "ADULT",
                "US",
    ...
    public EssentialCheckingProduct {

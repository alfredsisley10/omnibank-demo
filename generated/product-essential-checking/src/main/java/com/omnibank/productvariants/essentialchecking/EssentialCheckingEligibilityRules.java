...
/**
 * Eligibility rule engine for the Essential Checking product. Evaluates age,
 ...
 */
public final class EssentialCheckingEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Essential Checking",
                        Finding.Severity.BLOCKER));
            }

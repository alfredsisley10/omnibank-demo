...
/**
 * Regulation-mandated disclosure text for the Teen Checking product.
 ...
 */
public final class TeenCheckingDisclosure {

    public String title() {
        return "Teen Checking — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Teen Checking.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Teen Checking.",

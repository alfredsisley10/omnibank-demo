...
/**
 * Immutable descriptor for the Teen Checking product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record TeenCheckingProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static TeenCheckingProduct defaults() {
        return new TeenCheckingProduct(
                UUID.fromString("00000000-0000-0000-0000-45a4490c0000"),
                "CHE-TEENCHECKING",
                "Teen Checking",
                "CHECKING",
                "MINOR",

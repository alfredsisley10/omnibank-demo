...
/**
 * Eligibility rule engine for the Commercial 90-Day CD product. Evaluates age,
 ...
 */
public final class CommercialCd90DayEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Commercial 90-Day CD",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Pricing and interest accrual for the Commercial 90-Day CD product. Uses simple
 ...
 * engine.
 */
public final class CommercialCd90DayPricingEngine {
    ...
    public CommercialCd90DayPricingEngine() {
        this(new BigDecimal("0.0400"));
    }

    public CommercialCd90DayPricingEngine(BigDecimal baseRate) {

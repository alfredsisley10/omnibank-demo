...
/**
 * Regulation-mandated disclosure text for the Commercial 90-Day CD product.
 ...
 */
public final class CommercialCd90DayDisclosure {

    public String title() {
        return "Commercial 90-Day CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (30 <= 0) {
            return List.of("No early withdrawal penalty applies to the Commercial 90-Day CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Commercial 90-Day CD.",
                "Penalty equals interest on the amount withdrawn for 30 days.",

...
/**
 * Pricing and interest accrual for the Home Down Payment Savings product. Uses simple
 ...
 * engine.
 */
public final class HomeDownPaymentSavingsPricingEngine {
    ...
    public HomeDownPaymentSavingsPricingEngine() {
        this(new BigDecimal("0.0225"));
    }

    public HomeDownPaymentSavingsPricingEngine(BigDecimal baseRate) {

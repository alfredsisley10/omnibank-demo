...
/**
 * Immutable descriptor for the Home Down Payment Savings product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record HomeDownPaymentSavingsProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static HomeDownPaymentSavingsProduct defaults() {
        return new HomeDownPaymentSavingsProduct(
                UUID.fromString("00000000-0000-0000-0000-4fe22f8c0000"),
                "SAV-HOMEDOWNPAYMENTSAVINGS",
    ...
    public HomeDownPaymentSavingsProduct {

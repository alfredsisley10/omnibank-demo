...
/**
 * Regulation-mandated disclosure text for the Home Down Payment Savings product.
 ...
 */
public final class HomeDownPaymentSavingsDisclosure {

    public String title() {
        return "Home Down Payment Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Home Down Payment Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Home Down Payment Savings.",

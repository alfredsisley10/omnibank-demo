...
/**
 * Eligibility rule engine for the Home Down Payment Savings product. Evaluates age,
 ...
 */
public final class HomeDownPaymentSavingsEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Home Down Payment Savings",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Eligibility rule engine for the 24 Month CD product. Evaluates age,
 ...
 */
public final class CdLadder24MonthEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening 24 Month CD",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Regulation-mandated disclosure text for the 24 Month CD product.
 ...
 */
public final class CdLadder24MonthDisclosure {

    public String title() {
        return "24 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (180 <= 0) {
            return List.of("No early withdrawal penalty applies to the 24 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the 24 Month CD.",

...
/**
 * Pricing and interest accrual for the 24 Month CD product. Uses simple
 ...
 * engine.
 */
public final class CdLadder24MonthPricingEngine {
    ...
    public CdLadder24MonthPricingEngine() {
        this(new BigDecimal("0.0450"));
    }

    public CdLadder24MonthPricingEngine(BigDecimal baseRate) {

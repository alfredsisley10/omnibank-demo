...
/**
 * Eligibility rule engine for the Premier Money Market product. Evaluates age,
 ...
 */
public final class PremierMoneyMarketEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Premier Money Market",
                        Finding.Severity.BLOCKER));
            }

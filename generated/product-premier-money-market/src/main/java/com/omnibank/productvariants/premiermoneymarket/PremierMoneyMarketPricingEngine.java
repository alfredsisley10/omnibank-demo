...
/**
 * Pricing and interest accrual for the Premier Money Market product. Uses simple
 ...
 * engine.
 */
public final class PremierMoneyMarketPricingEngine {
    ...
    public PremierMoneyMarketPricingEngine() {
        this(new BigDecimal("0.0325"));
    }

    public PremierMoneyMarketPricingEngine(BigDecimal baseRate) {

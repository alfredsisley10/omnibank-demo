...
/**
 * Regulation-mandated disclosure text for the Premier Money Market product.
 ...
 */
public final class PremierMoneyMarketDisclosure {

    public String title() {
        return "Premier Money Market — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Premier Money Market.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Premier Money Market.",

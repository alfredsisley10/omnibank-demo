...
/**
 * Pricing and interest accrual for the SEP IRA product. Uses simple
 ...
 * engine.
 */
public final class SepIraPricingEngine {
    ...
    public SepIraPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public SepIraPricingEngine(BigDecimal baseRate) {

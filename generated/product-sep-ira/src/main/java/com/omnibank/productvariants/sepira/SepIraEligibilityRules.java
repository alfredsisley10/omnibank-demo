...
/**
 * Eligibility rule engine for the SEP IRA product. Evaluates age,
 ...
 */
public final class SepIraEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening SEP IRA",
                        Finding.Severity.BLOCKER));
            }

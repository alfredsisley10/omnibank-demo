...
public record SepIraProduct(
    ...
    public static SepIraProduct defaults() {
        return new SepIraProduct(
                UUID.fromString("00000000-0000-0000-0000-6c9a74c60000"),
                "RET-SEPIRA",
                "SEP IRA",
                "RETIREMENT",
                "SMALL_BUSINESS",

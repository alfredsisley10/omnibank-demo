...
/**
 * Regulation-mandated disclosure text for the SEP IRA product.
 ...
 */
public final class SepIraDisclosure {

    public String title() {
        return "SEP IRA — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the SEP IRA.");
        }
        return List.of(
                "An early withdrawal penalty applies to the SEP IRA.",

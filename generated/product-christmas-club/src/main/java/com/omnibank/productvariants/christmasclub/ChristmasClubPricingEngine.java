...
/**
 * Pricing and interest accrual for the Christmas Club Savings product. Uses simple
 ...
 * engine.
 */
public final class ChristmasClubPricingEngine {
    ...
    public ChristmasClubPricingEngine() {
        this(new BigDecimal("0.0075"));
    }

    public ChristmasClubPricingEngine(BigDecimal baseRate) {

...
/**
 * Eligibility rule engine for the Christmas Club Savings product. Evaluates age,
 ...
 */
public final class ChristmasClubEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Christmas Club Savings",
                        Finding.Severity.BLOCKER));
            }

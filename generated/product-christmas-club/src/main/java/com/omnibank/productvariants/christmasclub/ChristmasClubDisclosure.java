...
/**
 * Regulation-mandated disclosure text for the Christmas Club Savings product.
 ...
 */
public final class ChristmasClubDisclosure {

    public String title() {
        return "Christmas Club Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (365 <= 0) {
            return List.of("No early withdrawal penalty applies to the Christmas Club Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Christmas Club Savings.",

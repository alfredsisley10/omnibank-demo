...
/**
 * Pricing and interest accrual for the Uninvested Cash Sweep product. Uses simple
 ...
 * engine.
 */
public final class UninvestedCashSweepPricingEngine {
    ...
    public UninvestedCashSweepPricingEngine() {
        this(new BigDecimal("0.0475"));
    }

    public UninvestedCashSweepPricingEngine(BigDecimal baseRate) {

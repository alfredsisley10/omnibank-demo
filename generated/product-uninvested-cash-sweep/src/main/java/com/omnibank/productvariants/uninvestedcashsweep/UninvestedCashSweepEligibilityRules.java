...
/**
 * Eligibility rule engine for the Uninvested Cash Sweep product. Evaluates age,
 ...
 */
public final class UninvestedCashSweepEligibilityRules {
        ...
        if (true) {
            if (!applicant.identityVerified()) {
                findings.add(new Finding("ID_NOT_VERIFIED",
                        "Identity must be verified before opening Uninvested Cash Sweep",
                        Finding.Severity.BLOCKER));
            }

...
/**
 * Regulation-mandated disclosure text for the Uninvested Cash Sweep product.
 ...
 */
public final class UninvestedCashSweepDisclosure {

    public String title() {
        return "Uninvested Cash Sweep — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the Uninvested Cash Sweep.");
        }
        return List.of(
                "An early withdrawal penalty applies to the Uninvested Cash Sweep.",

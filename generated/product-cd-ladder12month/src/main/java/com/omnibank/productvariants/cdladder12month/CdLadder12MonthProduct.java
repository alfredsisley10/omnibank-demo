...
/**
 * Immutable descriptor for the 12 Month CD product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record CdLadder12MonthProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static CdLadder12MonthProduct defaults() {
        return new CdLadder12MonthProduct(
                UUID.fromString("00000000-0000-0000-0000-4965cb7c0000"),
                "CER-CDLADDER12MONTH",
                "12 Month CD",
                "CERTIFICATE",
                "ADULT",

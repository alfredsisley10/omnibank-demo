...
/**
 * Pricing and interest accrual for the 12 Month CD product. Uses simple
 ...
 * engine.
 */
public final class CdLadder12MonthPricingEngine {
    ...
    public CdLadder12MonthPricingEngine() {
        this(new BigDecimal("0.0425"));
    }

    public CdLadder12MonthPricingEngine(BigDecimal baseRate) {

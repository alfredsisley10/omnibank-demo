...
/**
 * Regulation-mandated disclosure text for the 12 Month CD product.
 ...
 */
public final class CdLadder12MonthDisclosure {

    public String title() {
        return "12 Month CD — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (90 <= 0) {
            return List.of("No early withdrawal penalty applies to the 12 Month CD.");
        }
        return List.of(
                "An early withdrawal penalty applies to the 12 Month CD.",

...
/**
 * Regulation-mandated disclosure text for the First Account Savings product.
 ...
 */
public final class FirstAccountSavingsDisclosure {

    public String title() {
        return "First Account Savings — Truth in Savings Disclosure";
    }
    ...
    public List<String> earlyWithdrawalPenalty() {
        if (0 <= 0) {
            return List.of("No early withdrawal penalty applies to the First Account Savings.");
        }
        return List.of(
                "An early withdrawal penalty applies to the First Account Savings.",

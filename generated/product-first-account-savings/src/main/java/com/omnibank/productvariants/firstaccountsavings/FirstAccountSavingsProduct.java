...
/**
 * Immutable descriptor for the First Account Savings product. Values come from the
 * product catalog and are stamped into the domain layer once the product
 * is activated for a customer.
 */
public record FirstAccountSavingsProduct(
        UUID productId,
        String productCode,
        String displayName,
        String category,
    ...
    public static FirstAccountSavingsProduct defaults() {
        return new FirstAccountSavingsProduct(
                UUID.fromString("00000000-0000-0000-0000-32b8907c0000"),
                "SAV-FIRSTACCOUNTSAVINGS",
    ...
    public FirstAccountSavingsProduct {

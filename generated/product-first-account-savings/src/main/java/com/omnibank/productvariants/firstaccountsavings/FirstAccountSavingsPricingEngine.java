...
/**
 * Pricing and interest accrual for the First Account Savings product. Uses simple
 ...
 * engine.
 */
public final class FirstAccountSavingsPricingEngine {
    ...
    public FirstAccountSavingsPricingEngine() {
        this(new BigDecimal("0.0150"));
    }

    public FirstAccountSavingsPricingEngine(BigDecimal baseRate) {

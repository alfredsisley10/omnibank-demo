...
/**
 * Pricing and interest accrual for the Solo 401(k) product. Uses simple
 ...
 * engine.
 */
public final class Sep401kPricingEngine {
    ...
    public Sep401kPricingEngine() {
        this(new BigDecimal("0.0450"));
    }

    public Sep401kPricingEngine(BigDecimal baseRate) {

package com.omnibank.brand.smallbizchecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for SmallBizChecking on SilverBank.
 */
public final class SmallBizCheckingSilverbankBrandProfile {

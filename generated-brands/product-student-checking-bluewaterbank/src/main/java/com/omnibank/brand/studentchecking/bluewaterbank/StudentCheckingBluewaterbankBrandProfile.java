package com.omnibank.brand.studentchecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for StudentChecking on BlueWater Community Bank.
 */
public final class StudentCheckingBluewaterbankBrandProfile {

package com.omnibank.brand.vacationclub.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for VacationClub on Omnibank.
 */
public final class VacationClubOmnibankBrandProfile {

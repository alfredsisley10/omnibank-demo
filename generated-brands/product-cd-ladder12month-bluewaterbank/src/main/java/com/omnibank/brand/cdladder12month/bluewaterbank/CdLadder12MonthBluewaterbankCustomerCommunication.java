 ...
 * statement inserts) for CdLadder12Month under BlueWater Community Bank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class CdLadder12MonthBluewaterbankCustomerCommunication {

package com.omnibank.brand.premiermoneymarket.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for PremierMoneyMarket on Omnibank.
 */
public final class PremierMoneyMarketOmnibankBrandProfile {

    private final String brandCode = "OMNIBANK";
    private final String displayName = "Omnibank";
    private final String tagline = "Banking for everyone";
    private final String primarySegment = "UNIVERSAL";
    private final String primaryColor = "#0A3D62";
    ...
    private final int brandFounded = 1987;

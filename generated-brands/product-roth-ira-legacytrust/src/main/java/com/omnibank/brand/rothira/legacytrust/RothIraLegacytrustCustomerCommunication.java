 ...
 * statement inserts) for RothIra under Legacy Trust. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class RothIraLegacytrustCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your RothIra account?",

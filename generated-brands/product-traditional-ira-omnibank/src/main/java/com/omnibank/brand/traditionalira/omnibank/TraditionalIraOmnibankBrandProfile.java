package com.omnibank.brand.traditionalira.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for TraditionalIra on Omnibank.
 */
public final class TraditionalIraOmnibankBrandProfile {

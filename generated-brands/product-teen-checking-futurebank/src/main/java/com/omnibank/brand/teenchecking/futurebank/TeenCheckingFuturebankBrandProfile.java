package com.omnibank.brand.teenchecking.futurebank;

import java.util.List;

/**
 * Brand metadata and policy profile for TeenChecking on FutureBank.
 */
public final class TeenCheckingFuturebankBrandProfile {

...
class TeenCheckingFuturebankBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new TeenCheckingFuturebankBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new TeenCheckingFuturebankOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new TeenCheckingFuturebankPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new TeenCheckingFuturebankMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new TeenCheckingFuturebankCustomerCommunication();

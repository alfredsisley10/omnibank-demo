package com.omnibank.brand.smallbizchecking.omnidirect;

import java.math.BigDecimal;
import org.junit.jupiter.api.Test;
import static org.assertj.core.api.Assertions.assertThat;

class SmallBizCheckingOmnidirectBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new SmallBizCheckingOmnidirectBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new SmallBizCheckingOmnidirectOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new SmallBizCheckingOmnidirectPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new SmallBizCheckingOmnidirectMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new SmallBizCheckingOmnidirectCustomerCommunication();

package com.omnibank.brand.basicchecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for BasicChecking on SilverBank.
 */
public final class BasicCheckingSilverbankBrandProfile {

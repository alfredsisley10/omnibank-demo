 ...
 * statement inserts) for BasicChecking under SilverBank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class BasicCheckingSilverbankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your BasicChecking account?",

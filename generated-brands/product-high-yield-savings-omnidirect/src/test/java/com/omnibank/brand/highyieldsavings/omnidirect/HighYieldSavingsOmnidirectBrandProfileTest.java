package com.omnibank.brand.highyieldsavings.omnidirect;

import java.math.BigDecimal;
import org.junit.jupiter.api.Test;
import static org.assertj.core.api.Assertions.assertThat;

class HighYieldSavingsOmnidirectBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new HighYieldSavingsOmnidirectBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new HighYieldSavingsOmnidirectOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new HighYieldSavingsOmnidirectPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new HighYieldSavingsOmnidirectMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new HighYieldSavingsOmnidirectCustomerCommunication();

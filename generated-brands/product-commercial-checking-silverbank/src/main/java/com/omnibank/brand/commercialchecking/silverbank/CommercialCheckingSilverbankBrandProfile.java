package com.omnibank.brand.commercialchecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for CommercialChecking on SilverBank.
 */
public final class CommercialCheckingSilverbankBrandProfile {

 ...
 * statement inserts) for DigitalOnlyChecking under SilverBank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class DigitalOnlyCheckingSilverbankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                "How likely are you to recommend SilverBank to a friend or colleague? (0-10)",
                "What was the most helpful part of opening your DigitalOnlyChecking account?",
    ...
    public String unsubscribeFooter() {
        return "To manage your email preferences, visit your SilverBank profile settings. "

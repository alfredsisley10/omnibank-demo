package com.omnibank.brand.digitalonlychecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for DigitalOnlyChecking on SilverBank.
 */
public final class DigitalOnlyCheckingSilverbankBrandProfile {

    private final String brandCode = "SILVERBANK";
    private final String displayName = "SilverBank";
    private final String tagline = "Banking designed for life after 55";
    private final String primarySegment = "SENIOR";
    private final String primaryColor = "#B68D40";
    private final boolean digitalOnly = false;
    private final int minimumAge = 55;
    private final boolean premiumBrand = false;
    private final boolean supportsForeignCurrency = false;
    private final int brandFounded = 2002;

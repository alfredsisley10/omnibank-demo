...
/**
 * Brand-tailored onboarding flow for DigitalOnlyChecking under SilverBank.
 ...
 */
public final class DigitalOnlyCheckingSilverbankOnboardingFlow {
    ...
    public List<Step> steps() {
        ...
        if ("STARTUPFI".equals("SILVERBANK")) {
        ...
        if ("OMNIDIRECT".equals("SILVERBANK")) {

package com.omnibank.brand.highyieldsavings.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for HighYieldSavings on SilverBank.
 */
public final class HighYieldSavingsSilverbankBrandProfile {

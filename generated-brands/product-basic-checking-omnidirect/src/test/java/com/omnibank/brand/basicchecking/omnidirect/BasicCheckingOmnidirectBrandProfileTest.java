package com.omnibank.brand.basicchecking.omnidirect;

import java.math.BigDecimal;
import org.junit.jupiter.api.Test;
import static org.assertj.core.api.Assertions.assertThat;

class BasicCheckingOmnidirectBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new BasicCheckingOmnidirectBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new BasicCheckingOmnidirectOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new BasicCheckingOmnidirectPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new BasicCheckingOmnidirectMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new BasicCheckingOmnidirectCustomerCommunication();

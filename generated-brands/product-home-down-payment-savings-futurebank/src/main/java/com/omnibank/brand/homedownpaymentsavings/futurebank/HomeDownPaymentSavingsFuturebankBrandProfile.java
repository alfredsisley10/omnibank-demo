package com.omnibank.brand.homedownpaymentsavings.futurebank;

import java.util.List;

/**
 * Brand metadata and policy profile for HomeDownPaymentSavings on FutureBank.
 */
public final class HomeDownPaymentSavingsFuturebankBrandProfile {

    private final String brandCode = "FUTUREBANK";
    private final String displayName = "FutureBank";
    private final String tagline = "Youth and family banking";
    private final String primarySegment = "FAMILY";
    private final String primaryColor = "#FD79A8";
    private final boolean digitalOnly = false;
    private final int minimumAge = 0;
    private final boolean premiumBrand = false;
    private final boolean supportsForeignCurrency = false;
    private final int brandFounded = 2009;

 ...
 * statement inserts) for VacationClub under BlueWater Community Bank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class VacationClubBluewaterbankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your VacationClub account?",

package com.omnibank.brand.vacationclub.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for VacationClub on BlueWater Community Bank.
 */
public final class VacationClubBluewaterbankBrandProfile {

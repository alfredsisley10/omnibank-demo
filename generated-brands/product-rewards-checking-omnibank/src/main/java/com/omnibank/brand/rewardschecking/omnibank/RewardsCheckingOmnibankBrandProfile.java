package com.omnibank.brand.rewardschecking.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for RewardsChecking on Omnibank.
 */
public final class RewardsCheckingOmnibankBrandProfile {

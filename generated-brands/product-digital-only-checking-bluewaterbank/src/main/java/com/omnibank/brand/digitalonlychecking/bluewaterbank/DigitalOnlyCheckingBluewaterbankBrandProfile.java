package com.omnibank.brand.digitalonlychecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for DigitalOnlyChecking on BlueWater Community Bank.
 */
public final class DigitalOnlyCheckingBluewaterbankBrandProfile {

    private final String brandCode = "BLUEWATERBANK";
    private final String displayName = "BlueWater Community Bank";
    private final String tagline = "Your community bank";
    private final String primarySegment = "COMMUNITY";
    private final String primaryColor = "#0984E3";
    ...
    private final int brandFounded = 1971;

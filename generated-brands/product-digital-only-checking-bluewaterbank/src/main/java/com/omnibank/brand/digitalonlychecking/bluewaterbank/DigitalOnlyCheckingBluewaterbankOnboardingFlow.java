...
/**
 * Brand-tailored onboarding flow for DigitalOnlyChecking under BlueWater Community Bank.
 ...
 */
public final class DigitalOnlyCheckingBluewaterbankOnboardingFlow {
    ...
    public List<Step> steps() {
        ...
        if ("STARTUPFI".equals("BLUEWATERBANK")) {
        ...
        if ("OMNIDIRECT".equals("BLUEWATERBANK")) {

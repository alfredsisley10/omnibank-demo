 ...
 * statement inserts) for StandardSavings under SilverBank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class StandardSavingsSilverbankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your StandardSavings account?",

package com.omnibank.brand.standardsavings.silverbank;
 ...
 */
public final class StandardSavingsSilverbankMarketingCopy {
    ...
    public String heroHeadline() {
        return switch ("SILVERBANK") {
            ...
            default -> "Standard Savings from SilverBank.";
        };
    }

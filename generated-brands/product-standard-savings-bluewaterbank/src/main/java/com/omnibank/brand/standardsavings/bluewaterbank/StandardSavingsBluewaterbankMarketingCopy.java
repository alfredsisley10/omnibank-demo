package com.omnibank.brand.standardsavings.bluewaterbank;

/**
 * Marketing copy snippets per brand for StandardSavings. Copy tone and
 * vocabulary shift dramatically — LegacyTrust speaks formally
 * in third person; FutureBank uses emoji and short sentences.
 */
public final class StandardSavingsBluewaterbankMarketingCopy {

    public String heroHeadline() {
        return switch ("BLUEWATERBANK") {
            case "OMNIBANK" -> "Your Standard Savings — done.";
            case "OMNIDIRECT" -> "Open Standard Savings in 4 minutes. Seriously.";
            case "SILVERBANK" -> "Thoughtful Standard Savings for life after 55.";
            case "STARTUPFI" -> "Standard Savings built for founders who can't wait.";
            case "LEGACYTRUST" -> "Legacy Trust is pleased to offer Standard Savings to qualified clients.";
            case "FUTUREBANK" -> "Saving is simple. Saving is fun. Standard Savings.";
            case "BLUEWATERBANK" -> "Standard Savings from your community bank.";
            default -> "Standard Savings from BlueWater Community Bank.";
        };
    }

package com.omnibank.brand.basicchecking.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for BasicChecking on Omnibank.
 */
public final class BasicCheckingOmnibankBrandProfile {

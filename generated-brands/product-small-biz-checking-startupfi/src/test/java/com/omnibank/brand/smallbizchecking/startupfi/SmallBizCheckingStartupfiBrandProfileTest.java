...
class SmallBizCheckingStartupfiBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new SmallBizCheckingStartupfiBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new SmallBizCheckingStartupfiOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new SmallBizCheckingStartupfiPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new SmallBizCheckingStartupfiMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new SmallBizCheckingStartupfiCustomerCommunication();

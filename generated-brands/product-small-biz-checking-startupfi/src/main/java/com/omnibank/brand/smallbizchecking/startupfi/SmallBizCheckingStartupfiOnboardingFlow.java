...
/**
 * Brand-tailored onboarding flow for SmallBizChecking under StartupFi.
 ...
 */
public final class SmallBizCheckingStartupfiOnboardingFlow {
    ...
    public List<Step> steps() {
        ...
        if ("OMNIDIRECT".equals("STARTUPFI")) {

 ...
 * statement inserts) for SmallBizChecking under StartupFi. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class SmallBizCheckingStartupfiCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                "How likely are you to recommend StartupFi to a friend or colleague? (0-10)",
    ...
    public String unsubscribeFooter() {
        return "To manage your email preferences, visit your StartupFi profile settings. "

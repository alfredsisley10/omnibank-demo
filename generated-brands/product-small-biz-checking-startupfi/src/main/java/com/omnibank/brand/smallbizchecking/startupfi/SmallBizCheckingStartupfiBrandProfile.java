package com.omnibank.brand.smallbizchecking.startupfi;

import java.util.List;

/**
 * Brand metadata and policy profile for SmallBizChecking on StartupFi.
 */
public final class SmallBizCheckingStartupfiBrandProfile {

    private final String brandCode = "STARTUPFI";
    private final String displayName = "StartupFi";
    private final String tagline = "Business banking for founders";
    private final String primarySegment = "SMALL_BUSINESS";
    private final String primaryColor = "#6C5CE7";
    ...
    private final int brandFounded = 2018;

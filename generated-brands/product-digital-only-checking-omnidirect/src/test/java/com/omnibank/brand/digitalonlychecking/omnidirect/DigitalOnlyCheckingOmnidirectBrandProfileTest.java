package com.omnibank.brand.digitalonlychecking.omnidirect;

import java.math.BigDecimal;
import org.junit.jupiter.api.Test;
import static org.assertj.core.api.Assertions.assertThat;

class DigitalOnlyCheckingOmnidirectBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new DigitalOnlyCheckingOmnidirectBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new DigitalOnlyCheckingOmnidirectOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new DigitalOnlyCheckingOmnidirectPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new DigitalOnlyCheckingOmnidirectMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new DigitalOnlyCheckingOmnidirectCustomerCommunication();

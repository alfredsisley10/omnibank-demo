...
/**
 * Brand-tailored onboarding flow for DigitalOnlyChecking under OmniDirect.
 ...
 */
public final class DigitalOnlyCheckingOmnidirectOnboardingFlow {
    ...
    public List<Step> steps() {
        ...
        if ("STARTUPFI".equals("OMNIDIRECT")) {
        ...
        if ("OMNIDIRECT".equals("OMNIDIRECT")) {

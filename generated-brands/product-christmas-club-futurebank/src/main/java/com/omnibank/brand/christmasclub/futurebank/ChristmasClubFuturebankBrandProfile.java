package com.omnibank.brand.christmasclub.futurebank;

import java.util.List;

/**
 * Brand metadata and policy profile for ChristmasClub on FutureBank.
 */
public final class ChristmasClubFuturebankBrandProfile {

 ...
 * statement inserts) for ChristmasClub under FutureBank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class ChristmasClubFuturebankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                "How likely are you to recommend FutureBank to a friend or colleague? (0-10)",
                "What was the most helpful part of opening your ChristmasClub account?",
    ...
    public String unsubscribeFooter() {
        return "To manage your email preferences, visit your FutureBank profile settings. "

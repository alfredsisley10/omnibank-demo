package com.omnibank.brand.traditionalira.legacytrust;

import java.util.List;

/**
 * Brand-shaped customer communication (emails, push notifications,
 * statement inserts) for TraditionalIra under Legacy Trust. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class TraditionalIraLegacytrustCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your TraditionalIra account?",

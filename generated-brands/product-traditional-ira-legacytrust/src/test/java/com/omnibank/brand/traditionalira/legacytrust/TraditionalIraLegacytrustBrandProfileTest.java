...
class TraditionalIraLegacytrustBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new TraditionalIraLegacytrustBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new TraditionalIraLegacytrustOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new TraditionalIraLegacytrustPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new TraditionalIraLegacytrustMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new TraditionalIraLegacytrustCustomerCommunication();

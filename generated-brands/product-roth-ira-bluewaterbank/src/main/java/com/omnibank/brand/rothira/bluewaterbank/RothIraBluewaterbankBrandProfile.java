package com.omnibank.brand.rothira.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for RothIra on BlueWater Community Bank.
 */
public final class RothIraBluewaterbankBrandProfile {

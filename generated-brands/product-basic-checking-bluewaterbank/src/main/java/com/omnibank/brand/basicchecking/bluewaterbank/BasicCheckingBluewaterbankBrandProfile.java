package com.omnibank.brand.basicchecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for BasicChecking on BlueWater Community Bank.
 */
public final class BasicCheckingBluewaterbankBrandProfile {

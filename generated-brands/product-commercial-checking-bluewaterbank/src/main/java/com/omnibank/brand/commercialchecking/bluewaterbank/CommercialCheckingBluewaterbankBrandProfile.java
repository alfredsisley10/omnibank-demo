package com.omnibank.brand.commercialchecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for CommercialChecking on BlueWater Community Bank.
 */
public final class CommercialCheckingBluewaterbankBrandProfile {

package com.omnibank.brand.seniorchecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for SeniorChecking on SilverBank.
 */
public final class SeniorCheckingSilverbankBrandProfile {

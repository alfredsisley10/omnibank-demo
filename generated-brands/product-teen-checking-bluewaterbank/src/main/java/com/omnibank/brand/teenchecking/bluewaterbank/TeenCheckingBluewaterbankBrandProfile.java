package com.omnibank.brand.teenchecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for TeenChecking on BlueWater Community Bank.
 */
public final class TeenCheckingBluewaterbankBrandProfile {

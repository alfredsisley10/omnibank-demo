 ...
 * statement inserts) for VeteranChecking under SilverBank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class VeteranCheckingSilverbankCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your VeteranChecking account?",

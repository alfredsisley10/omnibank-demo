package com.omnibank.brand.highyieldsavings.omnibank;

import java.util.List;

/**
 * Brand metadata and policy profile for HighYieldSavings on Omnibank.
 */
public final class HighYieldSavingsOmnibankBrandProfile {

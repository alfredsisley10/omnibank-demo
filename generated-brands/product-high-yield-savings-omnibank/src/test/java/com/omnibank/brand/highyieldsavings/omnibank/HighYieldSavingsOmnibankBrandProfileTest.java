...
class HighYieldSavingsOmnibankBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new HighYieldSavingsOmnibankBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new HighYieldSavingsOmnibankOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new HighYieldSavingsOmnibankPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new HighYieldSavingsOmnibankMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new HighYieldSavingsOmnibankCustomerCommunication();

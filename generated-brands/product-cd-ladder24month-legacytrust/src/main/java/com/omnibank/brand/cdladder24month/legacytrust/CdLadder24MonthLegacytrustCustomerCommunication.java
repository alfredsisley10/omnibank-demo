 ...
 * statement inserts) for CdLadder24Month under Legacy Trust. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class CdLadder24MonthLegacytrustCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your CdLadder24Month account?",

...
/**
 * Marketing copy snippets per brand for CdLadder24Month. Copy tone and
 * vocabulary shift dramatically — LegacyTrust speaks formally
 * in third person; FutureBank uses emoji and short sentences.
 */
public final class CdLadder24MonthLegacytrustMarketingCopy {

    public String heroHeadline() {
        return switch ("LEGACYTRUST") {
            case "OMNIBANK" -> "Your Cd Ladder24Month — done.";
            case "OMNIDIRECT" -> "Open Cd Ladder24Month in 4 minutes. Seriously.";
            case "SILVERBANK" -> "Thoughtful Cd Ladder24Month for life after 55.";
            case "STARTUPFI" -> "Cd Ladder24Month built for founders who can't wait.";
            case "LEGACYTRUST" -> "Legacy Trust is pleased to offer Cd Ladder24Month to qualified clients.";
            case "FUTUREBANK" -> "Saving is simple. Saving is fun. Cd Ladder24Month.";
            case "BLUEWATERBANK" -> "Cd Ladder24Month from your community bank.";
            default -> "Cd Ladder24Month from Legacy Trust.";
        };
    }
    ...
    public String footerLegal() {
        return "Legacy Trust is a service of Omnibank, N.A. "

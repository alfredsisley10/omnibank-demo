package com.omnibank.brand.highyieldsavings.legacytrust;

import java.util.List;

/**
 * Brand-shaped customer communication (emails, push notifications,
 * statement inserts) for HighYieldSavings under Legacy Trust. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class HighYieldSavingsLegacytrustCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                "How likely are you to recommend Legacy Trust to a friend or colleague? (0-10)",
                "What was the most helpful part of opening your HighYieldSavings account?",
    ...
    public String unsubscribeFooter() {
        return "To manage your email preferences, visit your Legacy Trust profile settings. "

package com.omnibank.brand.veteranchecking.bluewaterbank;

/**
 * Marketing copy snippets per brand for VeteranChecking. Copy tone and
 * vocabulary shift dramatically — LegacyTrust speaks formally
 * in third person; FutureBank uses emoji and short sentences.
 */
public final class VeteranCheckingBluewaterbankMarketingCopy {

    public String heroHeadline() {
        return switch ("BLUEWATERBANK") {
            case "OMNIBANK" -> "Your Veteran Checking — done.";
            case "OMNIDIRECT" -> "Open Veteran Checking in 4 minutes. Seriously.";
            case "SILVERBANK" -> "Thoughtful Veteran Checking for life after 55.";
            case "STARTUPFI" -> "Veteran Checking built for founders who can't wait.";
            case "LEGACYTRUST" -> "Legacy Trust is pleased to offer Veteran Checking to qualified clients.";
            case "FUTUREBANK" -> "Saving is simple. Saving is fun. Veteran Checking.";
            case "BLUEWATERBANK" -> "Veteran Checking from your community bank.";
            default -> "Veteran Checking from BlueWater Community Bank.";
        };
    }

...
class CdLadder24MonthOmnibankBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new CdLadder24MonthOmnibankBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new CdLadder24MonthOmnibankOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new CdLadder24MonthOmnibankPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new CdLadder24MonthOmnibankMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new CdLadder24MonthOmnibankCustomerCommunication();

...
class CdLadder12MonthLegacytrustBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new CdLadder12MonthLegacytrustBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new CdLadder12MonthLegacytrustOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new CdLadder12MonthLegacytrustPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new CdLadder12MonthLegacytrustMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new CdLadder12MonthLegacytrustCustomerCommunication();

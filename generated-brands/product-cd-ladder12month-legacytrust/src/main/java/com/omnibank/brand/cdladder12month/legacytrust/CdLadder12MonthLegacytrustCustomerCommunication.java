 ...
 * statement inserts) for CdLadder12Month under Legacy Trust. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class CdLadder12MonthLegacytrustCustomerCommunication {
    ...
    public List<String> postCloseSurveyQuestions() {
        return List.of(
                ...
                "What was the most helpful part of opening your CdLadder12Month account?",

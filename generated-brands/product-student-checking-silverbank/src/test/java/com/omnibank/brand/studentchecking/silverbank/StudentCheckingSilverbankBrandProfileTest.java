...
class StudentCheckingSilverbankBrandProfileTest {

    @Test
    void brand_profile_reports_expected_code() {
        var p = new StudentCheckingSilverbankBrandProfile();
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new StudentCheckingSilverbankOnboardingFlow();
    ...
    void pricing_override_apy_does_not_decrease_rate() {
        var po = new StudentCheckingSilverbankPricingOverride();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new StudentCheckingSilverbankMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new StudentCheckingSilverbankCustomerCommunication();

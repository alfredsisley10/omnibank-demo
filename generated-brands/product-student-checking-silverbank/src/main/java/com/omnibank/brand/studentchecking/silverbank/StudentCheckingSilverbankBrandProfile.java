package com.omnibank.brand.studentchecking.silverbank;

import java.util.List;

/**
 * Brand metadata and policy profile for StudentChecking on SilverBank.
 */
public final class StudentCheckingSilverbankBrandProfile {

...
class EssentialCheckingOmnidirectBrandProfileTest {
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new EssentialCheckingOmnidirectOnboardingFlow();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new EssentialCheckingOmnidirectMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new EssentialCheckingOmnidirectCustomerCommunication();

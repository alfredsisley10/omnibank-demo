...
/**
 * Brand-tailored onboarding flow for PremierMoneyMarket under Legacy Trust.
 ...
 */
public final class PremierMoneyMarketLegacytrustOnboardingFlow {
    ...
    public List<Step> steps() {
        ...
        if ("STARTUPFI".equals("LEGACYTRUST")) {
        ...
        if ("OMNIDIRECT".equals("LEGACYTRUST")) {

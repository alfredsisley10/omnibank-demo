 ...
 * statement inserts) for RewardsChecking under BlueWater Community Bank. Different brands
 * use different senders, signature blocks, and contact routes.
 */
public final class RewardsCheckingBluewaterbankCustomerCommunication {

package com.omnibank.brand.rewardschecking.bluewaterbank;

import java.util.List;

/**
 * Brand metadata and policy profile for RewardsChecking on BlueWater Community Bank.
 */
public final class RewardsCheckingBluewaterbankBrandProfile {

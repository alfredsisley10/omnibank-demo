...
class ChristmasClubBluewaterbankBrandProfileTest {
    ...
    void onboarding_flow_has_required_identity_step() {
        var flow = new ChristmasClubBluewaterbankOnboardingFlow();
    ...
    void marketing_headline_is_nonblank() {
        var mc = new ChristmasClubBluewaterbankMarketingCopy();
    ...
    void communication_sender_is_nonblank() {
        var cc = new ChristmasClubBluewaterbankCustomerCommunication();
